...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9BD33CC84D
	for <lists+alsa-devel@lfdr.de>; Sat,  5 Oct 2019 08:05:05 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 29E8B168D;
	Sat,  5 Oct 2019 08:04:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 29E8B168D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1570255505;
	bh=JCHpl13qVcWRk0ZMtjDVev0p4XdfPtVHVNe7UkmVsBM=;
	h=Date:In-Reply-To:References:From:To:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=SRdhKqaB4MPEOtvQuyGZ4rhK0yrvT4mQgioQPdmay6W3sBBpMluA4I2pT9rV4q7De
	 jmpWYMlXv9wRbVsP1Ho6gOrNSOj7UpPOipc64Bza/1LqJjR6ux4n3Q0ORdPQGhU7ev
	 246RgJq9nJ/1VWCCcvNV7SRceziyF2E04u6+GCSg=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id CAB42F80679;
	Sat,  5 Oct 2019 07:59:14 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id B2F3EF80676; Sat,  5 Oct 2019 07:59:12 +0200 (CEST)
...
Received: from mail-qt1-x84a.google.com (mail-qt1-x84a.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 1B81BF80671
 for <alsa-devel@alsa-project.org>; Sat,  5 Oct 2019 07:59:08 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 1B81BF80671
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=google.com header.i=@google.com
 header.b="vsk3Wg7m"
Received: by mail-qt1-x84a.google.com with SMTP id o34so8940636qtf.22
 for <alsa-devel@alsa-project.org>; Fri, 04 Oct 2019 22:59:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=20161025;
 h=date:in-reply-to:message-id:mime-version:references:subject:from:to
 :cc; bh=d1mgFuVV3hGsTpNJmcL0PoyHw4b7/AgA6VqHmRcyh9U=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:date:in-reply-to:message-id:mime-version
 :references:subject:from:to:cc;
 bh=d1mgFuVV3hGsTpNJmcL0PoyHw4b7/AgA6VqHmRcyh9U=;
 b=
X-Gm-Message-State: APjAAAXZEqwSFWTpiffzj3nuMN6CCEWSxuKzK4cEJ6Jg8WUaP+RWiSxo
 R5PzozTBt76KjSCGNhsbZ/hoJmPJt2p7
X-Google-Smtp-Source: APXvYqwDDIRdvQSFi85ukvbH0VPlF1GXnCYyAdNTa4WBPUhX7Tp3oJh7ldFZbWhELowOBAXpxn4nuUl0iOts
X-Received: by 2002:ad4:4cc6:: with SMTP id i6mr17934881qvz.166.1570255147430; 
 Fri, 04 Oct 2019 22:59:07 -0700 (PDT)
Date: Sat,  5 Oct 2019 13:58:05 +0800
In-Reply-To: <20191005055808.249089-1-tzungbi@google.com>
Message-Id: <20191005130552.7.I5388b69a7a9c551078fed216a77440cee6dedf49@changeid>
Mime-Version: 1.0
...
Cc: gwendal@google.com, devicetree@vger.kernel.org, alsa-devel@alsa-project.org,
 ...
 dgreid@google.com
Subject: [alsa-devel] [PATCH 07/10] ASoC: cros_ec_codec: support WoV
...
index 3d4f9e82d6e9..3b51fd5a2a63 100644
...
@@ -57,6 +99,42 @@ static int send_ec_host_command(struct cros_ec_device *ec_dev, uint32_t cmd,
 	return ret;
 }
...
@@ -324,23 +405,633 @@ static const struct snd_soc_component_driver i2s_rx_component_driver = {
