...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 2FF3965FA43
	for <lists+alsa-devel@lfdr.de>; Fri,  6 Jan 2023 04:30:17 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7D0851312B;
	Fri,  6 Jan 2023 04:29:26 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7D0851312B
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1672975816;
	bh=lk4Vi2cgpg0g97FwZ8wEBF+a5mkJYhDAdIi8DnVBSRY=;
	h=From:To:Subject:Date:In-Reply-To:References:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 Cc:From;
	b=Aaou+NhbHV2rD1+GDXemwo5HOGUvcy3s7fQ7nxLpO1YlqJpBNtha7AjbiFaNGoDlx
	 ltCSP0EAmztDNSypmlGPLUTUUJbgGFMXPhL/kysh/V6LvWzNfZTHYJR4Q60QyILD+g
	 /iXt3PgxdYISE4hl0P76ATdVAr2BoertcVlzetuk=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 3A0EBF802DB;
	Fri,  6 Jan 2023 04:29:18 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 7ADA0F80217; Fri,  6 Jan 2023 04:29:15 +0100 (CET)
...
Received: from out29-128.mail.aliyun.com (out29-128.mail.aliyun.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 57057F80217
 for <alsa-devel@alsa-project.org>; Fri,  6 Jan 2023 04:28:57 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 57057F80217
X-Alimail-AntiSpam: AC=CONTINUE; BC=0.06712911|-1; CH=green;
 DM=|CONTINUE|false|;
 DS=CONTINUE|ham_system_inform|0.00738935-0.000479261-0.992131;
 FP=0|0|0|0|0|-1|-1|-1; HT=ay29a033018047208; MF=wangweidong.a@awinic.com; NM=1;
 PH=DS; RN=26; RT=26; SR=0; TI=SMTPD_---.QlbrpCJ_1672975730; 
Received: from ubuntu-VirtualBox..(mailfrom:wangweidong.a@awinic.com
 fp:SMTPD_---.QlbrpCJ_1672975730) by smtp.aliyun-inc.com;
 Fri, 06 Jan 2023 11:28:53 +0800
...
Subject: [PATCH V9 2/5] ASoC: codecs: Aw883xx function for ACF file parse and
 check
Date: Fri,  6 Jan 2023 11:28:32 +0800
Message-Id: <20230106032835.141918-3-wangweidong.a@awinic.com>
...
index 000000000000..6cafa76e92f9
--- /dev/null
...
new file mode 100644
index 000000000000..cfb3ff403c09
--- /dev/null
+++ b/sound/soc/codecs/aw883xx/aw883xx_bin_parse.h
@@ -0,0 +1,92 @@
+// SPDX-License-Identifier: GPL-2.0-only
+//
+// aw_bin_parse.h  -- AW883XX function for ACF file parse and check
+//
+// Copyright (c) 2022 AWINIC Technology CO., LTD
+//
+// Author: Bruce zhao <zhaolei@awinic.com>
