...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 082ED7545A
	for <lists+alsa-devel@lfdr.de>; Thu, 25 Jul 2019 18:42:16 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 5F3371ED9;
	Thu, 25 Jul 2019 18:41:25 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 5F3371ED9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1564072935;
	bh=r8g2LpMXhHG8MEeQ9qz0v0bpZSIltoplgIJo7LvDx84=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Uczu5R2LBECvDoc53bKgQw0TTfiDzPs37g+5uyf+x2xQSKNNn5YtcxUuVD+7mgGJo
	 KyJcnapvjym41UukfMOGM/8HODfOldg7PCD/aLPR7uTTwka+gcSt5TAoJ++YRbc92O
	 2bugVbzVYgfIdXzLvGgMfHHwZlN8+0qfvhmiShJo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id AD8ACF8044C;
	Thu, 25 Jul 2019 18:39:47 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 84683F8045F; Thu, 25 Jul 2019 18:39:45 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id B8FCEF80392
 for <alsa-devel@alsa-project.org>; Thu, 25 Jul 2019 18:39:37 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B8FCEF80392
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="Qg0iySGD"
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
 by mx0b-001ae601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id
 x6PFwJsi020615; Thu, 25 Jul 2019 11:39:35 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=PODMain02222019;
 bh=NurMR2y6yVBmQIzjReTg219sWPZYi3CSNTBnhTCIGZk=;
 b= 2w== 
Authentication-Results: ppops.net;
 spf=fail smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from ediex01.ad.cirrus.com ([87.246.76.36])
 by mx0b-001ae601.pphosted.com with ESMTP id 2tx61nkefw-1
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id CA347448;
 Thu, 25 Jul 2019 17:39:31 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Thu, 25 Jul 2019 17:39:31 +0100
Message-ID: <20190725163931.24964-3-ckeepax@opensource.cirrus.com>
...
Cc: patches@opensource.cirrus.com, alsa-devel@alsa-project.org,
 lgirdwood@gmail.com
Subject: [alsa-devel] [PATCH v3 3/3] ASoC: cs47l92: Add codec driver for
...
Charles
 ...
 5 files changed, 2478 insertions(+), 9 deletions(-)
 create mode 100644 sound/soc/codecs/cs47l92.c

diff --git a/sound/soc/codecs/Kconfig b/sound/soc/codecs/Kconfig
index dc23476d2eea8..da4c1ae89742c 100644
...
index 174346b1418a9..9230016b0f9f7 100644
...
index 0000000000000..d50f75f3b3e41
--- /dev/null
