...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id CBB203F571A
	for <lists+alsa-devel@lfdr.de>; Tue, 24 Aug 2021 06:18:29 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id D85F1851;
	Tue, 24 Aug 2021 06:17:38 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz D85F1851
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1629778709;
	bh=YeCI9eoYGCUs5rWCFMqyTzJIKli1azk6bQ5ANo326pQ=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=OFrsJC462LwO2ykGV/hC8MobMbse/Hh0Mgf8sN38FqUAwhNCU8AOcQlIW03SIpAx/
	 bgmsgA2ON+eEPqDa5PgPCxylqxjDJatgCy6zaVAJtVJkxxk/pOkHHMkV/mNFtZsbOe
	 VWQuwoZDOP5O7Ah6rUUDVlv06NFHKfj9+xJSY9Zs=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 2A557F80087;
	Tue, 24 Aug 2021 06:17:11 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id AC1DCF801D8; Tue, 24 Aug 2021 06:17:08 +0200 (CEST)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=0.0 required=5.0 tests=SPF_HELO_NONE,SPF_NONE
 autolearn=disabled version=3.4.0
Received: from maillog.nuvoton.com (maillog.nuvoton.com [202.39.227.15])
 by alsa1.perex.cz (Postfix) with ESMTP id 4ED08F80171
 for <alsa-devel@alsa-project.org>; Tue, 24 Aug 2021 06:16:56 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 4ED08F80171
Received: from NTHCCAS04.nuvoton.com (NTHCCAS04.nuvoton.com [10.1.8.29])
 by maillog.nuvoton.com (Postfix) with ESMTP id 3FBDA1C810C2;
 Tue, 24 Aug 2021 12:16:51 +0800 (CST)
...
Received: from localhost.localdomain (10.11.36.27) by NTHCCAS01.nuvoton.com
 ...
 Transport; Tue, 24 Aug 2021 12:16:50 +0800
From: Seven Lee <wtli@nuvoton.com>
To: <broonie@kernel.org>
Subject: [PATCH] ASoC: nau8821: Add driver for Nuvoton codec NAU88L21
Date: Tue, 24 Aug 2021 12:16:47 +0800
Message-ID: <20210824041647.1732378-1-wtli@nuvoton.com>
...
In addition, DMIC function is added to calculate the clock threshold
value by device properties.
...
---
 ...
 sound/soc/codecs/nau8821.c                    | 1804 +++++++++++++++++
 sound/soc/codecs/nau8821.h                    |  533 +++++
 5 files changed, 2399 insertions(+)
...
index 8dcea2c4604a..55daf5fbc1b7 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -142,6 +142,7 @@ snd-soc-nau8315-objs := nau8315.o
...
new file mode 100644
index 000000000000..1090da91bafd
--- /dev/null
