...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 23B8D3935BD
	for <lists+alsa-devel@lfdr.de>; Thu, 27 May 2021 20:58:08 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 8D614172E;
	Thu, 27 May 2021 20:57:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 8D614172E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1622141887;
	bh=cmUVdg7WfMf5nm+YNpcCidsgH8c43/U9u/v7a+BA2Bg=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=kRh+cO1WH6noF7lRDRQAgseeHMqXwRV1XnXSQyivBG4f7X9mx0uDSG61JqQ+jrLYd
	 eEes96uC295TXmDW9fWKSKSG3R8jBjtgjueJM2pfuTKW1kBL+UwRpe4odB6XE0QFw1
	 X05xdW1owBv/YAJQqzTQAwtbbMpK7hzFjNydQJYQ=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 23BD6F80300;
	Thu, 27 May 2021 20:55:46 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 5EED3F804AF; Thu, 27 May 2021 20:55:44 +0200 (CEST)
...
Received: from mail-lf1-x130.google.com (mail-lf1-x130.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 3A983F80300
 for <alsa-devel@alsa-project.org>; Thu, 27 May 2021 20:55:32 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 3A983F80300
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="Urs/c/I3"
Received: by mail-lf1-x130.google.com with SMTP id r5so1600878lfr.5
 for <alsa-devel@alsa-project.org>; Thu, 27 May 2021 11:55:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=OoDJcXrEaicWB2zeQib4RRBPtOJDWLGSVypNu1Du+ik=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=OoDJcXrEaicWB2zeQib4RRBPtOJDWLGSVypNu1Du+ik=;
 b=
X-Gm-Message-State: AOAM533l1PyJ1rdLKBVECtLh96nYfhnOEDdNAKJnpQqxRvcBA1nMiJue
 MtNThOOVUSDL4305Qmx9KHP6bf9zvr0=
X-Google-Smtp-Source: ABdhPJzv8j3tddkfYW/clitMLjsPxQBTWwxEVB56m3KbMtVbI8KJOLauC22sHRXsU/DfXjgk3jzE6w==
X-Received: by 2002:a05:6512:36c5:: with SMTP id
 e5mr3236014lfs.41.1622141731375; 
 Thu, 27 May 2021 11:55:31 -0700 (PDT)
Received: from localhost.localdomain (46-138-12-55.dynamic.spd-mgts.ru.
 [46.138.12.55])
 by smtp.gmail.com with ESMTPSA id p16sm265217lfc.113.2021.05.27.11.55.30
...
Subject: [PATCH v4 2/3] ASoC: tegra: Unify ASoC machine drivers
Date: Thu, 27 May 2021 21:51:24 +0300
Message-Id: <20210527185125.18720-3-digetx@gmail.com>
...
---
 ...
 sound/soc/tegra/tegra_asoc_machine.c | 705 +++++++++++++++++++++++++++
 ...
 13 files changed, 842 insertions(+), 2112 deletions(-)
...
index 000000000000..a28ee0d60992
--- /dev/null
...
+}
+
+static unsigned int tegra_mclk_rate_12mhz(unsigned int srate)
+{
+	unsigned int mclk;
+
+	switch (srate) {
...
+	.mclk_rate = tegra_mclk_rate_12mhz,
...
new file mode 100644
index 000000000000..c60ac6c393a3
--- /dev/null
...
index f219c26d66a3..74101d2c7785 100644
...
-	.ops = &tegra_wm8903_ops,
 	.dai_fmt = SND_SOC_DAIFMT_I2S |
 		   SND_SOC_DAIFMT_NB_NF |
 		   SND_SOC_DAIFMT_CBS_CFS,
@@ -234,149 +129,59 @@ static struct snd_soc_dai_link tegra_wm8903_dai = {
 };
