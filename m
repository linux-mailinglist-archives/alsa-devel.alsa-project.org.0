...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 004314BA6F
	for <lists+alsa-devel@lfdr.de>; Wed, 19 Jun 2019 15:46:45 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 420B916B3;
	Wed, 19 Jun 2019 15:45:55 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 420B916B3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1560952005;
	bh=cGP3eg4OA9Sa81ABHh+OolKo/J0r4Ws132DFzfG/LcI=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=emlcLHC61nE/cMakiAMG1r1G8ICCnPiScCmXX10JZFd5Lx6xrmUBoeHi7UsqhUq6U
	 TjxDuYDptfaswm5biCK5JwCNGtC9MqgJYgxcVjSI4WLFyF/SKqbJQuVhlzL7QJCU3U
	 KIZReSZqEHhGD7KUUg33RDXlePOXE43fcmRQYbxw=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 04739F8974B;
	Wed, 19 Jun 2019 15:42:27 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 6E8CEF8973C; Wed, 19 Jun 2019 15:42:23 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id A1690F896C7
 for <alsa-devel@alsa-project.org>; Wed, 19 Jun 2019 15:42:04 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz A1690F896C7
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="P4yPAxne"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x5JDdg06003109; Wed, 19 Jun 2019 08:42:02 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=PODMain02222019;
 bh=4kSX287lsUa3dJ7VqoTDESmMm80Lt9FLQzq6c+vq7SY=;
 b= jA== 
Authentication-Results: ppops.net;
 spf=none smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from mail2.cirrus.com (mail2.cirrus.com [141.131.128.20])
 by mx0a-001ae601.pphosted.com with ESMTP id 2t780gh1ps-1;
 Wed, 19 Jun 2019 08:42:00 -0500
Received: from EDIEX02.ad.cirrus.com (unknown [198.61.84.81])
 by mail2.cirrus.com (Postfix) with ESMTP id 1943B605A6AF;
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 405F02A1;
 Wed, 19 Jun 2019 14:41:59 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Wed, 19 Jun 2019 14:41:56 +0100
Message-ID: <20190619134159.23580-2-ckeepax@opensource.cirrus.com>
...
Subject: [alsa-devel] [PATCH v3 2/5] ASoC: madera: Add common support for
...
Changes since v2:
 - Removed device tree reading code. These required adding some core
   helpers which looks like it is likely to be a fairly slow process, so
   would be good to get the rest of this code off my backlog and also
   give the larger set of reviews for those changes less code to look at.
 - General clean up of some formatting etc.
 - Removed the madera sleep helper, it was a minor optimisation just
   replaced with a normal msleep.
 - Changed the handling of mics to match the hardware far more closely
   which makes the handling in the driver slightly less error prone as
   well.
...
index 55d8b3d1a5cff..8ec586f2d20bc 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -3927,14 +3927,18 @@ W:	https://github.com/CirrusLogic/linux-drivers/wiki
 S:	Supported
...
index 8dc852402dbb1..60cd8ec985637 100644
...
index 0000000000000..441decefb7f34
--- /dev/null
...
index 4dfd4698b072c..1a50ccf872747 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -285,10 +285,12 @@ config SND_SOC_WM_HUBS
...
@@ -705,6 +707,9 @@ config SND_SOC_LOCHNAGAR_SC
...
index 112701fd44a8d..d21e1be3e7a75 100644
...
new file mode 100644
index 0000000000000..6146c7a070cb3
--- /dev/null
...
new file mode 100644
index 0000000000000..aa2db156582b9
--- /dev/null
