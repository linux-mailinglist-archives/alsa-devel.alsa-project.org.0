...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0611B71AB4
	for <lists+alsa-devel@lfdr.de>; Tue, 23 Jul 2019 16:46:39 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7A12718B3;
	Tue, 23 Jul 2019 16:45:48 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7A12718B3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1563893198;
	bh=DDPkXOFAQTCWYRDTySB0jJgWJRBm7OKsaDPuQ+u0SQs=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=GR9agdb3PNzW+G//wLxo8CzxlNCJYrh/1YRaOIDf/us0ymcEriYYkqqbuKoAGnauk
	 pOBzVLJe+WK7BawIewJaZJjPbM/xy5GDTeUGH1nJjTQFXHQpuQ4MO9Fe1tBZPMEmf8
	 r0Ai5nkrDAX7lGMuIeuAbwLrF7l4IUiJrS0em6Xk=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 3472AF8049A;
	Tue, 23 Jul 2019 16:44:24 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id F13B9F8048D; Tue, 23 Jul 2019 16:44:21 +0200 (CEST)
...
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E1315F8011C
 for <alsa-devel@alsa-project.org>; Tue, 23 Jul 2019 16:44:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E1315F8011C
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 23 Jul 2019 07:44:13 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,299,1559545200"; d="scan'208";a="177315216"
Received: from crojewsk-ctrl.igk.intel.com ([10.102.9.28])
 by FMSMGA003.fm.intel.com with ESMTP; 23 Jul 2019 07:44:10 -0700
From: Cezary Rojewski <cezary.rojewski@intel.com>
To: alsa-devel@alsa-project.org
Date: Tue, 23 Jul 2019 16:43:40 +0200
Message-Id: <20190723144341.21339-2-cezary.rojewski@intel.com>
...
Subject: [alsa-devel] [PATCH v2 1/2] ASoC: Intel: Update request-reply IPC
	model
...
index c6779e2ac830..c031bf878a72 100644
...
+	struct sst_ipc_message rx;
 	...
 	bool pending;
@@ -65,14 +66,14 @@ struct sst_generic_ipc {
...
index f2c09fa6ea40..eaaa0b19f704 100644
--- a/sound/soc/intel/skylake/cnl-sst.c
+++ b/sound/soc/intel/skylake/cnl-sst.c
@@ -367,10 +367,10 @@ static struct sst_dsp_device cnl_dev = {
...
index 2cc8f7d2d319..c040158ae282 100644
