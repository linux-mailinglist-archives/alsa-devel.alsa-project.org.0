...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D39D4BA65E
	for <lists+alsa-devel@lfdr.de>; Thu, 17 Feb 2022 17:49:10 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 769EB1A23;
	Thu, 17 Feb 2022 17:48:19 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 769EB1A23
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1645116549;
	bh=ZSlFmYwgUmpHAJYKDJOvlF7F8Bm4wM2p+5+hSzTdagE=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=ChPNqzECmKkJ68lQHDl9XEKi7mUSEBBnr+3XnW3Zb4AGk7r/Ho67elU74IRaJ2LH4
	 z5rpMYRDmD5Gy0GmhXlQCTqrXMZuopcsndMu25fhwl2hqNFrA4wziiMdEnvFqy1pTU
	 I+OEnGUVtBKQ8PI/tQ9Nt51ljfow5CL9ijsuBa5w=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 7B992F80518;
	Thu, 17 Feb 2022 17:47:02 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id A2788F805C1; Thu, 17 Feb 2022 14:43:07 +0100 (CET)
...
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 273DBF80240
 for <alsa-devel@alsa-project.org>; Thu, 17 Feb 2022 14:42:32 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 273DBF80240
X-UUID: 174db1801a7c4a079dbb59083ee47812-20220217
X-UUID: 174db1801a7c4a079dbb59083ee47812-20220217
Received: from mtkmbs10n1.mediatek.inc [(172.21.101.34)] by
 mailgw01.mediatek.com (envelope-from <jiaxin.yu@mediatek.com>)
 (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
 with ESMTP id 2055474108; Thu, 17 Feb 2022 21:42:27 +0800
Received: from mtkexhb02.mediatek.inc (172.21.101.103) by
 mtkmbs07n1.mediatek.inc (172.21.101.16) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Thu, 17 Feb 2022 21:42:26 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by mtkexhb02.mediatek.inc
 (172.21.101.103) with Microsoft SMTP Server (TLS) id 15.0.1497.2;
 Thu, 17 Feb 2022 21:42:24 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Thu, 17 Feb 2022 21:42:23 +0800
From: Jiaxin Yu <jiaxin.yu@mediatek.com>
To: <broonie@kernel.org>
Subject: [v2 12/17] ASoC: mediatek: mt8186: add platform driver
Date: Thu, 17 Feb 2022 21:42:00 +0800
Message-ID: <20220217134205.15400-13-jiaxin.yu@mediatek.com>
...
+#define ETDM_IN1_CON0_REG_ETDM_IN_EN_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_ETDM_IN_EN_MASK_SFT			(0x1 << 0)
+#define ETDM_IN1_CON0_REG_SYNC_MODE_SFT				(1)
+#define ETDM_IN1_CON0_REG_SYNC_MODE_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_SYNC_MODE_MASK_SFT			(0x1 << 1)
+#define ETDM_IN1_CON0_REG_LSB_FIRST_SFT				(3)
+#define ETDM_IN1_CON0_REG_LSB_FIRST_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_LSB_FIRST_MASK_SFT			(0x1 << 3)
+#define ETDM_IN1_CON0_REG_SOFT_RST_SFT				(4)
+#define ETDM_IN1_CON0_REG_SOFT_RST_MASK				(0x1)
+#define ETDM_IN1_CON0_REG_SOFT_RST_MASK_SFT			(0x1 << 4)
+#define ETDM_IN1_CON0_REG_SLAVE_MODE_SFT			(5)
+#define ETDM_IN1_CON0_REG_SLAVE_MODE_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_SLAVE_MODE_MASK_SFT			(0x1 << 5)
+#define ETDM_IN1_CON0_REG_FMT_SFT				(6)
+#define ETDM_IN1_CON0_REG_FMT_MASK				(0x7)
+#define ETDM_IN1_CON0_REG_FMT_MASK_SFT				(0x7 << 6)
+#define ETDM_IN1_CON0_REG_LRCK_EDGE_SEL_SFT			(10)
+#define ETDM_IN1_CON0_REG_LRCK_EDGE_SEL_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_LRCK_EDGE_SEL_MASK_SFT		(0x1 << 10)
+#define ETDM_IN1_CON0_REG_BIT_LENGTH_SFT			(11)
+#define ETDM_IN1_CON0_REG_BIT_LENGTH_MASK			(0x1f)
+#define ETDM_IN1_CON0_REG_BIT_LENGTH_MASK_SFT			(0x1f << 11)
+#define ETDM_IN1_CON0_REG_WORD_LENGTH_SFT			(16)
+#define ETDM_IN1_CON0_REG_WORD_LENGTH_MASK			(0x1f)
+#define ETDM_IN1_CON0_REG_WORD_LENGTH_MASK_SFT			(0x1f << 16)
+#define ETDM_IN1_CON0_REG_CH_NUM_SFT				(23)
+#define ETDM_IN1_CON0_REG_CH_NUM_MASK				(0x1f)
+#define ETDM_IN1_CON0_REG_CH_NUM_MASK_SFT			(0x1f << 23)
+#define ETDM_IN1_CON0_REG_RELATCH_1X_EN_SEL_DOMAIN_SFT		(28)
+#define ETDM_IN1_CON0_REG_RELATCH_1X_EN_SEL_DOMAIN_MASK		(0x7)
+#define ETDM_IN1_CON0_REG_RELATCH_1X_EN_SEL_DOMAIN_MASK_SFT	(0x7 << 28)
+#define ETDM_IN1_CON0_REG_VALID_TOGETHER_SFT			(31)
+#define ETDM_IN1_CON0_REG_VALID_TOGETHER_MASK			(0x1)
+#define ETDM_IN1_CON0_REG_VALID_TOGETHER_MASK_SFT		(0x1 << 31)
+#define ETDM_IN_CON0_CTRL_MASK					(0x1f9ff9e2)
+
+/* ETDM_IN1_CON1 */
+#define ETDM_IN1_CON1_REG_INITIAL_COUNT_SFT			(0)
+#define ETDM_IN1_CON1_REG_INITIAL_COUNT_MASK			(0x1f)
+#define ETDM_IN1_CON1_REG_INITIAL_COUNT_MASK_SFT		(0x1f << 0)
+#define ETDM_IN1_CON1_REG_INITIAL_POINT_SFT			(5)
+#define ETDM_IN1_CON1_REG_INITIAL_POINT_MASK			(0x1f)
+#define ETDM_IN1_CON1_REG_INITIAL_POINT_MASK_SFT		(0x1f << 5)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_OFF_SFT			(10)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_OFF_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_OFF_MASK_SFT		(0x1 << 10)
+#define ETDM_IN1_CON1_REG_BCK_AUTO_OFF_SFT			(11)
+#define ETDM_IN1_CON1_REG_BCK_AUTO_OFF_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_BCK_AUTO_OFF_MASK_SFT			(0x1 << 11)
+#define ETDM_IN1_CON1_REG_INITIAL_LRCK_SFT			(13)
+#define ETDM_IN1_CON1_REG_INITIAL_LRCK_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_INITIAL_LRCK_MASK_SFT			(0x1 << 13)
+#define ETDM_IN1_CON1_REG_LRCK_RESET_SFT			(15)
+#define ETDM_IN1_CON1_REG_LRCK_RESET_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_LRCK_RESET_MASK_SFT			(0x1 << 15)
+#define ETDM_IN1_CON1_PINMUX_MCLK_CTRL_OE_SFT			(16)
+#define ETDM_IN1_CON1_PINMUX_MCLK_CTRL_OE_MASK			(0x1)
+#define ETDM_IN1_CON1_PINMUX_MCLK_CTRL_OE_MASK_SFT		(0x1 << 16)
+#define ETDM_IN1_CON1_REG_OUTPUT_CR_EN_SFT			(18)
+#define ETDM_IN1_CON1_REG_OUTPUT_CR_EN_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_OUTPUT_CR_EN_MASK_SFT			(0x1 << 18)
+#define ETDM_IN1_CON1_REG_LR_ALIGN_SFT				(19)
+#define ETDM_IN1_CON1_REG_LR_ALIGN_MASK				(0x1)
+#define ETDM_IN1_CON1_REG_LR_ALIGN_MASK_SFT			(0x1 << 19)
+#define ETDM_IN1_CON1_REG_LRCK_WIDTH_SFT			(20)
+#define ETDM_IN1_CON1_REG_LRCK_WIDTH_MASK			(0x3ff)
+#define ETDM_IN1_CON1_REG_LRCK_WIDTH_MASK_SFT			(0x3ff << 20)
+#define ETDM_IN1_CON1_REG_DIRECT_INPUT_MASTER_BCK_SFT		(30)
+#define ETDM_IN1_CON1_REG_DIRECT_INPUT_MASTER_BCK_MASK		(0x1)
+#define ETDM_IN1_CON1_REG_DIRECT_INPUT_MASTER_BCK_MASK_SFT	(0x1 << 30)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_MODE_SFT			(31)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_MODE_MASK			(0x1)
+#define ETDM_IN1_CON1_REG_LRCK_AUTO_MODE_MASK_SFT		(0x1 << 31)
+#define ETDM_IN_CON1_CTRL_MASK					(0xbff10000)
+
+/* ETDM_IN1_CON2 */
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_SFT			(0)
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_MASK			(0x1f)
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_MASK_SFT			(0x1f << 0)
+#define ETDM_IN1_CON2_REG_UPDATE_GAP_SFT			(5)
+#define ETDM_IN1_CON2_REG_UPDATE_GAP_MASK			(0x1f)
+#define ETDM_IN1_CON2_REG_UPDATE_GAP_MASK_SFT			(0x1f << 5)
+#define ETDM_IN1_CON2_REG_CLOCK_SOURCE_SEL_SFT			(10)
+#define ETDM_IN1_CON2_REG_CLOCK_SOURCE_SEL_MASK			(0x7)
+#define ETDM_IN1_CON2_REG_CLOCK_SOURCE_SEL_MASK_SFT		(0x7 << 10)
+#define ETDM_IN1_CON2_REG_AGENT_USE_ETDM_BCK_SFT		(13)
+#define ETDM_IN1_CON2_REG_AGENT_USE_ETDM_BCK_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_AGENT_USE_ETDM_BCK_MASK_SFT		(0x1 << 13)
+#define ETDM_IN1_CON2_REG_CK_EN_SEL_AUTO_SFT			(14)
+#define ETDM_IN1_CON2_REG_CK_EN_SEL_AUTO_MASK			(0x1)
+#define ETDM_IN1_CON2_REG_CK_EN_SEL_AUTO_MASK_SFT		(0x1 << 14)
+#define ETDM_IN1_CON2_REG_MULTI_IP_ONE_DATA_CH_NUM_SFT		(15)
+#define ETDM_IN1_CON2_REG_MULTI_IP_ONE_DATA_CH_NUM_MASK		(0x1f)
+#define ETDM_IN1_CON2_REG_MULTI_IP_ONE_DATA_CH_NUM_MASK_SFT	(0x1f << 15)
+#define ETDM_IN1_CON2_REG_MASK_AUTO_SFT				(20)
+#define ETDM_IN1_CON2_REG_MASK_AUTO_MASK			(0x1)
+#define ETDM_IN1_CON2_REG_MASK_AUTO_MASK_SFT			(0x1 << 20)
+#define ETDM_IN1_CON2_REG_MASK_NUM_SFT				(21)
+#define ETDM_IN1_CON2_REG_MASK_NUM_MASK				(0x1f)
+#define ETDM_IN1_CON2_REG_MASK_NUM_MASK_SFT			(0x1f << 21)
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_AUTO_SFT			(26)
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_AUTO_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_UPDATE_POINT_AUTO_MASK_SFT		(0x1 << 26)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_0P5T_EN_SFT		(27)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_0P5T_EN_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_0P5T_EN_MASK_SFT		(0x1 << 27)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_BCK_INV_SFT		(28)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_BCK_INV_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_SDATA_DELAY_BCK_INV_MASK_SFT		(0x1 << 28)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_0P5T_EN_SFT		(29)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_0P5T_EN_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_0P5T_EN_MASK_SFT		(0x1 << 29)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_BCK_INV_SFT		(30)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_BCK_INV_MASK		(0x1)
+#define ETDM_IN1_CON2_REG_LRCK_DELAY_BCK_INV_MASK_SFT		(0x1 << 30)
+#define ETDM_IN1_CON2_REG_MULTI_IP_MODE_SFT			(31)
+#define ETDM_IN1_CON2_REG_MULTI_IP_MODE_MASK			(0x1)
+#define ETDM_IN1_CON2_REG_MULTI_IP_MODE_MASK_SFT		(0x1 << 31)
...
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_0_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_0_MASK_SFT		(0x1 << 0)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_1_SFT			(1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_1_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_1_MASK_SFT		(0x1 << 1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_2_SFT			(2)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_2_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_2_MASK_SFT		(0x1 << 2)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_3_SFT			(3)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_3_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_3_MASK_SFT		(0x1 << 3)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_4_SFT			(4)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_4_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_4_MASK_SFT		(0x1 << 4)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_5_SFT			(5)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_5_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_5_MASK_SFT		(0x1 << 5)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_6_SFT			(6)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_6_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_6_MASK_SFT		(0x1 << 6)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_7_SFT			(7)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_7_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_7_MASK_SFT		(0x1 << 7)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_8_SFT			(8)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_8_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_8_MASK_SFT		(0x1 << 8)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_9_SFT			(9)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_9_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_9_MASK_SFT		(0x1 << 9)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_10_SFT			(10)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_10_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_10_MASK_SFT		(0x1 << 10)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_11_SFT			(11)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_11_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_11_MASK_SFT		(0x1 << 11)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_12_SFT			(12)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_12_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_12_MASK_SFT		(0x1 << 12)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_13_SFT			(13)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_13_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_13_MASK_SFT		(0x1 << 13)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_14_SFT			(14)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_14_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_14_MASK_SFT		(0x1 << 14)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_15_SFT			(15)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_15_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_DISABLE_OUT_15_MASK_SFT		(0x1 << 15)
+#define ETDM_IN1_CON3_REG_RJ_DATA_RIGHT_ALIGN_SFT		(16)
+#define ETDM_IN1_CON3_REG_RJ_DATA_RIGHT_ALIGN_MASK		(0x1)
+#define ETDM_IN1_CON3_REG_RJ_DATA_RIGHT_ALIGN_MASK_SFT		(0x1 << 16)
+#define ETDM_IN1_CON3_REG_MONITOR_SEL_SFT			(17)
+#define ETDM_IN1_CON3_REG_MONITOR_SEL_MASK			(0x3)
+#define ETDM_IN1_CON3_REG_MONITOR_SEL_MASK_SFT			(0x3 << 17)
+#define ETDM_IN1_CON3_REG_CNT_UPPER_LIMIT_SFT			(19)
+#define ETDM_IN1_CON3_REG_CNT_UPPER_LIMIT_MASK			(0x3f)
+#define ETDM_IN1_CON3_REG_CNT_UPPER_LIMIT_MASK_SFT		(0x3f << 19)
+#define ETDM_IN1_CON3_REG_COMPACT_SAMPLE_END_DIS_SFT		(25)
+#define ETDM_IN1_CON3_REG_COMPACT_SAMPLE_END_DIS_MASK		(0x1)
+#define ETDM_IN1_CON3_REG_COMPACT_SAMPLE_END_DIS_MASK_SFT	(0x1 << 25)
+#define ETDM_IN1_CON3_REG_FS_TIMING_SEL_SFT			(26)
+#define ETDM_IN1_CON3_REG_FS_TIMING_SEL_MASK			(0x1f)
+#define ETDM_IN1_CON3_REG_FS_TIMING_SEL_MASK_SFT		(0x1f << 26)
+#define ETDM_IN1_CON3_REG_SAMPLE_END_MODE_SFT			(31)
+#define ETDM_IN1_CON3_REG_SAMPLE_END_MODE_MASK			(0x1)
+#define ETDM_IN1_CON3_REG_SAMPLE_END_MODE_MASK_SFT		(0x1 << 31)
+#define ETDM_IN_CON3_CTRL_MASK					(0x7c000000)
+#define ETDM_IN_CON3_FS(x)					(((x) & 0x1f) << 26)
+
+/* ETDM_IN1_CON4 */
+#define ETDM_IN1_CON4_REG_DSD_MODE_SFT				(0)
+#define ETDM_IN1_CON4_REG_DSD_MODE_MASK				(0x3f)
+#define ETDM_IN1_CON4_REG_DSD_MODE_MASK_SFT			(0x3f << 0)
+#define ETDM_IN1_CON4_REG_DSD_REPACK_AUTO_MODE_SFT		(8)
+#define ETDM_IN1_CON4_REG_DSD_REPACK_AUTO_MODE_MASK		(0x1)
+#define ETDM_IN1_CON4_REG_DSD_REPACK_AUTO_MODE_MASK_SFT		(0x1 << 8)
+#define ETDM_IN1_CON4_REG_REPACK_WORD_LENGTH_SFT		(9)
+#define ETDM_IN1_CON4_REG_REPACK_WORD_LENGTH_MASK		(0x3)
+#define ETDM_IN1_CON4_REG_REPACK_WORD_LENGTH_MASK_SFT		(0x3 << 9)
+#define ETDM_IN1_CON4_REG_ASYNC_RESET_SFT			(11)
+#define ETDM_IN1_CON4_REG_ASYNC_RESET_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_ASYNC_RESET_MASK_SFT			(0x1 << 11)
+#define ETDM_IN1_CON4_REG_DSD_CHNUM_SFT				(12)
+#define ETDM_IN1_CON4_REG_DSD_CHNUM_MASK			(0xf)
+#define ETDM_IN1_CON4_REG_DSD_CHNUM_MASK_SFT			(0xf << 12)
+#define ETDM_IN1_CON4_REG_SLAVE_BCK_INV_SFT			(16)
+#define ETDM_IN1_CON4_REG_SLAVE_BCK_INV_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_SLAVE_BCK_INV_MASK_SFT		(0x1 << 16)
+#define ETDM_IN1_CON4_REG_SLAVE_LRCK_INV_SFT			(17)
+#define ETDM_IN1_CON4_REG_SLAVE_LRCK_INV_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_SLAVE_LRCK_INV_MASK_SFT		(0x1 << 17)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_INV_SFT			(18)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_INV_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_INV_MASK_SFT		(0x1 << 18)
+#define ETDM_IN1_CON4_REG_MASTER_LRCK_INV_SFT			(19)
+#define ETDM_IN1_CON4_REG_MASTER_LRCK_INV_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_MASTER_LRCK_INV_MASK_SFT		(0x1 << 19)
+#define ETDM_IN1_CON4_REG_RELATCH_1X_EN_SEL_SFT			(20)
+#define ETDM_IN1_CON4_REG_RELATCH_1X_EN_SEL_MASK		(0x1f)
+#define ETDM_IN1_CON4_REG_RELATCH_1X_EN_SEL_MASK_SFT		(0x1f << 20)
+#define ETDM_IN1_CON4_REG_SAMPLE_END_POINT_SFT			(25)
+#define ETDM_IN1_CON4_REG_SAMPLE_END_POINT_MASK			(0x1f)
+#define ETDM_IN1_CON4_REG_SAMPLE_END_POINT_MASK_SFT		(0x1f << 25)
+#define ETDM_IN1_CON4_REG_WAIT_LAST_SAMPLE_SFT			(30)
+#define ETDM_IN1_CON4_REG_WAIT_LAST_SAMPLE_MASK			(0x1)
+#define ETDM_IN1_CON4_REG_WAIT_LAST_SAMPLE_MASK_SFT		(0x1 << 30)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_FORCE_ON_SFT		(31)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_FORCE_ON_MASK		(0x1)
+#define ETDM_IN1_CON4_REG_MASTER_BCK_FORCE_ON_MASK_SFT		(0x1 << 31)
...
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_0_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_0_MASK_SFT		(0x1 << 0)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_1_SFT			(1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_1_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_1_MASK_SFT		(0x1 << 1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_2_SFT			(2)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_2_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_2_MASK_SFT		(0x1 << 2)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_3_SFT			(3)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_3_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_3_MASK_SFT		(0x1 << 3)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_4_SFT			(4)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_4_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_4_MASK_SFT		(0x1 << 4)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_5_SFT			(5)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_5_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_5_MASK_SFT		(0x1 << 5)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_6_SFT			(6)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_6_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_6_MASK_SFT		(0x1 << 6)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_7_SFT			(7)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_7_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_7_MASK_SFT		(0x1 << 7)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_8_SFT			(8)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_8_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_8_MASK_SFT		(0x1 << 8)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_9_SFT			(9)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_9_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_9_MASK_SFT		(0x1 << 9)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_10_SFT			(10)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_10_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_10_MASK_SFT		(0x1 << 10)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_11_SFT			(11)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_11_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_11_MASK_SFT		(0x1 << 11)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_12_SFT			(12)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_12_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_12_MASK_SFT		(0x1 << 12)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_13_SFT			(13)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_13_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_13_MASK_SFT		(0x1 << 13)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_14_SFT			(14)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_14_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_14_MASK_SFT		(0x1 << 14)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_15_SFT			(15)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_15_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_ODD_FLAG_EN_15_MASK_SFT		(0x1 << 15)
+#define ETDM_IN1_CON5_REG_LR_SWAP_0_SFT				(16)
+#define ETDM_IN1_CON5_REG_LR_SWAP_0_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_0_MASK_SFT			(0x1 << 16)
+#define ETDM_IN1_CON5_REG_LR_SWAP_1_SFT				(17)
+#define ETDM_IN1_CON5_REG_LR_SWAP_1_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_1_MASK_SFT			(0x1 << 17)
+#define ETDM_IN1_CON5_REG_LR_SWAP_2_SFT				(18)
+#define ETDM_IN1_CON5_REG_LR_SWAP_2_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_2_MASK_SFT			(0x1 << 18)
+#define ETDM_IN1_CON5_REG_LR_SWAP_3_SFT				(19)
+#define ETDM_IN1_CON5_REG_LR_SWAP_3_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_3_MASK_SFT			(0x1 << 19)
+#define ETDM_IN1_CON5_REG_LR_SWAP_4_SFT				(20)
+#define ETDM_IN1_CON5_REG_LR_SWAP_4_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_4_MASK_SFT			(0x1 << 20)
+#define ETDM_IN1_CON5_REG_LR_SWAP_5_SFT				(21)
+#define ETDM_IN1_CON5_REG_LR_SWAP_5_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_5_MASK_SFT			(0x1 << 21)
+#define ETDM_IN1_CON5_REG_LR_SWAP_6_SFT				(22)
+#define ETDM_IN1_CON5_REG_LR_SWAP_6_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_6_MASK_SFT			(0x1 << 22)
+#define ETDM_IN1_CON5_REG_LR_SWAP_7_SFT				(23)
+#define ETDM_IN1_CON5_REG_LR_SWAP_7_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_7_MASK_SFT			(0x1 << 23)
+#define ETDM_IN1_CON5_REG_LR_SWAP_8_SFT				(24)
+#define ETDM_IN1_CON5_REG_LR_SWAP_8_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_8_MASK_SFT			(0x1 << 24)
+#define ETDM_IN1_CON5_REG_LR_SWAP_9_SFT				(25)
+#define ETDM_IN1_CON5_REG_LR_SWAP_9_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_9_MASK_SFT			(0x1 << 25)
+#define ETDM_IN1_CON5_REG_LR_SWAP_10_SFT			(26)
+#define ETDM_IN1_CON5_REG_LR_SWAP_10_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_10_MASK_SFT			(0x1 << 26)
+#define ETDM_IN1_CON5_REG_LR_SWAP_11_SFT			(27)
+#define ETDM_IN1_CON5_REG_LR_SWAP_11_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_11_MASK_SFT			(0x1 << 27)
+#define ETDM_IN1_CON5_REG_LR_SWAP_12_SFT			(28)
+#define ETDM_IN1_CON5_REG_LR_SWAP_12_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_12_MASK_SFT			(0x1 << 28)
+#define ETDM_IN1_CON5_REG_LR_SWAP_13_SFT			(29)
+#define ETDM_IN1_CON5_REG_LR_SWAP_13_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_13_MASK_SFT			(0x1 << 29)
+#define ETDM_IN1_CON5_REG_LR_SWAP_14_SFT			(30)
+#define ETDM_IN1_CON5_REG_LR_SWAP_14_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_14_MASK_SFT			(0x1 << 30)
+#define ETDM_IN1_CON5_REG_LR_SWAP_15_SFT			(31)
+#define ETDM_IN1_CON5_REG_LR_SWAP_15_MASK			(0x1)
+#define ETDM_IN1_CON5_REG_LR_SWAP_15_MASK_SFT			(0x1 << 31)
+
+/* ETDM_IN1_CON6 */
+#define ETDM_IN1_CON6_LCH_DATA_REG_SFT				(0)
+#define ETDM_IN1_CON6_LCH_DATA_REG_MASK				(0xffffffff)
+#define ETDM_IN1_CON6_LCH_DATA_REG_MASK_SFT			(0xffffffff << 0)
+
+/* ETDM_IN1_CON7 */
+#define ETDM_IN1_CON7_RCH_DATA_REG_SFT				(0)
+#define ETDM_IN1_CON7_RCH_DATA_REG_MASK				(0xffffffff)
+#define ETDM_IN1_CON7_RCH_DATA_REG_MASK_SFT			(0xffffffff << 0)
+
+/* ETDM_IN1_CON8 */
+#define ETDM_IN1_CON8_REG_AFIFO_THRESHOLD_SFT			(29)
+#define ETDM_IN1_CON8_REG_AFIFO_THRESHOLD_MASK			(0x3)
+#define ETDM_IN1_CON8_REG_AFIFO_THRESHOLD_MASK_SFT		(0x3 << 29)
+#define ETDM_IN1_CON8_REG_CK_EN_SEL_MANUAL_SFT			(16)
+#define ETDM_IN1_CON8_REG_CK_EN_SEL_MANUAL_MASK			(0x3ff)
+#define ETDM_IN1_CON8_REG_CK_EN_SEL_MANUAL_MASK_SFT		(0x3ff << 16)
+#define ETDM_IN1_CON8_REG_AFIFO_SW_RESET_SFT			(15)
+#define ETDM_IN1_CON8_REG_AFIFO_SW_RESET_MASK			(0x1)
+#define ETDM_IN1_CON8_REG_AFIFO_SW_RESET_MASK_SFT		(0x1 << 15)
+#define ETDM_IN1_CON8_REG_AFIFO_RESET_SEL_SFT			(14)
+#define ETDM_IN1_CON8_REG_AFIFO_RESET_SEL_MASK			(0x1)
+#define ETDM_IN1_CON8_REG_AFIFO_RESET_SEL_MASK_SFT		(0x1 << 14)
+#define ETDM_IN1_CON8_REG_AFIFO_AUTO_RESET_DIS_SFT		(9)
+#define ETDM_IN1_CON8_REG_AFIFO_AUTO_RESET_DIS_MASK		(0x1)
+#define ETDM_IN1_CON8_REG_AFIFO_AUTO_RESET_DIS_MASK_SFT		(0x1 << 9)
+#define ETDM_IN1_CON8_REG_ETDM_USE_AFIFO_SFT			(8)
+#define ETDM_IN1_CON8_REG_ETDM_USE_AFIFO_MASK			(0x1)
+#define ETDM_IN1_CON8_REG_ETDM_USE_AFIFO_MASK_SFT		(0x1 << 8)
+#define ETDM_IN1_CON8_REG_AFIFO_CLOCK_DOMAIN_SEL_SFT		(5)
+#define ETDM_IN1_CON8_REG_AFIFO_CLOCK_DOMAIN_SEL_MASK		(0x7)
+#define ETDM_IN1_CON8_REG_AFIFO_CLOCK_DOMAIN_SEL_MASK_SFT	(0x7 << 5)
+#define ETDM_IN1_CON8_REG_AFIFO_MODE_SFT			(0)
+#define ETDM_IN1_CON8_REG_AFIFO_MODE_MASK			(0x1f)
+#define ETDM_IN1_CON8_REG_AFIFO_MODE_MASK_SFT			(0x1f << 0)
+#define ETDM_IN_CON8_FS(x)					(((x) & 0x1f) << 0)
+#define ETDM_IN_CON8_CTRL_MASK					(0x0000013f)
+
