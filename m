...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id C27CB52DBEB
	for <lists+alsa-devel@lfdr.de>; Thu, 19 May 2022 19:51:56 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 5E09217E2;
	Thu, 19 May 2022 19:51:06 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 5E09217E2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1652982716;
	bh=HCflrmYDUF/BkVT0SiB5DmabKVH+vnMmB4y+IpOqE8E=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=GoQgEDWBgqcakt1SlaH6FLnkn3l9XkWhIUT8ywVQvU9mtuzzosJnrilAFoIqF6pGH
	 5g2lZ36x8xmyhOy9Z/UipG+qIEzp5LCrV2v35SzPaOSWL946Q/0VwB+AvIR8Qoa75P
	 3DRUDSNkkksDbErV3/dcydZ/1cf5VyVTdJtyiC/o=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 1DAD5F8055C;
	Thu, 19 May 2022 19:48:19 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 98BBDF8055B; Thu, 19 May 2022 19:48:12 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 5F8C7F8051E
 for <alsa-devel@alsa-project.org>; Thu, 19 May 2022 19:47:59 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 5F8C7F8051E
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="OqYLBqdL"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.17.1.5/8.17.1.5) with ESMTP id 24J5MiMv023727;
 Thu, 19 May 2022 12:47:57 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=9lMQzoxnJRexd+7H8k53YhH2epj7b3FBU7AnYJVAtds=;
 b= 3w== 
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
 by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3g29u37tee-7
...
Received: from vitaly-Legion-7-16ACHg6.ad.cirrus.com (unknown [198.90.238.59])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id A2C9011D3;
 Thu, 19 May 2022 17:47:54 +0000 (UTC)
From: Vitaly Rodionov <vitalyr@opensource.cirrus.com>
To: Jaroslav Kysela <perex@perex.cz>, Takashi Iwai <tiwai@suse.com>, Mark
 Brown <broonie@kernel.org>
Subject: [PATCH v3 12/17] ALSA: hda: cs35l41: Support Hibernation during
 Suspend
Date: Thu, 19 May 2022 18:47:44 +0100
Message-ID: <20220519174749.15459-13-vitalyr@opensource.cirrus.com>
...
X-Proofpoint-GUID: Wm9dl8YGrduEXC_zWTy2XUVFNi1CVrcw
X-Proofpoint-ORIG-GUID: Wm9dl8YGrduEXC_zWTy2XUVFNi1CVrcw
...
index ef716f0b0052..e84f278f0d0d 100644
--- a/sound/pci/hda/patch_realtek.c
+++ b/sound/pci/hda/patch_realtek.c
@@ -4003,15 +4003,22 @@ static void alc5505_dsp_init(struct hda_codec *codec)
...
@@ -4042,6 +4049,10 @@ static int alc269_resume(struct hda_codec *codec)
 	if (spec->has_alc5505_dsp)
...
+
 ...
 #endif /* CONFIG_PM */
@@ -6584,8 +6595,20 @@ static int comp_bind(struct device *dev)
 {
