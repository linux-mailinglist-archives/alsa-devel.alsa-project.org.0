...
In this state, the LED does turn on when both switches are off, but muting via PipeWire only toggles control 18.
...
Issue URL     : https://github.com/alsa-project/alsa-ucm-conf/issues/251
