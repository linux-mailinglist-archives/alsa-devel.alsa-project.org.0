...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id C03831F4F70
	for <lists+alsa-devel@lfdr.de>; Wed, 10 Jun 2020 09:46:39 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 2C6AC166C;
	Wed, 10 Jun 2020 09:45:49 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 2C6AC166C
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1591775199;
	bh=r3h6E4inR5je0iif9vwvuHqUJmXWIy3urVlyx8mecEU=;
	h=Date:From:To:Subject:References:In-Reply-To:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Kxq7OcTObElSx+RYnOl7yWBIYpNsydTj1QoTrweP1u7uuF1pRpq3I25eLDau+FtFP
	 CBk2NgrZOSEFiEzNGoAh/ecKXs2T1i5T64unQzCQRLDLSpl9gl+9sRHjl1mss86qqD
	 gAZ2+5y2YSWCZwfWky2ZasesmebQ+9rR4XJsyJkU=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 525F7F801F7;
	Wed, 10 Jun 2020 09:44:58 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 4B671F8021C; Wed, 10 Jun 2020 09:44:34 +0200 (CEST)
...
Received: from echo.tratt.net (echo.default.edsfctgx.uk0.bigv.io
 ...
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 6E96BF80088
 for <alsa-devel@alsa-project.org>; Wed, 10 Jun 2020 09:44:16 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 6E96BF80088
Received: by echo.tratt.net (Postfix, from userid 1000)
 id 6306365EC; Wed, 10 Jun 2020 08:44:10 +0100 (BST)
Date: Wed, 10 Jun 2020 08:44:09 +0100
From: Laurence Tratt <laurie@tratt.net>
To: Alexander Tsoy <alexander@tsoy.me>
Subject: Re: Clock sync problem?
Message-ID: <20200610074409.aknnhrzzu3ulfa4e@overdrive.tratt.net>
User-Agent: mutt
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="3farxdqolvczk32t"
Content-Disposition: inline
In-Reply-To: <d74af0e9a3074c3c9104cac7407185c825378de5.camel@tsoy.me>
...
>> because of the computation in Q16.16 format.  It works OK for async mode,
>> but for others, it can accumulate rounding errors.  The recent change
...
Device Descriptor:
  ...
  bcdDevice            5.07
  iManufacturer           3 Linux 5.7.0-3-MANJARO ehci_hcd
...
Device Descriptor:
  ...
  bcdDevice            5.07
  iManufacturer           3 Linux 5.7.0-3-MANJARO xhci-hcd
...
Bus 001 Device 005: ID 04f2:b45d Chicony Electronics Co., Ltd Integrated Camera
Device Descriptor:
  bLength                18
  bDescriptorType         1
  bcdUSB               2.00
...
Bus 001 Device 002: ID 31e9:0002 Solid State Logic SSL 2+
Device Descriptor:
  bLength                18
  bDescriptorType         1
  bcdUSB               2.00
  ...
  idProduct          0x0002 
  bcdDevice            0.61
  iManufacturer           1 Solid State Logic
  iProduct                3 SSL 2+
  iSerial                 0 
  ...
  Configuration Descriptor:
    ...
    Interface Descriptor:
      ...
      AudioControl Interface Descriptor:
        ...
        bAssocTerminal          0
        iClockSource            9 SSL 2+ Internal Clock
      AudioControl Interface Descriptor:
        bLength                 8
        bDescriptorType        36
        ...
        iClockSelector          8 SSL 2+ Clock Selector
      AudioControl Interface Descriptor:
        bLength                17
        bDescriptorType        36
        bDescriptorSubtype      2 (INPUT_TERMINAL)
