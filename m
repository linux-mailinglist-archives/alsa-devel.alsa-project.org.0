...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id C40E678A49A
	for <lists+alsa-devel@lfdr.de>; Mon, 28 Aug 2023 04:29:08 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7056A846;
	Mon, 28 Aug 2023 04:28:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7056A846
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1693189747;
	bh=ko27VtbtFANoFnK8k+GlnqyWavhPuj/6ddFk6Ybko0o=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=irQYpAvbm7s3RLhq2TCqvgycfQHtMdWtY2t/ByoCkXStSzeX/LMiQ6BP7sqWDOj91
	 jk7Mbeq+MMRTVGWxU3plCYEntKU6HHDxvIjhiHPcQR2B6PJALo7iNf+zY9//SuZV98
	 AUZqaER5Zs3VTKlTmxubSZ/yDA+oCsHEoLz7y9Lo=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 93289F80155; Mon, 28 Aug 2023 04:28:16 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id C022AF80155;
	Mon, 28 Aug 2023 04:28:15 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id AFE17F80236; Mon, 28 Aug 2023 04:28:03 +0200 (CEST)
...
Received: from fllv0016.ext.ti.com (fllv0016.ext.ti.com [198.47.19.142])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 7D4E6F800F5
	for <alsa-devel@alsa-project.org>; Mon, 28 Aug 2023 04:27:39 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7D4E6F800F5
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=GELBTMeT
Received: from lelv0266.itg.ti.com ([10.180.67.225])
	by fllv0016.ext.ti.com (8.15.2/8.15.2) with ESMTP id 37S2QHsq086386;
	Sun, 27 Aug 2023 21:26:17 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1693189577;
	bh=luB9r8n1ChvUhaMCuHLIamVYU2jjy2UAB8iNgZwUHN4=;
	h=From:To:CC:Subject:Date:In-Reply-To:References;
	b=GELBTMeTz7XEmBUvTL7X2D5kTQPsdAbhBEE/QXDg9tvRqtZITH+1F2GlyQEoM89K1
	 qevPipRuRl1XGVCVG5fdFhqABVfrx1exFzmIPdGKCrlJpDsyK5TpKsuwYKOIgtiQjt
	 18jLU6Bfs+eu4QrCL7kOKAhKWZPlOs7Aj/BieEMk=
Received: from DLEE103.ent.ti.com (dlee103.ent.ti.com [157.170.170.33])
	by lelv0266.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 37S2QHAm049809
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Sun, 27 Aug 2023 21:26:17 -0500
Received: from DLEE106.ent.ti.com (157.170.170.36) by DLEE103.ent.ti.com
 (157.170.170.33) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Sun, 27
 Aug 2023 21:26:17 -0500
Received: from fllv0040.itg.ti.com (10.64.41.20) by DLEE106.ent.ti.com
 (157.170.170.36) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Sun, 27 Aug 2023 21:26:17 -0500
Received: from LT5CG31242FY.dhcp.ti.com (ileaxei01-snat2.itg.ti.com
 [10.180.69.6])
	by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id 37S2Q46g130660;
	Sun, 27 Aug 2023 21:26:12 -0500
...
Subject: [PATCH v5 2/2] ALSA: hda/tas2781: Add tas2781 HDA driver
Date: Mon, 28 Aug 2023 10:25:56 +0800
Message-ID: <20230828022556.578-2-shenghao-ding@ti.com>
...
Message-ID-Hash: UG6EDQUK7YWABEMZCNJGVRUTYUM4UYVE
X-Message-ID-Hash: UG6EDQUK7YWABEMZCNJGVRUTYUM4UYVE
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/UG6EDQUK7YWABEMZCNJGVRUTYUM4UYVE/>
List-Archive: <>
...
---
 ...
 sound/pci/hda/tas2781_hda_i2c.c | 855 ++++++++++++++++++++++++++++++++
...
index 000000000000..7a720da462f0
--- /dev/null
...
+	int max_val = tas_priv->rcabin.ncfgs - 1;
+
+	nr_profile = clamp(nr_profile, 0, max_val);
+
...
+	int max_val = tas_fw->nr_programs - 1;
+
+	/* 0:			dsp mode
+	 * non-zero:	bypass mode
+	 */
...
+	int max_val = tas_fw->nr_configurations - 1;
+
+	nr_config = clamp(nr_config, 0, max_val);
+
...
+	int i, ret;
+
+	pm_runtime_resume_and_get(tas_priv->dev);
+	mutex_lock(&tas_priv->codec_lock);
+
