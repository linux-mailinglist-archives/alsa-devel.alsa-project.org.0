...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 699846FE368
	for <lists+alsa-devel@lfdr.de>; Wed, 10 May 2023 19:44:33 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 8D20B10AA;
	Wed, 10 May 2023 19:43:42 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 8D20B10AA
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1683740672;
	bh=XXS8gv8SjrUdAdig4MApp+l27dynh3zdCaPUyRtfpEs=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=uJDbHqkGbI2F8dFnuJbptUTuJEbN4T1PlQNVaN/c8OgxoFnVMvWvMmgbTGEOCmbdW
	 pB2oe791YcVC49QoMmD0GLPEgtvZqfwtGCI/mLE2dNn4TYWJ7nlmzn8ZnW7I2eFt+t
	 L9OAfolhI2PAeloWq2QDWaFlEmJFfDkb1VLYsD2E=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 8B659F805C9;
	Wed, 10 May 2023 19:40:06 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 8B0E8F8057A; Wed, 10 May 2023 19:39:46 +0200 (CEST)
...
Received: from bluemchen.kde.org (bluemchen.kde.org
 [IPv6:2001:470:142:8::100])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id B5FCEF80544
	for <alsa-devel@alsa-project.org>; Wed, 10 May 2023 19:39:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B5FCEF80544
Received: from ugly.fritz.box (localhost [127.0.0.1])
	by bluemchen.kde.org (Postfix) with ESMTP id 4C95624266;
	Wed, 10 May 2023 13:39:18 -0400 (EDT)
Received: by ugly.fritz.box (masqmail 0.3.4, from userid 1000)
	id 1pwnmX-tTs-00; Wed, 10 May 2023 19:39:17 +0200
From: Oswald Buddenhagen <oswald.buddenhagen@gmx.de>
To: alsa-devel@alsa-project.org
Cc: Takashi Iwai <tiwai@suse.de>,
	Jaroslav Kysela <perex@perex.cz>,
	Jonathan Dowland <jon@dow.land>
Subject: [PATCH 13/14] ALSA: emu10k1: enable bit-exact playback,
 part 1: DSP attenuation
Date: Wed, 10 May 2023 19:39:16 +0200
Message-Id: <20230510173917.3073107-14-oswald.buddenhagen@gmx.de>
...
Message-ID-Hash: ZVT6FCBFFNO3RKJCTGETP5WEFFE6BJV7
X-Message-ID-Hash: ZVT6FCBFFNO3RKJCTGETP5WEFFE6BJV7
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/ZVT6FCBFFNO3RKJCTGETP5WEFFE6BJV7/>
List-Archive: 
...
index 63e233130858..32d5ed7528e8 100644
...
@@ -1727,42 +1736,26 @@ A_OP(icode, &ptr, iMAC0, A_GPR(var), A_GPR(var), A_GPR(vol), A_EXTIN(input))
