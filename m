...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 57E3418EF23
	for <lists+alsa-devel@lfdr.de>; Mon, 23 Mar 2020 06:24:39 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id EF7D485D;
	Mon, 23 Mar 2020 06:23:48 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz EF7D485D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1584941079;
	bh=zUMp4XUYQ6Ib+WF/74zZhfSrj6Bhw3PmKnLL0YQ4gV8=;
	h=Date:From:Subject:To:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=dS76+Zrin8gEACpOMDMJq9S63y0HCpKECUZqwrFFzOPXTZcke2tI+J/GUxfayItwO
	 BRSkPcdVect10ZQ4rctjiJmKmhfl+cxi59BLtU7PtVtuhQO9i9u1fcrGcwDzOFQ7cd
	 J5b96kTNwqDtPYvttsVnMcmqaQsQYWpjzNue0zDA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 292ADF8028D;
	Mon, 23 Mar 2020 06:19:22 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 4B5EFF80290; Mon, 23 Mar 2020 06:19:18 +0100 (CET)
...
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com
 [210.160.252.172])
 by alsa1.perex.cz (Postfix) with ESMTP id DE94FF8028D
 for <alsa-devel@alsa-project.org>; Mon, 23 Mar 2020 06:19:07 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz DE94FF8028D
Date: 23 Mar 2020 14:19:05 +0900
X-IronPort-AV: E=Sophos;i="5.72,295,1580742000"; d="scan'208";a="42350356"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
 by relmlie6.idc.renesas.com with ESMTP; 23 Mar 2020 14:19:05 +0900
Received: from mercury.renesas.com (unknown [10.166.252.133])
 by relmlir6.idc.renesas.com (Postfix) with ESMTP id E269D4170D12;
 Mon, 23 Mar 2020 14:19:05 +0900 (JST)
Message-ID: <87r1xjir7a.wl-kuninori.morimoto.gx@renesas.com>
From: Kuninori Morimoto <kuninori.morimoto.gx@renesas.com>
Subject: [PATCH 11/36] ASoC: intel: use asoc_rtd_to_cpu() /
...
index ea1de8b3f3cd..667c0e9bc216 100644
...
index 6d210ba06d19..d78fdadee498 100644
--- a/sound/soc/intel/boards/sof_da7219_max98373.c
+++ b/sound/soc/intel/boards/sof_da7219_max98373.c
@@ -107,8 +107,8 @@ static struct snd_soc_jack headset;
...
@@ -166,7 +166,7 @@ static int ssp1_hw_params(struct snd_pcm_substream *substream,
 	int ret, j;
...
@@ -207,7 +207,7 @@ static struct snd_soc_codec_conf max98373_codec_conf[] = {
 static int hdmi_init(struct snd_soc_pcm_runtime *rtd)
 {
 	struct card_private *ctx = snd_soc_card_get_drvdata(rtd->card);
-	struct snd_soc_dai *dai = rtd->codec_dai;
...
index 6defe7c85c32..571097513a90 100644
--- a/sound/soc/intel/boards/sof_rt5682.c
+++ b/sound/soc/intel/boards/sof_rt5682.c
@@ -122,7 +122,7 @@ static const struct dmi_system_id sof_rt5682_quirk_table[] = {
 static int sof_hdmi_init(struct snd_soc_pcm_runtime *rtd)
 {
 	struct sof_card_private *ctx = snd_soc_card_get_drvdata(rtd->card);
-	struct snd_soc_dai *dai = rtd->codec_dai;
+	struct snd_soc_dai *dai = asoc_rtd_to_codec(rtd, 0);
 	...
 	pcm = devm_kzalloc(rtd->card->dev, sizeof(*pcm), GFP_KERNEL);
@@ -141,7 +141,7 @@ static int sof_hdmi_init(struct snd_soc_pcm_runtime *rtd)
...
@@ -209,7 +209,7 @@ static int sof_rt5682_hw_params(struct snd_pcm_substream *substream,
 {
 	struct snd_soc_pcm_runtime *rtd = substream->private_data;
 	struct sof_card_private *ctx = snd_soc_card_get_drvdata(rtd->card);
-	struct snd_soc_dai *codec_dai = rtd->codec_dai;
