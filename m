...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E537386E3D
	for <lists+alsa-devel@lfdr.de>; Tue, 18 May 2021 02:17:30 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 8E1631686;
	Tue, 18 May 2021 02:16:39 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 8E1631686
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1621297049;
	bh=FtYpSnCFRSgX8Tkby6+0RsW48l9vdjPrHF6W6NuxMq0=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=E09uuEJYHYLyxR2BdpW1WIx314jdf1EmmEXYeHhBXAC9ktn13NIUCm4b/QCSJ8pIz
	 BTOeMJurH0ej1xN673xUXGihfsfvIrmj2biPL0qKbiwrR1Yjd6or0Q94HISxeXyAyv
	 y4g81cee1nJ/8f8EJ8H9Z4Vyl5+lSdFqPDPdWcTI=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 95EE4F80425;
	Tue, 18 May 2021 02:15:16 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 64674F8029B; Tue, 18 May 2021 02:15:15 +0200 (CEST)
...
Received: from mail-lj1-x22e.google.com (mail-lj1-x22e.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 7E704F80082
 for <alsa-devel@alsa-project.org>; Tue, 18 May 2021 02:15:04 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7E704F80082
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="TIZ5cBro"
Received: by mail-lj1-x22e.google.com with SMTP id w4so9358761ljw.9
 for <alsa-devel@alsa-project.org>; Mon, 17 May 2021 17:15:04 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=QLLWXAPGEiX/pcxbgkFRDSp+Hh0XBD+LkJlbRamG+zQ=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=QLLWXAPGEiX/pcxbgkFRDSp+Hh0XBD+LkJlbRamG+zQ=;
 b=
X-Gm-Message-State: AOAM53008JyQmEIPBYvjsdy5FUCsYYh+etTKu+ys1des3l5zSwN/QYOt
 wS9YsEX541uhAiz78a0ql/c=
X-Google-Smtp-Source: ABdhPJzZpPXYMm5BRlX6+CQ8ouIjboKFtNMZxczWWtM3dTzHSN/pxqRbV82jXULDfJzfeFi1Jkq5XQ==
X-Received: by 2002:a2e:a795:: with SMTP id c21mr1707606ljf.26.1621296902934; 
...
Subject: [PATCH v1 2/2] ASoC: tegra: Unify ASoC machine drivers
Date: Tue, 18 May 2021 03:13:56 +0300
Message-Id: <20210518001356.19227-3-digetx@gmail.com>
...
---
 ...
 13 files changed, 859 insertions(+), 2116 deletions(-)
...
index 000000000000..9f64b188c5a2
--- /dev/null
...
new file mode 100644
index 000000000000..76d8698e1950
--- /dev/null
...
-
 	...
 	return 0;
@@ -207,8 +95,8 @@ static int tegra_wm8903_init(struct snd_soc_pcm_runtime *rtd)
...
@@ -226,7 +114,6 @@ static struct snd_soc_dai_link tegra_wm8903_dai = {
 	.name = "WM8903",
...
-	.ops = &tegra_wm8903_ops,
 	.dai_fmt = SND_SOC_DAIFMT_I2S |
 		   SND_SOC_DAIFMT_NB_NF |
 		   SND_SOC_DAIFMT_CBS_CFS,
@@ -239,143 +126,35 @@ static struct snd_soc_card snd_soc_tegra_wm8903 = {
