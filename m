...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C2DD3C948
	for <lists+alsa-devel@lfdr.de>; Tue, 11 Jun 2019 12:46:14 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id E1A651711;
	Tue, 11 Jun 2019 12:45:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz E1A651711
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1560249974;
	bh=MvUM3U4r8rA/PsEjuCne0bpKrL0CMgnHrQWWJt4zrac=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=KgWAbkIDH64JoZGa2EPL6TkBIoDLNXSbDzxF5IG+JjpKsSWX21JDmLS77EO8vMkgE
	 f7o7SLX+bPRWlY5jLD7QfT9Wb/Z1+48g3UFPsNTNx+RlARAGu1OMrt3fMSAiRzAszH
	 lKCWruTpVu3bQ5tHPfVoAoSIN7DuCmFV0vhs9iWc=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 3AD4FF89748;
	Tue, 11 Jun 2019 12:41:17 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 1A759F89737; Tue, 11 Jun 2019 12:41:10 +0200 (CEST)
...
Received: from mail-wm1-x342.google.com (mail-wm1-x342.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 43F8AF89719
 for <alsa-devel@alsa-project.org>; Tue, 11 Jun 2019 12:41:05 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 43F8AF89719
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="zSOAguX8"
Received: by mail-wm1-x342.google.com with SMTP id s3so2396016wms.2
 for <alsa-devel@alsa-project.org>; Tue, 11 Jun 2019 03:41:05 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=8hO2uGNtgte2snDH+1seSZoPvu/qQxevhGkFA2GvMPU=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=8hO2uGNtgte2snDH+1seSZoPvu/qQxevhGkFA2GvMPU=;
 b=
X-Gm-Message-State: APjAAAVXF6Vb3K/nL3xEVyjisVWXRSC90b44uExUEyUjVAl01OQ4Vsbd
 lsPwA2ermpusEPxwzeuNCwQt2g==
X-Google-Smtp-Source: APXvYqzD1bIE0qJqzViYqtMKq/wqhNDr0y1oU+czXusSWwpe6seTuG4ajPMHoi+9jvyT7FhDjZLi8w==
X-Received: by 2002:a1c:9c4d:: with SMTP id f74mr17043909wme.156.1560249664129; 
 Tue, 11 Jun 2019 03:41:04 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc89974-aztw32-2-0-cust43.18-1.cable.virginm.net. [86.30.250.44])
 by smtp.gmail.com with ESMTPSA id c65sm2359614wma.44.2019.06.11.03.41.02
 (version=TLS1_3 cipher=AEAD-AES256-GCM-SHA384 bits=256/256);
 Tue, 11 Jun 2019 03:41:03 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org,
	vkoul@kernel.org
Date: Tue, 11 Jun 2019 11:40:43 +0100
Message-Id: <20190611104043.22181-6-srinivas.kandagatla@linaro.org>
...
Subject: [alsa-devel] [RFC PATCH 5/5] ASoC: codecs: add wsa881x amplifier
	support
...
index 8f577258080b..3a5e9562faa2 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -1168,6 +1168,15 @@ config SND_SOC_WCD9335
 	  Qualcomm Technologies, Inc. (QTI) multimedia solutions,
 	  including the MSM8996, MSM8976, and MSM8956 chipsets.
 
+config SND_SOC_WSA881X
+	tristate "WSA881X Codec"
+	depends on SOUNDWIRE_QCOM
...
index aa7720a7a0aa..731081c64e08 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -206,6 +206,7 @@ snd-soc-twl6040-objs := twl6040.o
...
@@ -479,6 +480,7 @@ obj-$(CONFIG_SND_SOC_TWL6040)	+= snd-soc-twl6040.o
