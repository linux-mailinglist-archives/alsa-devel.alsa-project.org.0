...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 60B5512C1C9
	for <lists+alsa-devel@lfdr.de>; Sun, 29 Dec 2019 09:19:02 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 445D21747;
	Sun, 29 Dec 2019 09:18:11 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 445D21747
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1577607541;
	bh=rLQ/rVRRXN0L7AAixvf/+AGkSYoyaCZqQ3I525Fftd4=;
	h=From:To:Date:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=bt5wKoinuyXzvnfbHIcbkqMdxpWGqYQu7afJjknQT0PPSE1h/IAe/DwcBXTJW8JbW
	 BQQp7HjVZEHAX0kvFUG9qJpfLdxwERdSO5gdYNQbADkykUiRVfAU/HTs00KBeUrfls
	 2M0DE3KcBEYu8WRqM4v1f9pMhTSeF7eon2eUcAkY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 89FA8F8014F;
	Sun, 29 Dec 2019 09:17:17 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 84A9DF8014F; Sun, 29 Dec 2019 09:17:15 +0100 (CET)
...
Received: from mx2.suse.de (mx2.suse.de [195.135.220.15])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 28228F8011E
 for <alsa-devel@alsa-project.org>; Sun, 29 Dec 2019 09:17:11 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 28228F8011E
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
 by mx2.suse.de (Postfix) with ESMTP id 93AC6ACE0
 for <alsa-devel@alsa-project.org>; Sun, 29 Dec 2019 08:17:10 +0000 (UTC)
From: Takashi Iwai <tiwai@suse.de>
To: alsa-devel@alsa-project.org
Date: Sun, 29 Dec 2019 09:17:07 +0100
Message-Id: <20191229081707.7590-1-tiwai@suse.de>
X-Mailer: git-send-email 2.16.4
Subject: [alsa-devel] [PATCH RFC] ALSA: control: Add verification for kctl
	accesses
...
index 5d7c99475684..58446411ec10 100644
...
index 4044c42d8595..303d769a15b7 100644
--- a/sound/core/Kconfig
+++ b/sound/core/Kconfig
@@ -178,6 +178,14 @@ config SND_PCM_XRUN_DEBUG
...
+	help
+	  Say Y to enable the sanity-checks for each control element access.
+	  This will check whether the values returned from the driver are
+	  in the given ranges or check the out-of-array access.
+
 config SND_VMASTER
 	bool
 
diff --git a/sound/core/control.c b/sound/core/control.c
index 4728f6828890..6d27f0baff5e 100644
