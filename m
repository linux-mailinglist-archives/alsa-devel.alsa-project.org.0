...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id A190D19D362
	for <lists+alsa-devel@lfdr.de>; Fri,  3 Apr 2020 11:19:26 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 499CA169C;
	Fri,  3 Apr 2020 11:18:36 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 499CA169C
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1585905566;
	bh=Ywxd5AyLh6bNN7jzNHtNsSBFAMYZtYaTJX0YTLYNeBo=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=mO4Bx7TCrreiTZAbYcT9KmpUcfi2+YTH9gAkv0YlMvUbBFd13jtf3ZohBmoRtFTyS
	 kVUMH+5VT9GCR5eWDptboStpMTG4PyE8k9P+5rxPkC9okGv8orLgXIVWBINTg6xrgk
	 tZchjgxRfer6YT+95O+a+Re65rfV27IsIcGSFG9o=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 3D2D4F802FE;
	Fri,  3 Apr 2020 11:14:58 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id D29DEF802A8; Fri,  3 Apr 2020 11:14:38 +0200 (CEST)
...
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 9101FF8028F;
 Fri,  3 Apr 2020 11:14:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 9101FF8028F
IronPort-SDR: R6zfsiQsWKITvFBWU9lo4oqWIiAocMt6PrLXHvRb7WkwPnIeUQP3KnXdbp7w3QQlEG6i4Nz2TD
 qLvOMbwsbpDA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2020 02:14:26 -0700
IronPort-SDR: TajOz258xBYzUX4lcrDOQDYjzvhC8VePFtZYVBOrf/q/nK0uFgwL/N1P4Peibvc+B04TyP/xU+
 drtsCPXXmINQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,339,1580803200"; d="scan'208";a="451234991"
Received: from gliakhov-mobl2.ger.corp.intel.com (HELO
 ubuntu.ger.corp.intel.com) ([10.249.36.113])
 by fmsmga006.fm.intel.com with ESMTP; 03 Apr 2020 02:14:23 -0700
From: Guennadi Liakhovetski <guennadi.liakhovetski@linux.intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH v2 09/12] [RESEND] ASoC: SOF: add a vhost driver: sound part
Date: Fri,  3 Apr 2020 11:14:03 +0200
Message-Id: <20200403091406.22381-10-guennadi.liakhovetski@linux.intel.com>
...
---
 ...
 sound/soc/sof/vhost-be.c         | 1093 ++++++++++++++++++++++++++++++++++++++
 16 files changed, 1321 insertions(+), 12 deletions(-)
...
@@ -1468,10 +1469,15 @@ static bool dpcm_end_walk_at_be(struct snd_soc_dapm_widget *widget,
 	int stream;
...
+	}
 	...
 	if (rtd)
@@ -3018,14 +3024,6 @@ int soc_new_pcm(struct snd_soc_pcm_runtime *rtd, int num)
 	rtd->pcm = pcm;
...
@@ -3045,6 +3043,19 @@ int soc_new_pcm(struct snd_soc_pcm_runtime *rtd, int num)
...
+	size_t guest_offset;
 ...
 /* ALSA SOF PCM device */
@@ -106,6 +107,7 @@ struct snd_sof_dai {
...
@@ -216,4 +218,19 @@ int snd_sof_ipc_set_get_comp_data(struct snd_sof_control *scontrol,
...
index dcc897f..34e1020 100644
--- a/sound/soc/sof/topology.c
+++ b/sound/soc/sof/topology.c
@@ -1333,6 +1333,7 @@ static int sof_widget_load_dai(struct snd_soc_component *scomp, int index,
...
+
 	...
 	if (ret < 0) {
@@ -1424,6 +1432,16 @@ static int sof_widget_load_pcm(struct snd_soc_component *scomp, int index,
...
+
 	...
 	if (!host)
 		return -ENOMEM;
@@ -3144,6 +3162,15 @@ static int sof_link_load(struct snd_soc_component *scomp, int index,
...
+	/*
 	 ...
 	 */
@@ -3631,7 +3684,7 @@ int snd_sof_load_topology(struct snd_soc_component *scomp, const char *file)
