...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 7961A65E7F4
	for <lists+alsa-devel@lfdr.de>; Thu,  5 Jan 2023 10:38:01 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7A0CE1031E;
	Thu,  5 Jan 2023 10:37:04 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7A0CE1031E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1672911474;
	bh=dTzsmESo4bc/129qlgr5sinsxtKkeonBmEz0oqQ6B9Q=;
	h=Date:From:To:Subject:References:In-Reply-To:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 Cc:From;
	b=khIa16S+k8YyfFn9LYdrt/ZqZI9IRlBDP38Z0RTZw6SOk1KpSBUpADaLqlT6Fqmkh
	 FmYXKSlWvZMF5hVa96YlJfXnw8Ed5cgnsYKwn7BCXi5V5BRL7AstlZUrfrgzKFZWM/
	 ekRUPX4g/N9VKwWKx7jraItXAXDNQoLG7FFkcz/M=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 29C44F804AA;
	Thu,  5 Jan 2023 10:37:04 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 73344F80553; Wed,  4 Jan 2023 11:36:59 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.6 (2021-04-09) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=-1.3 required=5.0 tests=DKIMWL_WL_HIGH,DKIM_SIGNED,
 DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,RCVD_IN_DNSWL_MED,SPF_HELO_PASS,
 SPF_PASS,UPPERCASE_75_100,URIBL_BLOCKED shortcircuit=no autolearn=ham
 autolearn_force=no version=3.4.6
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 93EFFF8023B
 for <alsa-devel@alsa-project.org>; Wed,  4 Jan 2023 11:36:50 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 93EFFF8023B
Authentication-Results: alsa1.perex.cz; dkim=pass (2048-bit key,
 unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256
 header.s=Intel header.b=KzHCyjiT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672828611; x=1704364611;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=dTzsmESo4bc/129qlgr5sinsxtKkeonBmEz0oqQ6B9Q=;
 b=KzHCyjiTK/+gbWMRElEUfY5Z0UKQ/QUK//TCsq0z96LrXniVr/35RnHT
 HhkEkLzWI8N2vCH+8j6Zo/n/UXG0NK/isHyeO5xgWTwNmZ+wIu+4aMxYY
 80S+JwBWt27CuWu7VO9kk5Y/KReQsxxZYyz8/g9/dA51aC+XRRAI7fqx+
 IyQ8paj9Uq/B4w4PkTQ8pR8ZSQ8axs4TdAsTCBN/J3SwRCPVR+o0OI6J2
 gQlNSqSJT+Wg7qSfd/Z/vhyTUwg813cuNKUjxMsBPXbHmKHkNVdGFo511
 MHpiRdIgBXSd97z89o8Du5uZk45lZH7Qn+mCBoMYXQCwrCy3+qrxho8Zv g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10579"; a="301595511"
X-IronPort-AV: E=Sophos;i="5.96,299,1665471600"; d="scan'208";a="301595511"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jan 2023 02:36:47 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10579"; a="723595146"
X-IronPort-AV: E=Sophos;i="5.96,299,1665471600"; d="scan'208";a="723595146"
Received: from lkp-server02.sh.intel.com (HELO f1920e93ebb5) ([10.239.97.151])
 by fmsmga004.fm.intel.com with ESMTP; 04 Jan 2023 02:36:44 -0800
Received: from kbuild by f1920e93ebb5 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1pD18W-0000GN-0L;
 Wed, 04 Jan 2023 10:36:44 +0000
Date: Wed, 4 Jan 2023 18:36:32 +0800
...
Message-ID: <202301041809.km3YXFOm-lkp@intel.com>
References: <20230104064342.2094-4-kiseok.jo@irondevice.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="o3CRmkU6+iBeBtf5"
...
Cc: alsa-devel@alsa-project.org, application@irondevice.com,
 Kiseok Jo <kiseok.jo@irondevice.com>, oe-kbuild-all@lists.linux.dev
...
All warnings (new ones prefixed by >>):
   ...
   In file included from include/linux/device.h:15,
                    ...
                    from sound/soc/codecs/sma1303.c:12:
   sound/soc/codecs/sma1303.c: In function 'sma1303_add_component_controls':
>> sound/soc/codecs/sma1303.c:708:32: warning: format '%d' expects argument of type 'int', but argument 5 has type 'long unsigned int' [-Wformat=]
   ...
   include/linux/dev_printk.h:150:58: note: in expansion of macro 'dev_fmt'
     150 |         dev_printk_index_wrap(_dev_info, KERN_INFO, dev, dev_fmt(fmt), ##__VA_ARGS__)
         |                                                          ^~~~~~~
   sound/soc/codecs/sma1303.c:708:9: note: in expansion of macro 'dev_info'
     708 |         dev_info(sma1303->dev, "%s : prefix=\"%s\", num=%d, ret=%d\n", __func__,
         |         ^~~~~~~~
   sound/soc/codecs/sma1303.c:708:58: note: format string is defined here
     708 |         dev_info(sma1303->dev, "%s : prefix=\"%s\", num=%d, ret=%d\n", __func__,
         |                                                         ~^
         |                                                          |
         |                                                          int
...
vim +708 sound/soc/codecs/sma1303.c
...
# Linux/s390 6.2.0-rc1 Kernel Configuration
#
