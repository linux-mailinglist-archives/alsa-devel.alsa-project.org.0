...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F90F337B11
	for <lists+alsa-devel@lfdr.de>; Thu, 11 Mar 2021 18:39:24 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 2074A1757;
	Thu, 11 Mar 2021 18:38:34 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 2074A1757
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1615484364;
	bh=N7VJAK6Df687dx4owtDCgGzilT31HeBThYcVBKu3Mt4=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=ov/DFrdGFoKI5Zq8mYNCW6LAlaPGVrKUPsPe0WfKkJXQymLft5ByrjdWeND+XOxo5
	 RUjcOkS3owohrcLhTGfEmtyqg9gqd/SM9GpL4nNYTEWjnTYpb6KCttXc+xjVHUX1ZT
	 mZu8zMG+dQmmGaEOGWNlsYLc+rnSzc008U/OKiAE=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 61B2DF804E2;
	Thu, 11 Mar 2021 18:35:32 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 3C342F80256; Thu, 11 Mar 2021 18:35:26 +0100 (CET)
...
Received: from mail-wm1-x331.google.com (mail-wm1-x331.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id B0FA0F8032B
 for <alsa-devel@alsa-project.org>; Thu, 11 Mar 2021 18:35:07 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B0FA0F8032B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="Ua5C9GwT"
Received: by mail-wm1-x331.google.com with SMTP id g20so1892538wmk.3
 for <alsa-devel@alsa-project.org>; Thu, 11 Mar 2021 09:35:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=y81jUHZYkXMqOdOBgEombRrpPDIGK15xMJQO28xaR24=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=y81jUHZYkXMqOdOBgEombRrpPDIGK15xMJQO28xaR24=;
 b=
X-Gm-Message-State: AOAM532pt0IJyf+vKK5cUPrdddWHgv/096JcYAYMj0lBXFUCyNxSjbw3
 9NV6bEYBezZF/lBbOyQA307FQg==
X-Google-Smtp-Source: ABdhPJxNRpC1RRQGONLjP7BALo+eqxtCYqilC70zoEVkypPouG7ToAv6Q0xmeh2xBldKvXn8+0XC/w==
X-Received: by 2002:a1c:65c2:: with SMTP id z185mr9395348wmb.2.1615484106907; 
 Thu, 11 Mar 2021 09:35:06 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id 36sm5221152wrh.94.2021.03.11.09.35.05
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 11 Mar 2021 09:35:06 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH 6/7] ASoC: codecs: wcd938x: add capture dapm widgets
Date: Thu, 11 Mar 2021 17:34:15 +0000
Message-Id: <20210311173416.25219-7-srinivas.kandagatla@linaro.org>
...
---
 sound/soc/codecs/wcd938x.c | 822 +++++++++++++++++++++++++++++++++++++
 1 file changed, 822 insertions(+)

diff --git a/sound/soc/codecs/wcd938x.c b/sound/soc/codecs/wcd938x.c
index 2c3d07a90a18..d8aad187458f 100644
...
@@ -1220,6 +1230,70 @@ static struct regmap_irq_chip wcd938x_regmap_irq_chip = {
 	.irq_drv_data = NULL,
 };
...
+}
+
 static int wcd938x_io_init(struct wcd938x_sdw_priv *wcd)
 {
 	struct regmap *rm = wcd->wcd938x->regmap;
@@ -1916,6 +1990,489 @@ static int wcd938x_codec_enable_ear_pa(struct snd_soc_dapm_widget *w,
 	return 0;
 }
...
+
 ...
 {
@@ -2138,10 +2695,30 @@ static const char * const rx_hph_mode_mux_text[] = {
...
@@ -2172,12 +2749,80 @@ static const struct soc_enum rx_hph_mode_mux_enum =
...
@@ -2194,6 +2839,21 @@ static const struct snd_kcontrol_new hphr_rdac_switch[] = {
 	SOC_DAPM_SINGLE("Switch", SND_SOC_NOPM, 0, 1, 0)
 };
...
@@ -2321,6 +2981,166 @@ static const struct snd_kcontrol_new wcd938x_snd_controls[] = {
...
@@ -2580,6 +3400,8 @@ static const struct snd_soc_component_driver soc_codec_dev_wcd938x_sdw_tx = {
