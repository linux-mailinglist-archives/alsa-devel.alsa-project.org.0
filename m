...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B1076DC18A
	for <lists+alsa-devel@lfdr.de>; Sun,  9 Apr 2023 23:45:29 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B1B9EE99;
	Sun,  9 Apr 2023 23:44:37 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B1B9EE99
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1681076727;
	bh=6G2tXI2EAju22f4i9UUl5I9EaaIhHC3As+eOWC48hNM=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=XIzSVS0ZVR2xb5rkjdEeGlXGMUMWfBcwCXoR+OeQhkOLrx2brc5+ihyGSULhTLoAC
	 iHR63aIRNTDQGErowTvXzc2LEyr9TG7Vcv/mYDk5H2ZdmSLIkiWSWIQh2DFSP/PaP8
	 ZNWlfAsYqazZHFPd1ANPyPpumxeKqycAajHeXr+w=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id DB6A4F8025E;
	Sun,  9 Apr 2023 23:44:34 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id B4511F8032B; Sun,  9 Apr 2023 23:43:42 +0200 (CEST)
...
Received: from n169-114.mail.139.com (n169-114.mail.139.com [120.232.169.114])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 0AE05F80149
	for <alsa-devel@alsa-project.org>; Sun,  9 Apr 2023 23:43:19 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 0AE05F80149
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[58.32.216.169])
	by rmsmtp-lg-appmail-42-12056 (RichMail) with SMTP id 2f1864333167302-9b3c6;
	Mon, 10 Apr 2023 05:43:10 +0800 (CST)
X-RM-TRANSID: 2f1864333167302-9b3c6
From: Shenghao Ding <13916275206@139.com>
To: broonie@kernel.org,
	lgirdwood@gmail.com,
	perex@perex.cz,
	pierre-louis.bossart@linux.intel.com
Subject: [PATCH v12] ASoC: tas2781: Add tas2781 driver
Date: Mon, 10 Apr 2023 05:43:04 +0800
Message-Id: <20230409214304.23710-1-13916275206@139.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: 6FKS6MD6DD4TIBV76F3NY2754NOWTPA6
X-Message-ID-Hash: 6FKS6MD6DD4TIBV76F3NY2754NOWTPA6
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/6FKS6MD6DD4TIBV76F3NY2754NOWTPA6/>
List-Archive: 
...
Changes in v12:
 ...
 - remove unneeded page switch in the i2c broad-cast mode, all the pagings are handled inside regmap
...
---
 ...
 sound/soc/codecs/tas2781-dsp.c | 1829 ++++++++++++++++++++++++++++++++
 sound/soc/codecs/tas2781-dsp.h |  181 ++++
 sound/soc/codecs/tas2781-i2c.c | 1606 ++++++++++++++++++++++++++++
...
index 000000000000..a57804ee10bd
--- /dev/null
...
new file mode 100644
index 000000000000..1acc2d15be1d
--- /dev/null
...
new file mode 100644
index 000000000000..6f990a08f813
--- /dev/null
