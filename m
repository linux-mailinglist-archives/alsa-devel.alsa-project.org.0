...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 7217C474439
	for <lists+alsa-devel@lfdr.de>; Tue, 14 Dec 2021 15:01:57 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B84D11F4A;
	Tue, 14 Dec 2021 15:01:05 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B84D11F4A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1639490515;
	bh=XvF75Qq9S1M78mtYClI2cy+gOjpn6SXOEn/JFtYEAYU=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=t+1lr2myhu8lekc6Tumca6b/L6fAMjKoux7ICHwsFQpeEWa0VI8k3wq7hoQ5kTUbP
	 btRJVxmuDYm+lRwtoY8P4hC7iTOmizp2mTB+KrOe6odEkz0l+mH5Zozt9D3aNp9mLH
	 YW961CSeLg2gbJNMW4shEYazU5fXP+E6pwuMYavs=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id D3FFDF8025E;
	Tue, 14 Dec 2021 15:00:21 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 2E47DF80519; Tue, 14 Dec 2021 15:00:19 +0100 (CET)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 852F1F80249
 for <alsa-devel@alsa-project.org>; Tue, 14 Dec 2021 15:00:07 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 852F1F80249
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="nNgaPI8u"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 1BE4Ko3m006814;
 Tue, 14 Dec 2021 08:00:05 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=G+pWRXdyq/8edCi+o2TAeNA1KkVBRd6o3mntN3+JAlU=;
 b= zA== 
Received: from ediex02.ad.cirrus.com ([84.19.233.68])
 by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3cxh14grht-4
...
Received: from aryzen.ad.cirrus.com (unknown [198.61.64.39])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id A8550B13;
...
Subject: [PATCH v4 07/10] hda: cs35l41: Add support for CS35L41 in HDA systems
Date: Tue, 14 Dec 2021 13:59:56 +0000
Message-ID: <20211214135959.1317949-8-tanureal@opensource.cirrus.com>
...
X-Proofpoint-GUID: 0RLhJnZp3juCBor4sRC9tJ8Jox2Vb4aM
X-Proofpoint-ORIG-GUID: 0RLhJnZp3juCBor4sRC9tJ8Jox2Vb4aM
...
index 550281cf2414..b07b0ef3c858 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -4550,10 +4550,12 @@ F:	drivers/media/cec/i2c/ch7322.c
...
index ab9d2746e804..4dc83b718753 100644
...
index 000000000000..42e179f67a1c
--- /dev/null
...
new file mode 100644
index 000000000000..066128922960
--- /dev/null
...
index 2550870d384d..1ed57774a45c 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -614,6 +614,8 @@ config SND_SOC_CS35L36
 
 config SND_SOC_CS35L41_LIB
 	tristate
+	default y if SND_HDA_SCODEC_CS35L41=y
+	default m if SND_HDA_SCODEC_CS35L41=m
