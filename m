...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 07744113943
	for <lists+alsa-devel@lfdr.de>; Thu,  5 Dec 2019 02:24:54 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7025E1660;
	Thu,  5 Dec 2019 02:23:56 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7025E1660
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1575509086;
	bh=fP7jm2/FoJpdgEs1rC6xCPlz5COnzSbze/WK9qEpg/E=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=MPPakC70cpUfiRFyAwYOGjuqepNytcGhoOpT7PBQJVFqMDIA1glHqxaQAbZ4TMU7T
	 qo5+lzmpjvDvMiPw++YtYdc3aKSsslyi8wgPsRBdZMspO4XsmBCkXxkixWRxwjfXNc
	 sP0rzBR0BXmNGmSHZnoY4evE717Wk0qAuL95cbBg=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 2D442F80216;
	Thu,  5 Dec 2019 02:22:53 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id F2156F801EC; Thu,  5 Dec 2019 02:22:49 +0100 (CET)
...
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 114B4F8010F
 for <alsa-devel@alsa-project.org>; Thu,  5 Dec 2019 02:22:45 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 114B4F8010F
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 04 Dec 2019 17:22:43 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,279,1571727600"; d="scan'208";a="263136726"
Received: from gdeschee-mobl3.amr.corp.intel.com ([10.254.1.6])
 by FMSMGA003.fm.intel.com with ESMTP; 04 Dec 2019 17:22:42 -0800
Message-ID: <7205cec0f9d6082b0f3c1b9922f28b23696246f6.camel@linux.intel.com>
From: Ranjani Sridharan <ranjani.sridharan@linux.intel.com>
To: Curtis Malainey <cujomalainey@chromium.org>, alsa-devel@alsa-project.org
Date: Wed, 04 Dec 2019 17:22:42 -0800
...
> +	help
> +	  This adds the ASoC machine driver for Intel Broadwell
> platforms with
> +	  the RT5650 codec.
...
> hda_dsp_common.o
> @@ -37,6 +38,7 @@ obj-
> $(CONFIG_SND_SOC_INTEL_BXT_DA7219_MAX98357A_COMMON) += snd-soc-sst-
> bxt-da721
>  obj-$(CONFIG_SND_SOC_INTEL_BXT_RT298_MACH) += snd-soc-sst-bxt-
> rt298.o
>  obj-$(CONFIG_SND_SOC_INTEL_GLK_RT5682_MAX98357A_MACH) += snd-soc-
> sst-glk-rt5682_max98357a.o
>  obj-$(CONFIG_SND_SOC_INTEL_BROADWELL_MACH) += snd-soc-sst-
> broadwell.o
> +obj-$(CONFIG_SND_SOC_INTEL_BDW_RT5650_MACH) += snd-soc-sst-bdw-
> rt5650-mach.o
>  obj-$(CONFIG_SND_SOC_INTEL_BDW_RT5677_MACH) += snd-soc-sst-bdw-
> rt5677-mach.o
>  obj-$(CONFIG_SND_SOC_INTEL_BYTCR_RT5640_MACH) += snd-soc-sst-bytcr-
> rt5640.o
>  obj-$(CONFIG_SND_SOC_INTEL_BYTCR_RT5651_MACH) += snd-soc-sst-bytcr-
> rt5651.o
...
> +/*
> + * ASoC machine driver for Intel Broadwell platforms with RT5650
> codec
> + *
...
> +
> +	/* Digital MICs
> +	 * DMIC Pair1 are the two DMICs connected on the DMICN1
> connector.
> +	 * DMIC Pair2 are the two DMICs connected on the DMICN2
> connector.
> +	 * Facing the camera, DMIC Pair1 are on the left side, DMIC
> Pair2
...
> +	}
> +
> +	/* The actual MCLK freq is 24MHz. The codec is told that MCLK
> is
> +	 * 24.576MHz to satisfy the requirement of rl6231_get_clk_info.
> +	 * ASRC is enabled on AD and DA filters to ensure good audio
> quality.
> +	 */
...
> +	 */
> +	ret = sst_hsw_device_set_config(broadwell,
> SST_HSW_DEVICE_SSP_0,
> +		SST_HSW_DEVICE_MCLK_FREQ_24_MHZ,
> +		SST_HSW_DEVICE_TDM_CLOCK_MASTER, 4);
> +	if (ret < 0) {
> +		dev_err(rtd->dev, "error: failed to set device
> config\n");
> +		return ret;
> +	}
> +
...
> +	int ret;
> +
> +	/* Enable codec ASRC function for Stereo DAC/Stereo1
> ADC/DMIC/I2S1.
...
> +		dev_err(component->dev, "Can't create headphone
> jack\n");
> +	}
> +
...
> +	}
> +
> +	rt5645_set_jack_detect(component, &headphone_jack, &mic_jack,
> NULL);
> +
...
> +	DAILINK_COMP_ARRAY(COMP_CODEC("i2c-10EC5650:00", "rt5645-
> aif1")));
> +
...
> +	bdw_rt5650 = devm_kzalloc(&pdev->dev, sizeof(struct
> bdw_rt5650_priv),
> +		GFP_KERNEL);
> +	if (!bdw_rt5650)
> +		return -ENOMEM;
...
> +++ b/sound/soc/intel/common/soc-acpi-intel-hsw-bdw-match.c
> @@ -29,6 +29,13 @@ struct snd_soc_acpi_mach
