...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 38AB2136505
	for <lists+alsa-devel@lfdr.de>; Fri, 10 Jan 2020 02:48:55 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id D294F17A9;
	Fri, 10 Jan 2020 02:48:04 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz D294F17A9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1578620934;
	bh=nFN02yjJ788MXeEEUlM+3abMeWEdVj/fm6e/AYrWCJo=;
	h=From:To:Date:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=bLfxL37dEpbUccYuol6w0YSVKaZmKckKTuhyCIRgFN+QdLjUQsMzrNyNiNvgPRWiQ
	 qNp1o+x/XObd4mDAe/HH7rqoQYWwnAFfRJHDgsXelLODIX4EsoH6JPknavZlCA49AX
	 mjkomez2Heuky0et8/U5oMpyzCae2tiJQpisuX2A=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 2133FF80276;
	Fri, 10 Jan 2020 02:46:44 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id C98FBF80271; Fri, 10 Jan 2020 02:46:41 +0100 (CET)
...
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E44AAF80271
 for <alsa-devel@alsa-project.org>; Fri, 10 Jan 2020 02:46:35 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E44AAF80271
Authenticated-By: 
X-SpamFilter-By: BOX Solutions SpamTrap 5.62 with qID 00A1kWme002176,
 This message is accepted by code: ctloc85258
Received: from mail.realtek.com (RTITCASV01.realtek.com.tw[172.21.6.18])
 by rtits2.realtek.com.tw (8.15.2/2.57/5.78) with ESMTPS id 00A1kWme002176
 (version=TLSv1 cipher=DHE-RSA-AES256-SHA bits=256 verify=NOT);
 Fri, 10 Jan 2020 09:46:32 +0800
Received: from localhost.localdomain (172.22.102.1) by
 RTITCASV01.realtek.com.tw (172.21.6.18) with Microsoft SMTP Server id
 14.3.468.0; Fri, 10 Jan 2020 09:46:31 +0800
From: <shumingf@realtek.com>
To: <broonie@kernel.org>, <lgirdwood@gmail.com>
Date: Fri, 10 Jan 2020 09:46:06 +0800
Message-ID: <20200110014606.17333-1-shumingf@realtek.com>
...
Subject: [alsa-devel] [PATCH 2/2] ASoC: rt1308-sdw: add rt1308 SdW amplifier
	driver
...
index 7761aeec4d07..1de31f88a324 100644
...
@@ -1004,6 +1005,11 @@ config SND_SOC_RT1305
...
index 288b7af354a0..d49138640e0e 100644
...
@@ -447,6 +448,7 @@ obj-$(CONFIG_SND_SOC_RL6347A)	+= snd-soc-rl6347a.o
