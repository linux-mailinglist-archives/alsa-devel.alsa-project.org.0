...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A4FFFDA3C
	for <lists+alsa-devel@lfdr.de>; Fri, 15 Nov 2019 10:59:48 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 1BAB81666;
	Fri, 15 Nov 2019 10:58:58 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 1BAB81666
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1573811988;
	bh=opPYsqZecetXTe4MpnyMhBfzQjmBI8dqn4aGRuLNVsY=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=ivPH9u6laS2Ii7/lP+HEBM8qsmDfPfuIETmJV5fT3PmFBnoSQdSpWkdgApPgaT85Z
	 xzMLMebSL1JaCn5kGAtKF5NE/ZzrJchjvci2GO9GyTf7PhofI5B5f2ney0p6ONNNVu
	 CzlyKsEKEUC6GndLC+CGLb/DtzMmhvZJ6NTLZCOo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 28CAFF8010E;
	Fri, 15 Nov 2019 10:56:45 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id ED706F8010D; Fri, 15 Nov 2019 10:56:41 +0100 (CET)
...
Received: from hqemgate15.nvidia.com (hqemgate15.nvidia.com [216.228.121.64])
 ...
 by alsa1.perex.cz (Postfix) with ESMTPS id EAF97F8010A
 for <alsa-devel@alsa-project.org>; Fri, 15 Nov 2019 10:56:36 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz EAF97F8010A
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=nvidia.com header.i=@nvidia.com
 header.b="ZSBmvaH/"
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by
 hqemgate15.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
 id <B5dce76510000>; Fri, 15 Nov 2019 01:56:33 -0800
Received: from hqmail.nvidia.com ([172.20.161.6])
 by hqpgpgate101.nvidia.com (PGP Universal service);
 Fri, 15 Nov 2019 01:56:34 -0800
X-PGP-Universal: processed;
 by hqpgpgate101.nvidia.com on Fri, 15 Nov 2019 01:56:34 -0800
Received: from nvidia.com (10.124.1.5) by HQMAIL107.nvidia.com (172.20.187.13)
 with Microsoft SMTP Server (TLS) id 15.0.1473.3;
 Fri, 15 Nov 2019 09:56:30 +0000
From: Nikhil Mahale <nmahale@nvidia.com>
To: <tiwai@suse.com>
Date: Fri, 15 Nov 2019 15:26:03 +0530
Message-ID: <20191115095606.22392-3-nmahale@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
 t=1573811793; bh=NQTfxiQD6uqgn+lXTA4mvP0UF0HB2uGQkRvMPFAznhw=;
 h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
 In-Reply-To:References:X-NVConfidentiality:MIME-Version:
 X-Originating-IP:X-ClientProxiedBy:Content-Type;
 b=
Cc: alsa-devel@alsa-project.org, nmahale@nvidia.com, aplattner@nvidia.com
Subject: [alsa-devel] [PATCH v2 2/5] ALSA: hda - Add DP-MST jack support
...
---
 sound/pci/hda/hda_jack.c   | 139 ++++++++++++++++++++++++++++++++-------------
 sound/pci/hda/hda_jack.h   | 107 ++++++++++++++++++++++++++++++----
 sound/pci/hda/patch_hdmi.c |  70 ++++++++++++++---------
 3 files changed, 236 insertions(+), 80 deletions(-)

diff --git a/sound/pci/hda/hda_jack.c b/sound/pci/hda/hda_jack.c
index 1ea42447278f..2d50a13930f7 100644
...
+			      unsigned char tag, int dev_id)
 {
 	struct hda_jack_tbl *jack = codec->jacktbl.list;
 	int i;
@@ -95,29 +98,54 @@ snd_hda_jack_tbl_get_from_tag(struct hda_codec *codec, unsigned char tag)
 	if (!tag || !jack)
 		return NULL;
 	for (i = 0; i < codec->jacktbl.used; i++, jack++)
-		if (jack->tag == tag)
...
@@ -153,10 +181,12 @@ static void jack_detect_update(struct hda_codec *codec,
...
+	    !snd_hda_jack_detect_mst(codec, jack->gating_jack, jack->dev_id))
 	...
 	jack->jack_dirty = 0;
@@ -164,7 +194,8 @@ static void jack_detect_update(struct hda_codec *codec,
...
@@ -198,56 +229,62 @@ EXPORT_SYMBOL_GPL(snd_hda_jack_set_dirty_all);
...
+	jack = snd_hda_jack_tbl_new(codec, nid, dev_id);
 	...
 	if (func) {
@@ -256,6 +293,7 @@ snd_hda_jack_detect_enable_callback(struct hda_codec *codec, hda_nid_t nid,
 			return ERR_PTR(-ENOMEM);
 		callback->func = func;
...
@@ -272,19 +310,24 @@ snd_hda_jack_detect_enable_callback(struct hda_codec *codec, hda_nid_t nid,
 		return ERR_PTR(err);
 	return callback;
 }
...
@@ -299,8 +342,11 @@ EXPORT_SYMBOL_GPL(snd_hda_jack_detect_enable);
...
+	WARN_ON(codec->dp_mst);
 	...
 	if (!gated || !gating)
 		return -EINVAL;
@@ -376,9 +422,10 @@ static void hda_free_jack_priv(struct snd_jack *jack)
 }
...
@@ -387,15 +434,15 @@ static void hda_free_jack_priv(struct snd_jack *jack)
...
+	jack = snd_hda_jack_tbl_new(codec, nid, dev_id);
 	if (!jack)
 		return 0;
 	if (jack->jack)
@@ -425,12 +472,12 @@ int snd_hda_jack_add_kctl(struct hda_codec *codec, hda_nid_t nid,
...
@@ -441,6 +488,8 @@ static int add_jack_kctl(struct hda_codec *codec, hda_nid_t nid,
 	int err;
 	bool phantom_jack;
...
@@ -462,7 +511,7 @@ static int add_jack_kctl(struct hda_codec *codec, hda_nid_t nid,
 		return err;
...
@@ -540,7 +589,8 @@ static void call_jack_callback(struct hda_codec *codec, unsigned int res,
 	}
 	if (jack->gated_jack) {
 		struct hda_jack_tbl *gated =
-			snd_hda_jack_tbl_get(codec, jack->gated_jack);
...
+						 jack->dev_id);
 		if (gated) {
 			for (cb = gated->callback; cb; cb = cb->next) {
 				cb->jack = gated;
@@ -561,7 +611,14 @@ void snd_hda_jack_unsol_event(struct hda_codec *codec, unsigned int res)
