...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F00251D2F64
	for <lists+alsa-devel@lfdr.de>; Thu, 14 May 2020 14:19:19 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 88AAE167C;
	Thu, 14 May 2020 14:18:29 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 88AAE167C
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1589458759;
	bh=f2hCTxSKmFql/pSIspOlpf+DWN6k43B27K92gzh6E5k=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=Vnue1TsT7A7RnGEzXyp29neGex2mMEKEAS14gMI/nAW+bNbNRWq/+lsOccXVQuPly
	 4Y9nrFGtZq2yLVm35ZztibBgdrWqXpuv/QU/uGK2+bQE0f3dW39r7sqP+vEYqT5qiq
	 aUCP8v70Fv4NRIaDp14QBiZfFw5OPAXiz+rZf7HA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id F069BF800E3;
	Thu, 14 May 2020 14:17:38 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id CFAF5F801F2; Thu, 14 May 2020 14:17:35 +0200 (CEST)
...
Received: from mail-pg1-x544.google.com (mail-pg1-x544.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id F36C0F800E3
 for <alsa-devel@alsa-project.org>; Thu, 14 May 2020 14:17:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz F36C0F800E3
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="l6Ka3gde"
Received: by mail-pg1-x544.google.com with SMTP id p21so1162169pgm.13
 for <alsa-devel@alsa-project.org>; Thu, 14 May 2020 05:17:28 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id;
 bh=Z6Nh+Fjguy+AkiC+/ZdQwetYxU6QtDESVN5DZfk3otg=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id;
 bh=Z6Nh+Fjguy+AkiC+/ZdQwetYxU6QtDESVN5DZfk3otg=;
 b=
X-Gm-Message-State: AOAM532mW/3zlVzkg92z48ZxB1ZbSKI1da8djXaUoNDeiQQbPj+AWC72
 C0lZrce9h2YTroVke+WjhnA=
X-Google-Smtp-Source: ABdhPJx0NswIOYfDbblOkCvJpVeLQAww2kNDcuX2Z31C4EUgdj9l0a/QOHZ0CfUmH5vb4Asivx8Hmw==
X-Received: by 2002:a63:3c17:: with SMTP id j23mr3641059pga.343.1589458644102; 
 Thu, 14 May 2020 05:17:24 -0700 (PDT)
Received: from localhost.localdomain ([2001:2d8:eb02:505a:d5fe:3ea6:5791:c8e8])
 by smtp.gmail.com with ESMTPSA id q28sm2292465pfl.165.2020.05.14.05.17.17
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 14 May 2020 05:17:23 -0700 (PDT)
...
Subject: [V4 PATCH 2/2] ASoC: max98390: Added Amplifier Driver
Date: Thu, 14 May 2020 21:16:59 +0900
Message-Id: <20200514121659.8243-1-steves.lee@maximintegrated.com>
...
index 000000000000..b47ddd295f56
--- /dev/null
...
+		snd_soc_component_get_drvdata(component);
+
+	ucontrol->value.integer.value[0] = max98390->cal_running;
+
+	return 0;
+}
+
...
+
+	if (vendor && product) {
+		sprintf(filename, "dsm_param_%s_%s.bin",
+			vendor, product);
+	} else {
...
new file mode 100644
index 000000000000..d5c79e850fbb
--- /dev/null
