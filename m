...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E7C449F64C
	for <lists+alsa-devel@lfdr.de>; Fri, 28 Jan 2022 10:27:58 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 71F5A1670;
	Fri, 28 Jan 2022 10:27:07 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 71F5A1670
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1643362077;
	bh=iCAjVvvz1GMAlhI34IWtmjzxFXeFZzALCYq7eYhPWXU=;
	h=Date:From:To:Subject:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Y6XoTaHcaDl8zeEx3HgRTdpV17OeMC78eyzVoXPlNBZXoCkJ4O2fxX8okEK/Vj56X
	 02VKeK/F68agMN3hyf3jPHIAM1CAJRg3CoBbVM9Enp7qAGS1FPtf7r2T5QeYhjgwE+
	 3yeJcXoGZoqvrw3Xy2hfJGktqvoLATnDIZOU/6v4=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id BAF88F80529;
	Fri, 28 Jan 2022 10:24:48 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id B02C5F804C3; Tue, 25 Jan 2022 10:48:25 +0100 (CET)
...
Received: from frasgout.his.huawei.com (frasgout.his.huawei.com
 ...
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id AC43DF80161
 for <alsa-devel@alsa-project.org>; Tue, 25 Jan 2022 10:48:15 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz AC43DF80161
...
Cc: Andrew Lunn <andrew@lunn.ch>, Gwendal Grignou <gwendal@chromium.org>,
 Yasunari
 Takiguchi <Yasunari.Takiguchi@sony.com>, Claudius Heine <ch@denx.de>,
 ...
 Lucas Tanure <tanureal@opensource.cirrus.com>, David
 Airlie <airlied@linux.ie>, linux-wireless@vger.kernel.org,
 Marco Felsch <m.felsch@pengutronix.de>, David Rhodes <david.rhodes@cirrus.com>,
 Thierry
 Reding <thierry.reding@gmail.com>, Solomon Peachy <pizza@shaftnet.org>,
 Marek =?UTF-8?Q?Beh=C3=BAn?= <kabel@kernel.org>, Lars-Peter
 Clausen <lars@metafoo.de>,
 Krzysztof Kozlowski <krzysztof.kozlowski@canonical.com>,
 Emmanuel Gil Peyrot <linkmauve@linkmauve.fr>, Jiri
 Slaby <jirislaby@kernel.org>, Helge Deller <deller@gmx.de>,
 ...
 Michael Hennerich <Michael.Hennerich@analog.com>, Mike
 Looijmans <mike.looijmans@topic.nl>,
 Ronald =?UTF-8?Q?Tschal=C3=A4r?= <ronald@innovation.ch>, Daniel
 Thompson <daniel.thompson@linaro.org>, Maxime Ripard <mripard@kernel.org>,
 linux-can@vger.kernel.org, linux-gpio@vger.kernel.org,
 linux-arm-kernel@lists.infradead.org, Hans de Goede <hdegoede@redhat.com>,
 Stephen Boyd <sboyd@kernel.org>, Davidlohr Bueso <dbueso@suse.de>,
 UNGLinuxDriver@microchip.com, Jarkko Sakkinen <jarkko@kernel.org>,
 linux-usb@vger.kernel.org, Maxime Coquelin <mcoquelin.stm32@gmail.com>,
 ...
 Nuno =?UTF-8?Q?S=C3=A1?= <nuno.sa@analog.com>, netdev@vger.kernel.org,
 Wei Yongjun <weiyongjun1@huawei.com>, Sam Ravnborg <sam@ravnborg.org>,
 =?UTF-8?Q?J=C3=A9r=C3=B4me?= Pouiller <jerome.pouiller@silabs.com>,
 ...
 Dmitry Torokhov <dmitry.torokhov@gmail.com>, linux-mmc@vger.kernel.org, Liam
 Girdwood <lgirdwood@gmail.com>, Julia Lawall <Julia.Lawall@inria.fr>,
 Yang Li <yang.lee@linux.alibaba.com>, Dan Carpenter <dan.carpenter@oracle.com>,
 patches@opensource.cirrus.com, Kent Gustavsson <kent@minoris.se>, "David S.
 ...
 Torin Cooper-Bennun <torin@maxiluxsystems.com>, Lee
 Jones <lee.jones@linaro.org>, linux-leds@vger.kernel.org,
 ...
 Will Deacon <will@kernel.org>, Manivannan
 Sadhasivam <mani@kernel.org>, Kalle Valo <kvalo@kernel.org>,
 Rui Miguel Silva <rmfrfs@gmail.com>, Marc Kleine-Budde <mkl@pengutronix.de>,
 Fabio Estevam <festevam@gmail.com>, Harry Morris <h.morris@cascoda.com>, Andy
 Shevchenko <andriy.shevchenko@linux.intel.com>,
 Vincent Mailhol <mailhol.vincent@wanadoo.fr>,
 Alessandro Zummo <a.zummo@towertech.it>, Yang Shen <shenyang39@huawei.com>,
 Thomas Zimmermann <tzimmermann@suse.de>, Takashi
 Iwai <tiwai@suse.com>, Cai Huoqing <caihuoqing@baidu.com>,
...
>  {
>  	struct moxtet *moxtet =3D spi_get_drvdata(spi);
> =20
...
> @@ -381,13 +381,11 @@ static int st33zp24_spi_probe(struct spi_device *de=
v)
...
>  }
> =20
>  static const struct spi_device_id st33zp24_spi_id[] =3D {
...
> @@ -254,13 +254,12 @@ static int tpm_tis_spi_driver_probe(struct spi_devi=
ce *spi)
> =20
...
>  {
>  	struct gen_74x164_chip *chip =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id gen_74x164_spi_ids[] =3D {
...
>  {
>  	struct max3191x_chip *max3191x =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id max7301_id[] =3D {
...
>  }
> =20
>  static struct spi_driver mc33880_driver =3D {
...
> diff --git a/drivers/gpu/drm/panel/panel-abt-y030xx067a.c b/drivers/gpu/d=
rm/panel/panel-abt-y030xx067a.c
...
>  {
>  	struct y030xx067a *priv =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct drm_display_mode y030xx067a_modes[] =3D {
...
>  {
>  	struct ili9322 *ili =3D spi_get_drvdata(spi);
> =20
...
> =20
>  /*
> diff --git a/drivers/gpu/drm/panel/panel-ilitek-ili9341.c b/drivers/gpu/d=
rm/panel/panel-ilitek-ili9341.c
...
> diff --git a/drivers/gpu/drm/panel/panel-innolux-ej030na.c b/drivers/gpu/=
drm/panel/panel-innolux-ej030na.c
...
>  {
>  	struct ej030na *priv =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&priv->panel);
>  	drm_panel_disable(&priv->panel);
>  	drm_panel_unprepare(&priv->panel);
...
>  }
> =20
>  static const struct drm_display_mode ej030na_modes[] =3D {
...
>  {
>  	struct lb035q02_device *lcd =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id lb035q02_of_match[] =3D {
...
>  {
>  	struct lg4573 *ctx =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id lg4573_of_match[] =3D {
...
>  {
>  	struct nl8048_panel *lcd =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&lcd->panel);
>  	drm_panel_disable(&lcd->panel);
...
>  }
> =20
>  static const struct of_device_id nl8048_of_match[] =3D {
...
>  {
>  	struct nt39016 *panel =3D spi_get_drvdata(spi);
> =20
...
> diff --git a/drivers/gpu/drm/panel/panel-samsung-db7430.c b/drivers/gpu/d=
rm/panel/panel-samsung-db7430.c
...
>  {
>  	struct db7430 *db =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct ld9040 *ctx =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id ld9040_of_match[] =3D {
> diff --git a/drivers/gpu/drm/panel/panel-samsung-s6d27a1.c b/drivers/gpu/=
drm/panel/panel-samsung-s6d27a1.c
...
>  {
>  	struct s6d27a1 *ctx =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&ctx->panel);
> -	return 0;
>  }
> =20
>  static const struct of_device_id s6d27a1_match[] =3D {
> diff --git a/drivers/gpu/drm/panel/panel-samsung-s6e63m0-spi.c b/drivers/=
...
>  }
> =20
>  static const struct of_device_id s6e63m0_spi_of_match[] =3D {
...
>  {
>  	struct st7789v *ctx =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&ctx->panel);
> -
> -	return 0;
...
>  {
>  	struct acx565akm_panel *lcd =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id acx565akm_of_match[] =3D {
...
>  {
>  	struct td028ttec1_panel *lcd =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&lcd->panel);
>  	drm_panel_disable(&lcd->panel);
>  	drm_panel_unprepare(&lcd->panel);
...
>  }
> =20
>  static const struct of_device_id td028ttec1_of_match[] =3D {
...
>  {
>  	struct td043mtea1_panel *lcd =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id td043mtea1_of_match[] =3D {
...
>  {
>  	struct tpg110 *tpg =3D spi_get_drvdata(spi);
> =20
>  	drm_panel_remove(&tpg->panel);
> -	return 0;
>  }
> =20
>  static const struct of_device_id tpg110_match[] =3D {
...
>  {
>  	struct ws2401 *ws =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct adcxx *adc =3D spi_get_drvdata(spi);
>  	int i;
...
>  }
> =20
>  static const struct spi_device_id adcxx_ids[] =3D {
...
>  }
> =20
>  static const struct spi_device_id adt7310_id[] =3D {
...
>  {
>  	struct max1111_data *data =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id max1111_ids[] =3D {
...
>  {
>  	struct max31722_data *data =3D spi_get_drvdata(spi);
>  	int ret;
...
> diff --git a/drivers/iio/accel/bma400_spi.c b/drivers/iio/accel/bma400_sp=
i.c
...
>  }
> =20
>  static const struct spi_device_id bma400_spi_ids[] =3D {
> diff --git a/drivers/iio/accel/bmc150-accel-spi.c b/drivers/iio/accel/bmc=
150-accel-spi.c
...
> diff --git a/drivers/iio/accel/bmi088-accel-spi.c b/drivers/iio/accel/bmi=
088-accel-spi.c
...
>  }
> =20
>  static const struct spi_device_id bmi088_accel_id[] =3D {
...
>  }
> =20
>  static const struct spi_device_id kxsd9_spi_id[] =3D {
...
>  }
> =20
>  static const struct spi_device_id mma7455_spi_ids[] =3D {
> diff --git a/drivers/iio/accel/sca3000.c b/drivers/iio/accel/sca3000.c
> index 43ecacbdc95a..83c81072511e 100644
> --- a/drivers/iio/accel/sca3000.c
> +++ b/drivers/iio/accel/sca3000.c
> @@ -1524,7 +1524,7 @@ static int sca3000_stop_all_interrupts(struct sca30=
00_state *st)
>  	return ret;
>  }
> =20
...
>  }
> =20
>  static const struct spi_device_id sca3000_id[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct mcp320x *adc =3D iio_priv(indio_dev);
> =20
...
>  }
> =20
>  static const struct of_device_id mcp3911_dt_ids[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct adc12138 *adc =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct of_device_id adc12138_dt_ids[] =3D {
...
>  }
> =20
>  static const struct spi_device_id ti_ads7950_id[] =3D {
...
> diff --git a/drivers/iio/amplifiers/ad8366.c b/drivers/iio/amplifiers/ad8=
366.c
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad8366_state *st =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad8366_id[] =3D {
...
>  {
>  	struct ssp_data *data =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad5360_state *st =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad5360_ids[] =3D {
...
>  }
> =20
>  static const struct spi_device_id ad5380_spi_ids[] =3D {
...
>  }
> =20
>  static struct spi_driver ad5446_spi_driver =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad5449 *st =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad5449_spi_ids[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad5504_state *st =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad5504_id[] =3D {
...
>  }
> =20
>  static const struct spi_device_id ad5592r_spi_ids[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad5624r_state *st =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad5624r_id[] =3D {
...
>  }
> =20
>  static const struct spi_device_id ad5686_spi_id[] =3D {
...
>  {
>  	struct iio_dev *iio_dev =3D spi_get_drvdata(spi);
>  	struct ad5761_state *st =3D iio_priv(iio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad5761_id[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad5764_state *st =3D iio_priv(indio_dev);
> @@ -341,8 +341,6 @@ static int ad5764_remove(struct spi_device *spi)
> =20
>  	if (st->chip_info->int_vref =3D=3D 0)
...
>  }
> =20
>  static const struct spi_device_id ad5791_id[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ad8801_state *state =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id ad8801_ids[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ltc1660_priv *priv =3D iio_priv(indio_dev);
> =20
>  	iio_device_unregister(indio_dev);
...
>  }
> =20
>  static const struct of_device_id ltc1660_dt_ids[] =3D {
...
>  }
> =20
>  static const struct spi_device_id ltc2632_id[] =3D {
...
> diff --git a/drivers/iio/dac/ti-dac082s085.c b/drivers/iio/dac/ti-dac082s=
085.c
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct ti_dac_chip *ti_dac =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct of_device_id ti_dac_of_id[] =3D {
...
>  }
> =20
>  static const struct of_device_id adf4350_of_match[] =3D {
...
>  }
> =20
>  static const struct spi_device_id bmg160_spi_id[] =3D {
> diff --git a/drivers/iio/gyro/fxas21002c_spi.c b/drivers/iio/gyro/fxas210=
02c_spi.c
...
>  }
> =20
>  static const struct spi_device_id fxas21002c_spi_id[] =3D {
...
>  {
>  	struct iio_dev *indio_dev =3D spi_get_drvdata(spi);
>  	struct afe4403_data *afe =3D iio_priv(indio_dev);
...
>  }
> =20
>  static const struct spi_device_id afe4403_ids[] =3D {
> diff --git a/drivers/iio/magnetometer/bmc150_magn_spi.c b/drivers/iio/mag=
netometer/bmc150_magn_spi.c
> index c6ed3ea8460a..4c570412d65c 100644
> --- a/drivers/iio/magnetometer/bmc150_magn_spi.c
> +++ b/drivers/iio/magnetometer/bmc150_magn_spi.c
> @@ -29,11 +29,9 @@ static int bmc150_magn_spi_probe(struct spi_device *sp=
i)
...
>  }
> =20
>  static const struct spi_device_id bmc150_magn_spi_id[] =3D {
> diff --git a/drivers/iio/magnetometer/hmc5843_spi.c b/drivers/iio/magneto=
meter/hmc5843_spi.c
...
>  }
> =20
>  static const struct spi_device_id hmc5843_id[] =3D {
> diff --git a/drivers/iio/potentiometer/max5487.c b/drivers/iio/potentiome=
ter/max5487.c
...
>  	ret =3D max5487_write_cmd(spi, MAX5487_COPY_AB_TO_NV);
>  	if (ret)
...
>  }
> =20
>  static const struct spi_device_id max5487_id[] =3D {
...
>  }
> =20
>  static const struct of_device_id ms5611_spi_matches[] =3D {
> diff --git a/drivers/iio/pressure/zpa2326_spi.c b/drivers/iio/pressure/zp=
a2326_spi.c
...
>  }
> =20
>  static const struct spi_device_id zpa2326_spi_ids[] =3D {
> diff --git a/drivers/input/keyboard/applespi.c b/drivers/input/keyboard/a=
pplespi.c
> index eda1b23002b5..d1f5354d5ea2 100644
> --- a/drivers/input/keyboard/applespi.c
> +++ b/drivers/input/keyboard/applespi.c
> @@ -1858,7 +1858,7 @@ static void applespi_drain_reads(struct applespi_da=
ta *applespi)
...
>  {
>  	struct applespi_data *applespi =3D spi_get_drvdata(spi);
> =20
...
> diff --git a/drivers/input/touchscreen/ads7846.c b/drivers/input/touchscr=
een/ads7846.c
...
>  {
>  	struct ads7846 *ts =3D spi_get_drvdata(spi);
> =20
>  	ads7846_stop(ts);
> -
> -	return 0;
>  }
> =20
>  static struct spi_driver ads7846_driver =3D {
> diff --git a/drivers/input/touchscreen/cyttsp4_spi.c b/drivers/input/touc=
hscreen/cyttsp4_spi.c
...
>  {
>  	struct cyttsp4 *ts =3D spi_get_drvdata(spi);
>  	cyttsp4_remove(ts);
> -
> -	return 0;
>  }
> =20
>  static struct spi_driver cyttsp4_spi_driver =3D {
> diff --git a/drivers/input/touchscreen/tsc2005.c b/drivers/input/touchscr=
een/tsc2005.c
...
>  {
>  	struct cr0014114 *priv =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id cr0014114_dt_ids[] =3D {
> diff --git a/drivers/leds/leds-dac124s085.c b/drivers/leds/leds-dac124s08=
5.c
...
>  {
>  	struct dac124s085	*dac =3D spi_get_drvdata(spi);
>  	int i;
> =20
>  	for (i =3D 0; i < ARRAY_SIZE(dac->leds); i++)
>  		led_classdev_unregister(&dac->leds[i].ldev);
> -
> -	return 0;
>  }
> =20
>  static struct spi_driver dac124s085_driver =3D {
> diff --git a/drivers/leds/leds-el15203000.c b/drivers/leds/leds-el1520300=
0.c
...
>  {
>  	struct spi_byte_led	*led =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver spi_byte_driver =3D {
> diff --git a/drivers/media/spi/cxd2880-spi.c b/drivers/media/spi/cxd2880-=
spi.c
...
>  {
>  	struct cxd2880_dvb_spi *dvb_spi =3D spi_get_drvdata(spi);
...
>  }
> =20
>  static const struct spi_device_id cxd2880_spi_id[] =3D {
...
>  {
>  	struct v4l2_subdev *sd =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver gs_driver =3D {
...
>  {
>  	struct v4l2_subdev *sd =3D spi_get_drvdata(spi);
>  	struct msi001_dev *dev =3D sd_to_msi001_dev(sd);
...
>  }
> =20
>  static const struct spi_device_id msi001_id_table[] =3D {
...
>  {
>  	struct arizona *arizona =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id arizona_spi_ids[] =3D {
...
>  {
>  	struct da9052 *da9052 =3D spi_get_drvdata(spi);
> =20
>  	da9052_device_exit(da9052);
> -	return 0;
>  }
> =20
>  static const struct spi_device_id da9052_spi_id[] =3D {
...
>  {
>  	struct pcap_chip *pcap =3D spi_get_drvdata(spi);
>  	unsigned long flags;
...
>  {
>  	struct madera *madera =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id madera_spi_ids[] =3D {
...
>  }
> =20
>  static struct spi_driver mc13xxx_spi_driver =3D {
...
>  {
>  	struct stmpe *stmpe =3D spi_get_drvdata(spi);
> =20
>  	stmpe_remove(stmpe);
> -
> -	return 0;
>  }
> =20
>  static const struct of_device_id stmpe_spi_of_match[] =3D {
...
>  {
>  	struct tps65912 *tps =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id tps65912_spi_id_table[] =3D {
> diff --git a/drivers/misc/ad525x_dpot-spi.c b/drivers/misc/ad525x_dpot-sp=
i.c
...
>  }
> =20
>  static const struct spi_device_id ad_dpot_spi_id[] =3D {
...
> @@ -555,14 +555,12 @@ static int eeprom_93xx46_probe(struct spi_device *s=
pi)
>  	return 0;
>  }
> =20
...
>  {
>  	struct eeprom_93xx46_dev *edev =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver eeprom_93xx46_driver =3D {
> diff --git a/drivers/misc/lattice-ecp3-config.c b/drivers/misc/lattice-ec=
p3-config.c
> index 98828030b5a4..bac4df2e5231 100644
> --- a/drivers/misc/lattice-ecp3-config.c
> +++ b/drivers/misc/lattice-ecp3-config.c
> @@ -211,13 +211,11 @@ static int lattice_ecp3_probe(struct spi_device *sp=
i)
>  	return 0;
>  }
> =20
...
>  {
>  	struct fpga_data *data =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id lattice_ecp3_id[] =3D {
...
>  {
>  	struct lis3lv02d *lis3 =3D spi_get_drvdata(spi);
...
>  {
>  	struct mmc_host		*mmc =3D dev_get_drvdata(&spi->dev);
>  	struct mmc_spi_host	*host =3D mmc_priv(mmc);
> @@ -1507,7 +1507,6 @@ static int mmc_spi_remove(struct spi_device *spi)
>  	spi->max_speed_hz =3D mmc->f_max;
>  	mmc_spi_put_pdata(spi);
>  	mmc_free_host(mmc);
> -	return 0;
>  }
> =20
>  static const struct spi_device_id mmc_spi_dev_ids[] =3D {
> diff --git a/drivers/mtd/devices/mchp23k256.c b/drivers/mtd/devices/mchp2=
3k256.c
...
>  {
>  	struct mchp23k256_flash *flash =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id mchp23k256_of_table[] =3D {
...
>  {
>  	struct mchp48l640_flash *flash =3D spi_get_drvdata(spi);
> =20
>  	WARN_ON(mtd_device_unregister(&flash->mtd));
> -
> -	return 0;
>  }
> =20
>  static const struct of_device_id mchp48l640_of_table[] =3D {
> diff --git a/drivers/mtd/devices/mtd_dataflash.c b/drivers/mtd/devices/mt=
d_dataflash.c
...
>  {
>  	struct dataflash	*flash =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver dataflash_driver =3D {
...
>  {
>  	struct sst25l_flash *flash =3D spi_get_drvdata(spi);
> =20
>  	WARN_ON(mtd_device_unregister(&flash->mtd));
> -
> -	return 0;
>  }
> =20
>  static struct spi_driver sst25l_driver =3D {
...
>  {
>  	struct tcan4x5x_priv *priv =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct hi3110_priv *priv =3D spi_get_drvdata(spi);
>  	struct net_device *net =3D priv->net;
...
>  	struct net_device *net =3D priv->net;
> @@ -1442,8 +1442,6 @@ static int mcp251x_can_remove(struct spi_device *sp=
i)
>  	clk_disable_unprepare(priv->clk);
> =20
>  	free_candev(net);
...
>  }
> =20
>  static int __maybe_unused mcp251xfd_runtime_suspend(struct device *devic=
e)
...
>  {
>  	struct b53_device *dev =3D spi_get_drvdata(spi);
> =20
...
> diff --git a/drivers/net/dsa/microchip/ksz8795_spi.c b/drivers/net/dsa/mi=
crochip/ksz8795_spi.c
...
>  {
>  	struct ksz_device *dev =3D spi_get_drvdata(spi);
> =20
...
> diff --git a/drivers/net/dsa/microchip/ksz9477_spi.c b/drivers/net/dsa/mi=
crochip/ksz9477_spi.c
...
>  {
>  	struct sja1105_private *priv =3D spi_get_drvdata(spi);
> =20
>  	if (!priv)
> -		return 0;
> +		return;
...
> diff --git a/drivers/net/dsa/vitesse-vsc73xx-spi.c b/drivers/net/dsa/vite=
sse-vsc73xx-spi.c
...
>  {
>  	struct vsc73xx_spi *vsc_spi =3D spi_get_drvdata(spi);
> =20
>  	if (!vsc_spi)
> -		return 0;
> +		return;
...
>  }
> =20
>  static const struct of_device_id ks8851_match_table[] =3D {
...
>  {
>  	struct enc28j60_net *priv =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id enc28j60_dt_ids[] =3D {
...
> @@ -1093,7 +1093,7 @@ static int encx24j600_spi_probe(struct spi_device *=
spi)
>  	return ret;
>  }
> =20
...
>  {
>  	struct encx24j600_priv *priv =3D dev_get_drvdata(&spi->dev);
> =20
> @@ -1101,8 +1101,6 @@ static int encx24j600_spi_remove(struct spi_device =
*spi)
...
>  }
> =20
>  static const struct spi_device_id encx24j600_spi_id_table[] =3D {
...
>  {
>  	struct net_device *qcaspi_devs =3D spi_get_drvdata(spi);
...
>  }
> =20
>  static const struct spi_device_id qca_spi_id[] =3D {
...
>  }
> =20
>  static const struct of_device_id mse102x_match_table[] =3D {
...
>  }
> =20
>  static const struct spi_device_id w5100_spi_ids[] =3D {
...
>  {
>  	struct adf7242_local *lp =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id adf7242_of_match[] =3D {
> diff --git a/drivers/net/ieee802154/at86rf230.c b/drivers/net/ieee802154/=
at86rf230.c
...
>  {
>  	struct at86rf230_local *lp =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id at86rf230_of_match[] =3D {
...
> @@ -831,7 +831,7 @@ static void ca8210_rx_done(struct cas_control *cas_ct=
l)
>  finish:;
>  }
> =20
...
> @@ -3048,7 +3048,7 @@ static void ca8210_test_interface_clear(struct ca82=
10_priv *priv)
>   *
...
> @@ -3088,8 +3088,6 @@ static int ca8210_remove(struct spi_device *spi_dev=
ice)
...
> =20
>  /**
> diff --git a/drivers/net/ieee802154/cc2520.c b/drivers/net/ieee802154/cc2=
520.c
...
>  {
>  	struct cc2520_private *priv =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct spi_device_id cc2520_ids[] =3D {
> diff --git a/drivers/net/ieee802154/mcr20a.c b/drivers/net/ieee802154/mcr=
20a.c
...
>  {
>  	struct mcr20a_local *lp =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id mcr20a_of_match[] =3D {
> diff --git a/drivers/net/ieee802154/mrf24j40.c b/drivers/net/ieee802154/m=
rf24j40.c
...
>  {
>  	struct mrf24j40 *devrec =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id mrf24j40_of_match[] =3D {
...
>  {
>  	struct ks8995_switch *ks =3D spi_get_drvdata(spi);
> =20
...
> @@ -194,10 +194,9 @@ static int slic_ds26522_init_configure(struct spi_de=
vice *spi)
>  	return 0;
>  }
> =20
...
>  {
>  	struct p54s_priv *priv =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct if_spi_card *card =3D spi_get_drvdata(spi);
>  	struct lbs_private *priv =3D card->priv;
> @@ -1212,8 +1212,6 @@ static int libertas_spi_remove(struct spi_device *s=
pi)
...
>  }
> =20
>  /* Disconnect Function to be called by SPI stack when device is disconne=
cted */
> -static int cw1200_spi_disconnect(struct spi_device *func)
> +static void cw1200_spi_disconnect(struct spi_device *func)
>  {
>  	struct hwbus_priv *self =3D spi_get_drvdata(func);
> =20
> @@ -435,8 +435,6 @@ static int cw1200_spi_disconnect(struct spi_device *f=
unc)
>  		}
>  	}
...
> diff --git a/drivers/net/wireless/ti/wl1251/spi.c b/drivers/net/wireless/=
ti/wl1251/spi.c
...
>  {
>  	struct wl1251 *wl =3D spi_get_drvdata(spi);
> =20
>  	wl1251_free_hw(wl);
...
>  }
> =20
>  static struct spi_driver wl1251_spi_driver =3D {
> diff --git a/drivers/net/wireless/ti/wlcore/spi.c b/drivers/net/wireless/=
ti/wlcore/spi.c
...
>  {
>  	struct wl12xx_spi_glue *glue =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver wl1271_spi_driver =3D {
...
>  {
>  	struct nfcmrvl_spi_drv_data *drv_data =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct st_nci_spi_phy *phy =3D spi_get_drvdata(dev);
> =20
...
>  }
> =20
>  static struct spi_device_id st_nci_spi_id_table[] =3D {
> diff --git a/drivers/nfc/st95hf/core.c b/drivers/nfc/st95hf/core.c
> index b23f47936473..ed704bb77226 100644
> --- a/drivers/nfc/st95hf/core.c
> +++ b/drivers/nfc/st95hf/core.c
> @@ -1198,7 +1198,7 @@ static int st95hf_probe(struct spi_device *nfc_spi_=
dev)
>  	return ret;
>  }
> =20
...
>  {
>  	int result =3D 0;
>  	unsigned char reset_cmd =3D ST95HF_COMMAND_RESET;
> @@ -1236,8 +1236,6 @@ static int st95hf_remove(struct spi_device *nfc_spi=
_dev)
>  	/* disable regulator */
...
>  {
>  	struct trf7970a *trf =3D spi_get_drvdata(spi);
> =20
...
> @@ -648,7 +648,7 @@ static struct olpc_ec_driver olpc_xo175_ec_driver =3D=
 {
...
> @@ -657,8 +657,6 @@ static int olpc_xo175_ec_remove(struct spi_device *sp=
i)
> =20
...
>  {
>  	struct ds1305 *ds1305 =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver ds1305_driver =3D {
...
>  	struct spi_mem *mem =3D spi_get_drvdata(spi);
> =20
>  	if (memdrv->remove)
...
> diff --git a/drivers/spi/spi-slave-system-control.c b/drivers/spi/spi-sla=
ve-system-control.c
> index 169f3d595f60..d37cfe995a63 100644
> --- a/drivers/spi/spi-slave-system-control.c
> +++ b/drivers/spi/spi-slave-system-control.c
> @@ -132,13 +132,12 @@ static int spi_slave_system_control_probe(struct sp=
i_device *spi)
>  	return 0;
>  }
> =20
...
>  {
>  	struct spi_slave_system_control_priv *priv =3D spi_get_drvdata(spi);
> =20
>  	spi_slave_abort(spi);
...
>  }
> =20
>  static struct spi_driver spi_slave_system_control_driver =3D {
...
> @@ -106,13 +106,12 @@ static int spi_slave_time_probe(struct spi_device *=
spi)
>  	return 0;
>  }
> =20
...
>  {
>  	struct spi_slave_time_priv *priv =3D spi_get_drvdata(spi);
> =20
>  	spi_slave_abort(spi);
>  	wait_for_completion(&priv->finished);
> -	return 0;
>  }
> =20
>  static struct spi_driver spi_slave_time_driver =3D {
...
>  {
>  	struct tle62x0_state *st =3D spi_get_drvdata(spi);
>  	int ptr;
...
>  }
> =20
>  static struct spi_driver tle62x0_driver =3D {
...
> -		int ret;
> -
> -		ret =3D sdrv->remove(to_spi_device(dev));
> -		if (ret)
> -			dev_warn(dev,
...
>  {
>  	struct spidev_data	*spidev =3D spi_get_drvdata(spi);
> =20
> @@ -820,8 +820,6 @@ static int spidev_remove(struct spi_device *spi)
>  	if (spidev->users =3D=3D 0)
>  		kfree(spidev);
...
>  }
> =20
>  static struct spi_driver spidev_spi_driver =3D {
> diff --git a/drivers/staging/fbtft/fbtft.h b/drivers/staging/fbtft/fbtft.h
> index 6a7545b5bcd2..b68f5f9b7c78 100644
> --- a/drivers/staging/fbtft/fbtft.h
> +++ b/drivers/staging/fbtft/fbtft.h
> @@ -286,12 +286,11 @@ static int fbtft_driver_probe_spi(struct spi_device=
 *spi)			\
...
>  }										\
>  										\
>  static struct spi_driver fbtft_driver_spi_driver =3D {				\
> diff --git a/drivers/staging/pi433/pi433_if.c b/drivers/staging/pi433/pi4=
33_if.c
...
>  {
>  	struct pi433_device	*device =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static const struct of_device_id pi433_dt_ids[] =3D {
...
>  {
>  	struct max3100_port *s =3D spi_get_drvdata(spi);
>  	int i;
> @@ -828,13 +828,12 @@ static int max3100_remove(struct spi_device *spi)
>  	for (i =3D 0; i < MAX_MAX3100; i++)
>  		if (max3100s[i]) {
...
> @@ -1487,10 +1487,9 @@ static int max310x_spi_probe(struct spi_device *sp=
i)
...
> @@ -1440,11 +1440,9 @@ static int sc16is7xx_spi_probe(struct spi_device *=
spi)
...
>  }
> =20
>  static const struct spi_device_id sc16is7xx_spi_id_table[] =3D {
...
>  {
>  	struct max3420_udc *udc =3D spi_get_drvdata(spi);
>  	unsigned long flags;
...
>  }
> =20
>  static const struct of_device_id max3420_udc_of_match[] =3D {
...
>  }
> =20
>  static const struct of_device_id max3421_of_match_table[] =3D {
> diff --git a/drivers/video/backlight/ams369fg06.c b/drivers/video/backlig=
ht/ams369fg06.c
...
>  {
>  	struct ams369fg06 *lcd =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct corgi_lcd *lcd =3D spi_get_drvdata(spi);
> =20
> @@ -550,7 +550,6 @@ static int corgi_lcd_remove(struct spi_device *spi)
>  	lcd->bl_dev->props.brightness =3D 0;
>  	backlight_update_status(lcd->bl_dev);
>  	corgi_lcd_set_power(lcd->lcd_dev, FB_BLANK_POWERDOWN);
> -	return 0;
>  }
> =20
>  static struct spi_driver corgi_lcd_driver =3D {
> diff --git a/drivers/video/backlight/ili922x.c b/drivers/video/backlight/=
ili922x.c
...
>  }
> =20
>  static struct spi_driver ili922x_driver =3D {
> diff --git a/drivers/video/backlight/l4f00242t03.c b/drivers/video/backli=
ght/l4f00242t03.c
...
>  {
>  	struct l4f00242t03_priv *priv =3D spi_get_drvdata(spi);
> =20
...
> diff --git a/drivers/video/backlight/lms501kf03.c b/drivers/video/backlig=
ht/lms501kf03.c
...
>  {
>  	struct lms501kf03 *lcd =3D spi_get_drvdata(spi);
> =20
...
> =20
>  #ifdef CONFIG_PM_SLEEP
> diff --git a/drivers/video/backlight/ltv350qv.c b/drivers/video/backlight=
/ltv350qv.c
...
>  {
>  	struct ltv350qv *lcd =3D spi_get_drvdata(spi);
> =20
...
>  {
>  	struct tdo24m *lcd =3D spi_get_drvdata(spi);
> =20
...
> =20
>  #ifdef CONFIG_PM_SLEEP
> diff --git a/drivers/video/backlight/tosa_lcd.c b/drivers/video/backlight=
/tosa_lcd.c
...
>  {
>  	struct tosa_lcd_data *data =3D spi_get_drvdata(spi);
> =20
...
> =20
>  #ifdef CONFIG_PM_SLEEP
> diff --git a/drivers/video/backlight/vgg2432a4.c b/drivers/video/backligh=
t/vgg2432a4.c
...
> diff --git a/drivers/video/fbdev/omap/lcd_mipid.c b/drivers/video/fbdev/o=
map/lcd_mipid.c
...
>  {
>  	struct mipid_device *md =3D dev_get_drvdata(&spi->dev);
> =20
...
>  }
> =20
>  static struct spi_driver mipid_spi_driver =3D {
> diff --git a/drivers/video/fbdev/omap2/omapfb/displays/panel-lgphilips-lb=
035q02.c b/drivers/video/fbdev/omap2/omapfb/displays/panel-lgphilips-lb035q=
02.c
...
> @@ -316,7 +316,7 @@ static int lb035q02_panel_spi_probe(struct spi_device=
 *spi)
>  	return r;
>  }
> =20
...
>  {
>  	struct panel_drv_data *ddata =3D spi_get_drvdata(spi);
>  	struct omap_dss_device *dssdev =3D &ddata->dssdev;
> @@ -328,8 +328,6 @@ static int lb035q02_panel_spi_remove(struct spi_devic=
e *spi)
...
> =20
>  static const struct of_device_id lb035q02_of_match[] =3D {
> diff --git a/drivers/video/fbdev/omap2/omapfb/displays/panel-nec-nl8048hl=
11.c b/drivers/video/fbdev/omap2/omapfb/displays/panel-nec-nl8048hl11.c
...
>  {
>  	struct panel_drv_data *ddata =3D dev_get_drvdata(&spi->dev);
>  	struct omap_dss_device *dssdev =3D &ddata->dssdev;
...
> =20
>  #ifdef CONFIG_PM_SLEEP
> diff --git a/drivers/video/fbdev/omap2/omapfb/displays/panel-sony-acx565a=
km.c b/drivers/video/fbdev/omap2/omapfb/displays/panel-sony-acx565akm.c
...
> =20
>  static const struct of_device_id acx565akm_of_match[] =3D {
> diff --git a/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td028tte=
c1.c b/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td028ttec1.c
> index 595ebd8bd5dc..3c0f887d3092 100644
> --- a/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td028ttec1.c
> +++ b/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td028ttec1.c
> @@ -425,7 +425,7 @@ static int td028ttec1_panel_probe(struct spi_device *=
spi)
>  	return r;
>  }
> =20
...
>  	struct panel_drv_data *ddata =3D dev_get_drvdata(&spi->dev);
>  	struct omap_dss_device *dssdev =3D &ddata->dssdev;
> @@ -439,8 +439,6 @@ static int td028ttec1_panel_remove(struct spi_device =
*spi)
...
> =20
>  static const struct of_device_id td028ttec1_of_match[] =3D {
> diff --git a/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td043mte=
a1.c b/drivers/video/fbdev/omap2/omapfb/displays/panel-tpo-td043mtea1.c
...
>  };
> diff --git a/sound/pci/hda/cs35l41_hda_spi.c b/sound/pci/hda/cs35l41_hda_=
spi.c
> index 9f8123893cc8..50eb6c0e6658 100644
> --- a/sound/pci/hda/cs35l41_hda_spi.c
> +++ b/sound/pci/hda/cs35l41_hda_spi.c
> @@ -28,11 +28,9 @@ static int cs35l41_hda_spi_probe(struct spi_device *sp=
i)
...
> diff --git a/sound/soc/codecs/adau1761-spi.c b/sound/soc/codecs/adau1761-=
spi.c
...
>  }
> =20
>  static const struct spi_device_id adau1761_spi_id[] =3D {
> diff --git a/sound/soc/codecs/adau1781-spi.c b/sound/soc/codecs/adau1781-=
spi.c
...
>  }
> =20
>  static const struct spi_device_id adau1781_spi_id[] =3D {
> diff --git a/sound/soc/codecs/cs35l41-spi.c b/sound/soc/codecs/cs35l41-sp=
i.c
...
>  {
>  	struct cs35l41_private *cs35l41 =3D spi_get_drvdata(spi);
> =20
...
> =20
>  #ifdef CONFIG_OF
> diff --git a/sound/soc/codecs/pcm3168a-spi.c b/sound/soc/codecs/pcm3168a-=
spi.c
...
>  }
> =20
>  static const struct spi_device_id pcm3168a_spi_id[] =3D {
> diff --git a/sound/soc/codecs/pcm512x-spi.c b/sound/soc/codecs/pcm512x-sp=
i.c
...
>  }
> =20
>  static const struct spi_device_id pcm512x_spi_id[] =3D {
> diff --git a/sound/soc/codecs/tlv320aic32x4-spi.c b/sound/soc/codecs/tlv3=
20aic32x4-spi.c
...
>  }
> =20
>  static const struct spi_device_id aic32x4_spi_id[] =3D {
> diff --git a/sound/soc/codecs/tlv320aic3x-spi.c b/sound/soc/codecs/tlv320=
aic3x-spi.c
...
>  }
> =20
>  static const struct spi_device_id aic3x_spi_id[] =3D {
...
>  {
>  	struct wm0010_priv *wm0010 =3D spi_get_drvdata(spi);
> =20
...
>  }
> =20
>  static struct spi_driver wm0010_spi_driver =3D {
...
>  }
> =20
>  static const struct of_device_id wm8804_of_match[] =3D {
> diff --git a/sound/spi/at73c213.c b/sound/spi/at73c213.c
> index 76c0e37a838c..56d2c712e257 100644
> --- a/sound/spi/at73c213.c
> +++ b/sound/spi/at73c213.c
> @@ -1001,7 +1001,7 @@ static int snd_at73c213_probe(struct spi_device *sp=
i)
>  	return retval;
>  }
> =20
...
>  {
>  	struct snd_card *card =3D dev_get_drvdata(&spi->dev);
>  	struct snd_at73c213 *chip =3D card->private_data;
> @@ -1066,8 +1066,6 @@ static int snd_at73c213_remove(struct spi_device *s=
pi)
> =20
>  	ssc_free(chip->ssc);
>  	snd_card_free(card);
