...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 11983318A83
	for <lists+alsa-devel@lfdr.de>; Thu, 11 Feb 2021 13:30:25 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 3EBA31724;
	Thu, 11 Feb 2021 13:29:34 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 3EBA31724
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1613046624;
	bh=MKHf/hTvCJ+KsjX4IIxwot7NSBZW+yh58WBBUSm2nF0=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=qQLYiWqqewrIu/fVrB+MHqvUHJxDkR6KvzbgU0fVRNYR2aIbuWYah61WFj/Hc+lGA
	 J01394gWAhiU5xxdApCKaDVppuMizlBe32pj7uxe9G3KJ9L3IIqMRRI6JuVq+AtVje
	 UZFWArVrTjdAdurHF4Sl6AznSa5NewwHJlfaeRqs=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 6050CF802E2;
	Thu, 11 Feb 2021 13:28:05 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id ABC00F802E0; Thu, 11 Feb 2021 13:28:01 +0100 (CET)
...
Received: from mail-wr1-x432.google.com (mail-wr1-x432.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 4970DF8028B
 for <alsa-devel@alsa-project.org>; Thu, 11 Feb 2021 13:27:55 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 4970DF8028B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="JiDRpN4T"
Received: by mail-wr1-x432.google.com with SMTP id v1so404697wrd.6
 for <alsa-devel@alsa-project.org>; Thu, 11 Feb 2021 04:27:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=xUqilW5gAPkYhs7vlsPuk0dMitNi9oOJc9pY4mssT0U=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=xUqilW5gAPkYhs7vlsPuk0dMitNi9oOJc9pY4mssT0U=;
 b=
X-Gm-Message-State: AOAM531cB+xmnFfNMc/J46C6tWWCQf3V55XDqqvWSAiXlk0jIzGW1Tbz
 CCYKJzh+DiptKVDfdZU3jMkWjQ==
X-Google-Smtp-Source: ABdhPJzISr7wJgo7vbkWl3qTCUBHC8rGZ8rZp5zA3YdY6DD00YO8jJbpY0doma103YI7ETWPuV9wOA==
X-Received: by 2002:adf:a1d6:: with SMTP id v22mr5472514wrv.372.1613046474441; 
 Thu, 11 Feb 2021 04:27:54 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id d20sm4026477wrc.12.2021.02.11.04.27.49
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 11 Feb 2021 04:27:53 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v5 3/7] ASoC: codecs: lpass-rx-macro: add dapm widgets and
 route
Date: Thu, 11 Feb 2021 12:27:31 +0000
Message-Id: <20210211122735.5691-4-srinivas.kandagatla@linaro.org>
...
index 1c114a46c44a..2cf6eb9238a7 100644
--- a/sound/soc/codecs/lpass-rx-macro.c
+++ b/sound/soc/codecs/lpass-rx-macro.c
@@ -583,12 +583,210 @@ struct rx_macro {
...
+		SOC_DAPM_ENUM("RX MIX TX0_MUX Mux", rx_mix_tx0_mux_enum);
 ...
 static const struct reg_default rx_defaults[] = {
 	/* RX Macro */
@@ -1257,6 +1455,41 @@ static const struct regmap_config rx_regmap_config = {
...
+
 ...
 {
@@ -1615,6 +1848,248 @@ static void rx_macro_mclk_enable(struct rx_macro *rx, bool mclk_enable)
 	}
 }
...
@@ -1624,6 +2099,106 @@ static inline void rx_macro_enable_clsh_block(struct rx_macro *rx, bool enable)
 		rx->clsh_users = 0;
 }
...
+
 static int rx_macro_get_compander(struct snd_kcontrol *kcontrol,
 			       struct snd_ctl_elem_value *ucontrol)
 {
@@ -1649,6 +2224,91 @@ static int rx_macro_set_compander(struct snd_kcontrol *kcontrol,
 	return 0;
 }
...
+
 static int rx_macro_get_ear_mode(struct snd_kcontrol *kcontrol,
 			       struct snd_ctl_elem_value *ucontrol)
 {
@@ -1753,6 +2413,189 @@ static int rx_macro_aux_hpf_mode_put(struct snd_kcontrol *kcontrol,
 	return 0;
 }
...
+
 static const struct snd_kcontrol_new rx_macro_snd_controls[] = {
 	SOC_SINGLE_S8_TLV("RX_RX0 Digital Volume", CDC_RX_RX0_RX_VOL_CTL,
 			  -84, 40, digital_gain),
@@ -1789,6 +2632,500 @@ static const struct snd_kcontrol_new rx_macro_snd_controls[] = {
...
+
 ...
 {
 	struct rx_macro *rx = snd_soc_component_get_drvdata(component);
@@ -1908,6 +3245,10 @@ static const struct snd_soc_component_driver rx_macro_component_drv = {
