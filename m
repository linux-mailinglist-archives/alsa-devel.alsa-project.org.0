...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 12F60474441
	for <lists+alsa-devel@lfdr.de>; Tue, 14 Dec 2021 15:03:17 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 0CAD91F7D;
	Tue, 14 Dec 2021 15:02:26 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 0CAD91F7D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1639490596;
	bh=3U+mVT0RyiILSPzn4qW8vSYO4XXBOWxGQVlQwpLIbR8=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=s1AJYjQDTGXf1rT7Q3v5WXe9hVw8A/sVBUuKCBTku6LU4PqNfdlTF24GaSPQPlu8/
	 y25PKsTlxwfhybojjKRTahQKFZbbTT81Z5QMbKEgrqvKBbhw9xf+mAvMlhWHOPOonH
	 grxLp1QEjju7tT2gJMEJacdxTdXvIMOzSFkUlcI8=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 3BF3EF8052E;
	Tue, 14 Dec 2021 15:00:28 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 57F62F80517; Tue, 14 Dec 2021 15:00:21 +0100 (CET)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 471AEF80246
 for <alsa-devel@alsa-project.org>; Tue, 14 Dec 2021 15:00:06 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 471AEF80246
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="fDSt6upJ"
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
 by mx0b-001ae601.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 1BEAdVUM003487;
 Tue, 14 Dec 2021 08:00:04 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=3UmtYR2CbutfutA24SwvFkeXHjWdvZ64UlMcQ1Wbv74=;
 b= FQ== 
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
 by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 3cxe2f0uq1-1
...
Received: from aryzen.ad.cirrus.com (unknown [198.61.64.39])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id ADCC845A;
...
Subject: [PATCH v4 01/10] ASoC: cs35l41: Convert tables to shared source code
Date: Tue, 14 Dec 2021 13:59:50 +0000
Message-ID: <20211214135959.1317949-2-tanureal@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: NE2jhfarxjTcegrA-HFipv552NhY9dph
X-Proofpoint-GUID: NE2jhfarxjTcegrA-HFipv552NhY9dph
...
---
 ...
 7 files changed, 753 insertions(+), 739 deletions(-)
...
index c033ee7d82e4..2550870d384d 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -612,6 +612,11 @@ config SND_SOC_CS35L36
