...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F1AE53077D1
	for <lists+alsa-devel@lfdr.de>; Thu, 28 Jan 2021 15:22:32 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 6799116D2;
	Thu, 28 Jan 2021 15:21:42 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 6799116D2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1611843752;
	bh=X+x2L6i7YATX3aYRCrdGguXBC21wTlR0jOptx7GFYcM=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=PkQSBa8o6gtxGv8eNQc4B2MDx9ks8cHai+4/YZVazG4OzJLDLW9AxzFAVutRC7YnS
	 Ekux+Du+qctjTroWbgaoTsnwhy6i7Cc9DczSpajcxxHqvax0lO6+XQskDiwC88dPP0
	 +5qt2CxDs5s7I6IeISArAYL+bPHp8f6KF7aj1HHo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id E8025F804CA;
	Thu, 28 Jan 2021 15:20:18 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 6DD31F804CB; Thu, 28 Jan 2021 15:20:09 +0100 (CET)
...
Received: from mail-wr1-x436.google.com (mail-wr1-x436.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C5B71F801ED
 for <alsa-devel@alsa-project.org>; Thu, 28 Jan 2021 15:19:59 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C5B71F801ED
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="YiPXeoGs"
Received: by mail-wr1-x436.google.com with SMTP id c12so5568144wrc.7
 for <alsa-devel@alsa-project.org>; Thu, 28 Jan 2021 06:19:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=OoqA0k9iYKLPBu83Nxlsy6u/wBHD7mGjL8pZO3qbT2Q=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=OoqA0k9iYKLPBu83Nxlsy6u/wBHD7mGjL8pZO3qbT2Q=;
 b=
X-Gm-Message-State: AOAM530I87+QHQxfMMFCc7ZWdv1hmZFZuYLNlwxHHZQR/VQzsZZJQoJ0
 iWKrDYL47QW1CB1PbEs+tii32Q==
X-Google-Smtp-Source: ABdhPJwUGY/h7dAU8WmWfPG25747GXRpBnKYK9RVSEr/t5oYnOiEti8+wXcYPSUrCP7lNtqNO/Nang==
X-Received: by 2002:a5d:6509:: with SMTP id x9mr16795137wru.229.1611843598628; 
 Thu, 28 Jan 2021 06:19:58 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id d9sm7257096wrq.74.2021.01.28.06.19.57
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 28 Jan 2021 06:19:57 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH 3/7] ASoC: codec: lpass-rx-macro: add dapm widgets and route
Date: Thu, 28 Jan 2021 14:19:25 +0000
Message-Id: <20210128141929.26573-4-srinivas.kandagatla@linaro.org>
...
index 30f4b7b3189c..5ceb81e8f1d4 100644
--- a/sound/soc/codecs/lpass-rx-macro.c
+++ b/sound/soc/codecs/lpass-rx-macro.c
@@ -589,6 +589,56 @@ struct rx_macro {
...
@@ -601,6 +651,154 @@ static const char *const rx_macro_hph_pwr_mode_text[] = {"ULP", "LOHIFI"};
...
+		rx_int_mix_mux_text);
+static const struct snd_kcontrol_new rx_int0_2_mux = SOC_DAPM_ENUM("rx_int0_2", rx_int0_2_enum);
+static const struct snd_kcontrol_new rx_int1_2_mux = SOC_DAPM_ENUM("rx_int1_2", rx_int1_2_enum);
+static const struct snd_kcontrol_new rx_int2_2_mux = SOC_DAPM_ENUM("rx_int2_2", rx_int2_2_enum);
+
...
+			    iir_inp_mux_text);
+static const struct snd_kcontrol_new iir0_inp0_mux = SOC_DAPM_ENUM("iir0_inp0", iir0_inp0_enum);
+static const struct snd_kcontrol_new iir0_inp1_mux = SOC_DAPM_ENUM("iir0_inp1", iir0_inp1_enum);
+static const struct snd_kcontrol_new iir0_inp2_mux = SOC_DAPM_ENUM("iir0_inp2", iir0_inp2_enum);
+static const struct snd_kcontrol_new iir0_inp3_mux = SOC_DAPM_ENUM("iir0_inp3", iir0_inp3_enum);
+static const struct snd_kcontrol_new iir1_inp0_mux = SOC_DAPM_ENUM("iir1_inp0", iir1_inp0_enum);
+static const struct snd_kcontrol_new iir1_inp1_mux = SOC_DAPM_ENUM("iir1_inp1", iir1_inp1_enum);
+static const struct snd_kcontrol_new iir1_inp2_mux = SOC_DAPM_ENUM("iir1_inp2", iir1_inp2_enum);
+static const struct snd_kcontrol_new iir1_inp3_mux = SOC_DAPM_ENUM("iir1_inp3", iir1_inp3_enum);
+
...
@@ -1268,6 +1466,41 @@ static const struct regmap_config rx_regmap_config = {
...
+
 ...
 {
@@ -1626,6 +1859,282 @@ static void rx_macro_mclk_enable(struct rx_macro *rx, bool mclk_enable)
 	}
 }
...
@@ -1635,6 +2144,106 @@ static inline void rx_macro_enable_clsh_block(struct rx_macro *rx, bool enable)
 		rx->clsh_users = 0;
 }
...
+
 static int rx_macro_get_compander(struct snd_kcontrol *kcontrol,
 			       struct snd_ctl_elem_value *ucontrol)
 {
@@ -1660,6 +2269,91 @@ static int rx_macro_set_compander(struct snd_kcontrol *kcontrol,
 	return 0;
 }
...
+
 static int rx_macro_get_ear_mode(struct snd_kcontrol *kcontrol,
 			       struct snd_ctl_elem_value *ucontrol)
 {
@@ -1764,6 +2458,153 @@ static int rx_macro_aux_hpf_mode_put(struct snd_kcontrol *kcontrol,
 	return 0;
 }
...
@@ -1803,6 +2644,500 @@ static const struct snd_kcontrol_new rx_macro_snd_controls[] = {
...
@@ -1929,6 +3264,10 @@ static const struct snd_soc_component_driver rx_macro_component_drv = {
