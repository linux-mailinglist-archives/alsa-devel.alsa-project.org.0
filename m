...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 20FE8834F3
	for <lists+alsa-devel@lfdr.de>; Tue,  6 Aug 2019 17:17:47 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B0271950;
	Tue,  6 Aug 2019 17:16:56 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B0271950
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1565104666;
	bh=XXMSqfyU0rfLhsFyIoTcmngCA9HKGgdmMawcgCV/T6Q=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=JisQyJgtoBfnaVa7ey0H6MHqr4NlSbjuj8USAOUOtQBhdgnTdFcrQrhBV55Quqcgh
	 dKAbgY+xY/vE6T/ickStvy9SoazEccu/hfVjL2yva3gEsWFnZjld6T98CqEgA78LAv
	 cJedkorIaKTOQnKd5KDY/TFkfryiB5lsEUxUqPcU=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id E315FF80612;
	Tue,  6 Aug 2019 17:12:45 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 66491F805FC; Tue,  6 Aug 2019 17:12:42 +0200 (CEST)
...
Received: from inva021.nxp.com (inva021.nxp.com [92.121.34.21])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 41571F800F4
 for <alsa-devel@alsa-project.org>; Tue,  6 Aug 2019 17:12:32 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 41571F800F4
Received: from inva021.nxp.com (localhost [127.0.0.1])
 by inva021.eu-rdc02.nxp.com (Postfix) with ESMTP id 37DB42002EA;
 Tue,  6 Aug 2019 17:12:32 +0200 (CEST)
Received: from inva024.eu-rdc02.nxp.com (inva024.eu-rdc02.nxp.com
 [134.27.226.22])
 by inva021.eu-rdc02.nxp.com (Postfix) with ESMTP id 280202002CB;
 Tue,  6 Aug 2019 17:12:32 +0200 (CEST)
Received: from fsr-ub1864-103.ea.freescale.net
 (fsr-ub1864-103.ea.freescale.net [10.171.82.17])
 by inva024.eu-rdc02.nxp.com (Postfix) with ESMTP id 1B6A8205DD;
 Tue,  6 Aug 2019 17:12:31 +0200 (CEST)
From: Daniel Baluta <daniel.baluta@nxp.com>
To: broonie@kernel.org
Date: Tue,  6 Aug 2019 18:12:12 +0300
Message-Id: <20190806151214.6783-4-daniel.baluta@nxp.com>
...
Subject: [alsa-devel] [PATCH v3 3/5] ASoC: fsl_sai: Add support for SAI new
	version
...
index 637b1d12a575..291f414c41c6 100644
...
@@ -973,11 +1012,13 @@ static int fsl_sai_remove(struct platform_device *pdev)
...
@@ -1010,6 +1051,7 @@ static int fsl_sai_runtime_suspend(struct device *dev)
...
@@ -1031,11 +1073,11 @@ static int fsl_sai_runtime_resume(struct device *dev)
 	}
