...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 110F13FDE5F
	for <lists+alsa-devel@lfdr.de>; Wed,  1 Sep 2021 17:16:35 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9C09F1755;
	Wed,  1 Sep 2021 17:15:44 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9C09F1755
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1630509394;
	bh=AF8D8Y2ParAmpn5YGlwOlg42aPAOh6CS+guev/gFiCc=;
	h=References:In-Reply-To:From:Date:Subject:To:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=RNscRv2EUa60aEK2DFATEMO3Q5mL0k7xV+NejNmp4+LBCQUkxCmEGpF1AikkU9QFV
	 +P+mADodilGWSH8t3G/8/sJle8FPgWFSHsgvEh6rjuygrLmgJMCktpL+goO8rypzuQ
	 aNUMHFh23VRLWT40TFLAL13oEPghCFKkbo0+tPCk=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 9F42FF80516;
	Wed,  1 Sep 2021 17:12:42 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 98389F80227; Wed,  1 Sep 2021 05:01:00 +0200 (CEST)
Received: from mail-io1-xd2a.google.com (mail-io1-xd2a.google.com
 [IPv6:2607:f8b0:4864:20::d2a])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 2BE65F80256
 for <alsa-devel@alsa-project.org>; Wed,  1 Sep 2021 05:00:56 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 2BE65F80256
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=google.com header.i=@google.com
 header.b="ktzBSKn3"
Received: by mail-io1-xd2a.google.com with SMTP id e186so2174301iof.12
 for <alsa-devel@alsa-project.org>; Tue, 31 Aug 2021 20:00:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=20161025;
 h=mime-version:references:in-reply-to:from:date:message-id:subject:to
 :cc; bh=shI2J7KqYYVdy/mMmcftC5A6k50y6QKxeyZzj1vfhOk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:references:in-reply-to:from:date
 :message-id:subject:to:cc;
 bh=shI2J7KqYYVdy/mMmcftC5A6k50y6QKxeyZzj1vfhOk=;
 b=
X-Gm-Message-State: AOAM532X0F8otZj+JwgOSJmFBGlmzdQHBU7Oednl12bub48ZGwhCqcyy
 JmYh/YevDswp72x1zNgHsXocieXI5GhkRXiHEjh7YQ==
X-Google-Smtp-Source: ABdhPJx0L9paz1CGhrBOEaMzB+SuXxiyolGO8cgIPT39nAlN6Xw/icTFVl8oxG4sQ4kmV0dsVoon4DtwYpMYuz++kFU=
X-Received: by 2002:a02:caaf:: with SMTP id e15mr5812407jap.11.1630465252368; 
 Tue, 31 Aug 2021 20:00:52 -0700 (PDT)
MIME-Version: 1.0
References: <20210831130258.19286-1-derek.fang@realtek.com>
 <ee3ba91ee5c24dda9db9d05622d1dfaf@realtek.com>
In-Reply-To: <ee3ba91ee5c24dda9db9d05622d1dfaf@realtek.com>
From: Mingjane Hsieh <mingjanehsieh@google.com>
Date: Wed, 1 Sep 2021 11:00:14 +0800
Message-ID: <CAOCJVXxPFM4CZ88LPTRp10ExiB1YTvkGYU37aYPBUXcxD2=uyw@mail.gmail.com>
Subject: Re: [PATCH v2 1/2] ASoC: rt5682s: Add driver for ALC5682I-VS codec
To: Albert Wang <albertwang@realtek.com>, Yu-hsuan Hsu <yuhsuan@google.com>
...
If it's urgent, Yuhsuan may provide some information about what you can do
now.
...
> Hi MJ,
>
> Please you help us to cross check with Linux team for initial codec drive=
r
> of Realtek ALC5682I-VS. Thank you.
>
>
>
> Regards,
...
> jack.yu@realtek.com>; Shuming [=E8=8C=83=E6=9B=B8=E9=8A=98] <shumingf@rea=
ltek.com>; Albert Chen <
> albertchen@realtek.com>; Albert Wang <albertwang@realtek.com>; Derek [=E6=
=96=B9=E5=BE=B7=E7=BE=A9]
...
> btn_type);
>
> +            snd_soc_component_update_bits(component, RT5682S_SAR_IL_CMD_=
2,
>
...
> +                           default:
>
> +                                         jack_type =3D SND_JACK_HEADPHON=
E;
>
> +                                         break;
>
...
> rate).
>
> + * ASRC function will track i2s clock and generate a corresponding syste=
m
> clock
>
...
>
> +                           unsigned int filter_mask, unsigned int clk_sr=
c)
>
> +{
>
...
>
> +                           dmic_clk_rate =3D rt5682s->pdata.dmic_clk_rat=
e;
>
> +
>
...
> +
>
> +            val =3D snd_soc_component_read(component, RT5682S_GPIO_CTRL_=
1)
>
...
> +
>
> +            idx =3D rt5682s_div_sel(rt5682s, ref, div_f, ARRAY_SIZE(div_=
f));
>
> +
>
...
>
> +                           if (rt5682s->sysclk <=3D 12288000 * div_o[idx=
])
>
> +                                         break;
>
...
> +
>
> +            val =3D (snd_soc_component_read(component, reg) >> sft) & 0x=
f;
>
> +            switch (val) {
>
...
> +            /* ASRC */
>
> +            SND_SOC_DAPM_SUPPLY_S("DAC STO1 ASRC", 1, RT5682S_PLL_TRACK_=
1,
>
> +                           RT5682S_DAC_STO1_ASRC_SFT, 0, NULL, 0),
>
> +            SND_SOC_DAPM_SUPPLY_S("ADC STO1 ASRC", 1, RT5682S_PLL_TRACK_=
1,
>
...
>
> +                           if (params_channels(params) =3D=3D 1) /* mono=
 mode
> */
>
> +
...
> *component,
>
> +                           int clk_id, int source, unsigned int freq, in=
t
> dir)
>
> +{
...
> +
>
> +            if (freq =3D=3D rt5682s->sysclk && clk_id =3D=3D rt5682s->sy=
sclk_src)
>
> +                           return 0;
>
...
> +
>
> +            if (source =3D=3D rt5682s->pll_src[pll_id] && freq_in =3D=3D
...
> ||
>
> +                (pll_id =3D=3D RT5682S_PLL2 && (rt5682s->pll_comb =3D=3D=
 USE_PLLB
> ||
>
> +
...
>
> +                                         "Unsupported freq conversion fo=
r
> PLL%d:(%d->%d): %d\n",
>
> +                                         pll_id + 1, freq_in, freq_out,
...
> +
>
> +static int rt5682s_set_bclk2_ratio(struct snd_soc_dai *dai, unsigned int
> ratio)
>
> +{
>
...
> +
>
> +static long rt5682s_wclk_round_rate(struct clk_hw *hw, unsigned long rat=
e,
>
> +                                                          unsigned long
> *parent_rate)
...
> +            /*
>
> +            * To achieve the rate conversion from 48MHz to 44.1k or 48kH=
z,
>
> +            * PLL2 is needed.
>
...
> +
>
> +static long rt5682s_bclk_round_rate(struct clk_hw *hw, unsigned long rat=
e,
>
> +                                                          unsigned long
> *parent_rate)
...
> +
>
> +            rt5682s->regmap =3D devm_regmap_init_i2c(i2c, &rt5682s_regma=
p);
>
...
> +/* I/O - Input */
>
> +#define RT5682S_CBJ_BST_CTRL                                        0x00=
0b
>
> +#define RT5682S_CBJ_DET_CTRL                                        0x00=
0f
>
...
>
> +#define RT5682S_A_DAC1_MUX                                         0x002=
b
>
...
>
> +#define RT5682S_PWR_ANLG_1                                         0x006=
3
>
> +#define RT5682S_PWR_ANLG_2                                         0x006=
4
>
> +#define RT5682S_PWR_ANLG_3                                         0x006=
5
>
...
> +/* DMIC */
>
> +#define RT5682S_DMIC_CTRL_1                                         0x00=
6e
>
> +#define RT5682S_LPF_AD_DMIC                                        0x006=
f
>
> +/* Format - ADC/DAC */
>
...
> 0x0088
>
> +#define RT5682S_PLL_TRACK_11                                        0x00=
8c
>
...
> +
>
> +#define RT5682S_PLL_TRACK_12                                        0x00=
96
>
> +#define RT5682S_PLL_TRACK_14                                        0x00=
97
>
...
>
> +#define RT5682S_DIG_IN_CTRL_1                                      0x013=
2
>
> +#define RT5682S_PAD_DRIVING_CTRL               0x0136
>
> +#define RT5682S_CHOP_DAC_1                                          0x01=
39
>
> +#define RT5682S_CHOP_DAC_2                                          0x01=
3a
>
...
>
> +#define RT5682S_SIL_PSV_CTRL1                                       0x01=
94
>
> +#define RT5682S_SIL_PSV_CTRL2                                       0x01=
95
>
> +#define RT5682S_SIL_PSV_CTRL3                                       0x01=
97
>
> +#define RT5682S_SIL_PSV_CTRL4                                       0x01=
98
>
> +#define RT5682S_SIL_PSV_CTRL5                                       0x01=
99
>
...
>
> +#define RT5682S_HP_CALIB_ST_1                                      0x01e=
a
>
> +#define RT5682S_HP_CALIB_ST_2                                      0x01e=
b
>
> +#define RT5682S_HP_CALIB_ST_3                                      0x01e=
c
>
> +#define RT5682S_HP_CALIB_ST_4                                      0x01e=
d
>
> +#define RT5682S_HP_CALIB_ST_5                                      0x01e=
e
>
> +#define RT5682S_HP_CALIB_ST_6                                      0x01e=
f
>
> +#define RT5682S_HP_CALIB_ST_7                                      0x01f=
0
>
> +#define RT5682S_HP_CALIB_ST_8                                      0x01f=
1
>
> +#define RT5682S_HP_CALIB_ST_9                                      0x01f=
2
>
...
>
> +#define RT5682S_SAR_IL_CMD_1                                       0x021=
0
>
> +#define RT5682S_SAR_IL_CMD_2                                       0x021=
1
>
> +#define RT5682S_SAR_IL_CMD_3                                       0x021=
2
>
> +#define RT5682S_SAR_IL_CMD_4                                       0x021=
3
>
> +#define RT5682S_SAR_IL_CMD_5                                       0x021=
4
>
> +#define RT5682S_SAR_IL_CMD_6                                       0x021=
5
>
> +#define RT5682S_SAR_IL_CMD_7                                       0x021=
6
>
> +#define RT5682S_SAR_IL_CMD_8                                       0x021=
7
>
> +#define RT5682S_SAR_IL_CMD_9                                       0x021=
8
>
...
>
> +#define RT5682S_HP_AMP_DET                                         0x060=
0
>
...
>
> +#define RT5682S_EFUSE_READ_1                                       0x342=
4
>
> +#define RT5682S_EFUSE_READ_2                                       0x342=
5
>
> +#define RT5682S_EFUSE_READ_3                                       0x342=
6
>
> +#define RT5682S_EFUSE_READ_4                                       0x342=
7
>
> +#define RT5682S_EFUSE_READ_5                                       0x342=
8
>
> +#define RT5682S_EFUSE_READ_6                                       0x342=
9
>
> +#define RT5682S_EFUSE_READ_7                                       0x342=
a
>
> +#define RT5682S_EFUSE_READ_8                                       0x342=
b
>
> +#define RT5682S_EFUSE_READ_9                                       0x342=
c
>
...
>
> +#define RT5682S_CLK_SRC_PLL1                                         (0x=
1)
>
> +#define RT5682S_CLK_SRC_PLL2                                         (0x=
2)
>
...
7)
>
> +#define RT5682S_FAST_OFF_EN                                         (0x1
> << 7)
>
> +#define RT5682S_FAST_OFF_DIS                                        (0x0
> << 7)
>
...
> << 3)
>
> +#define RT5682S_TRIG_JD_HIGH                                        (0x1
> << 3)
>
...
> 1)
>
> +#define RT5682S_MIC_CAP_HS                                           (0x=
1
> << 1)
>
> +#define RT5682S_MIC_CAP_HP                                          (0x0
> << 1)
>
...
>
> +#define RT5682S_M_DAC_L1_STO_L                                 (0x1 << 1=
5)
>
...
>
> +#define RT5682S_M_ST_STO_L                                           (0x=
1
> << 9)
>
> +#define RT5682S_M_ST_STO_L_SFT                                  9
>
> +#define RT5682S_M_ST_STO_R                                          (0x1
> << 8)
>
...
>
> +#define RT5682S_BST_CBJ_MASK                                       (0x3f
> << 8)
>
...
>
> +#define RT5682S_PRE_CHR_DAC_R1                                 (0x1 << 1=
2)
>
> +#define RT5682S_PRE_CHR_DAC_R1_BIT                         12
>
> +#define RT5682S_PWR_DAC_L1                                          (0x1
> << 11)
>
...
>
> +#define RT5682S_LDO1_DBG_MASK                                  (0x3 << 1=
0)
>
...
>
> +#define RT5682S_LDO1_BYPASS                                         (0x1
> << 6)
>
...
>
> +#define RT5682S_SYS_CLK_DET                                          (0x=
1
> << 15)
>
> +#define RT5682S_SYS_CLK_DET_SFT                                  15
>
> +#define RT5682S_PLL1_CLK_DET                                        (0x1
> << 14)
>
...
>
> +#define RT5682S_SEL_ADCDAT_OUT                                 (0x0 << 1=
5)
>
...
> 12)
>
> +#define RT5682S_I2S1_TX_CHL_8                                       (0x4
> << 12)
>
...
> << 9)
>
> +#define RT5682S_I2S2_OUT_M                                           (0x=
1
> << 9)
>
> +#define RT5682S_I2S_BP_MASK                                         (0x1
> << 8)
>
...
>
> +#define RT5682S_TDM_S_BP_MASK                                  (0x1 << 1=
5)
>
...
> 15)
>
> +#define RT5682S_TDM_S_LP_MASK                                  (0x1 << 1=
4)
>
...
> << 11)
>
> +#define RT5682S_TDM_DF_PCM_A                                   (0x2 << 1=
1)
>
> +#define RT5682S_TDM_DF_PCM_B                                   (0x3 << 1=
1)
>
...
>
> +#define RT5682S_CAPLESS_L_EN                                        (0x1
> << 1)
>
...
>
> +#define RT5682S_PLLA_N_MASK                                        (0x1f=
f
> << 0)
>
> +
...
>
> +#define RT5682S_PLLA_K_MASK                                         (0x1=
f
> << 0)
>
> +
...
>
> +#define RT5682S_PLLB_N_MASK                                        (0x3f=
f
> << 0)
>
> +
...
>
> +#define RT5682S_PLLB_K_MASK                                         (0x1=
f
> << 0)
>
> +
...
>
> +#define RT5682S_PLLB_M_BP_MASK                                 (0x1 << 1=
1)
>
...
>
> +#define RT5682S_JD1_PULSE_DIS                                       (0x0
> << 10)
>
> +#define RT5682S_JD1_PULSE_EN                                        (0x1
> << 10)
>
> +
>
...
> 10)
>
> +#define RT5682S_JD1_IRQ_LEV                                          (0x=
0
> << 10)
>
> +#define RT5682S_JD1_IRQ_PUL                                          (0x=
1
> << 10)
>
> +
...
>
> +#define RT5682S_4BTN_IL_NOR                                         (0x1
> << 14)
>
...
>
> +#define RT5682S_AD2DA_LB_MASK                                  (0x1 << 1=
0)
>
...
> 13)
>
> +#define RT5682S_SAR_POW_MASK                                   (0x1 << 1=
2)
>
