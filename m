...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 81DEE74CB1F
	for <lists+alsa-devel@lfdr.de>; Mon, 10 Jul 2023 06:16:35 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id BEB9D7F4;
	Mon, 10 Jul 2023 06:15:44 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz BEB9D7F4
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1688962594;
	bh=3RoDBTorzSgIIAQrt8pYZFE19iaRAbT+kTFZHaC+49A=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=JRdlKEWeDT7X24UFsirNP+L8lKYw9ualK//p00AZL6FG7NFD9AksbFvqfRQbD6sjn
	 jSXJk3oEvnsAn/b6HrG7eXJrqzXurzhEWoQyo1ax8k7TS7bNjlZ72na4WtHlsCF+LS
	 MfQkDYhumIznIfxjt8d+pFZ+ZwcWjbG9Hnx5lE3s=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 65ED8F80249; Mon, 10 Jul 2023 06:15:44 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id B8C13F8024E;
	Mon, 10 Jul 2023 06:15:43 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 52015F8024E; Mon, 10 Jul 2023 06:13:04 +0200 (CEST)
...
Received: from n169-112.mail.139.com (n169-112.mail.139.com [120.232.169.112])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 66DC7F80249
	for <alsa-devel@alsa-project.org>; Mon, 10 Jul 2023 06:12:53 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 66DC7F80249
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from  (unknown[183.194.159.125])
	by rmsmtp-lg-appmail-26-12031 (RichMail) with SMTP id 2eff64ab852fc25-b3e05;
	Mon, 10 Jul 2023 12:12:36 +0800 (CST)
X-RM-TRANSID: 2eff64ab852fc25-b3e05
...
Subject: [PATCH v2 2/3] ALSA: hda/tas2781: Add tas2781 HDA driver
Date: Mon, 10 Jul 2023 12:12:16 +0800
Message-Id: <20230710041217.151099-2-13916275206@139.com>
...
Message-ID-Hash: WYP76NWNVLQLJZUU6B6U45VBGSTEJUWO
X-Message-ID-Hash: WYP76NWNVLQLJZUU6B6U45VBGSTEJUWO
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/WYP76NWNVLQLJZUU6B6U45VBGSTEJUWO/>
List-Archive: 
...
---
 ...
 sound/pci/hda/tas2781_hda_i2c.c | 840 ++++++++++++++++++++++++++++++++
...
index 000000000000..39a512aa8ab8
--- /dev/null
...
+};
+
+static const struct snd_kcontrol_new tas2781_dsp_controls[] = {
+	{
...
+	}
+
+	for (i = 0; i < ARRAY_SIZE(tas2781_dsp_controls); i++) {
+		ret = snd_ctl_add(codec->card,
+			snd_ctl_new1(&tas2781_dsp_controls[i], tas_priv));
+		if (ret) {
+			dev_err(tas_priv->dev,
+				"Failed to add KControl %s = %d\n",
+				tas2781_dsp_controls[i].name, ret);
+			goto out;
+		}
+	}
+
