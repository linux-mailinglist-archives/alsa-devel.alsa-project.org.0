...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id ADB9137434F
	for <lists+alsa-devel@lfdr.de>; Wed,  5 May 2021 19:06:17 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 375411801;
	Wed,  5 May 2021 19:05:27 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 375411801
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1620234377;
	bh=YcYcUSsPsTWS8EzR30+qMUBY+xFVbXnOG5bXmBarbQ0=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=ubJcs4I4HyxU1ANmHD6QJ4QBfTPu8pSZc5j9iqPmYlC//Fg0qqACHjZ4nTpo40Xpt
	 EfQiBsFlKf0nhc4w2WVHpsK+fSxyHKXMW1XST6zzjon0oZcX+xAIMWRgGEvAc/n6xj
	 ZO69WtBAGwTN5CxLrPmAeqWNxTbfF8hK4gH5C1yM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 450ABF804A9;
	Wed,  5 May 2021 19:03:23 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 3A8B0F8049C; Wed,  5 May 2021 19:03:21 +0200 (CEST)
...
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id B2450F80163
 for <alsa-devel@alsa-project.org>; Wed,  5 May 2021 19:03:09 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B2450F80163
IronPort-SDR: c0DWGGgUtHWAwmZHUmLMek7qVA6Es2qIaIp2A593Cgs4zarjU/+neVGEm+pshewPIeG1EyVT/u
 uk1mzTr5mTQg==
X-IronPort-AV: E=McAfee;i="6200,9189,9975"; a="262200760"
X-IronPort-AV: E=Sophos;i="5.82,276,1613462400"; d="scan'208";a="262200760"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 05 May 2021 10:03:02 -0700
IronPort-SDR: trCKOYLDZZ29t27XFiR4JboqWfRMfYgYwlj59zF2cAhngD+SnIqjhKl2GLSBxcNGXhKs5+mA3h
 Uzjq5cHT5dTA==
X-IronPort-AV: E=Sophos;i="5.82,276,1613462400"; d="scan'208";a="406619766"
...
Subject: [PATCH 2/2] ASoC: SOF: Intel: move common ATOM stuff to module
Date: Wed,  5 May 2021 12:02:35 -0500
Message-Id: <20210505170235.306797-3-pierre-louis.bossart@linux.intel.com>
...
---
 ...
 sound/soc/sof/intel/byt.c     | 667 +---------------------------------
 sound/soc/sof/intel/pci-tng.c | 171 ++++++++-
 5 files changed, 723 insertions(+), 657 deletions(-)
...
index 0b948ef79431..8edaf6fdd218 100644
...
@@ -722,33 +107,6 @@ static int byt_remove(struct snd_sof_dev *sdev)
 	return 0;
 }
...
-
 ...
 {
 	struct snd_sof_pdata *pdata = sdev->pdata;
@@ -1092,9 +450,8 @@ static struct platform_driver snd_sof_acpi_intel_byt_driver = {
 };
