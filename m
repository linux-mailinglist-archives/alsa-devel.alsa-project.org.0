...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E2AAC2963D
	for <lists+alsa-devel@lfdr.de>; Fri, 24 May 2019 12:44:39 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 427EA16BC;
	Fri, 24 May 2019 12:43:49 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 427EA16BC
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1558694679;
	bh=0qY30ZFS76uFviHz9autk/Cp2fThpztA7UXqWVIFsAM=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=FaMIaC/99l2VEZ/1fYnUlbHKH5XWsEa+yWy1UcnXaKEKl3Ba1AkvBBY+o7/3aUL6f
	 m8rM/lST9FXJIcKoOHvIx9wo56tnF4/UkjeWOKeHzuaap6mZnd2+78NUoPRPN0kKKc
	 u+rvOhg1dXCZVbAZ5jxYHnRFtgzIP93o9LAUjBAw=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 25CD9F89633;
	Fri, 24 May 2019 12:42:19 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id C2025F89673; Fri, 24 May 2019 12:42:14 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 16463F8962F
 for <alsa-devel@alsa-project.org>; Fri, 24 May 2019 12:42:03 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 16463F8962F
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
 by mx0b-001ae601.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x4OAdKJT005094; Fri, 24 May 2019 05:42:02 -0500
Authentication-Results: ppops.net;
 spf=none smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from mail2.cirrus.com (mail2.cirrus.com [141.131.128.20])
 by mx0b-001ae601.pphosted.com with ESMTP id 2sjefn0pcr-1;
 Fri, 24 May 2019 05:42:01 -0500
Received: from EDIEX02.ad.cirrus.com (unknown [198.61.84.81])
 by mail2.cirrus.com (Postfix) with ESMTP id D5744605A6A9;
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 4079E2DA;
 Fri, 24 May 2019 11:41:59 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Fri, 24 May 2019 11:41:58 +0100
Message-ID: <20190524104158.30731-5-ckeepax@opensource.cirrus.com>
...
Subject: [alsa-devel] [PATCH 5/5] ASoC: cs47l90: Add codec driver for Cirrus
	Logic CS47L90
...
@@ -585,6 +586,9 @@ config SND_SOC_CS47L35
...
@@ -710,8 +714,10 @@ config SND_SOC_MADERA
 	tristate
...
index 109b565855f5b..b1b12ec3cd120 100644
...
@@ -344,6 +345,7 @@ obj-$(CONFIG_SND_SOC_CS4349)	+= snd-soc-cs4349.o
...
index 0000000000000..c18b03ac0b474
--- /dev/null
