...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 97E02649252
	for <lists+alsa-devel@lfdr.de>; Sun, 11 Dec 2022 05:32:30 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 1917C27B4;
	Sun, 11 Dec 2022 05:31:40 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 1917C27B4
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1670733150;
	bh=43iM4vOBfAGguqP9/kjEzCXQJ+YeoWyWLbU1S3qwppY=;
	h=Date:From:To:Subject:References:In-Reply-To:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 Cc:From;
	b=Yh4tXuU3NZTCcvJoxeZcTkqFXekE3ywxc+UWNVmgwW9rvMvBJ6kD3iWDRT09SKvxx
	 JIId1fPxjnx4m8kyOqsHiAnIj2Ty4R9RECAke9JTHYrz7PYnHeYtg4H0BvVQqTjboM
	 Bjy8sIpizbHliZmUkrred+QUB2F3zlZzcE5wh90c=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 9A7DFF80149;
	Sun, 11 Dec 2022 05:31:32 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id CC35FF801EB; Sun, 11 Dec 2022 05:31:25 +0100 (CET)
...
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id D1028F800F8
 for <alsa-devel@alsa-project.org>; Sun, 11 Dec 2022 05:31:18 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz D1028F800F8
Authentication-Results: alsa1.perex.cz; dkim=pass (2048-bit key,
 unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256
 header.s=Intel header.b=leoEwOIk
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1670733080; x=1702269080;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=43iM4vOBfAGguqP9/kjEzCXQJ+YeoWyWLbU1S3qwppY=;
 b=leoEwOIkA3yV96/7DnnelHDEvZzPzNOGVUUaERajGZ0ssMfD6O2hbQ9C
 u8YR1hrMAtVdpSEUjI9dS7cttZmCiRQiD1BOoKUq/GMbQvKht0HDoM3S5
 7Dv4+P3mZeisXs+7GL6UyRACCImY9mhRntcTt7oSFkcLNj+dobNoaCypV
 SmjORaH/UAQW9Yr0KLCuAhjjJtjMkB0RNLybTLRtKJG04nZY7agnqqH+9
 hvVMHJJ0e5PS+Q/gb+iP/pYxPTY0T/pYzpro/zbGrydqDcoK72MneTbYL
 V1hrH5wsUxYGuW2jnu/6DFK7Fuw8Gp7mf0KN9vPsjv+cOzMC5+EKDqu+Y A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10557"; a="319532520"
X-IronPort-AV: E=Sophos;i="5.96,235,1665471600"; d="scan'208";a="319532520"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Dec 2022 20:31:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10557"; a="790121370"
X-IronPort-AV: E=Sophos;i="5.96,235,1665471600"; d="scan'208";a="790121370"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
 by fmsmga001.fm.intel.com with ESMTP; 10 Dec 2022 20:31:09 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1p4DzY-0002qL-2Y;
 Sun, 11 Dec 2022 04:31:08 +0000
Date: Sun, 11 Dec 2022 12:31:06 +0800
...
Message-ID: <202212111254.qayUwX39-lkp@intel.com>
References: <20221211024109.671538-2-marex@denx.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="uqzJRmOqLDOGULrR"
...
Cc: Marek Vasut <marex@denx.de>, Xiubo Li <Xiubo.Lee@gmail.com>,
 Fabio Estevam <festevam@gmail.com>, llvm@lists.linux.dev,
 Takashi Iwai <tiwai@suse.com>, Liam Girdwood <lgirdwood@gmail.com>,
 Nicolin Chen <nicoleotsuka@gmail.com>, Mark Brown <broonie@kernel.org>,
 oe-kbuild-all@lists.linux.dev, Shengjiu Wang <shengjiu.wang@gmail.com>
...
url:    https://github.com/intel-lab-lkp/linux/commits/Marek-Vasut/ASoC-fsl_sai-Factor-out-SAI-reset/20221211-104415
base:   https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound.git for-next
patch link:    https://lore.kernel.org/r/20221211024109.671538-2-marex%40denx.de
patch subject: [PATCH 2/2] ASoC: fsl_sai: Export transmitter MCLK as clock
config: hexagon-randconfig-r045-20221211
compiler: clang version 16.0.0 (https://github.com/llvm/llvm-project 6e4cea55f0d1104408b26ac574566a0e4de48036)
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/5e123e6575149ec2edb1a16fe989cc8d75cc96d1
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Marek-Vasut/ASoC-fsl_sai-Factor-out-SAI-reset/20221211-104415
        git checkout 5e123e6575149ec2edb1a16fe989cc8d75cc96d1
...
>> ld.lld: error: undefined symbol: clk_hw_get_name
   >>> referenced by fsl_sai.c:1267 (sound/soc/fsl/fsl_sai.c:1267)
   >>>               sound/soc/fsl/fsl_sai.o:(mclk_gate_is_enabled) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1267 (sound/soc/fsl/fsl_sai.c:1267)
   >>>               sound/soc/fsl/fsl_sai.o:(mclk_gate_is_enabled) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1267 (sound/soc/fsl/fsl_sai.c:1267)
   >>>               sound/soc/fsl/fsl_sai.o:(mclk_gate_get_parent) in archive vmlinux.a
   >>> referenced 7 more times
--
>> ld.lld: error: undefined symbol: __clk_get_name
   >>> referenced by fsl_sai.c:1406 (sound/soc/fsl/fsl_sai.c:1406)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1406 (sound/soc/fsl/fsl_sai.c:1406)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:0 (sound/soc/fsl/fsl_sai.c:0)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced 1 more times
--
>> ld.lld: error: undefined symbol: of_clk_hw_register
   >>> referenced by fsl_sai.c:1522 (sound/soc/fsl/fsl_sai.c:1522)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1522 (sound/soc/fsl/fsl_sai.c:1522)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1529 (sound/soc/fsl/fsl_sai.c:1529)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced 1 more times
--
>> ld.lld: error: undefined symbol: clk_hw_get_clk
   >>> referenced by fsl_sai.c:1533 (sound/soc/fsl/fsl_sai.c:1533)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1533 (sound/soc/fsl/fsl_sai.c:1533)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1539 (sound/soc/fsl/fsl_sai.c:1539)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced 1 more times
--
>> ld.lld: error: undefined symbol: of_clk_hw_simple_get
   >>> referenced by fsl_sai.c:1579 (sound/soc/fsl/fsl_sai.c:1579)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1579 (sound/soc/fsl/fsl_sai.c:1579)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
--
...
>> ld.lld: error: undefined symbol: clk_hw_unregister
   >>> referenced by fsl_sai.c:1593 (sound/soc/fsl/fsl_sai.c:1593)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1593 (sound/soc/fsl/fsl_sai.c:1593)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced by fsl_sai.c:1596 (sound/soc/fsl/fsl_sai.c:1596)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_probe) in archive vmlinux.a
   >>> referenced 5 more times
--
>> ld.lld: error: undefined symbol: clk_hw_is_enabled
   >>> referenced by fsl_sai.c:688 (sound/soc/fsl/fsl_sai.c:688)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_reset) in archive vmlinux.a
   >>> referenced by fsl_sai.c:688 (sound/soc/fsl/fsl_sai.c:688)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_reset) in archive vmlinux.a
   >>> referenced by fsl_sai.c:690 (sound/soc/fsl/fsl_sai.c:690)
   >>>               sound/soc/fsl/fsl_sai.o:(fsl_sai_reset) in archive vmlinux.a
   >>> referenced 1 more times
