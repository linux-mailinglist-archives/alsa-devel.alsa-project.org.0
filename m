...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 23DB446B69E
	for <lists+alsa-devel@lfdr.de>; Tue,  7 Dec 2021 10:05:39 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 8F3A3241E;
	Tue,  7 Dec 2021 10:04:48 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 8F3A3241E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1638867938;
	bh=zaFxGaFxxxuHYlGIDh3P3cUFxCly8ssBZA8xF0CemKs=;
	h=Date:Subject:To:References:From:In-Reply-To:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=OjSuino6MConcdM61WMHXExri7rcz/rtMXL6DwkaLtHHhkvN0cmlY2jR9l7K5TVWK
	 0hCD1zECwT5q+sSHsSrCwKoJbvlf1NV4R3Umk1BdQZu8ZlYlwpNZieXRLTpAFQdgV5
	 nS77MgAJZZuExxl8N6CVtWZRIGDSgGvtYBt0LKoQ=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 7D6F0F8032B;
	Tue,  7 Dec 2021 10:04:24 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id CD6B8F8028D; Tue,  7 Dec 2021 10:04:22 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=0.8 required=5.0 tests=NICE_REPLY_A,PRX_BODY_13,
...
Received: from wp530.webpack.hosteurope.de (wp530.webpack.hosteurope.de
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C1537F80103
 for <alsa-devel@alsa-project.org>; Tue,  7 Dec 2021 10:04:11 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C1537F80103
Received: from ip4d173d4a.dynamic.kabel-deutschland.de ([77.23.61.74]
 helo=[192.168.66.200]); authenticated
 by wp530.webpack.hosteurope.de running ExIM with esmtpsa
 (TLS1.3:ECDHE_RSA_AES_128_GCM_SHA256:128)
 id 1muWOL-0004c3-An; Tue, 07 Dec 2021 10:04:05 +0100
Message-ID: <1bea38bd-d223-c65b-7345-8546b99645ad@leemhuis.info>
Date: Tue, 7 Dec 2021 10:04:04 +0100
MIME-Version: 1.0
...
To: u34@net9.ga, alsa-devel@alsa-project.org, Takashi Iwai <tiwai@suse.com>,
...
X-bounce-key: webpack.hosteurope.de; regressions@leemhuis.info; 1638867854;
 21d68009; 
X-HE-SMSGID: 1muWOL-0004c3-An
...
What's the status here? This looks a lot like a regression from my point
of view, but this didn't get a single reply. Or was it further handled
somewhere else? Anyway:

To be sure this issue doesn't fall through the cracks unnoticed, I'm
adding it to regzbot, my Linux kernel regression tracking bot:

#regzbot ^introduced v5.12.13..v5.15.5
#regzbot title alsa: no sound anymore after updating from 5.12.13 to 5.15.5
...
On 29.11.21 14:03, u34@net9.ga wrote:
