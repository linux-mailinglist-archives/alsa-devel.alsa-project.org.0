...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 7DA3136A9C
	for <lists+alsa-devel@lfdr.de>; Thu,  6 Jun 2019 06:09:38 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 152D882E;
	Thu,  6 Jun 2019 06:08:48 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 152D882E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1559794178;
	bh=jBoYF/8DmQst4pWCFQ43zvxn36pE25EmCEqTg3YuLL8=;
	h=Date:From:To:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=OXNNtVVk+vuf/WXIookFSlHKGOOExK5gGwjiEdJMlpJ/I5iO4uLu9HBe9X07QFfgX
	 UMDHjOpRyNOwmAbuvMdm00Ym+PyEwUfRciRLxalE6Bo/A+RjiF9R1vzkRKpNAbJkoR
	 iI8palkIYJhgckVqbr76U7fq6iBrBC2fge7ycJPc=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 084CFF8972F;
	Thu,  6 Jun 2019 06:07:31 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 79C4CF89732; Thu,  6 Jun 2019 06:07:28 +0200 (CEST)
...
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com
 [210.160.252.171])
 by alsa1.perex.cz (Postfix) with ESMTP id 5742BF8972F
 for <alsa-devel@alsa-project.org>; Thu,  6 Jun 2019 06:07:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 5742BF8972F
Date: 06 Jun 2019 13:07:22 +0900
X-IronPort-AV: E=Sophos;i="5.60,557,1549897200"; d="scan'208";a="17945289"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
 by relmlie5.idc.renesas.com with ESMTP; 06 Jun 2019 13:07:22 +0900
Received: from morimoto-PC.renesas.com (unknown [10.166.18.140])
 by relmlir5.idc.renesas.com (Postfix) with ESMTP id 33B09400A0ED;
 Thu,  6 Jun 2019 13:07:22 +0900 (JST)
Message-ID: <87ftonmkuo.wl-kuninori.morimoto.gx@renesas.com>
...
Subject: [alsa-devel] [PATCH v2 001/146] ASoC: soc-core: use
...
@@ -1048,6 +1045,46 @@ static void soc_remove_dai_links(struct snd_soc_card *card)
 	}
 }
...
+
 static int snd_soc_init_platform(struct snd_soc_card *card,
 				 struct snd_soc_dai_link *dai_link)
 {
@@ -1087,7 +1124,7 @@ static int snd_soc_init_platform(struct snd_soc_card *card,
 	return 0;
 }
...
@@ -1207,12 +1254,20 @@ static int soc_init_dai_link(struct snd_soc_card *card,
...
+	if (link->cpus->name && link->cpus->of_node) {
 		dev_err(card->dev,
 			...
 			link->name);
@@ -1223,16 +1278,16 @@ static int soc_init_dai_link(struct snd_soc_card *card,
...
+	    !(link->cpus->name || link->cpus->of_node)) {
 		dev_err(card->dev,
 			...
 			link->name);
@@ -2048,7 +2103,7 @@ static int soc_cleanup_card_resources(struct snd_soc_card *card)
...
@@ -2805,7 +2860,7 @@ int snd_soc_register_card(struct snd_soc_card *card)
