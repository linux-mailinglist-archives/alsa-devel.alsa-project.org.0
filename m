...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9167318D34F
	for <lists+alsa-devel@lfdr.de>; Fri, 20 Mar 2020 16:49:56 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 22DAC86F;
	Fri, 20 Mar 2020 16:49:06 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 22DAC86F
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1584719396;
	bh=hzEVkzgCS9z5/x3+3mNBkeBtz8s+SzsyEUtnYXnUgPg=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=J/ZTWsHyEp2LUDwBnhPquQQyTK9fzn4RPk33T039h8S/NP5rs4crqeYLVStTEWEIF
	 +Pr7fdHrQXFCICjnsjdT+U+06JRFfXj67rP+xc0MPOcS2asbtFWhNZGHbaydxzDHgu
	 AmOdUZ8qhett/sCkEdusLwMJxMPLd1eZhklLw0Jo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 8AF9BF8036B;
	Fri, 20 Mar 2020 16:41:24 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 69CEFF802E9; Fri, 20 Mar 2020 16:41:01 +0100 (CET)
...
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 0D5B3F800C0;
 Fri, 20 Mar 2020 16:40:36 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 0D5B3F800C0
IronPort-SDR: /p1xolYGIWvIDy4lE5VeV4c5oG5Yh3zoo5fe0Sd0JgpkFXavsMk1FzuImwbYiz9xswk7NLIlEu
 oZTmSDCpp78w==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Mar 2020 08:40:32 -0700
IronPort-SDR: dR+xHc8aOnbZ1DK3BhijIgpeFHR5tRl5bUmvF8KHWAgEiPahzW5ZDHxNcKIuEx/dBpwAN99bVM
 wWCvhELN/0uQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,285,1580803200"; d="scan'208";a="237257400"
Received: from gliakhov-mobl2.ger.corp.intel.com (HELO
 ubuntu.ger.corp.intel.com) ([10.252.57.199])
 by fmsmga007.fm.intel.com with ESMTP; 20 Mar 2020 08:40:31 -0700
From: Guennadi Liakhovetski <guennadi.liakhovetski@linux.intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH 08/12] ASoC: SOF: add a VirtIO DSP driver
Date: Fri, 20 Mar 2020 16:40:17 +0100
Message-Id: <20200320154021.5964-9-guennadi.liakhovetski@linux.intel.com>
...
index f4769e1..1c7ace6 100644
--- a/sound/soc/sof/pcm.c
+++ b/sound/soc/sof/pcm.c
@@ -679,6 +679,13 @@ static int sof_pcm_dai_link_fixup(struct snd_soc_pcm_runtime *rtd,
 		return -EINVAL;
 	}
...
@@ -785,6 +792,8 @@ void snd_sof_new_platform_drv(struct snd_sof_dev *sdev)
...
+
  ...
  * Device Level.
  */
@@ -526,10 +545,20 @@ void snd_sof_get_status(struct snd_sof_dev *sdev, u32 panic_code,
...
index 058de94..3fa0717 100644
--- a/sound/soc/sof/topology.c
+++ b/sound/soc/sof/topology.c
@@ -1300,7 +1300,8 @@ static int sof_widget_load_dai(struct snd_soc_component *scomp, int index,
...
@@ -3613,12 +3614,21 @@ static int sof_manifest(struct snd_soc_component *scomp, int index,
...
+
 	if (ret < 0) {
 		dev_err(scomp->dev, "error: tplg request firmware %s failed err: %d\n",
 			file, ret);
@@ -3634,7 +3644,9 @@ int snd_sof_load_topology(struct snd_soc_component *scomp, const char *file)
 		ret = -EINVAL;
 	}
