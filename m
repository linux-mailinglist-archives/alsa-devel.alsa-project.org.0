...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 18F7B8CB00E
	for <lists+alsa-devel@lfdr.de>; Tue, 21 May 2024 16:08:21 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 2860B93A;
	Tue, 21 May 2024 16:08:10 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 2860B93A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1716300500;
	bh=eY4y2SRATAF3jcvQ7KlUtQkqVWDniBNHsCMKa5eetmc=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=Fg/GEUjQPHtfJspDNyQILNcr3oLzJy2vevM6BA9eMcHiypo0BYH+mGeLpHd7q1ig+
	 ecPthzU0Dw3kaj55vqt0jxlLOx80Csw/0nglCCdpjyimUR/aDQlcSs/S8nEMhdWN6w
	 KICfw+sHjuZf3bcep6LRQPzUoPoKtvMlganWGR0I=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 57D84F805D3; Tue, 21 May 2024 16:07:23 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 78C0CF805AB;
	Tue, 21 May 2024 16:07:23 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 79284F8026A; Mon, 20 May 2024 21:00:12 +0200 (CEST)
...
Received: from fllv0015.ext.ti.com (fllv0015.ext.ti.com [198.47.19.141])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id B2FF2F801F5
	for <alsa-devel@alsa-project.org>; Mon, 20 May 2024 20:59:41 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B2FF2F801F5
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=rSuKoTv9
Received: from fllv0035.itg.ti.com ([10.64.41.0])
	by fllv0015.ext.ti.com (8.15.2/8.15.2) with ESMTP id 44JF5GkK115557;
	Sun, 19 May 2024 10:05:16 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1716131116;
	bh=gg4TJQ26sQPjSRjLDvf+mDPW+YNofjq1FTwPSAlWDTA=;
	h=From:To:CC:Subject:Date:In-Reply-To:References;
	b=rSuKoTv9oyN801wLTTYBYjWY15kke3ch58TvLu04B800Z+6u641wyIWdfKSqwv98k
	 N/YMXedN8BEWl0Ku/au/Aw9J/P35hpvVNUrjiLypACG+YKN7ZYKBBSXNXKy/tzygJY
	 N6STPOilvGGNJ/bsMjdCTB7T2Y22s2JH1mGlJRZE=
Received: from DFLE103.ent.ti.com (dfle103.ent.ti.com [10.64.6.24])
	by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 44JF5GU1119302
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Sun, 19 May 2024 10:05:16 -0500
Received: from DFLE104.ent.ti.com (10.64.6.25) by DFLE103.ent.ti.com
 (10.64.6.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Sun, 19
 May 2024 10:05:15 -0500
Received: from lelvsmtp6.itg.ti.com (10.180.75.249) by DFLE104.ent.ti.com
 (10.64.6.25) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Sun, 19 May 2024 10:05:15 -0500
Received: from lelvsmtp6.itg.ti.com ([10.250.165.138])
	by lelvsmtp6.itg.ti.com (8.15.2/8.15.2) with ESMTP id 44JF4xbD074474;
...
Subject: [PATCH v5 1/1] ALSA: hda/tas2781: Add tas2781 hda driver based on SPI
Date: Sun, 19 May 2024 23:04:32 +0800
Message-ID: <20240519150433.760-2-baojun.xu@ti.com>
X-Mailer: git-send-email 2.43.0.windows.1
In-Reply-To: <20240519150433.760-1-baojun.xu@ti.com>
References: <20240519150433.760-1-baojun.xu@ti.com>
MIME-Version: 1.0
...
Message-ID-Hash: SAPTJSUF5QKIWU6QHIWDPILPTPV7T7PR
X-Message-ID-Hash: SAPTJSUF5QKIWU6QHIWDPILPTPV7T7PR
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/SAPTJSUF5QKIWU6QHIWDPILPTPV7T7PR/>
List-Archive: 
...
index a696943aec0d..15832675bbd3 100644
...
new file mode 100644
index 000000000000..dc7b237f8420
--- /dev/null
...
+		return ret;
+
+	ret = regmap_update_bits(map, TASDEVICE_PAGE_REG(reg), mask, value);
+	if (ret < 0)
+		dev_err(tas_priv->dev, "%s, E=%d\n", __func__, ret);
+
+	return ret;
...
new file mode 100644
index 000000000000..90b720ecca9a
--- /dev/null
