...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 1DE4929640
	for <lists+alsa-devel@lfdr.de>; Fri, 24 May 2019 12:45:21 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9251216D8;
	Fri, 24 May 2019 12:44:29 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9251216D8
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1558694719;
	bh=7psPwdfecoCF+GvecYeboak+j1NSX405qv93Re3/SQM=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=kWPF8kB0ZuK8OlRamjL4F+KzHcJw5Hpp34zQwkqoVvRGnNHOc1AyuKBuyqRGpWoS8
	 zWguwdqQycbyLLZZYzOlo/i9bzFfo8aSnGL1UyBh1OAmLH8KxMT4aAgxDq2MnQAK14
	 bvsETDxs5QP95BnUxz1HmIbBrHfMyYF9z7DXfL7w=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id EE448F89733;
	Fri, 24 May 2019 12:42:20 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 64A49F8972A; Fri, 24 May 2019 12:42:17 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id BF0DCF89633
 for <alsa-devel@alsa-project.org>; Fri, 24 May 2019 12:42:03 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz BF0DCF89633
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
 by mx0b-001ae601.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x4OAdVip005183; Fri, 24 May 2019 05:42:01 -0500
Authentication-Results: ppops.net;
 spf=none smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from mail2.cirrus.com (mail2.cirrus.com [141.131.128.20])
 by mx0b-001ae601.pphosted.com with ESMTP id 2sjefn0pcq-1;
 Fri, 24 May 2019 05:42:00 -0500
Received: from EDIEX02.ad.cirrus.com (unknown [198.61.84.81])
 by mail2.cirrus.com (Postfix) with ESMTP id 7FAC6605A6A3;
 Fri, 24 May 2019 05:42:00 -0500 (CDT)
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 2C6FE2DB;
 Fri, 24 May 2019 11:41:59 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Fri, 24 May 2019 11:41:57 +0100
Message-ID: <20190524104158.30731-4-ckeepax@opensource.cirrus.com>
...
Subject: [alsa-devel] [PATCH 4/5] ASoC: cs47l85: Add codec driver for Cirrus
	Logic CS47L85
...
---
 ...
 sound/soc/codecs/cs47l85.c | 2686 ++++++++++++++++++++++++++++++++++++++++++++
 3 files changed, 2694 insertions(+)
 create mode 100644 sound/soc/codecs/cs47l85.c

diff --git a/sound/soc/codecs/Kconfig b/sound/soc/codecs/Kconfig
index ce5d1efb6e7d0..40804e844069c 100644
...
@@ -581,6 +582,9 @@ config SND_SOC_CS47L24
...
@@ -705,7 +709,9 @@ config SND_SOC_LOCHNAGAR_SC
...
index 1092ac195d04a..109b565855f5b 100644
...
@@ -342,6 +343,7 @@ obj-$(CONFIG_SND_SOC_CS4341)	+= snd-soc-cs4341.o
...
index 0000000000000..7c47e0feecde6
--- /dev/null
