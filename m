...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id DE6D818D34B
	for <lists+alsa-devel@lfdr.de>; Fri, 20 Mar 2020 16:49:15 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7CF9A1669;
	Fri, 20 Mar 2020 16:48:25 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7CF9A1669
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1584719355;
	bh=9d0lkmKPuy87+KM2q6St0uGYaHt2neT1JXaLetRlng4=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=OOtZS3NecE1WzDGcf7FkNzEiAg3rVc7X0etLvY9Lo3rOu+oPo5XIPHdah/+n0AJBe
	 qdzbeWOFSYlPdlGJ7LYZ7VpVURhkDDvs0TWCrAqV9af8ZHHQKPiZIVRLdciCRzvsXV
	 XL9Qq88QhkpYpUfMUpl7Ip88uZ0GtglMUfM6HNAo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 4FC88F80361;
	Fri, 20 Mar 2020 16:41:23 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id B1168F802EA; Fri, 20 Mar 2020 16:41:00 +0100 (CET)
...
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 900C4F8028B;
 Fri, 20 Mar 2020 16:40:37 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 900C4F8028B
IronPort-SDR: NWy1JnRq8u8srVxM42oISwZ/5Z4FV47NXj5iro0JfqBj/X233dJb2AYrNLpJQTt1sfrvn1oz3s
 ZxdSwawmRMFA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Mar 2020 08:40:34 -0700
IronPort-SDR: uO52HjQca/Gf8eaFMJot38ETcPIuiXTp1v630epdZ7QjHEFgpPIXD8HB7zozUInXpPhNdYj60y
 KSBQnxVPva3w==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,285,1580803200"; d="scan'208";a="237257404"
Received: from gliakhov-mobl2.ger.corp.intel.com (HELO
 ubuntu.ger.corp.intel.com) ([10.252.57.199])
 by fmsmga007.fm.intel.com with ESMTP; 20 Mar 2020 08:40:32 -0700
From: Guennadi Liakhovetski <guennadi.liakhovetski@linux.intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH 09/12] ASoC: SOF: add a vhost driver: sound part
Date: Fri, 20 Mar 2020 16:40:18 +0100
Message-Id: <20200320154021.5964-10-guennadi.liakhovetski@linux.intel.com>
...
---
 ...
 16 files changed, 1324 insertions(+), 13 deletions(-)
...
@@ -750,6 +751,7 @@ static int sof_pcm_probe(struct snd_soc_component *component)
...
@@ -609,4 +625,6 @@ int intel_pcm_close(struct snd_sof_dev *sdev,
...
index 3fa0717..f8bba27 100644
--- a/sound/soc/sof/topology.c
+++ b/sound/soc/sof/topology.c
@@ -1332,6 +1332,7 @@ static int sof_widget_load_dai(struct snd_soc_component *scomp, int index,
...
@@ -1378,6 +1379,13 @@ static int sof_widget_load_buffer(struct snd_soc_component *scomp, int index,
...
+
 	...
 	if (ret < 0) {
@@ -1423,6 +1431,16 @@ static int sof_widget_load_pcm(struct snd_soc_component *scomp, int index,
...
+
 	...
 	if (!host)
 		return -ENOMEM;
@@ -3137,6 +3155,15 @@ static int sof_link_load(struct snd_soc_component *scomp, int index,
...
@@ -3358,6 +3385,32 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
 	}
...
+	/*
 	 ...
 	 */
@@ -3624,7 +3677,7 @@ int snd_sof_load_topology(struct snd_soc_component *scomp, const char *file)
