...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 34D3B50ABCB
	for <lists+alsa-devel@lfdr.de>; Fri, 22 Apr 2022 01:05:33 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C3326171A;
	Fri, 22 Apr 2022 01:04:42 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C3326171A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1650582332;
	bh=x9horz52y7tlWGhiNCE3raG41QRQzs3Lfw8lMgujIRQ=;
	h=From:To:Subject:Date:In-Reply-To:References:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=gfl5zD3nydNNvbNFx0xEpf29saVYMMgTEahoBluIuUBfESF5z9ru9RoAML4vEQWZ/
	 qKpowOYnZrFx4GLArMn+rOLiA/8ZtYZy21mma56gxD8Wcu6EohZ3tw5d1G9iqC9uFy
	 DF8bSM0LXYLwfDC+dSu6wiBUaqAMF8Qcat6K3j0w=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id BD982F804F1;
	Fri, 22 Apr 2022 01:04:05 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id D9DE8F804DA; Fri, 22 Apr 2022 01:04:03 +0200 (CEST)
...
Received: from mail-pl1-x644.google.com (mail-pl1-x644.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id D1BC1F800C1
 for <alsa-devel@alsa-project.org>; Fri, 22 Apr 2022 01:03:56 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz D1BC1F800C1
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="IZwNgnlr"
Received: by mail-pl1-x644.google.com with SMTP id t12so6953028pll.7
 for <alsa-devel@alsa-project.org>; Thu, 21 Apr 2022 16:03:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=from:to:subject:date:message-id:in-reply-to:references:mime-version
 :content-transfer-encoding;
 bh=z1KKASmXmYrJ6VacvfRXsIfYZgeiDf6LpKPVvRoea+I=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=z1KKASmXmYrJ6VacvfRXsIfYZgeiDf6LpKPVvRoea+I=;
 b=
X-Gm-Message-State: AOAM530ebT5lm9fLkMUafmFIGYQ2Qbw+yrcBCdNekFXN0QQL7n05hf9V
 JIGFPUdkhOvBci6V15NgDwI=
X-Google-Smtp-Source: ABdhPJx/SVt/8olc+QraS/2ffPENvYUVWXbVYs/H7MHqpY42KrbZ1lmJjyUkmRNkvDTrUOWWaU4H1g==
X-Received: by 2002:a17:902:c2c7:b0:159:9f9:85f3 with SMTP id
 c7-20020a170902c2c700b0015909f985f3mr1490663pla.18.1650582234061; 
 Thu, 21 Apr 2022 16:03:54 -0700 (PDT)
Received: from localhost.localdomain (c-73-241-94-58.hsd1.ca.comcast.net.
 [73.241.94.58]) by smtp.gmail.com with ESMTPSA id
 t2-20020a17090a448200b001cd4989fee7sm3810238pjg.51.2022.04.21.16.03.50
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 21 Apr 2022 16:03:53 -0700 (PDT)
...
Subject: [PATCH V2 2/2] ASoC: max98396: add amplifier driver
Date: Thu, 21 Apr 2022 16:02:53 -0700
Message-Id: <20220421230253.823798-2-ryan.lee.analog@gmail.com>
X-Mailer: git-send-email 2.25.1
In-Reply-To: <20220421230253.823798-1-ryan.lee.analog@gmail.com>
References: <20220421230253.823798-1-ryan.lee.analog@gmail.com>
MIME-Version: 1.0
...
---
  Changes from v1:
    : Fixed DAI format configuration issue. BCLK/FRSYNC polarity configuration
    was inappropriate.
    : max98396_mux_put function return 1 if the value changed. Otherwise
    the function return 0 or -EINVAL;
    : Modified wrong amp POR(Power On Register) value in max98396_reg.

 sound/soc/codecs/Kconfig    |   10 +
 sound/soc/codecs/Makefile   |    2 +
 sound/soc/codecs/max98396.c | 1640 +++++++++++++++++++++++++++++++++++
 sound/soc/codecs/max98396.h |  306 +++++++
...
index f46a22660103..7881e6120dea 100644
...
@@ -1015,6 +1016,15 @@ config SND_SOC_MAX98390
...
index 8637e9e869e3..8bfe32cbcb06 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -135,6 +135,7 @@ snd-soc-max98373-objs := max98373.o
...
@@ -474,6 +475,7 @@ obj-$(CONFIG_SND_SOC_MAX98373)	+= snd-soc-max98373.o
...
index 000000000000..902f0f8eee4a
--- /dev/null
...
+		fsync_pol = MAX98396_PCM_MODE_CFG_PCM_LRCLKEDGE;
+		break;
+	case SND_SOC_DAIFMT_IB_NF:
+		bclk_pol = MAX98396_PCM_MODE_CFG_PCM_BCLKEDGE;
+		break;
...
+			   MAX98396_PCM_MODE_CFG_PCM_LRCLKEDGE,
+			   fsync_pol);
+
+	regmap_update_bits(max98396->regmap,
...
+			update = true;
+		/* GLOBAL_EN OFF prior to pcm mode change */
+		if (update)
...
new file mode 100644
index 000000000000..dec772cd84d1
--- /dev/null
...
+
+/* MAX98396_R2041_PCM_MODE_CFG */
+#define MAX98396_PCM_MODE_CFG_PCM_LRCLKEDGE	(0x1 << 1)
+
+/* MAX98396_R2042_PCM_CLK_SETUP */
