...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id B82F212101
	for <lists+alsa-devel@lfdr.de>; Thu,  2 May 2019 19:28:38 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 355721670;
	Thu,  2 May 2019 19:27:48 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 355721670
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1556818118;
	bh=lJU+EbCgZZ7QGlBuIGf9ra1DsfJlcXNSsTZEb8nf1qc=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=tG4WqjqoWCduwx8ovdftKm4zOJ+swogf4JMaJh3hks6qC373PzeQNyFLHrKDWt8Ob
	 dPTT9z3l1hvOy/m02Ic584+bD8hs9ErWUYy2pvxU+7b/7AsJSK3yY3FiBZUR4Y+eKj
	 CVE5jIFfCrZHDH+uYytmYJA9TT3F9cDWcsjNBato=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 5F115F89726;
	Thu,  2 May 2019 19:25:40 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 2E591F89724; Thu,  2 May 2019 19:25:38 +0200 (CEST)
...
Received: from mx1.suse.de (mx2.suse.de [195.135.220.15])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id B7D98F8075A
 for <alsa-devel@alsa-project.org>; Thu,  2 May 2019 19:25:26 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B7D98F8075A
X-Virus-Scanned: by amavisd-new at test-mx.suse.de
Received: from relay2.suse.de (unknown [195.135.220.254])
 by mx1.suse.de (Postfix) with ESMTP id D5860AD17;
 Thu,  2 May 2019 17:25:25 +0000 (UTC)
From: Takashi Iwai <tiwai@suse.de>
To: Mark Brown <broonie@kernel.org>
Date: Thu,  2 May 2019 19:25:23 +0200
Message-Id: <20190502172524.10746-2-tiwai@suse.de>
X-Mailer: git-send-email 2.16.4
In-Reply-To: <20190502172524.10746-1-tiwai@suse.de>
References: <20190502172524.10746-1-tiwai@suse.de>
Cc: alsa-devel@alsa-project.org,
 Pierre-Louis Bossart <pierre-louis.bossart@linux.intel.com>
Subject: [alsa-devel] [PATCH v4 1/2] ASoC: Add support for Conexant CX2071X
	CODEC
...
v1->v2: No change
 ...
 4 files changed, 2479 insertions(+)
...
index 000000000000..c136c660b8ef
--- /dev/null
...
+
+	ret = regmap_multi_reg_write(cx2072x->regmap, cx2072x_reg_init,
...
new file mode 100644
index 000000000000..86844816c2de
--- /dev/null
