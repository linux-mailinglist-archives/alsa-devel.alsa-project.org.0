...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 8019C73514D
	for <lists+alsa-devel@lfdr.de>; Mon, 19 Jun 2023 11:59:35 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 905D2844;
	Mon, 19 Jun 2023 11:58:44 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 905D2844
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1687168774;
	bh=BqvzAZuJtqQHC6RvLlB4nFKluYg0MaVf2N6aJmdLrK4=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=Hk3/oWVK4oV4LTv5X23bDvw+jI+Z/Dudqa/zUCoIOYsxDluUiwZhBzvJ9U6KMAFjF
	 rEwK5UWtjj7wJ2J+LxRYZrGWIIIiXxHIHNdkmhY98APFX8F4eNTxCNjOptaKsQCkrZ
	 SWcNvQ6kcMczdrCh0pkBXv0sbYsmGhm9+S7ErvnM=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 35829F805C6; Mon, 19 Jun 2023 11:57:17 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 818D6F8052E;
	Mon, 19 Jun 2023 11:57:16 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id C835BF805B1; Mon, 19 Jun 2023 11:57:09 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 [67.231.149.25])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 67C84F80448
	for <alsa-devel@alsa-project.org>; Mon, 19 Jun 2023 11:56:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 67C84F80448
Authentication-Results: alsa1.perex.cz;
	dkim=pass (2048-bit key,
 unprotected) header.d=cirrus.com header.i=@cirrus.com header.a=rsa-sha256
 header.s=PODMain02222019 header.b=TVEOPmOG
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 ...
 bh=HcZmgjGZwkAI1GFO6D1+5D90iSLdxVdfyDZOkuYwJNM=;
 b= TQ==
Received: from ediex02.ad.cirrus.com ([84.19.233.68])
	by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3r9a809n3e-2
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
	by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 7B70646B;
...
Subject: [PATCH v5 3/6] mfd: cs42l43: Add support for cs42l43 core driver
Date: Mon, 19 Jun 2023 10:56:20 +0100
Message-ID: <20230619095623.1987742-4-ckeepax@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: dRhkmANcna2YVImuXHBQEY5NOkOTIxMG
X-Proofpoint-GUID: dRhkmANcna2YVImuXHBQEY5NOkOTIxMG
X-Proofpoint-Spam-Reason: safe
Message-ID-Hash: TIG7VRZY7NTVNYBE45TWSWYTMNPRQINH
X-Message-ID-Hash: TIG7VRZY7NTVNYBE45TWSWYTMNPRQINH
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/TIG7VRZY7NTVNYBE45TWSWYTMNPRQINH/>
List-Archive: 
...
Changes since v4:
 - Remove the i2c module table
 - De-kernel doc the mcu function comments
 - Move the regmap configs out into the i2c and sdw modules, in the end
   I decided just add a define for the array size. This will be a mild
   inconvience but it makes the code look much nicer. Adding registers
   to the array whilst forgetting to update the define will result in a
   compile error, so it is only really risky in the case we remove a
   register from the array, and that will almost never happen (since the
   chips registers are not going away).
...
index 0000000000000..4832e491f3c2d
--- /dev/null
...
new file mode 100644
index 0000000000000..946dac1c135a7
--- /dev/null
...
new file mode 100644
index 0000000000000..2b4a34a01f949
--- /dev/null
