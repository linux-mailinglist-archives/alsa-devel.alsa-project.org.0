...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 934E931624F
	for <lists+alsa-devel@lfdr.de>; Wed, 10 Feb 2021 10:34:40 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 664C216F9;
	Wed, 10 Feb 2021 10:33:49 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 664C216F9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1612949679;
	bh=FryVv3q3b8X7B9W9gBcGt5Ae/QAJ6cVjsKckG33T6XQ=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Fw/LEkWWuJKZYM1UW3wyTBdCEVoRvwkT+GsQrNLqCsIa0pbiwoHrTajxPvrm6Abz2
	 Y+XoBL2VrU5zyVM/FuWwgN0pL73LcrGnpIyqppW9mFBXwxGA63UCjTZ/wddWT8NR2V
	 Qmn7hwb9N5TTxN0xtH0rg6zQOOBYsUPBBFys7GvA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C402BF802E3;
	Wed, 10 Feb 2021 10:32:27 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 5BE1EF802E2; Wed, 10 Feb 2021 10:32:25 +0100 (CET)
...
Received: from mail-wm1-x334.google.com (mail-wm1-x334.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 37766F8026C
 for <alsa-devel@alsa-project.org>; Wed, 10 Feb 2021 10:32:17 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 37766F8026C
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="IJWWEKIq"
Received: by mail-wm1-x334.google.com with SMTP id o24so1210855wmh.5
 for <alsa-devel@alsa-project.org>; Wed, 10 Feb 2021 01:32:17 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=+cyACm2cTROhY6lRPl7OSmdzfEF9+qk/qQEw9p1sNvk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=+cyACm2cTROhY6lRPl7OSmdzfEF9+qk/qQEw9p1sNvk=;
 b=
X-Gm-Message-State: AOAM532gg6Xdv2dtUVaeNz1RnVVajT9zWo3FDzhCJsg3icMfEnBIX2RH
 ETeC2XwzuFpLxhcmIJZbBDbhjw==
X-Google-Smtp-Source: ABdhPJxPb8LFGQaLWgdBz/OzPp9Ly401rS7Xz/JzHcVgY4qcfI3utVnI7nye68yQhzY/AEN04v/edw==
X-Received: by 2002:a05:600c:47d7:: with SMTP id
 l23mr2145790wmo.16.1612949535542; 
 Wed, 10 Feb 2021 01:32:15 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id t2sm2150583wru.53.2021.02.10.01.32.10
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 10 Feb 2021 01:32:14 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v4 3/7] ASoC: codecs: lpass-rx-macro: add dapm widgets and
 route
Date: Wed, 10 Feb 2021 09:30:51 +0000
Message-Id: <20210210093055.18350-4-srinivas.kandagatla@linaro.org>
...
index 5dd84f09ec0c..bf42e8affdf2 100644
...
+
 static int rx_macro_get_ear_mode(struct snd_kcontrol *kcontrol,
 			       struct snd_ctl_elem_value *ucontrol)
 {
@@ -1760,6 +2420,189 @@ static int rx_macro_aux_hpf_mode_put(struct snd_kcontrol *kcontrol,
 	return 0;
 }
...
+
 static const struct snd_kcontrol_new rx_macro_snd_controls[] = {
 	SOC_SINGLE_S8_TLV("RX_RX0 Digital Volume", CDC_RX_RX0_RX_VOL_CTL,
 			  -84, 40, digital_gain),
@@ -1796,6 +2639,500 @@ static const struct snd_kcontrol_new rx_macro_snd_controls[] = {
...
+
 ...
 {
 	struct rx_macro *rx = snd_soc_component_get_drvdata(component);
@@ -1915,6 +3252,10 @@ static const struct snd_soc_component_driver rx_macro_component_drv = {
