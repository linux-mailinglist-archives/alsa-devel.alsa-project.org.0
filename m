...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id A27424DDF14
	for <lists+alsa-devel@lfdr.de>; Fri, 18 Mar 2022 17:32:10 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 3DB7717F5;
	Fri, 18 Mar 2022 17:31:20 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 3DB7717F5
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1647621130;
	bh=VwAREvH2GMPYzDEwQ2ZV6ma9T4ISya08TUhhZiShkcA=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=DlzWfQZD7aC88oJj+PxuS9vTBZ8ESwA9efGLZGOuAtj81OpsIw4uQr7VA6zhfyOq6
	 nm6in0rVohcv79Nz7uJ/4ZMxUs+pgr1szHqIUM9bF7L7IJkUsZX2R6EymYqCWlcEdR
	 QMtj94GLVUA40lkclT3ImkxtCuKoocPeZ1G4o2z0=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 7459BF8051F;
	Fri, 18 Mar 2022 17:30:05 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id DA144F80516; Fri, 18 Mar 2022 17:29:59 +0100 (CET)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 0EE88F80125
 for <alsa-devel@alsa-project.org>; Fri, 18 Mar 2022 17:29:49 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 0EE88F80125
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="hK4aFpBr"
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
 by mx0b-001ae601.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 22ICwIRD029747;
 Fri, 18 Mar 2022 11:29:48 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=MMbaw4bZj9YucxuF659lJ9PCvuZNR6KudOqz5qU2AFo=;
 b= og== 
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
 by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 3et5yp677a-3
...
Received: from debianA11184.ad.cirrus.com (debianA11184.ad.cirrus.com
 [198.90.251.45])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id A63D0B1A;
 Fri, 18 Mar 2022 16:29:44 +0000 (UTC)
From: Richard Fitzgerald <rf@opensource.cirrus.com>
To: <broonie@kernel.org>, <robh+dt@kernel.org>
Subject: [PATCH 5/5] ASoC: cs35l45: Add driver for Cirrus Logic CS35L45 Smart
 Amp
Date: Fri, 18 Mar 2022 16:29:43 +0000
Message-ID: <20220318162943.1578102-6-rf@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: EJQqRE09QPY8eyrfRlO8lX_EXZwd_NjX
X-Proofpoint-GUID: EJQqRE09QPY8eyrfRlO8lX_EXZwd_NjX
...
This initial driver provides standard audio operation without
the DSP.
...
index f46a22660103..449fe25d3a79 100644
...
@@ -655,6 +657,34 @@ config SND_SOC_CS35L41_I2C
...
index 8637e9e869e3..60e9957e2dd1 100644
...
@@ -404,6 +408,10 @@ obj-$(CONFIG_SND_SOC_CS35L41)	+= snd-soc-cs35l41.o
...
index 000000000000..0f4a080e2494
--- /dev/null
...
new file mode 100644
index 000000000000..a2d77b4d7f85
--- /dev/null
...
new file mode 100644
index 000000000000..ce7a33e9baec
--- /dev/null
...
new file mode 100644
index 000000000000..9088613bd2a9
--- /dev/null
