...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9C13D33F9EB
	for <lists+alsa-devel@lfdr.de>; Wed, 17 Mar 2021 21:23:52 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 618E816D4;
	Wed, 17 Mar 2021 21:23:01 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 618E816D4
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1616012631;
	bh=SIVU2HDuol5lq/Ox8UP/reAHKHoNy7eHpbpyYpw/0iE=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=u6L19AZjq6roBVU6H5/tvFNyE6ullyGXqLu3CDzphazRri2pEiuY1tbc3XK+19MVj
	 7YCOtqso8CuUScKk9yOv/CGum0atXwkFLez5zR8xgOZYc+6ScRXlh8KwRrxb/KIe0N
	 jSZV89bMH8k/2iIvYyHu00p7e9kUX1MuGZGiGQDw=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id A0C9FF80124;
	Wed, 17 Mar 2021 21:22:15 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 72FAFF80423; Wed, 17 Mar 2021 21:22:09 +0100 (CET)
...
Received: from NAM02-DM3-obe.outbound.protection.outlook.com
 (mail-dm3nam07olkn2052.outbound.protection.outlook.com [40.92.43.52])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 7933BF8013F
 for <alsa-devel@alsa-project.org>; Wed, 17 Mar 2021 21:21:58 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7933BF8013F
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=hotmail.com header.i=@hotmail.com
 header.b="YnUllpVj"
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com; 
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=KB82pb04LjK/8KeUH+qqQWJUaKYM5tHq2XHrHyoKdJY=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=hotmail.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=KB82pb04LjK/8KeUH+qqQWJUaKYM5tHq2XHrHyoKdJY=;
 b=
Received: from SN1NAM02FT061.eop-nam02.prod.protection.outlook.com
 (10.152.72.52) by SN1NAM02HT104.eop-nam02.prod.protection.outlook.com
 (10.152.73.127) with Microsoft SMTP Server (version=TLS1_2,
...
Received: from SN6PR06MB5342.namprd06.prod.outlook.com
 ...
 Transport; Wed, 17 Mar 2021 20:21:46 +0000
X-IncomingTopHeaderMarker: OriginalChecksum:163EA45BF63BCCEE44F5C41AB82168176F09ACD8983CB8546F48C0D07F48909A;
 UpperCasedChecksum:70621E0A59E5BBD847BDAFF043C84C2B9DDF03C0989FAA6B473BB6C67C30A33F;
 SizeAsReceived:7386; Count:45
Received: from SN6PR06MB5342.namprd06.prod.outlook.com
...
Subject: [PATCH v4 1/3] ASoC: Add Rockchip rk817 audio CODEC support
Date: Wed, 17 Mar 2021 15:21:15 -0500
Message-ID: <SN6PR06MB534267976CCAB77E25EF10A9A56A9@SN6PR06MB5342.namprd06.prod.outlook.com>
X-Mailer: git-send-email 2.25.1
Content-Transfer-Encoding: 8bit
Content-Type: text/plain
X-TMN: [iToEW+dG87JHXoY/NN1Bx3amybpFZXG+]
X-ClientProxiedBy: SN6PR2101CA0021.namprd21.prod.outlook.com
 ...
 (2603:10b6:805:f9::31)
X-Microsoft-Original-Message-ID: <20210317202117.29926-1-macromorgan@hotmail.com>
MIME-Version: 1.0
...
Received: from wintermute.localdomain (76.183.134.35) by
 ...
 Transport; Wed, 17 Mar 2021 20:21:45 +0000
X-MS-PublicTrafficType: Email
X-IncomingHeaderCount: 45
X-EOPAttributedMessage: 0
X-MS-Office365-Filtering-Correlation-Id: d3ebb267-aebb-452c-58e4-08d8e9824942
X-MS-Exchange-SLBlob-MailProps: 
X-MS-TrafficTypeDiagnostic: SN1NAM02HT104:
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-MS-Exchange-AntiSpam-MessageData: FkCWXHvLSjBxjF/i7XmxDojqvLkUYmGXhjk6Vn3tVrtOoKvMSdFKnVo/tlU7bolXVA7mpfzdY1ghOyeTBD1G8UlObKPX/PscTNcGddMiZLfIhK3oGVNbGHegZFaZVkv5UzBx9ZoMk8lzvLEiIYwkbw==
X-OriginatorOrg: hotmail.com
X-MS-Exchange-CrossTenant-Network-Message-Id: d3ebb267-aebb-452c-58e4-08d8e9824942
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 17 Mar 2021 20:21:46.7134 (UTC)
...
Changes from v3:
	Created separate set_pll() call.
	Created user visible gain control for microphone.
	Check for return value of clk_prepare_enable().
	Remove duplicate clk_prepare_enable().
	Moved documentation to a separate commit.

Signed-off-by: Chris Morgan <macromorgan@hotmail.com>
---
 sound/soc/codecs/Kconfig       |   6 +
 sound/soc/codecs/Makefile      |   2 +
 sound/soc/codecs/rk817_codec.c | 706 +++++++++++++++++++++++++++++++++
 sound/soc/codecs/rk817_codec.h |  94 +++++
...
index 000000000000..045acf05da5c
--- /dev/null
...
new file mode 100644
index 000000000000..f3bc59d498b4
--- /dev/null
