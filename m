...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 969B3316266
	for <lists+alsa-devel@lfdr.de>; Wed, 10 Feb 2021 10:36:58 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id AD0D216F3;
	Wed, 10 Feb 2021 10:36:07 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz AD0D216F3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1612949817;
	bh=JaVu5iAxIkl5MnWGKtFIkD0IfL61tV8BMokk/PDXy68=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=IC7CkFU9+iVc88a7LOncih7KRwQT9ghMpmTfBcvq/295keAnXHU57V6co8CTOLTF5
	 M+PEIFj0UfObBGZOKL7dwBh17xr572wwwMNF+sAwtEpJ/OO4zN1idyASEi+QQ8V/31
	 7Um40DXfOPbMcg/UZN8MVH/2X7XtUBBv/dnawgkk=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C5AF7F804EB;
	Wed, 10 Feb 2021 10:32:48 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id C2ECAF804E1; Wed, 10 Feb 2021 10:32:47 +0100 (CET)
...
Received: from mail-wm1-x32e.google.com (mail-wm1-x32e.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 95DC3F804AD
 for <alsa-devel@alsa-project.org>; Wed, 10 Feb 2021 10:32:42 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 95DC3F804AD
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="PF28AEDH"
Received: by mail-wm1-x32e.google.com with SMTP id j21so1231310wmj.0
 for <alsa-devel@alsa-project.org>; Wed, 10 Feb 2021 01:32:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=eAc1svEWn3cuW55q5S09kWTrcUNsPJfrxynjKFv8jqE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=eAc1svEWn3cuW55q5S09kWTrcUNsPJfrxynjKFv8jqE=;
 b=
X-Gm-Message-State: AOAM5310jkioLNa7AYdkXuBiWqQQMdxV+k9Y+bwW6mEiq9mTa/WB2gMY
 I19HYV0XrK22yO7kTosGYsoYIw==
X-Google-Smtp-Source: ABdhPJzAE0Da9ksPhX7Co94YFmiCrvCdUJsUfyDac3c4+IHBaec0zUcXgotkuKuq7AoiAkivJKWcOQ==
X-Received: by 2002:a1c:29c6:: with SMTP id p189mr2119117wmp.110.1612949562499; 
 Wed, 10 Feb 2021 01:32:42 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id t2sm2150583wru.53.2021.02.10.01.32.35
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 10 Feb 2021 01:32:41 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v4 7/7] ASoC: codecs: lpass-tx-macro: add dapm widgets and
 route
Date: Wed, 10 Feb 2021 09:30:55 +0000
Message-Id: <20210210093055.18350-8-srinivas.kandagatla@linaro.org>
...
index 0c834e9b1f67..8ace3afaf0e2 100644
--- a/sound/soc/codecs/lpass-tx-macro.c
+++ b/sound/soc/codecs/lpass-tx-macro.c
@@ -709,6 +709,289 @@ static void tx_macro_mute_update_callback(struct work_struct *work)
...
+
 static int tx_macro_dec_mode_get(struct snd_kcontrol *kcontrol,
 				 struct snd_ctl_elem_value *ucontrol)
 {
@@ -904,6 +1187,83 @@ static struct snd_soc_dai_driver tx_macro_dai[] = {
 	},
 };
...
@@ -927,6 +1287,327 @@ static const struct soc_enum dec_mode_mux_enum[] = {
 			dec_mode_mux_text),
 };
...
+
 static const struct snd_kcontrol_new tx_macro_snd_controls[] = {
 	SOC_SINGLE_S8_TLV("TX_DEC0 Volume",
 			  CDC_TX0_TX_VOL_CTL,
@@ -1100,6 +1781,10 @@ static const struct snd_soc_component_driver tx_macro_component_drv = {
