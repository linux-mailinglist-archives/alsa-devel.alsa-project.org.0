...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F1E7D938F95
	for <lists+alsa-devel@lfdr.de>; Mon, 22 Jul 2024 15:02:27 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C9575EB6;
	Mon, 22 Jul 2024 15:02:16 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C9575EB6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1721653346;
	bh=G44yCuNHPuRPdZOanNffaIFdvZ8xqhQHzw7CqQS7OTU=;
	h=From:To:CC:Subject:Date:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=BHNOA9kJQztktPxpI1UwfwEtb7cpcn0k0vVtBmULsmg39A2hLQ4wwPpZUCt2tIlI7
	 gWaUGg8Ysnp8wh1iWkZf26OyKpLMDUOU9653O8l9pRW0rUaO+EPEzXVSmkm33VYuAy
	 QEnOwIBOd07R2NCZZOfGHQiCCoMawrNIRcOWsPK4=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id F07A9F80601; Mon, 22 Jul 2024 15:00:49 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 7269CF80601;
	Mon, 22 Jul 2024 15:00:49 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 49D06F801F5; Sun, 21 Jul 2024 16:24:10 +0200 (CEST)
...
Received: from lelv0142.ext.ti.com (lelv0142.ext.ti.com [198.47.23.249])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 01C32F8013D
	for <alsa-devel@alsa-project.org>; Sun, 21 Jul 2024 16:23:39 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 01C32F8013D
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=kvhF1Tue
Received: from lelv0265.itg.ti.com ([10.180.67.224])
	by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id 46LENW54083081;
	Sun, 21 Jul 2024 09:23:32 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1721571812;
	bh=4Uc6V/w0FJaxQPQE+kPPTXUv5XyTPNZzHoWzjh5Vmkg=;
	h=From:To:CC:Subject:Date;
	b=kvhF1TueO+e+ULU2kjr61DxqxeoWaIR61hudTpCUqdOSNgi8FPX+CRdC6ereUliV7
	 G/BRS4t3FzK5uz1/nZYq4LonP8epCfjhjlgDkl4znxD3NEHFiLp2qnxcG/jUsh+eZC
	 +JwAW5I5mv1AuX8viX2UrfPhOFFwc2a2AmuYkt2o=
Received: from DLEE113.ent.ti.com (dlee113.ent.ti.com [157.170.170.24])
	by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 46LENWtA002377
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Sun, 21 Jul 2024 09:23:32 -0500
Received: from DLEE115.ent.ti.com (157.170.170.26) by DLEE113.ent.ti.com
 (157.170.170.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Sun, 21
 Jul 2024 09:23:31 -0500
Received: from lelvsmtp5.itg.ti.com (10.180.75.250) by DLEE115.ent.ti.com
 (157.170.170.26) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Sun, 21 Jul 2024 09:23:31 -0500
Received: from lelvsmtp5.itg.ti.com ([10.250.165.138])
	by lelvsmtp5.itg.ti.com (8.15.2/8.15.2) with ESMTP id 46LENM8P101487;
	Sun, 21 Jul 2024 09:23:23 -0500
...
Message-ID: <20240721142258.504-1-baojun.xu@ti.com>
...
Message-ID-Hash: GLUG637EEMCGERMYYVHEHPOYYE4YA6TV
X-Message-ID-Hash: GLUG637EEMCGERMYYVHEHPOYYE4YA6TV
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/GLUG637EEMCGERMYYVHEHPOYYE4YA6TV/>
List-Archive: 
...
---
 ...
 sound/pci/hda/tas2781_hda_spi.c               | 1317 ++++++++++
 sound/pci/hda/tas2781_spi_fwlib.c             | 2115 +++++++++++++++++
 8 files changed, 3632 insertions(+)
...
index c3a86a99f8c6..51707270943a 100644
--- a/sound/pci/hda/patch_realtek.c
+++ b/sound/pci/hda/patch_realtek.c
@@ -6924,6 +6924,11 @@ static void tas2781_fixup_i2c(struct hda_codec *cdc,
...
@@ -9726,6 +9732,12 @@ static const struct hda_fixup alc269_fixups[] = {
 		.chained = true,
...
@@ -10263,6 +10275,7 @@ static const struct snd_pci_quirk alc269_fixup_tbl[] = {
...
index 000000000000..0cadfd18bde2
--- /dev/null
...
new file mode 100644
index 000000000000..dd979cb46fce
--- /dev/null
...
+	}
+	for (int j = 0; j >= 0; j++) {
+		if (tas2781_pre_reset_table[j].reg == 0)
+			break;
+		if (tas2781_pre_reset_table[j].data[0] > 1) {
+			tasdevice_spi_dev_bulk_write(tas_dev,
+				tas2781_pre_reset_table[j].reg,
+				&tas2781_pre_reset_table[j].data[1],
+				tas2781_pre_reset_table[j].data[0]);
+		} else {
+			tasdevice_spi_dev_write(tas_dev,
+				tas2781_pre_reset_table[j].reg,
+				tas2781_pre_reset_table[j].data[1]);
+		}
+	}
...
+	fsleep(1000);
+	for (int j = 0; j >= 0; j++) {
+		if (tas2781_post_reset_table[j].reg == 0)
+			break;
+		if (tas2781_post_reset_table[j].data[0] > 1) {
+			tasdevice_spi_dev_bulk_write(tas_dev,
+				tas2781_post_reset_table[j].reg,
+				&tas2781_post_reset_table[j].data[1],
+				tas2781_post_reset_table[j].data[0]);
+		} else {
+			tasdevice_spi_dev_write(tas_dev,
+				tas2781_post_reset_table[j].reg,
+				tas2781_post_reset_table[j].data[1]);
...
+
+		tasdevice_spi_prmg_load(tas_hda->priv, 0);
...
new file mode 100644
index 000000000000..9e58e8d981e3
--- /dev/null
...
+	return rc;
+}
+/* Calibration block load function. */
