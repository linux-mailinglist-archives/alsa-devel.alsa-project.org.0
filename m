...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 7705078CF5E
	for <lists+alsa-devel@lfdr.de>; Wed, 30 Aug 2023 00:04:14 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C6717E7A;
	Wed, 30 Aug 2023 00:03:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C6717E7A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1693346653;
	bh=dhd50cuuZAKIgsDyDJ4jwYsroSlmQFHaDITFtdNCK4c=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=QyU+KM1rVNoWhUtg0Fzn/nFrNMovngzR0SaqVkatDskCzbz1XcEvmLGAmviJK0JTI
	 8OGMRiLMP018iJ7AmuJicSi/QxbZjvsF7X2dNJ3ioei5dmVWQbE7EkbttKBwLdoNbj
	 KaU8LL7hi1ukejYvfZxbYJ9D8IcE+/FPVdwn2xr4=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 50646F805B6; Wed, 30 Aug 2023 00:01:54 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id B2589F805B1;
	Wed, 30 Aug 2023 00:01:53 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id BA0E2F80588; Wed, 30 Aug 2023 00:01:49 +0200 (CEST)
...
Received: from mail.mutex.one (mail.mutex.one [62.77.152.124])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id B5F08F80236
	for <alsa-devel@alsa-project.org>; Wed, 30 Aug 2023 00:01:33 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B5F08F80236
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=mutex.one header.i=@mutex.one header.a=rsa-sha256
 header.s=default header.b=SwnHPudj
Received: from localhost (localhost.localdomain [127.0.0.1])
	by mail.mutex.one (Postfix) with ESMTP id 4B55C16C004E;
	Wed, 30 Aug 2023 01:01:33 +0300 (EEST)
X-Virus-Scanned: Debian amavisd-new at mail.mutex.one
Received: from mail.mutex.one ([127.0.0.1])
	by localhost (mail.mutex.one [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id S86dJDbEpIYk; Wed, 30 Aug 2023 01:01:31 +0300 (EEST)
From: Marian Postevca <posteuca@mutex.one>
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mutex.one; s=default;
	t=1693346491; bh=dhd50cuuZAKIgsDyDJ4jwYsroSlmQFHaDITFtdNCK4c=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=SwnHPudj2XYU1CVVd9jsAVQAcVebu0/NHIszFJgdgXeho2w6A9HslhiBnB1bmP1gz
	 P1X4LFBuoyJxXvkpxhDInl28bRdf28Q4CQgWB/CZDxLPM/wJG1DBa98nRLIppn37n4
	 aXAs23j+NWQwZgvGBMipe9auGjq5ADY/VaDcgV6Q=
...
Subject: [PATCH v3 5/5] ASoC: amd: acp: Add machine driver that enables sound
 for systems with a ES8336 codec
Date: Wed, 30 Aug 2023 01:01:16 +0300
Message-ID: <20230829220116.1159-6-posteuca@mutex.one>
In-Reply-To: <20230829220116.1159-1-posteuca@mutex.one>
References: <20230829220116.1159-1-posteuca@mutex.one>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: NQCQO37IT5FJAGJIICENI6TNUMJE44GA
X-Message-ID-Hash: NQCQO37IT5FJAGJIICENI6TNUMJE44GA
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/NQCQO37IT5FJAGJIICENI6TNUMJE44GA/>
List-Archive: 
