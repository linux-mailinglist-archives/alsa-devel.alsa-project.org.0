...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 98BDD21917D
	for <lists+alsa-devel@lfdr.de>; Wed,  8 Jul 2020 22:29:00 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 221C21607;
	Wed,  8 Jul 2020 22:28:10 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 221C21607
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1594240140;
	bh=Av35bZzP783eOZ+Sn+Wl1ZcqT1oJr908uN2lpy6ai54=;
	h=Date:From:To:Subject:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=oyIQSrJecZQQq2efH3vaBUUVOeyANZHn32p0HR0Etba4Wp4kYy7UwkjjJ5/5faKk3
	 MNQxHYjXm9DgPYTK6Ik44f/+lkB/YQ4KBPdyYI2wkYmpVCZqvbXGVFTxE2vUIM+jw3
	 aMsSyKkE6ON2Vh6ASA+slLzPM4be3yoKQ4e+ZJ3k=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 0A9ACF8015C;
	Wed,  8 Jul 2020 22:27:19 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id BB634F8015A; Wed,  8 Jul 2020 22:27:16 +0200 (CEST)
...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 46337F80115
 for <alsa-devel@alsa-project.org>; Wed,  8 Jul 2020 22:27:11 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 46337F80115
...
Received: from embeddedor (unknown [201.162.240.161])
 ...
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 7455420739;
 Wed,  8 Jul 2020 20:27:06 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1594240028;
 bh=Av35bZzP783eOZ+Sn+Wl1ZcqT1oJr908uN2lpy6ai54=;
 h=Date:From:To:Cc:Subject:From;
 b=mFUxw14v2IZXBFuB1tKUxnvkkR8RTjT383Wx1nK2HZqfrWB2KaFQc4ttqC0/jkJaD
 we+N1P/ZgaGLfRI6hmoYzvJk3P5llGPXeW7p7losEA9CTTXvCO+5giGM398sBSqlLV
 dT8cbD22amz78UdDXjp0Fiq1CdPgi/W4FC1j8LMw=
Date: Wed, 8 Jul 2020 15:32:36 -0500
From: "Gustavo A. R. Silva" <gustavoars@kernel.org>
To: Jaroslav Kysela <perex@perex.cz>, Takashi Iwai <tiwai@suse.com>,
 Nicolas Ferre <nicolas.ferre@microchip.com>,
 Alexandre Belloni <alexandre.belloni@bootlin.com>,
 Ludovic Desroches <ludovic.desroches@microchip.com>
Subject: [PATCH v2] ALSA: Use fallthrough pseudo-keyword
Message-ID: <20200708203236.GA5112@embeddedor>
MIME-Version: 1.0
...
Changes in v2:
 ...
 35 files changed, 78 insertions(+), 80 deletions(-)
...
index d8f28d030985..ad74ea9cbff5 100644
...
index 1e51c849d3d4..9e0b2d73faf6 100644
...
index bee3271e29da..b07d3c5be9aa 100644
...
index d796963b80d7..be5000dd1585 100644
...
index ad43812d63b5..605c76bcc52a 100644
...
+		fallthrough;
 	...
 	case 0x10ec0233:
 	case 0x10ec0235:
@@ -4698,7 +4698,7 @@ static void alc_headset_mode_mic_in(struct hda_codec *codec, hda_nid_t hp_pin,
 		break;
 	case 0x10ec0867:
...
index 4987b6dab84c..deb977e9c35a 100644
--- a/sound/usb/pcm.c
+++ b/sound/usb/pcm.c
@@ -1743,7 +1743,7 @@ static int snd_usb_substream_playback_trigger(struct snd_pcm_substream *substrea
 	switch (cmd) {
 	case SNDRV_PCM_TRIGGER_START:
