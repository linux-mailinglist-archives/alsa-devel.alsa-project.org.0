...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id DB241301D97
	for <lists+alsa-devel@lfdr.de>; Sun, 24 Jan 2021 17:50:46 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 5A9D91871;
	Sun, 24 Jan 2021 17:49:51 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 5A9D91871
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1611507041;
	bh=pf4VFkvwpBDpNYdUmYv0FRa3EWm5dhfie2BwrRSI0oU=;
	h=Subject:To:References:From:Date:In-Reply-To:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=DPVswMMlr8O7LSP+NOGhA/aFd4aYd8ufbHDqLXPA30HvUo+pPx93im7HKJoDsOFWo
	 L7ET8jkYqJokBWmSU/AAxeDmGjy909kgYCFjzNwAIxY9Z4ia1rEHoXaBGNPcPcgSOQ
	 DHlTdpGhtSeo/CuSJEwX8oy0k/3sH8vdVQyt06Co=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 6E151F801D8;
	Sun, 24 Jan 2021 17:49:09 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 0AC4EF8015B; Sun, 24 Jan 2021 17:49:05 +0100 (CET)
...
Received: from mx1.opensynergy.com (mx1.opensynergy.com [217.66.60.4])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 3414DF80148
 for <alsa-devel@alsa-project.org>; Sun, 24 Jan 2021 17:48:57 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 3414DF80148
...
Since only the event virtqueue must be disabled before calling
virtsnd_build_devs, I've simplified the code here in v2. The other three
virtqueues are now always enabled.
...
We can get here also because of the DEVICE_NEEDS_RESET status. In this
case, there may be pending synchronous control requests. This means that
a subsequent call to snd_card_free may take a significant amount of time
(until the message timed out). So it is best to disable the virtqueues
and cancel any pending messages first.

By the way, could you take a look into the reset worker function in v2:
   [2/9] virtio_card.c:virtsnd_reset_fn()
I put there additional comments. The question is, is the current
solution acceptable? The code itself works fine though.
