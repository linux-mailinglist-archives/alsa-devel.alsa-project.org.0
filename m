...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 063B52CB2AF
	for <lists+alsa-devel@lfdr.de>; Wed,  2 Dec 2020 03:15:32 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 6559817B6;
	Wed,  2 Dec 2020 03:14:41 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 6559817B6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1606875331;
	bh=/yvY1XArnxSkZ54WdFVVNRBtkEEXQvaHAueFLz+YRok=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=lPvWZguLStK6XPP05of8/wC14bLVik4fEgqkeylzdKNjYv6W7gZxxHexYNkiN08Gq
	 PxfxEuIRcmnKucuQB/citWM6sXsZy5yD92VeeKScR25Vds4gT9fraUxGqvArYKwTsI
	 4N6UBSnnQ+sibZUkYxf7GmXnWgbqcDiBW8s2iqgY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 4039BF8026D;
	Wed,  2 Dec 2020 03:13:56 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 0B89EF80254; Wed,  2 Dec 2020 03:13:54 +0100 (CET)
...
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id B8BE7F80139
 for <alsa-devel@alsa-project.org>; Wed,  2 Dec 2020 03:13:45 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B8BE7F80139
IronPort-SDR: Aoi0QZec721XWQ4VSZWbrqJDdhIih1ujR+8uEibAOa7XUqeezXG9UsbqI3xwuwdTCKt/xSdEno
 mZTnGpi0XISg==
X-IronPort-AV: E=McAfee;i="6000,8403,9822"; a="257650787"
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; d="scan'208";a="257650787"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 01 Dec 2020 18:13:39 -0800
IronPort-SDR: s9fRK5mMsJ+CT09L5U2ZGAe/axLssI9ywoiIY/g63XgnwR96uWUSj61zCjRbnMKX53vjOk6r+8
 PBEP09Ph5TGw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.78,385,1599548400"; d="scan'208";a="537794948"
Received: from brentlu-desk0.itwn.intel.com ([10.5.253.11])
 by fmsmga006.fm.intel.com with ESMTP; 01 Dec 2020 18:13:34 -0800
From: Brent Lu <brent.lu@intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH] ASoC: intel: sof_rt5682: Add support for tgl_rt1011_rt5682
Date: Wed,  2 Dec 2020 09:58:26 +0800
Message-Id: <20201202015826.7678-1-brent.lu@intel.com>
...
index 9f243e60b95c..84cc6326979a 100644
--- a/sound/soc/intel/common/soc-acpi-intel-tgl-match.c
+++ b/sound/soc/intel/common/soc-acpi-intel-tgl-match.c
@@ -310,6 +310,11 @@ static struct snd_soc_acpi_codecs tgl_max98373_amp = {
 	.codecs = {"MX98373"}
 };
 
+static struct snd_soc_acpi_codecs tgl_rt1011_amp = {
+	.num_codecs = 1,
+	.codecs = {"10EC1011"}
+};
+
