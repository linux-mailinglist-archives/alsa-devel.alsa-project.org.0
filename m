...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id BFC5010A070
	for <lists+alsa-devel@lfdr.de>; Tue, 26 Nov 2019 15:37:13 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 27F22173D;
	Tue, 26 Nov 2019 15:36:23 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 27F22173D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1574779033;
	bh=OtiifvVLhOxVtc/KSmuAo+3B2QuRf2FsOuJwX3+WT7w=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=M2FBibkI951m8Da+KSoLr4k5P54RbLCSoYesBhy7pUwzbw3X494KDgepWBZHch3DH
	 YYoFA5doZrM14SLscCp2ZGvcujedueqsq+lcMbCM+rb24bcjbcnCnkSbUTE1r3gG7C
	 k5R5u8fq7rYDBNsSKGKYnsaoTO1lSjcVdU1uocjc=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 807B0F8027C;
	Tue, 26 Nov 2019 15:29:01 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 7502BF80234; Tue, 26 Nov 2019 15:28:52 +0100 (CET)
...
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 6129AF800AB
 for <alsa-devel@alsa-project.org>; Tue, 26 Nov 2019 15:28:35 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 6129AF800AB
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by orsmga101.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 26 Nov 2019 06:28:32 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,246,1571727600"; d="scan'208";a="206473469"
Received: from vramali2-mobl1.amr.corp.intel.com (HELO
 pbossart-mobl3.amr.corp.intel.com) ([10.251.155.193])
 by fmsmga008.fm.intel.com with ESMTP; 26 Nov 2019 06:28:31 -0800
From: Pierre-Louis Bossart <pierre-louis.bossart@linux.intel.com>
To: alsa-devel@alsa-project.org
Date: Tue, 26 Nov 2019 08:28:10 -0600
Message-Id: <20191126142815.21856-6-pierre-louis.bossart@linux.intel.com>
...
Subject: [alsa-devel] [PATCH 05/10] ASoC: SOF: partition audio-related parts
	from SOF core
...
index 29ab43281670..92643a801f4f 100644
...
index f31791ce9958..ff25d5c95b70 100644
...
+	dev_err(scomp->dev, "error: failed to find dai %s in %s",
 	...
 	return -EINVAL;
 found:
@@ -3140,7 +3138,7 @@ static int sof_link_unload(struct snd_soc_component *scomp,
...
+		dev_err(scomp->dev, "error: invalid DAI type %d\n",
 		...
 		ret = -EINVAL;
 		break;
@@ -3166,7 +3164,7 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
 	if (!sroute)
 		return -ENOMEM;
...
+	sroute->scomp = scomp;
 	...
 	if (!connect) {
@@ -3177,14 +3175,14 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
...
+		dev_err(scomp->dev, "error: source %s not found\n",
 		...
 		ret = -EINVAL;
 		goto err;
@@ -3203,9 +3201,9 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
...
+		dev_err(scomp->dev, "error: sink %s not found\n",
 		...
 		ret = -EINVAL;
 		goto err;
@@ -3229,7 +3227,7 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
 	 */
...
+		dev_dbg(scomp->dev, "warning: neither Linked source component %s nor sink component %s is of buffer type, ignoring link\n",
 		...
 		ret = 0;
 		goto err;
@@ -3241,7 +3239,7 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
...
+			dev_err(scomp->dev, "error: failed to add route sink %s control %s source %s\n",
 				...
 				route->source);
@@ -3250,7 +3248,7 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
...
@@ -3277,8 +3275,9 @@ static int sof_route_load(struct snd_soc_component *scomp, int index,
...
+	struct snd_sof_dev *sdev = snd_soc_component_get_drvdata(scomp);
 	...
 	int ipc_cmd, ctrl_type;
 	int ret = 0;
@@ -3298,33 +3297,34 @@ static int snd_sof_cache_kcontrol_val(struct snd_sof_dev *sdev)
...
@@ -3354,7 +3354,7 @@ static void sof_complete(struct snd_soc_component *scomp)
 		switch (swidget->id) {
 		case snd_soc_dapm_scheduler:
 			swidget->complete =
-				snd_sof_complete_pipeline(sdev, swidget);
+				snd_sof_complete_pipeline(scomp->dev, swidget);
 		...
 		default:
 			break;
@@ -3364,14 +3364,13 @@ static void sof_complete(struct snd_soc_component *scomp)
...
@@ -3379,16 +3378,16 @@ static int sof_manifest(struct snd_soc_component *scomp, int index,
...
@@ -3399,15 +3398,15 @@ static int sof_manifest(struct snd_soc_component *scomp, int index,
 				  man->priv.data[2]);
...
@@ -3465,25 +3464,25 @@ static struct snd_soc_tplg_ops sof_tplg_ops = {
