...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C3A77123C3
	for <lists+alsa-devel@lfdr.de>; Fri, 26 May 2023 11:36:05 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 0F7DE836;
	Fri, 26 May 2023 11:35:14 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 0F7DE836
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1685093764;
	bh=eaIDAWy3t/Fq6qjUpxmZiQg0d4Zax+oYbt9djXHLZ80=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=F2FnAjJcW8cAgwXlUm6GfHMjMMRazL58/CDwb6VzB7lv7Pia5f0tPC2aBBC4d48+d
	 zRFQhTjwVtjgR3gwGaanEUvsf8tvLH9a9d6/ktMYJ0SxfRtKHyKS1KacFYtiPwR5xn
	 A4MuCCIDPKLSvL4g7021q9HMLnUtPGOPWwxT7rmo=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 077ADF805A8; Fri, 26 May 2023 11:34:00 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id B0662F80588;
	Fri, 26 May 2023 11:34:00 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 9F8CAF8024E; Fri, 26 May 2023 11:32:28 +0200 (CEST)
...
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
 ...
 SHA256)
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 96C52F80053
	for <alsa-devel@alsa-project.org>; Fri, 26 May 2023 11:32:03 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 96C52F80053
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=mediatek.com header.i=@mediatek.com header.a=rsa-sha256
 header.s=dk header.b=PpCqtZhY
X-UUID: 2687eb0afba811edb20a276fd37b9834-20230526
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 d=mediatek.com; s=dk;
	h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From;
 bh=yX11w3m9AHpAAv+P2NKB/owHFxvemKpwoQydROCXUNo=;
	b=PpCqtZhY1WUIssseL3rsWlf1e5uny70TEsqoIHBAc3XG2w4cG3AasSQ8D0J+fQiAFYvkLQ+YvlD/hBnJMbGV938qppH08xZyCAtRb96z9hsG937Sjvu4wcJtcY6+IPogHT5nztWynNZMu9M+cjglgKeS7yz2c65Ok0HroUxLX8w=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.25,REQID:441e8fe2-fbfd-4b2d-a6e6-2904e91e3f3d,IP:0,U
	RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
	N:release,TS:-25
X-CID-META: VersionHash:d5b0ae3,CLOUDID:140b753c-de1e-4348-bc35-c96f92f1dcbb,B
...
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by
 mailgw02.mediatek.com
	...
	with ESMTP id 125189397; Fri, 26 May 2023 17:31:53 +0800
...
Subject: [PATCH v3 6/7] ASoC: mediatek: mt8188-mt6359: support new board with
 nau88255
Date: Fri, 26 May 2023 17:31:49 +0800
Message-ID: <20230526093150.22923-7-trevor.wu@mediatek.com>
...
X-MTK: N
Message-ID-Hash: RSSNWD3A76FR7DBZX2YEQKNNYNAAGCXS
X-Message-ID-Hash: RSSNWD3A76FR7DBZX2YEQKNNYNAAGCXS
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/RSSNWD3A76FR7DBZX2YEQKNNYNAAGCXS/>
List-Archive: 
...
---
 ...
 sound/soc/mediatek/mt8188/mt8188-mt6359.c | 327 +++++++++++++++++++++-
...
index 6c3f36e2fffd..bc4b74970a46 100644
...
@@ -776,9 +1066,35 @@ static int mt8188_mt6359_dev_probe(struct platform_device *pdev)
...
@@ -795,11 +1111,20 @@ static struct mt8188_card_data mt8188_evb_card = {
 	.name = "mt8188_mt6359",
 };
