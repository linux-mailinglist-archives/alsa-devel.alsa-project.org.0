...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 3ED2D378101
	for <lists+alsa-devel@lfdr.de>; Mon, 10 May 2021 12:14:54 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id AABA916BD;
	Mon, 10 May 2021 12:14:03 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz AABA916BD
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1620641693;
	bh=Lkzd76gexTUpMQPkQVwKbksrYMyEeRWO2bEnQItcuvs=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=KQ/jo8FVGskxvNf6wu4iw+XudsTR6Aup81KW587xRMgOjXwkAxspUSNJH8QjleZG4
	 DMVYgDPedj7X42hlAwj1uU1MZ0zXYdzyGsPQCpR1XjNbTkpg3kbcotGvgBz7TTO+Q1
	 8Cf1vxDBI+ubuQz4kilJRVP83gIC3H9J/uGRaIqY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id E35F8F804AA;
	Mon, 10 May 2021 12:12:42 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 02920F80425; Mon, 10 May 2021 12:12:27 +0200 (CEST)
...
Received: from mail-wm1-x329.google.com (mail-wm1-x329.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 4BEA8F8027B
 for <alsa-devel@alsa-project.org>; Mon, 10 May 2021 12:12:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 4BEA8F8027B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="S/UtbeLa"
Received: by mail-wm1-x329.google.com with SMTP id g65so8846613wmg.2
 for <alsa-devel@alsa-project.org>; Mon, 10 May 2021 03:12:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=+lfD/C2C2BLi2Ysaf1xra/oDC6Irj32BV/INNKLfWIE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=+lfD/C2C2BLi2Ysaf1xra/oDC6Irj32BV/INNKLfWIE=;
 b=
X-Gm-Message-State: AOAM533WV2o5AbxMsdxu8vz1SuK6qiWZmNbnVe7fhz+73pTIh2BXKmbB
 CJOWrrf77sejxWaYHD07vyFvJg==
X-Google-Smtp-Source: ABdhPJyTeWEbX3WLByTY1xyq8ZLgrgLVhjMQvEYVblQRXjsbLU8Wqtu41sYgxjjSzV2AZuGIiL2K2w==
X-Received: by 2002:a05:600c:22c9:: with SMTP id
 9mr25713788wmg.85.1620641535173; 
 Mon, 10 May 2021 03:12:15 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id b7sm22072109wri.83.2021.05.10.03.12.14
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 10 May 2021 03:12:14 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH 2/4] ASoC: codecs: wcd: add multi button Headset detection
 support
Date: Mon, 10 May 2021 11:11:59 +0100
Message-Id: <20210510101201.7281-3-srinivas.kandagatla@linaro.org>
...
index 2a7b3e363069..2faf0809d01f 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -1525,6 +1525,9 @@ config SND_SOC_WCD9335
...
index 0efdba609048..a24bd8247d77 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -250,6 +250,7 @@ snd-soc-twl6040-objs := twl6040.o
...
@@ -572,6 +573,7 @@ obj-$(CONFIG_SND_SOC_TWL6040)	+= snd-soc-twl6040.o
...
index 000000000000..7e1697956037
--- /dev/null
...
+		sprintf(prop_str, "qcom,mbhc-button%d-vthreshold-microvolt", i);
+		ret = of_property_read_u32(np, prop_str, &microvolt);
+		if (ret) /* default voltage */
+			microvolt = 500000;
+
+		/* Micro to Milli Volts */
+		cfg->btn_high[i] = microvolt/1000;
+	}
+
+	return 0;
+}
