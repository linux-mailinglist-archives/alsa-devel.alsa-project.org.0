...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E42B13077EA
	for <lists+alsa-devel@lfdr.de>; Thu, 28 Jan 2021 15:24:01 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 5001D16CA;
	Thu, 28 Jan 2021 15:23:11 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 5001D16CA
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1611843841;
	bh=HBHGPJuKVESOEK0c4fZWnK9+/yr3GMvGH8yq5Tc2ew0=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=bew+nmqvAN4XouPB/KFPq6MHm0sC/WIcRXde/iclR0w0JrakhZBcTZpCf8WLX4kAG
	 ZJNS+8jnboXjmy9UmXX8Ih7CSMkrjgpOiZxpdnQZd9/bjfn8YiALCzSlcCMI5O2x9H
	 s47HwuzDg0U5s9SvxI14q3qgCAbAaO3bSK7ZKEHY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id A2C4FF804FF;
	Thu, 28 Jan 2021 15:20:27 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id A7F52F804DF; Thu, 28 Jan 2021 15:20:18 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=0.7 required=5.0 tests=DKIM_SIGNED,DKIM_VALID,
 DKIM_VALID_AU,SPF_HELO_NONE,UPPERCASE_50_75,URIBL_BLOCKED autolearn=disabled
 version=3.4.0
Received: from mail-wr1-x42e.google.com (mail-wr1-x42e.google.com
 [IPv6:2a00:1450:4864:20::42e])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 7AD1AF800BE
 for <alsa-devel@alsa-project.org>; Thu, 28 Jan 2021 15:20:03 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7AD1AF800BE
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="X9bH2STL"
Received: by mail-wr1-x42e.google.com with SMTP id d16so5532899wro.11
 for <alsa-devel@alsa-project.org>; Thu, 28 Jan 2021 06:20:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=v1Xvuy3gfwr5TpPlmWSqzF0p12mWJHTiiMlIEZNjfGs=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=v1Xvuy3gfwr5TpPlmWSqzF0p12mWJHTiiMlIEZNjfGs=;
 b=
X-Gm-Message-State: AOAM5303tPJSWz906NIVmBRp9HPZC/d6seVAkmiwSXkc6/716pFzsXrb
 F+fTCKCFXHZQiJpR718nczC40g==
X-Google-Smtp-Source: ABdhPJwJX0DCQFnESn/uN0CHoxUp2BFEP8w6ys1AgcGQu/F+40zTG8N28lQ9FNBu7K2SmTQp9U4N4Q==
X-Received: by 2002:adf:f183:: with SMTP id h3mr16897329wro.30.1611843597164; 
 Thu, 28 Jan 2021 06:19:57 -0800 (PST)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id d9sm7257096wrq.74.2021.01.28.06.19.55
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Thu, 28 Jan 2021 06:19:56 -0800 (PST)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH 2/7] ASoC: codec: lpass-rx-macro: add support for lpass rx
 macro
Date: Thu, 28 Jan 2021 14:19:24 +0000
Message-Id: <20210128141929.26573-3-srinivas.kandagatla@linaro.org>
...
index 9bf6bfdaf11e..5dbe2bf2d329 100644
...
index 628b0c9b3e2a..045263122761 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -108,6 +108,7 @@ snd-soc-lm49453-objs := lm49453.o
...
index 000000000000..30f4b7b3189c
--- /dev/null
...
+		CDC_RX_RX0_RX_VOL_MIX_CTL, -84, 40, digital_gain),
+	SOC_SINGLE_S8_TLV("RX_RX1 Mix Digital Volume",
+		CDC_RX_RX1_RX_VOL_MIX_CTL, -84, 40, digital_gain),
+	SOC_SINGLE_S8_TLV("RX_RX2 Mix Digital Volume",
+		CDC_RX_RX2_RX_VOL_MIX_CTL, -84, 40, digital_gain),
+
