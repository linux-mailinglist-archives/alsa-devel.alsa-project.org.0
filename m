...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DAB235F841
	for <lists+alsa-devel@lfdr.de>; Wed, 14 Apr 2021 17:54:38 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id E13D81661;
	Wed, 14 Apr 2021 17:53:47 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz E13D81661
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1618415678;
	bh=AZxh4ypKh5I8apQ7Ve8LVmIpmNmHetsshyIZ1MZjJzg=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=IcPFZ4GHpTiBRP7xv4czc44y4Be56Hr6nBCI1R1g8vzLKalpqMSXTxblq1y66EmGq
	 Dgj7ShXFKOUdzcK9FiOBxemmKMXGvO/34T2TZkGK29Exdq2R6LD6fbN7pwmyUvHGNs
	 DASTp6pWKIwMq+iZkGHI8hffrmd8GZe8nDEPAU9Q=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 12D77F804FA;
	Wed, 14 Apr 2021 17:49:58 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 91DBCF804B0; Wed, 14 Apr 2021 17:49:52 +0200 (CEST)
...
Received: from mail-ed1-x536.google.com (mail-ed1-x536.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 0DA34F8042F
 for <alsa-devel@alsa-project.org>; Wed, 14 Apr 2021 17:49:38 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 0DA34F8042F
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="Lo0ilR04"
Received: by mail-ed1-x536.google.com with SMTP id s15so24307999edd.4
 for <alsa-devel@alsa-project.org>; Wed, 14 Apr 2021 08:49:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=T9HLOgcZp40AQ6hc3XaeZYRZ6ltOwBQbQkNxm+EuytI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=T9HLOgcZp40AQ6hc3XaeZYRZ6ltOwBQbQkNxm+EuytI=;
 b=
X-Gm-Message-State: AOAM531MdDITY8OIR6C7iF/J2fh4qDhiI5PEEW+ug4fWkqYKY11VjpZ4
 OKhhQiUZHpfuhvDwD76pRqy6qw==
X-Google-Smtp-Source: ABdhPJyJImZt4HYtXWZgNQW4dNQjwKxksclFZj/stAutE3k8cULDIRuobkKB4TwNSSG6Lm5Lr7q/LA==
X-Received: by 2002:a05:6402:84b:: with SMTP id
 b11mr41515544edz.56.1618415373250; 
 Wed, 14 Apr 2021 08:49:33 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id q12sm10495540ejy.91.2021.04.14.08.49.32
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Wed, 14 Apr 2021 08:49:32 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v4 8/9] ASoC: codecs: wcd938x: add capture dapm widgets
Date: Wed, 14 Apr 2021 16:48:44 +0100
Message-Id: <20210414154845.21964-9-srinivas.kandagatla@linaro.org>
...
@@ -1915,6 +1989,455 @@ static int wcd938x_codec_enable_ear_pa(struct snd_soc_dapm_widget *w,
 	return 0;
 }
...
+
 ...
 {
@@ -2093,10 +2616,30 @@ static const char * const rx_hph_mode_mux_text[] = {
...
@@ -2127,10 +2670,78 @@ static const struct soc_enum rx_hph_mode_mux_enum =
...
@@ -2147,6 +2758,21 @@ static const struct snd_kcontrol_new hphr_rdac_switch[] = {
 	SOC_DAPM_SINGLE("Switch", SND_SOC_NOPM, 0, 1, 0)
 };
...
@@ -2279,6 +2905,165 @@ static const struct snd_kcontrol_new wcd938x_snd_controls[] = {
 };
