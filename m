...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F01237D69B4
	for <lists+alsa-devel@lfdr.de>; Wed, 25 Oct 2023 13:03:14 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id D189983A;
	Wed, 25 Oct 2023 13:02:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz D189983A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1698231793;
	bh=jR+i2rUwaZ8yaSj6dhOhZpNlyOB7lzl01a4eOriILeg=;
	h=Date:Subject:To:References:From:In-Reply-To:List-Id:List-Archive:
	 List-Help:List-Owner:List-Post:List-Subscribe:List-Unsubscribe:
	 From;
	b=h89AmCqRwm6DihEfuRnCoNiBueflYQ43aTPgJ/7MelP+YBtPVLZinR4PofBBFWTrd
	 DC1xiZliZxF6mD4uSmUnfr+c4idfeydcp6upCHYdOWFzrFI846cze7VMZJ9KzT8VI6
	 ZHbSWVvGOrE8NYbPHIBDLsao4dd9KZEg+54tr9yc=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 49A7DF8019B; Wed, 25 Oct 2023 13:02:23 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id AB697F8012B;
	Wed, 25 Oct 2023 13:02:22 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 11318F80165; Wed, 25 Oct 2023 13:02:18 +0200 (CEST)
...
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
 ...
 SHA256)
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 23276F80152
	for <alsa-devel@alsa-project.org>; Wed, 25 Oct 2023 13:01:55 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 23276F80152
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by ams.source.kernel.org (Postfix) with ESMTP id 93523B82E2C;
	Wed, 25 Oct 2023 11:01:53 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 3D71EC433CA;
	Wed, 25 Oct 2023 11:01:49 +0000 (UTC)
Message-ID: <4432f073-46c3-4d8b-b20d-f518cc0d8647@xs4all.nl>
Date: Wed, 25 Oct 2023 13:01:47 +0200
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Subject: Re: [RFC PATCH v7 12/13] media: imx-asrc: Add memory to memory driver
...
References: <1697794232-2607-1-git-send-email-shengjiu.wang@nxp.com>
 <1697794232-2607-13-git-send-email-shengjiu.wang@nxp.com>
...
In-Reply-To: <1697794232-2607-13-git-send-email-shengjiu.wang@nxp.com>
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 7bit
Message-ID-Hash: 6PUC3PO5MM4LZMH3APGWF3VVHU2GCFCG
X-Message-ID-Hash: 6PUC3PO5MM4LZMH3APGWF3VVHU2GCFCG
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/6PUC3PO5MM4LZMH3APGWF3VVHU2GCFCG/>
List-Archive: 
...
> index 000000000000..b1b5f1bbdf19
> --- /dev/null
...
> +		if (pdata->rate_min == 5512)
> +			new_rate = asrc_v1_m2m_rates[ctrl->val];
> +		else
> +			new_rate = asrc_v2_m2m_rates[ctrl->val];

You can just do:

		new_rate = ctrl->qmenu_int[ctrl->val];

> +		pair->rate[V4L_OUT] = new_rate;
> +		break;
