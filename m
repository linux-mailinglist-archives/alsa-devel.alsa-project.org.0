...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id AA9217226AA
	for <lists+alsa-devel@lfdr.de>; Mon,  5 Jun 2023 14:58:13 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 1EDBB82B;
	Mon,  5 Jun 2023 14:57:23 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 1EDBB82B
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1685969893;
	bh=SRIaMNQfAF3RkVIpuJZbEMatVsNep1p/a2XC/cuRnS8=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=cjIIZJ3Uj2Z7xyUjVI9wlr2G3rD9rD6N2TWyt6AWkDlcRBfjKwsWDEhnKVcJRqdYF
	 w2+7skmDQa1Ot0u8GRf1INSCrwNuBX+o3LAAWfmZDNPM3M+mWb+3I5fKHdBTXmNBGb
	 yRu7PW+2gCwmwkgyirhXG3+nr3xq23fFNIZ8CzDw=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 7861CF805CB; Mon,  5 Jun 2023 14:55:35 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id A61FCF805CA;
	Mon,  5 Jun 2023 14:55:34 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 23969F805B1; Mon,  5 Jun 2023 14:55:28 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 [67.231.149.25])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id D9357F80290
	for <alsa-devel@alsa-project.org>; Mon,  5 Jun 2023 14:55:12 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz D9357F80290
Authentication-Results: alsa1.perex.cz;
	dkim=pass (2048-bit key,
 unprotected) header.d=cirrus.com header.i=@cirrus.com header.a=rsa-sha256
 header.s=PODMain02222019 header.b=D3KvDX8a
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
	by mx0a-001ae601.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id
 355CoAMs020912;
	Mon, 5 Jun 2023 07:55:10 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=TLET5D7k0TwYcIAyw4LZb83jl6EewsPTddF5NpEZVXo=;
 b= pQ==
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
	by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3r02x19tf1-5
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Mon, 05 Jun 2023 07:55:10 -0500
...
Received: from ediswmail.ad.cirrus.com (198.61.86.93) by ediex01.ad.cirrus.com
 ...
 Transport; Mon, 5 Jun 2023 13:55:05 +0100
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
	by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 5A112458;
	Mon,  5 Jun 2023 12:55:05 +0000 (UTC)
...
Subject: [PATCH v3 6/6] ASoC: cs42l43: Add support for the cs42l43
Date: Mon, 5 Jun 2023 13:55:04 +0100
Message-ID: <20230605125504.2570158-7-ckeepax@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: nFkkDd7Q08MBFbUBy64pO-iulFO5RsoX
X-Proofpoint-GUID: nFkkDd7Q08MBFbUBy64pO-iulFO5RsoX
X-Proofpoint-Spam-Reason: safe
Message-ID-Hash: BLNMIMQ3H4D2LTE4ECJ65WLJLBL6DXCK
X-Message-ID-Hash: BLNMIMQ3H4D2LTE4ECJ65WLJLBL6DXCK
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/BLNMIMQ3H4D2LTE4ECJ65WLJLBL6DXCK/>
List-Archive: 
...
Changes since v2:
 - Change bias-sense-ua to bias-sense-microamp
 - Remove NULL check before snd_soc_dai_dma_data_set for soundwire
 - Fix return type on cs42l43_request_irq
 - Correct node passed to device properties
 - Move buttons to a work queue, this was causing some issues where
   button events happen at the same time as a DAPM sequence and the
   button handler waits for the DAPM mutex (snd_soc_jack_report).
   Causing the power up/down IRQs to get blocked and time out.
 - Add a separate bias detect IRQ, using the button IRQ was an issue if
   the button was processed just before the bias detect triggered.
...
Charles
 ...
 7 files changed, 3487 insertions(+)
...
new file mode 100644
index 0000000000000..57839ccdd9a67
--- /dev/null
...
new file mode 100644
index 0000000000000..55ac5fe8c3db8
--- /dev/null
...
new file mode 100644
index 0000000000000..55a79219af354
--- /dev/null
...
new file mode 100644
index 0000000000000..bf4f728eea3e0
--- /dev/null
