...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 5059B715F19
	for <lists+alsa-devel@lfdr.de>; Tue, 30 May 2023 14:24:52 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id CEA50820;
	Tue, 30 May 2023 14:24:01 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz CEA50820
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1685449491;
	bh=77y6nP5m4Gw8hi38hdeTMcfSNt+xhQH5rQ5Sv9pncGc=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=VvjYtWXeXgOQaTB+5je318sZJ+KdelFxwv6UXLn2ZKYgwO8T2IrSWiah7jZH3GlOW
	 Bbk+MEjmHJaDaa8Ne5Ey1JHFPD1ds3ywB7Gh8l62dcsKQGfoBdB089vt+Hofvqpntl
	 t+ipG7h15CJCdZQ76FKEamCeLV2Gu4MYUENxGkeQ=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 98FA1F80549; Tue, 30 May 2023 14:24:01 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id C0939F804FC;
	Tue, 30 May 2023 14:24:00 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id A6C1AF80528; Tue, 30 May 2023 14:23:56 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 [67.231.152.168])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id AD7E7F8053D
	for <alsa-devel@alsa-project.org>; Tue, 30 May 2023 14:21:21 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz AD7E7F8053D
Authentication-Results: alsa1.perex.cz;
	dkim=pass (2048-bit key,
 unprotected) header.d=cirrus.com header.i=@cirrus.com header.a=rsa-sha256
 header.s=PODMain02222019 header.b=SLkeQNG8
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 ...
 bh=4aVAqI1UXgWGJeLFdBNWAE+lw68OR42YV+PpxfMbRlA=;
 b= EQ==
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
	by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 3que9mu7xx-2
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
	by ediswmail.ad.cirrus.com (Postfix) with ESMTP id DFE1115A4;
...
Subject: [PATCH v2 4/6] pinctrl: cs42l43: Add support for the cs42l43
Date: Tue, 30 May 2023 13:21:10 +0100
Message-ID: <20230530122112.1314458-5-ckeepax@opensource.cirrus.com>
...
X-Proofpoint-GUID: ybRT3XTy7VPEQISvUG_jNEzuUZSN5rU_
X-Proofpoint-ORIG-GUID: ybRT3XTy7VPEQISvUG_jNEzuUZSN5rU_
X-Proofpoint-Spam-Reason: safe
Message-ID-Hash: VUN5L252OSPKYC5CIBYB3RYB66C7QHLM
X-Message-ID-Hash: VUN5L252OSPKYC5CIBYB3RYB66C7QHLM
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/VUN5L252OSPKYC5CIBYB3RYB66C7QHLM/>
List-Archive: 
...
Changes since v1:
 - Tidy up code around device_set_node
 - Use same node for GPIO and Pinctrl in binding
 - Re-order include files
 - Move gpio_chip to start of the private struct
 - Use PINCTRL_PINGROUP/PINFUNCTION
 - Add/remove a bunch of commas to arrays
 - Change BUILD_BUG_ONs to static_asserts
 - Use a ternary for value setting in cs42l43_pin_set_mux
 - Remove uneccesary else
 - Use str_on_off
 - Use post increment operator rather than pre inc
 - Use devm_pm_runtime_enable
 - Use dev_err_probe
 - Switch to using a platform_device_id table
 - Use the callback for adding pin ranges
...
index 8d2076941ff36..ed26f63087342 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
