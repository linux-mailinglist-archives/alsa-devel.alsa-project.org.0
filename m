...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id C941A13544
	for <lists+alsa-devel@lfdr.de>; Sat,  4 May 2019 00:11:26 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 543E01830;
	Sat,  4 May 2019 00:10:36 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 543E01830
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1556921486;
	bh=/gW7fcPo74Yn2WUbX0/7G2h4RRlPv36M3cyRbqgPXj0=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=bLizWQf+rifLQCRHvrpXMdX9BMXmCit6ILM5v2aCuTll78xaNEbHwxG+NxrhRb66o
	 2s84Lr3qg3lcpCaz4VyKugcIpcb/keDLDS+juq072x+BAUJmfbPGmxVuvtfKCt8x1p
	 yl9J7UqQ9wyJiK/6HtN0JDiHJw9s1G4qkxCdSnw0=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id B18B4F89760;
	Sat,  4 May 2019 00:03:39 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 29228F89711; Sat,  4 May 2019 00:03:12 +0200 (CEST)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: *
X-Spam-Status: No, score=1.4 required=5.0 tests=DKIM_SIGNED,DKIM_VALID,
 DKIM_VALID_AU,PRX_BODYSUB_5,SPF_PASS,T_DKIMWL_WL_HIGH,URIBL_BLOCKED
 autolearn=disabled version=3.4.0
Received: from mail-pl1-x644.google.com (mail-pl1-x644.google.com
 [IPv6:2607:f8b0:4864:20::644])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 48CB8F89711
 for <alsa-devel@alsa-project.org>; Sat,  4 May 2019 00:02:54 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 48CB8F89711
Authentication-Results: alsa1.perex.cz;
 dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org
 header.b="B6GEnkZt"
Received: by mail-pl1-x644.google.com with SMTP id w20so3323390plq.3
 for <alsa-devel@alsa-project.org>; Fri, 03 May 2019 15:02:54 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=r3rCMyQRuqNEJNAJZNewCbprIO59xrVvdV6v6duMLLg=;
 b=
X-Gm-Message-State: APjAAAWtdwXetRTm6nmYNla95khGh42WB4sMUHZBXgo8nlhgor5VDg4J
 c5NTxniW+74nP5SxktIVgVEz6g==
...
X-Received: by 2002:a17:902:4a:: with SMTP id
 68mr14093554pla.212.1556920973305; 
...
Subject: [alsa-devel] [PATCH v2 06/30] mfd: cros_ec: use BIT macro
