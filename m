...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B7F8653CB4
	for <lists+alsa-devel@lfdr.de>; Thu, 22 Dec 2022 08:54:53 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id A295034DD;
	Thu, 22 Dec 2022 08:54:02 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz A295034DD
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1671695693;
	bh=04Sy29ZoEDN4J4SB5Jk/NtaAqls4MH/k2Vny+DP5U8Y=;
	h=Date:From:To:Subject:References:In-Reply-To:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 Cc:From;
	b=ncobtFx+qAOD1cKwrzyYoFPfX8T4iaUplkIMCcUChVJ0B7S5/WhNyRpiln9au1jf5
	 AQyus9qA5d4lQ0LzSQflJwuIi/d+sp1YwSpDs0iEkthL7+684oKmApvwshWnfCh4uf
	 vOoyl7jCCxeA6hhWB/TI6872HjeidUxUvBJra/kw=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C786AF80553;
	Thu, 22 Dec 2022 08:52:13 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 99E8DF80423; Wed, 21 Dec 2022 05:13:35 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.6 (2021-04-09) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=-4.0 required=5.0 tests=DKIMWL_WL_HIGH,DKIM_SIGNED,
 DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,RCVD_IN_DNSWL_HI,
 RCVD_IN_MSPIKE_H3,RCVD_IN_MSPIKE_WL,SPF_HELO_NONE,SPF_PASS,
 UPPERCASE_75_100,URIBL_BLOCKED shortcircuit=no autolearn=ham
 autolearn_force=no version=3.4.6
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E8F1BF8047B
 for <alsa-devel@alsa-project.org>; Wed, 21 Dec 2022 05:13:21 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E8F1BF8047B
Authentication-Results: alsa1.perex.cz; dkim=pass (2048-bit key,
 unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256
 header.s=Intel header.b=dmd3uVz4
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1671596008; x=1703132008;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=04Sy29ZoEDN4J4SB5Jk/NtaAqls4MH/k2Vny+DP5U8Y=;
 b=dmd3uVz412G2ve3/DrFG79nd3kwBVWhYcRNyx2IspN2jkmcY+YyBkXcL
 NVYNSedctwvBJyjzaPiLOnntSk7o55OKDuC/BT7oXGgctGW9YHMJNXoDd
 UjcEiVgqePKql2godpSV+3pPioiz8o5IeaqFMaDth2ugMeJeOozY0uGFl
 w+7DzFcsW3E8tmW6NaRePoOpAZInVZGx9dJ+GBmJrsYsQTCXzCjPEhtaf
 e9P9WT8MnCbWby93xL1K98K2cdWBdMP8ZIrqxWoIe7z4O3T9vjO7eNbff
 twRgxWu2B/R89468dsBOhII46EMP7/oROjKRGHoCV6tCY7zOhmnUHG8Lg Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10567"; a="346903706"
X-IronPort-AV: E=Sophos;i="5.96,261,1665471600"; d="scan'208";a="346903706"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 20 Dec 2022 20:13:15 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10567"; a="980053275"
X-IronPort-AV: E=Sophos;i="5.96,261,1665471600"; d="scan'208";a="980053275"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
 by fmsmga005.fm.intel.com with ESMTP; 20 Dec 2022 20:13:11 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1p7qTU-0009vi-2A;
 Wed, 21 Dec 2022 04:13:00 +0000
Date: Wed, 21 Dec 2022 12:12:06 +0800
...
Message-ID: <202212211125.4QXhmoUr-lkp@intel.com>
References: <20221220151157.2247-1-luminlong@139.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="A+zEkRey8tbA9LLV"
...
Cc: alsa-devel@alsa-project.org, Kevin Lu <luminlong@139.com>,
 linux-kernel@vger.kernel.org, navada@ti.com, kevin-lu@ti.com,
 shenghao-ding@ti.com, oe-kbuild-all@lists.linux.dev, peeyush@ti.com
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=s390 SHELL=/bin/bash sound/soc/codecs/
...
vim +875 sound/soc/codecs/tas2781-dsp.c
   ...
   806	
   807	static int fw_parse_block_data(struct TFirmware *pFirmware,
   808		struct TBlock *pBlock, const struct firmware *pFW, int offset)
   809	{
   810		unsigned char *pData = (unsigned char *)pFW->data;
   811		int n;
   812	
   813		if (offset + 4 > pFW->size) {
   814			dev_err(pFirmware->dev, "%s: mnType error\n", __func__);
   815			offset = -1;
   816			goto out;
   817		}
   818		pBlock->mnType = SMS_HTONL(pData[offset],
   819			pData[offset + 1], pData[offset + 2], pData[offset + 3]);
   820		offset  += 4;
   821	
   822		if (pFirmware->fw_hdr.mnFixedHdr.mnDriverVersion >=
   823			PPC_DRIVER_CRCCHK) {
   824			if (offset + 1 > pFW->size) {
   825				dev_err(pFirmware->dev, "%s: mbPChkSumPresent error\n",
   826					__func__);
   827				offset = -1;
   828				goto out;
   829			}
   830			pBlock->mbPChkSumPresent = pData[offset];
   831			offset++;
   832	
   833			if (offset + 1 > pFW->size) {
   834				dev_err(pFirmware->dev, "%s: mnPChkSum error\n",
   835					__func__);
   836				offset = -1;
   837				goto out;
   838			}
   839			pBlock->mnPChkSum = pData[offset];
   840			offset++;
   841	
   842			if (offset + 1 > pFW->size) {
   843				dev_err(pFirmware->dev, "%s: mbYChkSumPresent error\n",
   844					__func__);
   845				offset = -1;
   846				goto out;
   847			}
   848			pBlock->mbYChkSumPresent = pData[offset];
   849			offset++;
   850	
   851			if (offset + 1 > pFW->size) {
   852				dev_err(pFirmware->dev, "%s: mnYChkSum error\n",
   853					__func__);
   854				offset = -1;
   855				goto out;
   856			}
   857			pBlock->mnYChkSum = pData[offset];
   858			offset++;
   859		} else {
   860			pBlock->mbPChkSumPresent = 0;
   861			pBlock->mbYChkSumPresent = 0;
   862		}
   863		if (offset + 4 > pFW->size) {
   864			dev_err(pFirmware->dev, "%s: mnCommands error\n", __func__);
   865			offset = -1;
   866			goto out;
   867		}
   868		pBlock->mnCommands = SMS_HTONL(pData[offset],
   869			pData[offset + 1], pData[offset + 2], pData[offset + 3]);
   870		offset  += 4;
   871	
   872		n = pBlock->mnCommands * 4;
   873		if (offset + n > pFW->size) {
   874			dev_err(pFirmware->dev,
 > 875				"%s: File Size(%u) error offset = %d n = %d\n",
   876				__func__, pFW->size, offset, n);
   877			offset = -1;
   878			goto out;
   879		}
   880		pBlock->mpData = kmemdup(&pData[offset], n, GFP_KERNEL);
   881		if (pBlock->mpData == NULL) {
   882			offset = -1;
   883			goto out;
   884		}
   885		offset  += n;
