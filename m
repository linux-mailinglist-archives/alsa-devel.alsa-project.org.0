...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id BA19D6CBB7F
	for <lists+alsa-devel@lfdr.de>; Tue, 28 Mar 2023 11:51:04 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 420E31F0;
	Tue, 28 Mar 2023 11:50:11 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 420E31F0
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1679997061;
	bh=IvpzJfZ5OxvuBcU/n2YDE/SigHd83wwPmuRkD4ud4rI=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=pP86UFUMfHsz6G4GosuTCrYHKhyqZlMUSgoV6tgdlrXpeiHLJWFLCt0ianW3ee2ew
	 9afiO5DSbb3QN6F2CSZ/VVD7A160PKCAv9YhK2M2e94eS0zVKVEVckw8E28MjX0+4W
	 5y02AtZV0UPSs8KwECd0xJGdzJXQQWo6jS5I5TCw=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 9AF1FF8032D;
	Tue, 28 Mar 2023 11:50:10 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 21EEDF80423; Tue, 28 Mar 2023 11:50:06 +0200 (CEST)
...
Received: from n169-112.mail.139.com (n169-112.mail.139.com [120.232.169.112])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 56711F8032D
	for <alsa-devel@alsa-project.org>; Tue, 28 Mar 2023 11:49:59 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 56711F8032D
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[39.144.43.215])
	by rmsmtp-lg-appmail-22-12025 (RichMail) with SMTP id 2ef96422b8399c1-0c205;
	Tue, 28 Mar 2023 17:49:50 +0800 (CST)
X-RM-TRANSID: 2ef96422b8399c1-0c205
From: Shenghao Ding <13916275206@139.com>
To: broonie@kernel.org,
	lgirdwood@gmail.com,
	perex@perex.cz,
	pierre-louis.bossart@linux.intel.com
Subject: [PATCH v9] ASoC: tas2781: Add tas2781 driver
Date: Tue, 28 Mar 2023 17:49:40 +0800
Message-Id: <20230328094940.1796-1-13916275206@139.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: CSBTL5CKH6ETXYABQD4CU2BWZ5PC4Y6X
X-Message-ID-Hash: CSBTL5CKH6ETXYABQD4CU2BWZ5PC4Y6X
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/CSBTL5CKH6ETXYABQD4CU2BWZ5PC4Y6X/>
List-Archive: 
...
---
 ...
 sound/soc/codecs/tas2781-dsp.c | 2154 ++++++++++++++++++++++++++++++++
 sound/soc/codecs/tas2781-dsp.h |  181 +++
 sound/soc/codecs/tas2781-i2c.c | 1622 ++++++++++++++++++++++++
 sound/soc/codecs/tas2781.h     |  159 +++
 6 files changed, 4131 insertions(+)
...
index 000000000000..92080f793d9f
--- /dev/null
...
new file mode 100644
index 000000000000..c8183e5916bc
--- /dev/null
...
+	 * portrait, landscape, etc. Even in multiple audio, one or two of the
+	 * chips should work for special cases. In order to support these
+	 * variable-numbers of audio cases, flexible configs have been
+	 * introduced in the dsp firmware.
+	 */
