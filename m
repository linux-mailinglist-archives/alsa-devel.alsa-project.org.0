...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 5E9C271A31F
	for <lists+alsa-devel@lfdr.de>; Thu,  1 Jun 2023 17:49:52 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9578C823;
	Thu,  1 Jun 2023 17:49:01 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9578C823
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1685634591;
	bh=2If1K3Xf19ZLNLfxh0F1wmFVi8UbuA6mGa/JpLjS5Xo=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=nFWt9XQh5F2weHRx3txGWAsa1LntFy8BxhdOanIKSB/U9JWFlBeqU/yIWPaqzWkEH
	 VKhpCbxg0zIEVwPtIdkIMfnnw4DWX6k0LnSTelmiKFYOEZxQ2OpbnpQvxuMlE1Gc0c
	 2eLqYNZXYycH/0dYV1gdxpQK/J1hRrjVp9oRPrus=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id C7D1EF8057B; Thu,  1 Jun 2023 17:47:55 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id E2595F8047D;
	Thu,  1 Jun 2023 17:47:54 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id A5396F8057A; Thu,  1 Jun 2023 17:47:46 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 [67.231.149.25])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id B453AF800C8
	for <alsa-devel@alsa-project.org>; Thu,  1 Jun 2023 17:47:35 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz B453AF800C8
Authentication-Results: alsa1.perex.cz;
	dkim=pass (2048-bit key,
 unprotected) header.d=cirrus.com header.i=@cirrus.com header.a=rsa-sha256
 header.s=PODMain02222019 header.b=cy5V0DJ5
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 ...
 bh=8VFBq664tJA2mFQa+E65KStmUEjyMNYR8Rg2HD8pp/Y=;
 b= kg==
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
	by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3quf90x42d-1
...
Received: from edi-sw-dsktp-006.ad.cirrus.com (edi-sw-dsktp-006.ad.cirrus.com
 [198.90.251.127])
	by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 4C576475;
...
Subject: [PATCH v4 01/12] ASoC: cs35l56: Move shared data into a common data
 structure
Date: Thu, 1 Jun 2023 16:47:20 +0100
Message-ID: <20230601154731.3210572-2-rf@opensource.cirrus.com>
...
X-Proofpoint-GUID: _wWBxbaeMAcXuxowtjXGhRw014__bCeL
X-Proofpoint-ORIG-GUID: _wWBxbaeMAcXuxowtjXGhRw014__bCeL
X-Proofpoint-Spam-Reason: safe
Message-ID-Hash: X45X4UE4WN5MHCHQ7FJNXENHYJEMRYJF
X-Message-ID-Hash: X45X4UE4WN5MHCHQ7FJNXENHYJEMRYJF
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/X45X4UE4WN5MHCHQ7FJNXENHYJEMRYJF/>
List-Archive: 
...
---
Changes since Mark acked V1:
- The 1-line fix for cs35l56_sdw_interrupt() has been squashed in.
  Mark's ack was conditional on this.
- There was an identical error calling devm_free_irq() in
  cs35l56_remove() which has been fixed in V4. As this is
  a small 1-line bugfix I've carried forward Mark's ack.
---
...
index 2cde78605ba9..98be005b8787 100644
...
index c03f9d3c9a13..7acd0492ecdd 100644
...
@@ -1556,29 +1560,29 @@ int cs35l56_init(struct cs35l56_private *cs35l56)
...
+	cs35l56->base.init_done = true;
 	...
 	return 0;
@@ -1587,26 +1591,26 @@ EXPORT_SYMBOL_NS_GPL(cs35l56_init, SND_SOC_CS35L56_CORE);
