...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4BBED715F10
	for <lists+alsa-devel@lfdr.de>; Tue, 30 May 2023 14:23:23 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 6D748836;
	Tue, 30 May 2023 14:22:32 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 6D748836
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1685449402;
	bh=/sS+tbhgAbGxPyx6lsgpu5UNk+AOYniavKinKRmj1iY=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=jWwWixZ5f56Ne/ZcriKx/OxYGtPSfy1eMPFAqQY1Et1zZubfvhRBKU0etnkAB7ksY
	 xxYbZnXYLPNdPgK65xCbriHV78lK2AJ2S+D4RhkSyaDaur058WDkmHZu3KgzKqcRtg
	 yAFHxa4CBiqX/SYSCogkSu1X/2QOPQ9EAxIqG/I0=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 88146F80587; Tue, 30 May 2023 14:22:01 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 913AEF80579;
	Tue, 30 May 2023 14:22:00 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 20B18F8057A; Tue, 30 May 2023 14:21:55 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com
 [67.231.152.168])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 618A0F8016B
	for <alsa-devel@alsa-project.org>; Tue, 30 May 2023 14:21:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 618A0F8016B
Authentication-Results: alsa1.perex.cz;
	dkim=pass (2048-bit key,
 unprotected) header.d=cirrus.com header.i=@cirrus.com header.a=rsa-sha256
 header.s=PODMain02222019 header.b=AapHVDul
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 ...
 bh=yIMlJvgFtoKzmTAsg92EpBEPYRa7M4jVhiwtOQIkhTc=;
 b= Sg==
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
	by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 3que9mu7xx-3
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
	by ediswmail.ad.cirrus.com (Postfix) with ESMTP id C727945;
...
Subject: [PATCH v2 3/6] mfd: cs42l43: Add support for cs42l43 core driver
Date: Tue, 30 May 2023 13:21:09 +0100
Message-ID: <20230530122112.1314458-4-ckeepax@opensource.cirrus.com>
...
X-Proofpoint-GUID: ToJXNHHRLlS-XH22-0AvzggyyEPWdXbu
X-Proofpoint-ORIG-GUID: ToJXNHHRLlS-XH22-0AvzggyyEPWdXbu
X-Proofpoint-Spam-Reason: safe
Message-ID-Hash: LVYTQCKPQLQC2ZBGDD2DI6UQOQLH2A6B
X-Message-ID-Hash: LVYTQCKPQLQC2ZBGDD2DI6UQOQLH2A6B
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/LVYTQCKPQLQC2ZBGDD2DI6UQOQLH2A6B/>
List-Archive: 
...
Changes since v1:
 - Move second-class IRQ muck into the MFD driver
 - Make regulator names lower case
 - Expand/Add/Update various comments
 - Move pm_runtime_put to after mfd_add_devices
 - Drop pm reference on the error path in suspend
 - Avoid casting away const in mcu_load_firmware
 - Use dev_err_probe
 - Move cs42l43_patch_header to be at the top of the file
 - Remove most of the debug prints
 - Use devm_pm_runtime_enable
 - Switch to plain probe rather than probe_new for I2C, now the
   migration is done
