...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 89654584DDF
	for <lists+alsa-devel@lfdr.de>; Fri, 29 Jul 2022 11:10:19 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C647A1666;
	Fri, 29 Jul 2022 11:09:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C647A1666
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1659085818;
	bh=kcYC3nGiTXw2NPgpELt8J4vNb0iez/NfuQUXVh0A97w=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=X4yFkkKBVic+ZnF1DaLvAOyYqvIgGTbmflTbP7oZh6qSt9J0DgnnzL3CTbjByG7zQ
	 KH5zQ3yh97vqs3WxSvRDJMYgE8xvrcerPYUPEk4bY6mY0YtmXi/7uPieF430pbTcIw
	 dQv+h/jt19ozGrlJE7pBUkpVp9kdTDvJUA1AEMcA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 30F3CF804B1;
	Fri, 29 Jul 2022 11:09:19 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 9931FF804B1; Fri, 29 Jul 2022 11:09:17 +0200 (CEST)
...
Received: from mail-pg1-x534.google.com (mail-pg1-x534.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 5F305F8015B
 for <alsa-devel@alsa-project.org>; Fri, 29 Jul 2022 11:09:09 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 5F305F8015B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="iO1PJJwo"
Received: by mail-pg1-x534.google.com with SMTP id s206so3563505pgs.3
 for <alsa-devel@alsa-project.org>; Fri, 29 Jul 2022 02:09:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=content-transfer-encoding:mime-version:message-id:date:subject:cc
 :to:from:from:to:cc;
 bh=zJ/Wsy0TjVxEvzaOJhSamgwJIFhieFDNkT4T5GS3FsE=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=zJ/Wsy0TjVxEvzaOJhSamgwJIFhieFDNkT4T5GS3FsE=;
 b=
X-Gm-Message-State: AJIora+vvp2JcY4y//8GZZBCR1z5M2gZ/+LEu6JUDbOnwDibWj5sGwZy
 uktTAWRA0ADz31HfRECgsyDRyx1tWT3i+j/5
X-Google-Smtp-Source: AGRyM1uT/UZrcCaPNnuEYsbkeBY4is0nsoVdReNAkSj6JJBPkJaZ2WhlzLrd0tdrCQ+du4KvyNu2CQ==
X-Received: by 2002:a63:2a0e:0:b0:41a:f82d:72f6 with SMTP id
 q14-20020a632a0e000000b0041af82d72f6mr2203160pgq.42.1659085746287; 
 Fri, 29 Jul 2022 02:09:06 -0700 (PDT)
Received: from a-VirtualBox.. ([116.233.75.140])
 by smtp.gmail.com with ESMTPSA id
 s3-20020a170902ea0300b0016d763967f8sm2954832plg.107.2022.07.29.02.09.02
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 29 Jul 2022 02:09:05 -0700 (PDT)
From: Zhu Ning <zhuning0077@gmail.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH v4 1/2] ASoC: codecs: add support for ES8326
Date: Fri, 29 Jul 2022 17:08:56 +0800
Message-Id: <20220729090857.579785-1-zhuning0077@gmail.com>
...
1. remove sysconstrains
2. remove check for null mclk
3. add button detection
3. add properity for reg 58 & 59
-----
v3 changes since v2
1. remove .non_legacy_dai_naming flag
---
 sound/soc/codecs/Kconfig  |   5 +
 sound/soc/codecs/Makefile |   2 +
 sound/soc/codecs/es8326.c | 908 ++++++++++++++++++++++++++++++++++++++
...
index 000000000000..ac6ed27adad7
--- /dev/null
...
+
+	/* set iface & srate */
+	snd_soc_component_update_bits(component, ES8326_FMT_13, ES8326_DATA_LEN_MASK, srate);
+
+	if (coeff >= 0) {
...
+						ES8326_ADC1_SRC_2A, es8326->mic1_src);
+			} else {
...
+	regmap_write(es8326->regmap, ES8326_INT_SOURCE_58, es8326->interrupt_src);
+	regmap_write(es8326->regmap, ES8326_INTOUT_IO_59, es8326->interrupt_clk);
+	regmap_write(es8326->regmap, ES8326_RESET_00, ES8326_CSM_ON);
+	snd_soc_component_update_bits(component, ES8326_PGAGAIN_23,
+				      ES8326_MIC_SEL_MASK, ES8326_MIC1_SEL);
+	if ((reg & ES8326_VERSION_B) == 1) {
+		regmap_write(es8326->regmap, ES8326_ANA_MICBIAS_1B, 0xDD);
+		regmap_write(es8326->regmap, ES8326_ANA_VSEL_1C, 0x7F);
+		regmap_write(es8326->regmap, ES8326_VMIDLOW_22, 0x0F);
+		/* enable button detect */
+		regmap_write(es8326->regmap, ES8326_HP_DRIVER_24, 0xA0);
+	}
+
...
+		es8326->interrupt_src = ES8326_INT_SRC_PIN9;
+	}
...
new file mode 100755
index 000000000000..717f3fd42372
--- /dev/null
