...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 087C23DBC3C
	for <lists+alsa-devel@lfdr.de>; Fri, 30 Jul 2021 17:25:28 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9285F2009;
	Fri, 30 Jul 2021 17:24:37 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9285F2009
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1627658727;
	bh=BkoSTNwjU83IeM3qQlU/Pd6MiaKatKrVWzXhhx/7OdA=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=SCa4zS+/C4724M2l7cZrJybcSwzQY2iQbNN+mEAZaXUl3hpOBJFXU2hX1X9llTlBt
	 ymbubV/18tnQGP1YkjOmOG1t0AC7clsFifMV5HyyZO6u0NVVzPwiDORCx9+7ztq+gD
	 PxWanxqpcoeEeaFj8rmpQ8ghNhTK89BMIbDROuTs=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id CAC51F804ED;
	Fri, 30 Jul 2021 17:19:59 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 92128F80551; Fri, 30 Jul 2021 17:19:50 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C60DAF804E0
 for <alsa-devel@alsa-project.org>; Fri, 30 Jul 2021 17:19:22 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C60DAF804E0
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="FkrkjIHr"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.16.1.2/8.16.1.2) with SMTP id 16UEL0di003614; 
 Fri, 30 Jul 2021 10:19:20 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=bvS5KnTgjT/Y5vjLZdH2CwYK1XiKXkelSdNR140qxX8=;
 b= sQ== 
Received: from ediex01.ad.cirrus.com ([87.246.76.36])
 by mx0a-001ae601.pphosted.com with ESMTP id 3a41wd181n-9
...
Received: from vitaly-Inspiron-5415.ad.cirrus.com (unknown [198.90.238.32])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id BD01545D;
 Fri, 30 Jul 2021 15:19:10 +0000 (UTC)
From: Vitaly Rodionov <vitalyr@opensource.cirrus.com>
To: Jaroslav Kysela <perex@perex.cz>, Takashi Iwai <tiwai@suse.com>
Subject: [PATCH v3 18/27] ALSA: hda/cs8409: Move codec properties to its own
 struct
Date: Fri, 30 Jul 2021 16:18:35 +0100
Message-ID: <20210730151844.7873-19-vitalyr@opensource.cirrus.com>
...
X-Proofpoint-GUID: RLhzP2K0xPeHTrXQWRbubq6S20yQytTD
X-Proofpoint-ORIG-GUID: RLhzP2K0xPeHTrXQWRbubq6S20yQytTD
...
index 257dd9006786..4b4f4dc54617 100644
--- a/sound/pci/hda/patch_cs8409.c
+++ b/sound/pci/hda/patch_cs8409.c
@@ -164,20 +164,20 @@ static void cs8409_set_i2c_dev_addr(struct hda_codec *codec, unsigned int addr)
...
+		scodec->last_page = i2c_reg >> 8;
 	...
 	return 0;
@@ -185,31 +185,27 @@ static int cs8409_i2c_set_page(struct hda_codec *codec, unsigned int i2c_reg)
...
@@ -224,34 +220,34 @@ static int cs8409_i2c_read(struct hda_codec *codec, unsigned int i2c_address, un
...
@@ -269,39 +265,34 @@ static int cs8409_i2c_bulk_read(struct hda_codec *codec, unsigned int i2c_addres
...
@@ -314,34 +305,35 @@ static int cs8409_i2c_write(struct hda_codec *codec, unsigned int i2c_address, u
...
@@ -357,7 +349,7 @@ static int cs8409_i2c_bulk_write(struct hda_codec *codec, unsigned int i2c_addre
...
@@ -450,6 +442,7 @@ int cs42l42_volume_get(struct snd_kcontrol *kctrl, struct snd_ctl_elem_value *uc
 {
...
@@ -457,13 +450,13 @@ int cs42l42_volume_get(struct snd_kcontrol *kctrl, struct snd_ctl_elem_value *uc
 	switch (ofs) {
...
+			*valp = cs42l42->vol[ofs];
 	...
 	default:
 		break;
@@ -476,6 +469,7 @@ int cs42l42_volume_put(struct snd_kcontrol *kctrl, struct snd_ctl_elem_value *uc
 {
 	struct hda_codec *codec = snd_kcontrol_chip(kctrl);
 	struct cs8409_spec *spec = codec->spec;
+	struct sub_codec *cs42l42 = spec->scodecs[get_amp_index(kctrl)];
 	...
 	unsigned int ofs = get_amp_offset(kctrl);
 	long *valp = uctrl->value.integer.value;
@@ -483,23 +477,23 @@ int cs42l42_volume_put(struct snd_kcontrol *kctrl, struct snd_ctl_elem_value *uc
 	switch (ofs) {
 	case CS42L42_VOL_DAC:
 		if (chs & BIT(0)) {
-			spec->vol[ofs] = *valp;
...
+					 cs42l42->vol[ofs] & CS42L42_REG_AMIC_VOL_MASK);
 		...
 		break;
 	default:
@@ -510,54 +504,45 @@ int cs42l42_volume_put(struct snd_kcontrol *kctrl, struct snd_ctl_elem_value *uc
 }
...
-	struct cs8409_spec *spec = codec->spec;
 	...
 	int reg_cdc_status;
 	int reg_hs_status;
@@ -565,9 +550,9 @@ static int cs42l42_jack_unsol_event(struct hda_codec *codec)
 	int type;
...
@@ -577,45 +562,45 @@ static int cs42l42_jack_unsol_event(struct hda_codec *codec)
...
@@ -629,10 +614,8 @@ static int cs42l42_jack_unsol_event(struct hda_codec *codec)
...
-	struct cs8409_spec *spec = codec->spec;
 	struct cs8409_i2c_param irq_regs[] = {
 		{ 0x1308, 0x00 },
 		{ 0x1309, 0x00 },
@@ -640,27 +623,35 @@ static void cs42l42_reset(struct hda_codec *codec)
 		{ 0x130F, 0x00 },
 	};
...
@@ -684,9 +675,10 @@ static void cs8409_free(struct hda_codec *codec)
...
@@ -694,12 +686,12 @@ static void cs8409_jack_unsol_event(struct hda_codec *codec, unsigned int res)
...
+				    cs42l42->hp_jack_in ? 0 : PIN_OUT);
 		...
 		if (jk)
@@ -721,9 +713,7 @@ static int cs8409_cs42l42_suspend(struct hda_codec *codec)
...
+	cs42l42_suspend(spec->scodecs[CS8409_CODEC0]);
 	...
 	snd_hda_codec_write(codec, CS8409_PIN_AFG, 0, AC_VERB_SET_GPIO_DATA, 0);
@@ -742,6 +732,7 @@ static void cs8409_cs42l42_hw_init(struct hda_codec *codec)
...
@@ -755,33 +746,21 @@ static void cs8409_cs42l42_hw_init(struct hda_codec *codec)
 	for (; seq->nid; seq++)
...
@@ -792,7 +771,7 @@ static const struct hda_codec_ops cs8409_cs42l42_patch_ops = {
...
+	.unsol_event = cs8409_cs42l42_jack_unsol_event,
 ...
 #endif
@@ -803,6 +782,7 @@ static int cs8409_cs42l42_exec_verb(struct hdac_device *dev, unsigned int cmd, u
 {
...
@@ -815,18 +795,16 @@ static int cs8409_cs42l42_exec_verb(struct hdac_device *dev, unsigned int cmd, u
 	switch (nid) {
...
@@ -845,6 +823,9 @@ void cs8409_cs42l42_fixups(struct hda_codec *codec, const struct hda_fixup *fix,
...
@@ -852,21 +833,38 @@ void cs8409_cs42l42_fixups(struct hda_codec *codec, const struct hda_fixup *fix,
...
@@ -890,7 +888,7 @@ void cs8409_cs42l42_fixups(struct hda_codec *codec, const struct hda_fixup *fix,
