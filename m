...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 040A0AEB8E6
	for <lists+alsa-devel@lfdr.de>; Fri, 27 Jun 2025 15:28:53 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [45.14.194.44])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id DA1E660338;
	Fri, 27 Jun 2025 15:28:41 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz DA1E660338
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1751030931;
	bh=RWTjcc4uDwjzTdpZBFpBXYj4AwLbWxQQotte3d/VlzA=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=iGAWUVwBWAsyoJLCXBjHM+5IIfhduJDBwj+WHBQmP3QPZcmro9LQQvLPFxYYtH53r
	 XjYBxLNAK7te4OqTrPb3c/vlKuMis729pnVHqMuvN438hOHj3/y8ew+tbAeU5NAmvi
	 RFDdYiOHgcnBVS5jjCNsMhBVPzYZDOcCD7UoQP3s=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 48F28F80C7D; Fri, 27 Jun 2025 15:24:42 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 47AFEF80C79;
	Fri, 27 Jun 2025 15:24:42 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id D647BF8016E; Thu, 26 Jun 2025 20:14:11 +0200 (CEST)
...
Received: from lelvem-ot02.ext.ti.com (lelvem-ot02.ext.ti.com [198.47.23.235])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 9F243F80124
	for <alsa-devel@alsa-project.org>; Thu, 26 Jun 2025 20:14:06 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 9F243F80124
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=Lv/0HJjI
Received: from fllvem-sh03.itg.ti.com ([10.64.41.86])
	by lelvem-ot02.ext.ti.com (8.15.2/8.15.2) with ESMTP id 55QIE5DW2501787;
	Thu, 26 Jun 2025 13:14:05 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1750961645;
	bh=07H+uiSHOzby1+IjPMdbcoR8L/doif+tx9eANFmaptU=;
	h=From:To:CC:Subject:Date:In-Reply-To:References;
	b=Lv/0HJjIfiYi2HAAJ14Y9/z9UhINM4of5XHok0CWpMcGTAHSvommA+KrJh+D/MjSc
	 wFEemEvZtW0N3cXYTNfywRLNpg0nx4br4zYJf2oAjXsc+4pRFecrmOHeex2gTHwKnJ
	 ZlR3EX9j6KWUf0i+q/iiASz3VYylQyt+vYFeCf9g=
Received: from DFLE107.ent.ti.com (dfle107.ent.ti.com [10.64.6.28])
	by fllvem-sh03.itg.ti.com (8.18.1/8.18.1) with ESMTPS id 55QIE54B2215968
...
Received: from DFLE100.ent.ti.com (10.64.6.21) by DFLE107.ent.ti.com
 ...
 Jun 2025 13:14:04 -0500
Received: from lelvem-mr05.itg.ti.com (10.180.75.9) by DFLE100.ent.ti.com
 (10.64.6.21) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.55 via
 Frontend Transport; Thu, 26 Jun 2025 13:14:04 -0500
Received: from LTPW0EX92E.dhcp.ti.com ([10.249.133.122])
	by lelvem-mr05.itg.ti.com (8.18.1/8.18.1) with ESMTP id 55QIDr671713573;
	Thu, 26 Jun 2025 13:14:00 -0500
...
Subject: [PATCH v3 1/4] ASoc: tac5x1x: add codec driver tac5x1x family
Date: Thu, 26 Jun 2025 23:43:30 +0530
Message-ID: <20250626181334.1200-2-niranjan.hy@ti.com>
...
Message-ID-Hash: JBN5EO7ZATELAGELYYQGQXO4ANJRGNW2
X-Message-ID-Hash: JBN5EO7ZATELAGELYYQGQXO4ANJRGNW2
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/JBN5EO7ZATELAGELYYQGQXO4ANJRGNW2/>
List-Archive: 
...
v3:
- dev_err to dev_dbg for interrupt and return IRQ_NONE on latch read error
- Removed read only mixer control to check the GPIO settings
- Removed pdm data in pin selection from mixer control and moved the
  configuration to dts
- moved the reset to i2c_probe
- refactored the device initialisation code
- replace dev_err with dev_dbg for the non-mandatory dts entry parse errors
- made tac5x1x_of_match as static
---
 sound/soc/codecs/Kconfig       |   12 +
 sound/soc/codecs/Makefile      |    2 +
 sound/soc/codecs/tac5x1x-i2c.c | 2137 ++++++++++++++++++++++++++++++++
 sound/soc/codecs/tac5x1x.h     |  300 +++++
 4 files changed, 2451 insertions(+)
...
index 000000000000..ed1fd60f644e
--- /dev/null
...
+
+	{"ADC Power", NULL, "CH1_PDM_EN"},
+	{"ADC Power", NULL, "CH3_PDM_EN"},
+
