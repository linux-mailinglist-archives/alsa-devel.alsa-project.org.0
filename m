...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0BDB229175
	for <lists+alsa-devel@lfdr.de>; Fri, 24 May 2019 09:05:10 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 78D99169F;
	Fri, 24 May 2019 09:04:19 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 78D99169F
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1558681509;
	bh=VgXSAO/CgBeN7SJIrMFFZ2u3cWcRERDP8mdZl499L/U=;
	h=From:To:Date:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=nPy0mKCGNUGLuTLjuAlNgowoP0Y7W/ku9VlEdx9+zn6mIlUJLZIYvN+hOnw40IjAE
	 /8pEUAtd+rEHF2jt9OoIlTsZKAYtoWc6WJlqDU31h7MM7HQW4voLjZgT/vRazQ2IZo
	 pbDg2ThRgWd8QW0DG277Or8d3glWwQM8XoJOANEM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id CD1B5F89625;
	Fri, 24 May 2019 09:03:24 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 3BA65F89630; Fri, 24 May 2019 09:03:23 +0200 (CEST)
...
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 074C5F80C0F
 for <alsa-devel@alsa-project.org>; Fri, 24 May 2019 09:03:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 074C5F80C0F
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga104.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 24 May 2019 00:03:15 -0700
X-ExtLoop1: 1
Received: from younglee-svr.sh.intel.com ([10.239.159.31])
 by FMSMGA003.fm.intel.com with ESMTP; 24 May 2019 00:03:14 -0700
From: libin.yang@intel.com
To: alsa-devel@alsa-project.org
Date: Fri, 24 May 2019 14:43:06 +0800
Message-Id: <1558680186-12994-1-git-send-email-libin.yang@intel.com>
...
@@ -176,33 +177,24 @@ static void hdac_hdmi_jack_report(struct hdac_hdmi_pcm *pcm,
 	else
...
-	snd_soc_dapm_sync(port->dapm);
 ...
 /* MST supported verbs */
@@ -855,7 +847,6 @@ static int hdac_hdmi_pin_mux_widget_event(struct snd_soc_dapm_widget *w,
...
@@ -865,6 +856,7 @@ static int hdac_hdmi_set_pin_port_mux(struct snd_kcontrol *kcontrol,
...
+	int ret;
 	...
 	if (ret < 0)
@@ -880,13 +872,12 @@ static int hdac_hdmi_set_pin_port_mux(struct snd_kcontrol *kcontrol,
...
@@ -895,7 +886,6 @@ static int hdac_hdmi_set_pin_port_mux(struct snd_kcontrol *kcontrol,
...
@@ -1247,27 +1237,18 @@ static void hdac_hdmi_present_sense(struct hdac_hdmi_pin *pin,
 	}
...
@@ -1664,6 +1646,30 @@ static int create_fill_jack_kcontrols(struct snd_soc_card *card,
...
+
 int hdac_hdmi_jack_port_init(struct snd_soc_component *component,
 			struct snd_soc_dapm_context *dapm)
 {
@@ -1673,6 +1679,7 @@ int hdac_hdmi_jack_port_init(struct snd_soc_component *component,
...
@@ -1701,6 +1708,23 @@ int hdac_hdmi_jack_port_init(struct snd_soc_component *component,
...
@@ -1708,6 +1732,8 @@ int hdac_hdmi_jack_port_init(struct snd_soc_component *component,
 			i++;
 		}
 	}
...
@@ -1739,6 +1765,10 @@ int hdac_hdmi_jack_port_init(struct snd_soc_component *component,
 }
...
+ */
 int hdac_hdmi_jack_init(struct snd_soc_dai *dai, int device,
 				struct snd_soc_jack *jack)
 {
@@ -1758,8 +1788,6 @@ int hdac_hdmi_jack_init(struct snd_soc_dai *dai, int device,
 		return -ENOMEM;
 	pcm->pcm_id = device;
...
@@ -1779,30 +1807,6 @@ int hdac_hdmi_jack_init(struct snd_soc_dai *dai, int device,
 }
...
@@ -1837,7 +1841,6 @@ static int hdmi_codec_probe(struct snd_soc_component *component)
 		return ret;
 	}
