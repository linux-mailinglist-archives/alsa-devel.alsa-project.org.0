...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 910923DEEA2
	for <lists+alsa-devel@lfdr.de>; Tue,  3 Aug 2021 15:00:56 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id AEECE17D3;
	Tue,  3 Aug 2021 15:00:05 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz AEECE17D3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1627995655;
	bh=Zg6CEGRR6BTDx8UoU7l33EJyTPqaUEU6Yne0Z2FZjcQ=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=u7PMW/75x91YjdUSW4WdRiSzhKKIuQy30ZTznl1bhyLmijJ3O755T4gqwG+/7meHN
	 7bQcpr16kitdGtiiqREx57y05hf0Xoip1NESxb0cj3xgZl5eKw91Ukw9sBvRZod/Zz
	 ye+4GjD7yb+FmLsLMPVJTzX8ZBTavDeZGHoA1wQA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 540B7F8055A;
	Tue,  3 Aug 2021 14:54:54 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id EBA94F80549; Tue,  3 Aug 2021 14:54:50 +0200 (CEST)
...
Received: from mail-wm1-x32c.google.com (mail-wm1-x32c.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id A33E6F804FE
 for <alsa-devel@alsa-project.org>; Tue,  3 Aug 2021 14:54:39 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz A33E6F804FE
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="MhdsKOGJ"
Received: by mail-wm1-x32c.google.com with SMTP id u15so12425424wmj.1
 for <alsa-devel@alsa-project.org>; Tue, 03 Aug 2021 05:54:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=blPWAPCpJdmyEDySDnGxq6NZLZh6XUL6U3iXcoVFBkc=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=blPWAPCpJdmyEDySDnGxq6NZLZh6XUL6U3iXcoVFBkc=;
 b=
X-Gm-Message-State: AOAM531x12ugE253aiUgAPvGrxPp7Cy31eutAwIvV6o9a86iwOQxYN65
 RVSuvSTP91Aw9SNJb6ZarON/9g==
X-Google-Smtp-Source: ABdhPJzReCb1j8sQONW/WifI4KVzkIJYTWDhxidX/TtU98v9q0585OYVMyH+EFAn3+6IUvpYwLXmlw==
X-Received: by 2002:a7b:ce89:: with SMTP id q9mr21174808wmj.156.1627995278616; 
 Tue, 03 Aug 2021 05:54:38 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id h14sm14695574wrp.55.2021.08.03.05.54.37
...
To: bjorn.andersson@linaro.org,
	broonie@kernel.org,
	robh@kernel.org
Subject: [PATCH v3 14/20] ASoC: qdsp6: audioreach: add q6apm support
Date: Tue,  3 Aug 2021 13:54:05 +0100
Message-Id: <20210803125411.28066-15-srinivas.kandagatla@linaro.org>
...
---
 ...
 sound/soc/qcom/qdsp6/q6apm.c      | 662 ++++++++++++++++++++++++++++++
...
index d3fb677f00b3..b6e7f905736d 100644
...
index af8fdf190740..d4d8c4b6850f 100644
...
+#include "q6apm.h"
 ...
 /* SubGraph Config */
@@ -275,3 +276,307 @@ void *audioreach_alloc_apm_cmd_pkt(int pkt_size, uint32_t opcode,
 				       true);
 }
...
index 1c463281d59a..362b721ae51a 100644
...
+
 ...
 void *audioreach_alloc_apm_cmd_pkt(int pkt_size, uint32_t opcode, uint32_t
 				    token);
@@ -631,4 +648,17 @@ void *audioreach_alloc_apm_pkt(int pkt_size, uint32_t opcode, uint32_t token,
 				uint32_t src_port);
...
new file mode 100644
index 000000000000..e1c9a06fd27a
--- /dev/null
