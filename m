...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E30C1387B77
	for <lists+alsa-devel@lfdr.de>; Tue, 18 May 2021 16:42:48 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 64D1B172F;
	Tue, 18 May 2021 16:41:58 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 64D1B172F
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1621348968;
	bh=yImsuObuj8z0DaMuVlqQ80pu2feVlJaST/dg8pJbn90=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=nLNqBzrIVm84Z2eh3rVyG4O/MvxKYxJd3Trz5OJ7swAoo/qGqSFY1udhFvsH122Ei
	 1ZmckFCxzECVDzAl9sY4ZBhmyz8QnATd92fMhFTroyRUT/597+BpJqqMS6I24T7Xxi
	 dOClSfsQBBpq+rSO6DX3pxqoY9yX64PVDL2zlJtI=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id F2EC2F804ED;
	Tue, 18 May 2021 16:38:34 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 49E4CF804D8; Tue, 18 May 2021 16:38:31 +0200 (CEST)
...
Received: from mail-wr1-x431.google.com (mail-wr1-x431.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C24A7F80430
 for <alsa-devel@alsa-project.org>; Tue, 18 May 2021 16:38:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C24A7F80430
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="yVIOzJxy"
Received: by mail-wr1-x431.google.com with SMTP id v12so10508680wrq.6
 for <alsa-devel@alsa-project.org>; Tue, 18 May 2021 07:38:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=y5vVcCFgdkk2LEblcSpgWjbkieexDzzzVOaMAwBHoVI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=y5vVcCFgdkk2LEblcSpgWjbkieexDzzzVOaMAwBHoVI=;
 b=
X-Gm-Message-State: AOAM5315clYjT+bSwh7LAX2cfN2A+HDVOOmgjL4YuaXsm6/DoHohEGZM
 uvRvL8bPAKHc7uhypGtvq0G6Lw==
X-Google-Smtp-Source: ABdhPJwYFekOKDB1iyOsfoERVVNZaP0cDgrniEQK64Nx4znpIxGd3wblsCiNmCXyujaZDVFrJskCtg==
X-Received: by 2002:a5d:4151:: with SMTP id c17mr7614482wrq.262.1621348694789; 
 Tue, 18 May 2021 07:38:14 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id m6sm21329087wrp.29.2021.05.18.07.38.13
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 18 May 2021 07:38:14 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v6 8/9] ASoC: codecs: wcd938x: add capture dapm widgets
Date: Tue, 18 May 2021 15:37:58 +0100
Message-Id: <20210518143759.16837-9-srinivas.kandagatla@linaro.org>
...
index 26ff795d5e09..dfd14b223bff 100644
...
@@ -1241,6 +1251,70 @@ static struct regmap_irq_chip wcd938x_regmap_irq_chip = {
 	.irq_drv_data = NULL,
 };
...
@@ -1916,6 +1990,455 @@ static int wcd938x_codec_enable_ear_pa(struct snd_soc_dapm_widget *w,
 	return 0;
 }
...
+	int rate;
+
+	bank = (wcd938x_swr_slv_get_current_bank(wcd938x->sdw_priv[AIF1_CAP])) ? 0 : 1;
+	bank = bank ? 0 : 1;
+
+	switch (event) {
+	case SND_SOC_DAPM_PRE_PMU:
...
+
 ...
 {
@@ -2094,10 +2617,30 @@ static const char * const rx_hph_mode_mux_text[] = {
...
@@ -2128,10 +2671,78 @@ static const struct soc_enum rx_hph_mode_mux_enum =
...
@@ -2148,6 +2759,21 @@ static const struct snd_kcontrol_new hphr_rdac_switch[] = {
 	SOC_DAPM_SINGLE("Switch", SND_SOC_NOPM, 0, 1, 0)
 };
...
@@ -2280,6 +2906,165 @@ static const struct snd_kcontrol_new wcd938x_snd_controls[] = {
 };
