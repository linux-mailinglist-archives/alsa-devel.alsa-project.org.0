...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 116C86F3D18
	for <lists+alsa-devel@lfdr.de>; Tue,  2 May 2023 07:39:56 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 2451218DB;
	Tue,  2 May 2023 07:39:05 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 2451218DB
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1683005995;
	bh=IdX/y4x4SIjh/AXvtgEYHD+/UpJI0RCxjv4SjIkz4E0=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=TlHDhhLv1I8QmosZ97rA2Esno1akUR6pdAV80j3B7T5QmvgsI1nD/dwvhqLFyTWEM
	 acGbgvvHzUMrb6hBmdnPxKzhjbO1kFpU6ZcadL0ep35duwbHmXM4BWrOajofbnnKvL
	 cRvjCDZS8VXD8wIyqiLcmTPGKA00kpw3McuYJTcE=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 5D94CF8053D;
	Tue,  2 May 2023 07:38:18 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 0E29AF804B1; Tue,  2 May 2023 07:36:59 +0200 (CEST)
X-Spam-Checker-Version: SpamAssassin 3.4.6 (2021-04-09) on alsa1.perex.cz
X-Spam-Level: 
X-Spam-Status: No, score=-4.1 required=5.0 tests=FREEMAIL_ENVFROM_END_DIGIT,
	FREEMAIL_FROM,FROM_LOCAL_DIGITS,FROM_LOCAL_HEX,RCVD_IN_DNSWL_HI,
	SPF_HELO_NONE,SPOOFED_FREEMAIL,T_SCC_BODY_TEXT_LINE,URIBL_BLOCKED
	shortcircuit=no autolearn=ham autolearn_force=no version=3.4.6
Received: from n169-110.mail.139.com (n169-110.mail.139.com [120.232.169.110])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 1A903F800EC
	for <alsa-devel@alsa-project.org>; Tue,  2 May 2023 07:33:06 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 1A903F800EC
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[183.194.159.16])
	by rmsmtp-lg-appmail-08-12086 (RichMail) with SMTP id 2f366450a08ce66-e30b6;
	Tue, 02 May 2023 13:33:02 +0800 (CST)
X-RM-TRANSID: 2f366450a08ce66-e30b6
From: Shenghao Ding <13916275206@139.com>
To: broonie@kernel.org,
	lgirdwood@gmail.com,
	perex@perex.cz,
	pierre-louis.bossart@linux.intel.com
Subject: [PATCH v1 4/5] ASoC: tas2781: Add tas2781 driver
Date: Tue,  2 May 2023 13:32:54 +0800
Message-Id: <20230502053254.27085-1-13916275206@139.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: GR25HBMOBGSZROMYWYV6H7TUJERN3ABU
X-Message-ID-Hash: GR25HBMOBGSZROMYWYV6H7TUJERN3ABU
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/GR25HBMOBGSZROMYWYV6H7TUJERN3ABU/>
List-Archive: 
