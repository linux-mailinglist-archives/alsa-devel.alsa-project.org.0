...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id D0BE03DEEA3
	for <lists+alsa-devel@lfdr.de>; Tue,  3 Aug 2021 15:01:31 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 1159317D9;
	Tue,  3 Aug 2021 15:00:41 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 1159317D9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1627995691;
	bh=/5F6S2CXlEfXFmoO2qotJR2tD+fmhQ7Dy1QI8yFPgCE=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=RTdaVgePIasFTSZk5Vo3dZlN/pbL2L+g/4cRE454JLBnS6MZy0gbWrCxipsv2/gmT
	 8RB4ivUP4RNE9t7xEQZIw+j3ZXuH0/7STsxc9XWudjXNnJI3TTn/M2l6kJs0rXrzuu
	 B602aLG8Dev2GRRebpibte4ETUds/FLtDHjCG8g4=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id A2EDFF8057C;
	Tue,  3 Aug 2021 14:54:56 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 6738EF80552; Tue,  3 Aug 2021 14:54:52 +0200 (CEST)
...
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 396B6F804FB
 for <alsa-devel@alsa-project.org>; Tue,  3 Aug 2021 14:54:37 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 396B6F804FB
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="V8+gDqWT"
Received: by mail-wr1-x435.google.com with SMTP id h13so11740405wrp.1
 for <alsa-devel@alsa-project.org>; Tue, 03 Aug 2021 05:54:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=4HvAMtHSOLDxkx7bO/q0qud/QYRpwFZw9Ab+V1zsu18=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=4HvAMtHSOLDxkx7bO/q0qud/QYRpwFZw9Ab+V1zsu18=;
 b=
X-Gm-Message-State: AOAM530RtOldCWZiJvIICLvfjQaihh8U/GUrAvXxBknL0iWiqzJDpnoC
 ArPD2VWNGhNIKuv86ehnhE6XDA==
X-Google-Smtp-Source: ABdhPJy5mOMTacraH0rqek1s3ds5icOrxkwcx+uMDLN8gKqy/X4hgtR/LoaeA9cXmMxCDZcpCgtAew==
X-Received: by 2002:adf:eecf:: with SMTP id a15mr2743995wrp.269.1627995277394; 
 Tue, 03 Aug 2021 05:54:37 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id h14sm14695574wrp.55.2021.08.03.05.54.36
...
To: bjorn.andersson@linaro.org,
	broonie@kernel.org,
	robh@kernel.org
Subject: [PATCH v3 13/20] ASoC: qdsp6: audioreach: add basic pkt alloc support
Date: Tue,  3 Aug 2021 13:54:04 +0100
Message-Id: <20210803125411.28066-14-srinivas.kandagatla@linaro.org>
...
---
 ...
 sound/soc/qcom/qdsp6/audioreach.h | 634 ++++++++++++++++++++++++++++++
...
index cc7c1de2f1d9..5129b3b80da3 100644
--- a/sound/soc/qcom/Kconfig
+++ b/sound/soc/qcom/Kconfig
@@ -103,6 +103,15 @@ config SND_SOC_QDSP6
...
index 1600ae55bd34..b6a0ff0284cf 100644
...
index 2a19fd3ae352..d3fb677f00b3 100644
...
@@ -11,3 +13,5 @@ obj-$(CONFIG_SND_SOC_QDSP6_ADM) += q6adm.o
...
index 000000000000..af8fdf190740
--- /dev/null
...
new file mode 100644
index 000000000000..1c463281d59a
--- /dev/null
