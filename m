...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F1FA214056C
	for <lists+alsa-devel@lfdr.de>; Fri, 17 Jan 2020 09:26:09 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id D0EC117D4;
	Fri, 17 Jan 2020 09:25:18 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz D0EC117D4
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1579249568;
	bh=tD/5b6GYHPM08DvjlWKoMjvwSzuRWPvklB7eCvKePOE=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=OcxNEtThqN0rp4pRoM8x5fv5JvnNGtYbBMEwy4RwC3kAq/XoG09GvR1Vd3Akw+yHW
	 7pJaxEcPUM12hyBxrLeFDd9ABQ3xrlXYgnGNA3ihaSkDzQ4nivmqfmsje0zf8G04rB
	 ASXCnf7c18KbSsN8nvIUhF67MsDj5uVDIrINFCYo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 89FD4F80277;
	Fri, 17 Jan 2020 09:22:59 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 3D9ACF8022B; Fri, 17 Jan 2020 09:22:52 +0100 (CET)
...
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id CCD63F8014B
 for <alsa-devel@alsa-project.org>; Fri, 17 Jan 2020 09:22:39 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz CCD63F8014B
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
 by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 17 Jan 2020 00:22:36 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.70,329,1574150400"; d="scan'208";a="274295691"
Received: from bard-ubuntu.sh.intel.com ([10.239.13.33])
 by FMSMGA003.fm.intel.com with ESMTP; 17 Jan 2020 00:22:35 -0800
From: Bard liao <yung-chuan.liao@linux.intel.com>
To: broonie@kernel.org,
	tiwai@suse.de
Date: Fri, 17 Jan 2020 04:26:18 +0800
Message-Id: <20200116202620.7401-3-yung-chuan.liao@linux.intel.com>
...
Subject: [alsa-devel] [PATCH RFC v3 2/4] ASoC: Add multiple CPU DAI support
	for PCM ops
...
---
 sound/soc/soc-pcm.c | 521 +++++++++++++++++++++++++++++---------------
 1 file changed, 348 insertions(+), 173 deletions(-)

diff --git a/sound/soc/soc-pcm.c b/sound/soc/soc-pcm.c
index 74d340d1c9f7..ae1017637e86 100644
...
@@ -1831,6 +1993,7 @@ static int dpcm_apply_symmetry(struct snd_pcm_substream *fe_substream,
...
@@ -1845,11 +2008,13 @@ static int dpcm_apply_symmetry(struct snd_pcm_substream *fe_substream,
...
+			}
 		...
 		for_each_rtd_codec_dai(rtd, i, codec_dai) {
@@ -2836,7 +3001,7 @@ static int dpcm_fe_dai_close(struct snd_pcm_substream *fe_substream)
