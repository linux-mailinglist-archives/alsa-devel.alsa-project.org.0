...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id F237A4FA7AB
	for <lists+alsa-devel@lfdr.de>; Sat,  9 Apr 2022 14:29:42 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 14E0E18F1;
	Sat,  9 Apr 2022 14:28:52 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 14E0E18F1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1649507382;
	bh=NdD880+fgUI3xMsLbS38EaZPm6atj8F1r5Nac4oUNRY=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=XK4XfKrp/lueFktktcnf359//oBygq6tCYWiDITB8FnHg6aSqHSmX20agCqYepzaE
	 wK3MIq7d+SwQqjsbSTLl3V8XhaZD9mdXs5s+XARB6ZjsqfwNcdohrtojsBSagvL9jB
	 nNIc10kdmuqlj0JyW0EiD7OIHeQht2WU8H6lrLNw=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C290FF80519;
	Sat,  9 Apr 2022 14:28:08 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 2FCB3F80253; Sat,  9 Apr 2022 14:28:03 +0200 (CEST)
...
Received: from n169-110.mail.139.com (n169-110.mail.139.com [120.232.169.110])
 ...
 by alsa1.perex.cz (Postfix) with ESMTPS id 7053BF80253
 for <alsa-devel@alsa-project.org>; Sat,  9 Apr 2022 14:27:49 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7053BF80253
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from LAPTOP-39QA2GAC.localdomain (unknown[120.231.214.90])
 by rmsmtp-lg-appmail-01-12079 (RichMail) with SMTP id 2f2f62517bb5bd0-8c3a3;
 Sat, 09 Apr 2022 20:27:46 +0800 (CST)
X-RM-TRANSID: 2f2f62517bb5bd0-8c3a3
From: Raphael-Xu <13691752556@139.com>
To: broonie@kernel.org
Subject: [PATCH v7 2/3] rename variables from tas2764 to tas27xx
Date: Sat,  9 Apr 2022 20:27:08 +0800
Message-Id: <20220409122709.15419-2-13691752556@139.com>
...
---
 sound/soc/codecs/tas27xx.c | 510 +++++++++++++++++++------------------
 sound/soc/codecs/tas27xx.h | 131 +++++-----
 2 files changed, 334 insertions(+), 307 deletions(-)

diff --git a/sound/soc/codecs/tas27xx.c b/sound/soc/codecs/tas27xx.c
index 9265af41c235..ac7a54d00532 100644
...
+					    mute ? TAS27XX_PWR_CTRL_MUTE : 0);
 	...
 	if (ret < 0)
 		return ret;
@@ -210,9 +223,9 @@ static int tas2764_mute(struct snd_soc_dai *dai, int mute, int direction)
 	return 0;
 }
...
+	struct snd_soc_component *component = tas27xx->component;
 	...
 	int val;
 	int ret;
@@ -220,21 +233,21 @@ static int tas2764_set_bitwidth(struct tas2764_priv *tas2764, int bitwidth)
 	switch (bitwidth) {
...
+					TAS27XX_TDM_CFG2_RXW_32BITS);
 	...
 	default:
@@ -244,65 +257,64 @@ static int tas2764_set_bitwidth(struct tas2764_priv *tas2764, int bitwidth)
 	if (ret < 0)
 		return ret;
...
+					    TAS27XX_TDM_CFG0_MASK,
 	...
 	if (ret < 0)
 		return ret;
@@ -310,43 +322,45 @@ static int tas2764_set_samplerate(struct tas2764_priv *tas2764, int samplerate)
 	return 0;
 }
...
+					    TAS27XX_TDM_CFG1_RX_MASK,
 	...
 	if (ret < 0)
 		return ret;
@@ -354,41 +368,42 @@ static int tas2764_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
...
+		snd_soc_component_get_drvdata(component);
 	...
 	int slots_cfg;
 	int slot_size;
@@ -416,159 +431,162 @@ static int tas2764_set_dai_tdm_slot(struct snd_soc_dai *dai,
...
+		.selector_reg = TAS27XX_PAGE,
 		...
 		.selector_shift = 0,
 		.window_start = 0,
@@ -576,113 +594,113 @@ static const struct regmap_range_cfg tas2764_regmap_ranges[] = {
 	},
 };
