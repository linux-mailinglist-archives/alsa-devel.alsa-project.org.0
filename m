...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 3DDFC26DE03
	for <lists+alsa-devel@lfdr.de>; Thu, 17 Sep 2020 16:21:38 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C08C0168F;
	Thu, 17 Sep 2020 16:20:47 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C08C0168F
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1600352497;
	bh=xFTuyEuZuccHxWAUTbgI2Qbu85MbX9fD/zRNMkre324=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=lqQ/UatS8kcXUhgS1QzhvM0ktFtW5cqQkq7iw2xSxdLOvrqugCSZO6XmuTe8cjX0X
	 nH4ReAaLsjTKlOzPQO4GZ8nf/CfxbhoqkQ7+q0dnDwbJEKbBIyR9cWTzk+HJYhxMpO
	 ickC5hHhFq4YiaC8OjYOGdZ5zxDMepdZWsqOxn8Q=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 003D4F8013A;
	Thu, 17 Sep 2020 16:19:00 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 7F164F802E0; Thu, 17 Sep 2020 16:18:57 +0200 (CEST)
...
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 908EEF80212
 for <alsa-devel@alsa-project.org>; Thu, 17 Sep 2020 16:18:46 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 908EEF80212
IronPort-SDR: QNctItoykINUG2ETdUluZlXMMDF4QqOLIR2UxD6ocsvjNQ837INRVsYe4jknWp+DEgwwjOtDt1
 zDbPzntKv38A==
X-IronPort-AV: E=McAfee;i="6000,8403,9746"; a="139207190"
X-IronPort-AV: E=Sophos;i="5.76,437,1592895600"; d="scan'208";a="139207190"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 17 Sep 2020 07:13:11 -0700
IronPort-SDR: vd1wzWZd1Vrp8CrVH4GskQrwH+MyX5jcbC02R0WUzKhmWVCIn2bbK+B2BNK3xg8990eE3bgdvd
 PtO+Bard6ufw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.76,437,1592895600"; d="scan'208";a="452317834"
Received: from crojewsk-ctrl.igk.intel.com ([10.102.9.28])
 by orsmga004.jf.intel.com with ESMTP; 17 Sep 2020 07:13:06 -0700
From: Cezary Rojewski <cezary.rojewski@intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH v6 02/14] ASoC: Intel: catpt: Implement IPC protocol
Date: Thu, 17 Sep 2020 16:12:30 +0200
Message-Id: <20200917141242.9081-3-cezary.rojewski@intel.com>
...
index 48952e93d86f..31285b11f12c 100644
...
+#include "messages.h"
 ...
 struct catpt_dev;
@@ -29,6 +30,32 @@ static inline bool catpt_resource_overlapping(struct resource *r1,
 	return true;
 }
