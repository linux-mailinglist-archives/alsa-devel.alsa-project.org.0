...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 80CB3577A66
	for <lists+alsa-devel@lfdr.de>; Mon, 18 Jul 2022 07:34:06 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 001ED16D9;
	Mon, 18 Jul 2022 07:33:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 001ED16D9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1658122446;
	bh=7/tCl4xSc4LOfq7i5KW5wsOliUIO51Jgp6PsrUj4ejw=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=eXm9yonQctwHN/N3l38fJj5+k4lFs/o36h3RvfaiBViT2lnRsyk6JcS/T8v6VGLK6
	 TMYb6hKCLpXhW0o0XcjZOd/7emIzYE+KSLZwemFCgjTW7W6Cn2nLqZK7232WMfk6EP
	 tNsAND1mCBExkW7R3rj5JmtmNXWh3h+dOillanAY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 46DB9F80508;
	Mon, 18 Jul 2022 07:33:05 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 9A93CF80095; Mon, 18 Jul 2022 07:33:02 +0200 (CEST)
...
Received: from mail-pj1-x1036.google.com (mail-pj1-x1036.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id D4D7CF80095
 for <alsa-devel@alsa-project.org>; Mon, 18 Jul 2022 07:32:52 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz D4D7CF80095
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="SXsQ/LtL"
Received: by mail-pj1-x1036.google.com with SMTP id
 cp18-20020a17090afb9200b001ef79e8484aso11767934pjb.1
 for <alsa-devel@alsa-project.org>; Sun, 17 Jul 2022 22:32:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=from:to:cc:subject:date:message-id:mime-version
 :content-transfer-encoding;
 bh=SkFbyiD01x0kKbzSv7S5fnwUFzCQA869iqfIKyOYwUI=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=SkFbyiD01x0kKbzSv7S5fnwUFzCQA869iqfIKyOYwUI=;
 b=
X-Gm-Message-State: AJIora/ZRIecnHWIX2WYGJWKLxpht9zRLFrp7kgH19KOdydmPVq0gYXs
 xRuH1TGMUQaYBwr08LB6h4vYvUXCPusbr+UY
X-Google-Smtp-Source: AGRyM1tSg18CUCH6n8p2voQjd+4VvTVzJNepjdJtPXylSFU2p2QD8cbWCYegff1cvFb6IxnzMdP1IA==
X-Received: by 2002:a17:90b:4c0b:b0:1ef:f525:97ba with SMTP id
 na11-20020a17090b4c0b00b001eff52597bamr30968173pjb.44.1658122369026; 
 Sun, 17 Jul 2022 22:32:49 -0700 (PDT)
Received: from a-VirtualBox.tendawifi.com ([101.224.225.209])
 by smtp.gmail.com with ESMTPSA id
 z6-20020a1709027e8600b0016c1fdaa38fsm8227608pla.231.2022.07.17.22.32.45
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Sun, 17 Jul 2022 22:32:47 -0700 (PDT)
From: Zhu Ning <zhuning0077@gmail.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH v1 1/2] ASoC: codecs: add support for ES8326
Date: Mon, 18 Jul 2022 13:32:36 +0800
Message-Id: <20220718053237.20146-1-zhuning0077@gmail.com>
...
v1
Changes:
1.remove 24kHz support
2.disables micbias during suspend and remove
3.regmap resync during resume
4.make irq optional
5.cancel_delay_work during suspend and remove
Unchanged:
1.dts about reg58,59. We ask OEMs to use a specific board layout for irq
and jack detection.
a dts about it can be added, but only useful in rare situation.
---
 sound/soc/codecs/Kconfig  |   5 +
 sound/soc/codecs/Makefile |   2 +
 sound/soc/codecs/es8326.c | 806 ++++++++++++++++++++++++++++++++++++++
...
index 000000000000..4c9e844d4c47
--- /dev/null
