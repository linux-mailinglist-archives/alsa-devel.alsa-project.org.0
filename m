...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id B0A0B59C03
	for <lists+alsa-devel@lfdr.de>; Fri, 28 Jun 2019 14:53:52 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 294C91616;
	Fri, 28 Jun 2019 14:53:02 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 294C91616
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1561726432;
	bh=Ys034CJJy2TeFb2jHzasFH0FRfamaq4fipaPLKHKfXo=;
	h=From:To:Date:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=fwh2zdvKma54cFcrJ1DjVpRadYPZbOrrq7IoFB1KAnE77zXN07SILWk7VeRQcd3rq
	 5/HWY0IhmaIC7n1V+t9orV+cufczuLEFiCHZ94HrUjJdd4XYhdh9qrY2YoS+PlDWbe
	 AN2A+nBwP9TvsmlQ9iNdYI4BOaU6xp65kOUsAtEM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 700ABF80C0B;
	Fri, 28 Jun 2019 14:52:07 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 6FB26F896B9; Fri, 28 Jun 2019 14:52:04 +0200 (CEST)
...
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id F321FF80058
 for <alsa-devel@alsa-project.org>; Fri, 28 Jun 2019 14:51:57 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz F321FF80058
Authenticated-By: 
X-SpamFilter-By: BOX Solutions SpamTrap 5.62 with qID x5SCpn35023949,
 This message is accepted by code: ctloc85258
Received: from mail.realtek.com (RTITCASV01.realtek.com.tw[172.21.6.18])
 by rtits2.realtek.com.tw (8.15.2/2.57/5.78) with ESMTPS id x5SCpn35023949
 (version=TLSv1 cipher=DHE-RSA-AES256-SHA bits=256 verify=NOT);
 Fri, 28 Jun 2019 20:51:49 +0800
Received: from localhost.localdomain (172.22.102.141) by
 RTITCASV01.realtek.com.tw (172.21.6.18) with Microsoft SMTP Server id
 14.3.439.0; Fri, 28 Jun 2019 20:51:48 +0800
From: <derek.fang@realtek.com>
To: <broonie@kernel.org>, <lgirdwood@gmail.com>
Date: Fri, 28 Jun 2019 20:51:43 +0800
Message-ID: <1561726303-29058-1-git-send-email-derek.fang@realtek.com>
...
Subject: [alsa-devel] [PATCH v4] ASoC: rt1308: Add RT1308 amplifier driver
