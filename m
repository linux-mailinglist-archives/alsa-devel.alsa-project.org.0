...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id EBF865F0E5B
	for <lists+alsa-devel@lfdr.de>; Fri, 30 Sep 2022 17:02:02 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 38E7D16CF;
	Fri, 30 Sep 2022 17:01:12 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 38E7D16CF
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1664550122;
	bh=R/QVz25E0YxgLyUmWqiDzGew0/qYgnGlzXGRitfAsMY=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=PX7MMsW9mwO+TsImp1tVEM3xSsD5bLwHXUdZMYEf+hl3fvk/89flZky1oJEqSjxWm
	 irgQ7Qbh00cWTPFrsOUQatgv3uVpRA4gYFgfzDw3bx308g6ukLJwIAjVxuIWN7/mPE
	 2x+FNTUmxh7S2ihdVrv45V2uQL8NFlaEvTMP2nPY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 98052F805C5;
	Fri, 30 Sep 2022 16:57:55 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 7517CF805A0; Fri, 30 Sep 2022 16:57:50 +0200 (CEST)
...
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id F2B2BF8032B
 for <alsa-devel@alsa-project.org>; Fri, 30 Sep 2022 16:57:31 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz F2B2BF8032B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (1024-bit key) header.d=mediatek.com header.i=@mediatek.com
 header.b="MIyt7bRz"
X-UUID: 260e04c0e83845c79bde2a52adc325b7-20220930
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com;
 s=dk; 
 h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From;
 bh=w7LYibSq91E7aoYnUh3+mfsPfvlfJrwrkDmSj7DaypM=; 
 b=MIyt7bRzBY8Ar2HR46LJXBUyYzziSy+Td2q5WzDkNteah06lU1il85eT6rPhAZDGe3z0YF2xSzCgQCwsLRkSlS5OMeUXE1ereFoAkLLSceWoOiLKMDu+d7eZMyQ8V92xGIg2Zm4r5BODhrCxnfNfVr4qCrjMauw5bLhJJTrM3dc=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.11, REQID:87f4f095-3a69-4790-8c79-80599bb13d29, IP:0,
 U
 RL:0,TC:0,Content:0,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Release_Ham,ACTION
 :release,TS:95
X-CID-INFO: VERSION:1.1.11, REQID:87f4f095-3a69-4790-8c79-80599bb13d29, IP:0,
 URL
 :0,TC:0,Content:0,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACTION
 :quarantine,TS:95
X-CID-META: VersionHash:39a5ff1, CLOUDID:4b35a6a3-dc04-435c-b19b-71e131a5fc35,
 B
 ulkID:220930225712PEHJGQRA,BulkQuantity:0,Recheck:0,SF:38|28|17|19|48|823|
...
Received: from mtkcas10.mediatek.inc [(172.21.101.39)] by mailgw02.mediatek.com
 ...
 with ESMTP id 582971581; Fri, 30 Sep 2022 22:57:10 +0800
...
Subject: [PATCH 02/12] ASoC: mediatek: mt8188: add common header
Date: Fri, 30 Sep 2022 22:56:51 +0800
Message-ID: <20220930145701.18790-3-trevor.wu@mediatek.com>
...
---
 ...
 2 files changed, 3451 insertions(+)
...
index 000000000000..0c53f13c53e6
--- /dev/null
...
new file mode 100644
index 000000000000..6e903a148285
--- /dev/null
...
+#define PWR1_ASM_CON2_GASRC4_CALI_CK_SEL(x)     ((x) << 2)
+#define PWR1_ASM_CON2_GASRC5_CALI_CK_SEL_MASK   BIT(7)
+#define PWR1_ASM_CON2_GASRC5_CALI_CK_SEL(x)     ((x) << 7)
+#define PWR1_ASM_CON2_GASRC6_CALI_CK_SEL_MASK   BIT(12)
+#define PWR1_ASM_CON2_GASRC6_CALI_CK_SEL(x)     ((x) << 12)
+#define PWR1_ASM_CON2_GASRC7_CALI_CK_SEL_MASK   BIT(17)
+#define PWR1_ASM_CON2_GASRC7_CALI_CK_SEL(x)     ((x) << 17)
+#define PWR1_ASM_CON2_GASRC8_CALI_CK_SEL_MASK   BIT(22)
+#define PWR1_ASM_CON2_GASRC8_CALI_CK_SEL(x)     ((x) << 22)
+#define PWR1_ASM_CON2_GASRC9_CALI_CK_SEL_MASK   BIT(27)
+#define PWR1_ASM_CON2_GASRC9_CALI_CK_SEL(x)     ((x) << 27)
+
+/* PWR1_ASM_CON3 */
+#define PWR1_ASM_CON3_GASRC10_CALI_CK_SEL_MASK   BIT(2)
+#define PWR1_ASM_CON3_GASRC10_CALI_CK_SEL(x)     ((x) << 2)
+#define PWR1_ASM_CON3_GASRC11_CALI_CK_SEL_MASK   BIT(7)
+#define PWR1_ASM_CON3_GASRC11_CALI_CK_SEL(x)     ((x) << 7)
+
+/* AUDIO_TOP_CON0 */
...
+#define AFE_GAIN_CON0_SAMPLE_PER_STEP(x)    (((x) & 0xff) << 8)
+#define AFE_GAIN_CON0_GAIN_ON_MASK          BIT(0)
+#define AFE_GAIN_CON0_GAIN_MODE_MASK        GENMASK(7, 3)
+#define AFE_GAIN_CON0_GAIN_MODE_VAL(x)      (((x) & 0x1f) << 3)
+
+/* AFE_GAINx_CON1 */
...
+#define AFE_DMIC_UL_SRC_CON0_UL_IIR_ON_TMP_CTL_MASK  BIT(10)
...
+#define DMIC_GAIN_CON0_SAMPLE_PER_STEP(x)    (((x) & 0xff) << 8)
+
+/* DMIC_GAINx_CON1 */
...
+#define ETDM_OUT1_SYNC_SEL(x)		((x) << 16)
...
+#define ETDM_IN1_SYNC_SEL(x)		((x) << 12)
...
+
+/* ETDM_COWORK_CON2 */
+#define ETDM_IN2_SYNC_SEL(x)		((x) << 28)
...
+#define ETDM_OUT3_SYNC_SEL(x)		((x) << 16)
...
+#define ETDM_OUT2_SYNC_SEL(x)		((x) << 4)
...
+#define GASRC_TIMING_CON0_GASRC4_IN_MODE(x)     (((x) & 0x1f) << 20)
+#define GASRC_TIMING_CON0_GASRC5_IN_MODE(x)     (((x) & 0x1f) << 25)
...
+
+/* GASRC_TIMING_CON1 */
+#define GASRC_TIMING_CON1_GASRC6_IN_MODE(x)     (((x) & 0x1f) << 0)
+#define GASRC_TIMING_CON1_GASRC7_IN_MODE(x)     (((x) & 0x1f) << 5)
+#define GASRC_TIMING_CON1_GASRC8_IN_MODE(x)     (((x) & 0x1f) << 10)
+#define GASRC_TIMING_CON1_GASRC9_IN_MODE(x)     (((x) & 0x1f) << 15)
+#define GASRC_TIMING_CON1_GASRC10_IN_MODE(x)    (((x) & 0x1f) << 20)
+#define GASRC_TIMING_CON1_GASRC11_IN_MODE(x)    (((x) & 0x1f) << 25)
...
+
+/* GASRC_TIMING_CON2 */
+#define GASRC_TIMING_CON2_GASRC12_IN_MODE(x)    (((x) & 0x1f) << 0)
+#define GASRC_TIMING_CON2_GASRC13_IN_MODE(x)    (((x) & 0x1f) << 5)
+#define GASRC_TIMING_CON2_GASRC14_IN_MODE(x)    (((x) & 0x1f) << 10)
+#define GASRC_TIMING_CON2_GASRC15_IN_MODE(x)    (((x) & 0x1f) << 15)
+#define GASRC_TIMING_CON2_GASRC16_IN_MODE(x)    (((x) & 0x1f) << 20)
+#define GASRC_TIMING_CON2_GASRC17_IN_MODE(x)    (((x) & 0x1f) << 25)
...
+
+/* GASRC_TIMING_CON3 */
+#define GASRC_TIMING_CON3_GASRC18_IN_MODE(x)    (((x) & 0x1f) << 0)
+#define GASRC_TIMING_CON3_GASRC19_IN_MODE(x)    (((x) & 0x1f) << 5)
+#define GASRC_TIMING_CON3_GASRC18_IN_MODE_MASK  GENMASK(4, 0)
+#define GASRC_TIMING_CON3_GASRC19_IN_MODE_MASK  GENMASK(9, 5)
+
+/* GASRC_TIMING_CON4 */
+#define GASRC_TIMING_CON4_GASRC0_OUT_MODE(x)     (((x) & 0x1f) << 0)
+#define GASRC_TIMING_CON4_GASRC1_OUT_MODE(x)     (((x) & 0x1f) << 5)
+#define GASRC_TIMING_CON4_GASRC2_OUT_MODE(x)     (((x) & 0x1f) << 10)
+#define GASRC_TIMING_CON4_GASRC3_OUT_MODE(x)     (((x) & 0x1f) << 15)
+#define GASRC_TIMING_CON4_GASRC4_OUT_MODE(x)     (((x) & 0x1f) << 20)
+#define GASRC_TIMING_CON4_GASRC5_OUT_MODE(x)     (((x) & 0x1f) << 25)
...
+
+/* GASRC_TIMING_CON5 */
+#define GASRC_TIMING_CON5_GASRC6_OUT_MODE(x)     (((x) & 0x1f) << 0)
+#define GASRC_TIMING_CON5_GASRC7_OUT_MODE(x)     (((x) & 0x1f) << 5)
+#define GASRC_TIMING_CON5_GASRC8_OUT_MODE(x)     (((x) & 0x1f) << 10)
+#define GASRC_TIMING_CON5_GASRC9_OUT_MODE(x)     (((x) & 0x1f) << 15)
+#define GASRC_TIMING_CON5_GASRC10_OUT_MODE(x)    (((x) & 0x1f) << 20)
+#define GASRC_TIMING_CON5_GASRC11_OUT_MODE(x)    (((x) & 0x1f) << 25)
...
+
+#define BUS_REMAP_CTRL				(0x10B8F168)
+#define EMI_OFFSET_EN				BIT(6)
+#define SUB_EMI_OFFSET_EN			BIT(7)
+#define EMI_OFFSET					(0x10000000)
+
+/* AFE_GASRCx_NEW_CON0 */
...
+#define AFE_GASRC_NEW_CON0_CHSET0_IIR_STAGE(x)      (((x) - 1) << 8)
...
+#define AFE_GASRC_NEW_CON5_CALI_LRCK_SEL(x)     (((x) & 0x7) << 1)
+#define AFE_GASRC_NEW_CON5_SOFT_RESET           BIT(0)
+
+/* AFE_GASRCx_NEW_CON6 */
+#define AFE_GASRC_NEW_CON6_FREQ_CALI_CYCLE_MASK     GENMASK(31, 16)
+#define AFE_GASRC_NEW_CON6_FREQ_CALI_CYCLE(x)       ((((x) - 1) & 0xffff) << 16)
...
+#define AFE_GASRC_NEW_CON6_CALI_SIG_MUX_SEL(x)      (((x) & 0x3) << 8)
