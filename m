...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id A175B85F200
	for <lists+alsa-devel@lfdr.de>; Thu, 22 Feb 2024 08:43:07 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id BAE8383E;
	Thu, 22 Feb 2024 08:42:51 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz BAE8383E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1708587781;
	bh=FxwV+qnYFqWQVGNyWJ57X7Sx9rhrLP6HlfGC/Cl0+/M=;
	h=From:To:CC:Subject:Date:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=nprmXVAJz/x0WhWStjGjONXU7YwKzBIWW8xpHPxGVa/FpPoK4ez8shzm+wUL0pvXn
	 UjB7VyrSz3aix4cDH2bDdTIL4s5Ls1ijJJZ58xMrsAKbOPbHOpwZYoCCtzQIG/lAGb
	 FwUJG3aYMGySgr+XA1VmVkVKqZ1tCD53SFR7wYoI=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id EA2D1F805A0; Thu, 22 Feb 2024 08:42:30 +0100 (CET)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 5BA0EF80589;
	Thu, 22 Feb 2024 08:42:29 +0100 (CET)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 7EC36F80496; Thu, 22 Feb 2024 08:41:30 +0100 (CET)
...
Received: from fllv0015.ext.ti.com (fllv0015.ext.ti.com [198.47.19.141])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 26A51F800ED
	for <alsa-devel@alsa-project.org>; Thu, 22 Feb 2024 08:40:16 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 26A51F800ED
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=Lo9d4p+U
Received: from fllv0034.itg.ti.com ([10.64.40.246])
	by fllv0015.ext.ti.com (8.15.2/8.15.2) with ESMTP id 41M7eAfT124357;
	Thu, 22 Feb 2024 01:40:10 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1708587610;
	bh=wmoBJlCguGKcUg4tMn/jMgfuCZdaHrQ3Vs/LQh/tPqk=;
	h=From:To:CC:Subject:Date;
	b=Lo9d4p+U0Scz85Zg8l0DHwq3KK/2YFiAeB2nxDPxKTMNRGKzQGrFQ0Hg0iGOM0Jcd
	 TYMDi2OVXTzGIqE2gIa0yF8QoJ8vf2iktbWV7PjKmr2+YyTsAOGK+JWsG0xBCFTaQ3
	 NLcy0dFsI9wdO089DpFtFMIqAfB35c+edpmPcCIk=
Received: from DFLE100.ent.ti.com (dfle100.ent.ti.com [10.64.6.21])
	by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 41M7eAt0063448
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Thu, 22 Feb 2024 01:40:10 -0600
Received: from DFLE112.ent.ti.com (10.64.6.33) by DFLE100.ent.ti.com
 (10.64.6.21) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Thu, 22
 Feb 2024 01:40:10 -0600
Received: from lelvsmtp5.itg.ti.com (10.180.75.250) by DFLE112.ent.ti.com
 (10.64.6.33) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Thu, 22 Feb 2024 01:40:09 -0600
Received: from LT5CG31242FY.dhcp.ti.com (lt5cg31242fy.dhcp.ti.com
 [10.85.14.246])
	by lelvsmtp5.itg.ti.com (8.15.2/8.15.2) with ESMTP id 41M7e3bw032536;
	Thu, 22 Feb 2024 01:40:04 -0600
...
Subject: [PATCH v9] ASoc: tas2783: Add tas2783 codec driver
Date: Thu, 22 Feb 2024 15:40:00 +0800
Message-ID: <20240222074000.659-1-shenghao-ding@ti.com>
X-Mailer: git-send-email 2.33.0.windows.2
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Content-Type: text/plain
X-EXCLAIMER-MD-CONFIG: e1e8a2fd-e40a-4ac6-ac9b-f7e9cc9ee180
Message-ID-Hash: CB74JKWT6XLEA5FYLK7BIG2U6LBXCB4T
X-Message-ID-Hash: CB74JKWT6XLEA5FYLK7BIG2U6LBXCB4T
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/CB74JKWT6XLEA5FYLK7BIG2U6LBXCB4T/>
List-Archive: <>
...
---
 ...
 sound/soc/codecs/tas2783-sdw.c | 851 +++++++++++++++++++++++++++++++++
...
index 000000000000..42a6f70dd108
--- /dev/null
...
+		dev_dbg(tas_dev->dev, "%ptTs", &tmp_val[40]);
+	} else {
