...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id AB0C67A94B9
	for <lists+alsa-devel@lfdr.de>; Thu, 21 Sep 2023 15:25:06 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id D201BDEB;
	Thu, 21 Sep 2023 15:24:10 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz D201BDEB
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1695302700;
	bh=HhW7q1mPcHxA08tpmbAngOKG9Apz3sfG3R9dQDskDm4=;
	h=From:To:CC:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=ZLJM47p5TF0xTsaIVzzTQKj4Aux0uKFnqAbPtCDj7ouUWfTXaSRdmnVfoPuNz6amE
	 ELR9cc61XMVbOBY3YV7k/BGF05iBZbPshsEfocHrVRvRvzCM5fIBstZyZLii4Nijdy
	 oEhWab2d4GA91441L85dlWi90PW2xjDgEd2poL9w=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 40FA7F80571; Thu, 21 Sep 2023 15:22:56 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id DA127F8055B;
	Thu, 21 Sep 2023 15:22:55 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 48B1DF8047D; Wed, 20 Sep 2023 05:51:28 +0200 (CEST)
...
Received: from mg.richtek.com (mg.richtek.com [220.130.44.152])
	by alsa1.perex.cz (Postfix) with ESMTP id 06418F8025A
	for <alsa-devel@alsa-project.org>; Wed, 20 Sep 2023 05:51:06 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 06418F8025A
X-MailGates: (SIP:2,PASS,NONE)(compute_score:DELIVER,40,3)
Received: from 192.168.10.46
	by mg.richtek.com with MailGates ESMTPS Server V6.0(1978110:0:AUTH_RELAY)
...
Received: from linuxcarl2.richtek.com (192.168.10.154) by ex4.rt.l
 ...
 Transport; Wed, 20 Sep 2023 11:50:36 +0800
...
Subject: [PATCH v3 2/2] ASoC: codecs: Add Richtek rtq9128 audio amplifier
 support
Date: Wed, 20 Sep 2023 11:50:34 +0800
Message-ID: <1695181834-5809-3-git-send-email-cy_huang@richtek.com>
...
Message-ID-Hash: MSOW3A4P522K53GU3C7MIKP7HR2GKSYZ
X-Message-ID-Hash: MSOW3A4P522K53GU3C7MIKP7HR2GKSYZ
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/MSOW3A4P522K53GU3C7MIKP7HR2GKSYZ/>
List-Archive: 
...
At v3, the new added item for DVDD undervoltage selection is
from our HW guy's suggestion. Only this item is not from
the reviewer comment list.

v3
- Fix patch title
- Modify the copyright and author comment text to c++ style
- Change regmap cache type from RBTREE to MAPLE
- Remove magic soc_enum array, change it to each dedicated soc_enum instance
- Change regmap bus read/write BUG_ON to if/errlog/return
- Remove the fixed DVDD undervoltage threshold setting in RTQ9128 DH&DL
  init table.
- Add DVDD undervoltage threshold selection in mixer control.
---
...
index 000000000000..926b79ed8078
--- /dev/null
