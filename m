...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 92B7A397296
	for <lists+alsa-devel@lfdr.de>; Tue,  1 Jun 2021 13:39:56 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id E5CB316DC;
	Tue,  1 Jun 2021 13:39:05 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz E5CB316DC
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1622547596;
	bh=eSUrQZvmol68ikE1oF1WrmD6Bor2I2jH7KHCxJlamyQ=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=sJlibrJILQNBLIwHiZ1g+bM/I2ZPAqhxEWmyGAcy5NcfeKb5ZWinOrACkC20pazWZ
	 qe8Magy/J7GjcDOO+seahUfPRhap2Y/r4gNDdRm1bBGiNgaYsV2LrX32oh0bj9Utyd
	 lL/666MKAsVtL7fHK+1kPeFkNhwDpV0hz2gNNBjE=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id ABF63F8051E;
	Tue,  1 Jun 2021 13:35:09 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 03B1CF804F2; Tue,  1 Jun 2021 13:35:05 +0200 (CEST)
...
Received: from mail-ed1-x52d.google.com (mail-ed1-x52d.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 67B21F8025B
 for <alsa-devel@alsa-project.org>; Tue,  1 Jun 2021 13:34:40 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 67B21F8025B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="gG7C2J98"
Received: by mail-ed1-x52d.google.com with SMTP id o5so16909232edc.5
 for <alsa-devel@alsa-project.org>; Tue, 01 Jun 2021 04:34:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=H6DbLc4XyKfTJiY1vViE4IcQiADMq4h7bEWZBobJV74=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=H6DbLc4XyKfTJiY1vViE4IcQiADMq4h7bEWZBobJV74=;
 b=
X-Gm-Message-State: AOAM533vGmneo7dPdFKn+uiFmgdZeiwJiJrDyzVHbRd/rzZyEC9opN9t
 lRdZwfbfVx1Hc+yed2b3OePbeg==
X-Google-Smtp-Source: ABdhPJwSflfVD+PGAqY8edWmvtwqUbwerel+suvTg4BZVZPe+J0CQjTCzc3iR3yxS0mx1aDuTy3/6A==
X-Received: by 2002:aa7:ce0b:: with SMTP id d11mr32118106edv.283.1622547279090; 
 Tue, 01 Jun 2021 04:34:39 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id f10sm4729487edx.60.2021.06.01.04.34.37
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 01 Jun 2021 04:34:38 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v8 3/9] ASoC: codecs: wcd938x: add basic driver
Date: Tue,  1 Jun 2021 12:31:52 +0100
Message-Id: <20210601113158.16085-4-srinivas.kandagatla@linaro.org>
...
---
 ...
 sound/soc/codecs/wcd938x.c | 1695 ++++++++++++++++++++++++++++++++++++
 sound/soc/codecs/wcd938x.h |  671 ++++++++++++++
 4 files changed, 2372 insertions(+)
 create mode 100644 sound/soc/codecs/wcd938x.c
 create mode 100644 sound/soc/codecs/wcd938x.h

diff --git a/sound/soc/codecs/Kconfig b/sound/soc/codecs/Kconfig
index 196919bc27ab..f6ca59624e76 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -233,6 +233,7 @@ config SND_SOC_ALL_CODECS
...
@@ -1544,6 +1545,9 @@ config SND_SOC_WCD934X
...
index 8c7257035e4c..444f60269b80 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -253,6 +253,7 @@ snd-soc-uda134x-objs := uda134x.o
...
@@ -576,6 +577,7 @@ obj-$(CONFIG_SND_SOC_UDA134X)	+= snd-soc-uda134x.o
...
index 000000000000..6b8ee9971945
--- /dev/null
...
new file mode 100644
index 000000000000..efaa4dfc752a
--- /dev/null
