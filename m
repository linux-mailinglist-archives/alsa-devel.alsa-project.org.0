...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B04174C6A
	for <lists+alsa-devel@lfdr.de>; Thu, 25 Jul 2019 13:05:15 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id A5D151AC7;
	Thu, 25 Jul 2019 13:04:24 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz A5D151AC7
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1564052714;
	bh=tEcpVlEbftYvQI8H9mc5IWFmT7NAHpLjXaUgzaBGg3Y=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=cu3nXx4r4g960cDO6Kqf4UKPMynJHL3IS5S34qYokYy5syebx7MRz/yBdZy4Jsgx3
	 L7u7WdO0o42oZ3aoEs6RB4wVf+VQP6q4W/Pok881XyJ5mKFhfw50P3fo1Nz6B5FwF0
	 Po/jmo7K1rS9HI2sl0YRsG2fLievfIHOGmye/JAU=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id CC06DF8048D;
	Thu, 25 Jul 2019 13:02:47 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id AA28BF803D0; Thu, 25 Jul 2019 13:02:42 +0200 (CEST)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: *
X-Spam-Status: No, score=1.8 required=5.0 tests=DKIM_SIGNED,DKIM_VALID,
 PRX_BODY_30,SPF_HELO_NONE,SPF_PASS,UPPERCASE_50_75 autolearn=disabled
 version=3.4.0
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 [67.231.149.25])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E6332F800E8
 for <alsa-devel@alsa-project.org>; Thu, 25 Jul 2019 13:02:35 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E6332F800E8
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="Q2qyw54p"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id
 x6PAxPSs029817; Thu, 25 Jul 2019 06:02:33 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=PODMain02222019;
 bh=IT7ny5o3h7SGrccuLRf44cwWWgiiChQ/ZM+ihhbp9AA=;
 b= +A== 
Authentication-Results: ppops.net;
 spf=fail smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from ediex02.ad.cirrus.com ([87.246.76.36])
 by mx0a-001ae601.pphosted.com with ESMTP id 2tx61s37dp-2
 (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT);
 Thu, 25 Jul 2019 06:02:32 -0500
...
Received: from ediswmail.ad.cirrus.com (198.61.86.93) by EDIEX01.ad.cirrus.com
 ...
 Frontend Transport; Thu, 25 Jul 2019 12:02:28 +0100
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id A8B762A1;
 Thu, 25 Jul 2019 12:02:28 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Thu, 25 Jul 2019 12:02:28 +0100
Message-ID: <20190725110228.16205-2-ckeepax@opensource.cirrus.com>
X-Mailer: git-send-email 2.11.0
In-Reply-To: <20190725110228.16205-1-ckeepax@opensource.cirrus.com>
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 mlxlogscore=999
 ...
 engine=8.12.0-1906280000 definitions=main-1907250132
Cc: patches@opensource.cirrus.com, alsa-devel@alsa-project.org,
 lgirdwood@gmail.com
Subject: [alsa-devel] [PATCH 2/2] ASoC: cs47l92: Add codec driver for Cirrus
	Logic CS47L92
...
---
 include/sound/madera-pdata.h |   11 +
 sound/soc/codecs/Kconfig     |    6 +
 sound/soc/codecs/Makefile    |    2 +
 sound/soc/codecs/cs47l92.c   | 2047 ++++++++++++++++++++++++++++++++++++++++++
 sound/soc/codecs/madera.c    |  430 ++++++++-
 sound/soc/codecs/madera.h    |   10 +
 6 files changed, 2497 insertions(+), 9 deletions(-)
 create mode 100644 sound/soc/codecs/cs47l92.c

diff --git a/include/sound/madera-pdata.h b/include/sound/madera-pdata.h
index e3060f48f1081..c9dba4a4225a8 100644
...
index b027af8e9f39f..9034f85455fb9 100644
...
index 2de423621ba4a..1ce7ab6d08dd4 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -69,6 +69,7 @@ snd-soc-cs47l15-objs := cs47l15.o
...
index 0000000000000..ce41026b6f30a
--- /dev/null
...
+		goto error_dsp_irq;
+
+	ret = madera_init_bus_error_irq(&cs47l92->core, 0,
...
index 1c00e2a115bcd..52639811cc525 100644
...
index 0af66f2807708..1f3e8e230cf25 100644
