...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0887C2DA68
	for <lists+alsa-devel@lfdr.de>; Wed, 29 May 2019 12:24:33 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id BBF0C16F2;
	Wed, 29 May 2019 12:23:41 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz BBF0C16F2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1559125471;
	bh=eIPl2bhL1OnqcANvU1z2Y9LuMS2gowtwtiBlWy6/Ac0=;
	h=From:To:Date:In-Reply-To:References:Cc:Subject:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=EF6FILp7HGfV3MnQOzia6MCMgIw/oKbdZ5LJ7gbuYgi0j/aL3jqbYF93v68yvATQ2
	 kAdUb2fXy/H1ge5BazvJRm9g/XmAkvCdV6mIARILc+nOjwpqGAlwNI9IIsdo9HgLHd
	 hb9ZSARDvX3MAkeNbT/l4z1lTKyDNyjDxmfjb8NY=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 59AB1F89749;
	Wed, 29 May 2019 12:20:26 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 5DAE5F89738; Wed, 29 May 2019 12:20:19 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id CD0CEF896F7
 for <alsa-devel@alsa-project.org>; Wed, 29 May 2019 12:19:59 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz CD0CEF896F7
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x4TAGMI4009726; Wed, 29 May 2019 05:19:58 -0500
Authentication-Results: ppops.net;
 spf=none smtp.mailfrom=ckeepax@opensource.cirrus.com
Received: from mail2.cirrus.com (mail2.cirrus.com [141.131.128.20])
 by mx0a-001ae601.pphosted.com with ESMTP id 2sq340mnh2-1;
 Wed, 29 May 2019 05:19:56 -0500
Received: from EDIEX02.ad.cirrus.com (unknown [198.61.84.81])
 by mail2.cirrus.com (Postfix) with ESMTP id 41A14605A686;
...
Received: from algalon.ad.cirrus.com (algalon.ad.cirrus.com [198.90.251.122])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 648E745;
 Wed, 29 May 2019 11:19:54 +0100 (BST)
From: Charles Keepax <ckeepax@opensource.cirrus.com>
To: <broonie@kernel.org>
Date: Wed, 29 May 2019 11:19:51 +0100
Message-ID: <20190529101954.10438-3-ckeepax@opensource.cirrus.com>
...
Subject: [alsa-devel] [PATCH v2 3/6] ASoC: madera: Add common support for
...
Changes since v1:
 - Improve error message in madera_spin_sysclk
 - Handle spurious over temperature events
 - Factor out generic OF helper function for array reads
 - Rename destory functions to free
 - Add spaces in madera_dfc_width_text
...
Charles
 ...
 sound/soc/codecs/madera.c        | 4435 ++++++++++++++++++++++++++++++++++++++
 sound/soc/codecs/madera.h        |  445 ++++
 7 files changed, 4958 insertions(+)
...
index 642cb5610dd50..793dbe7e57897 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 0835d4b0d8c3b..88e133e670872 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -283,10 +283,12 @@ config SND_SOC_WM_HUBS
...
@@ -703,6 +705,9 @@ config SND_SOC_LOCHNAGAR_SC
...
index 454b8087a5bdd..2a39ddbaccba1 100644
...
@@ -368,6 +369,7 @@ obj-$(CONFIG_SND_SOC_L3)	+= snd-soc-l3.o
...
new file mode 100644
index 0000000000000..fb40e876022f2
--- /dev/null
...
+
+	n = device_property_read_u32_2darray(madera->dev,
+					  "cirrus,inmode",
+					  tmp,
+					  ARRAY_SIZE(tmp),
+					  MADERA_MAX_MUXED_CHANNELS);
...
+	int i, ret;
+
+	ret = device_property_read_u32_2darray(madera->dev,
...
new file mode 100644
index 0000000000000..df1f744e977fa
--- /dev/null
