...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id DCB9A1A7060
	for <lists+alsa-devel@lfdr.de>; Tue, 14 Apr 2020 02:57:24 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 643DC1696;
	Tue, 14 Apr 2020 02:56:34 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 643DC1696
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1586825844;
	bh=/UrMxuovB0oljRCp9rURv4/fUh9W9nD7QGcWdrFs/0c=;
	h=From:To:Subject:Date:In-Reply-To:References:In-Reply-To:
	 References:Cc:List-Id:List-Unsubscribe:List-Archive:List-Post:
	 List-Help:List-Subscribe:From;
	b=uvwEzRvgm30mwiGUan+KRmnyHYUikLkZFsU7gYQU8jKRWk2kgomLeOZCorYTdYRnr
	 aKqCh70T51EchrI50Gg2T2DwOXM1K9nu2C6Juz6LPUXWAMNt7XjSu2VSqXjk5wJXm4
	 XtBqqkVYCUfn0Z45wST9V38LssdoHS/PHqtE1WT8=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 5AF0EF802C4;
	Tue, 14 Apr 2020 02:51:54 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 29984F8026A; Tue, 14 Apr 2020 02:51:50 +0200 (CEST)
...
Received: from inva020.nxp.com (inva020.nxp.com [92.121.34.13])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 3365FF8026A
 for <alsa-devel@alsa-project.org>; Tue, 14 Apr 2020 02:51:39 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 3365FF8026A
Received: from inva020.nxp.com (localhost [127.0.0.1])
 by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id C71531A024C;
 Tue, 14 Apr 2020 02:51:38 +0200 (CEST)
Received: from invc005.ap-rdc01.nxp.com (invc005.ap-rdc01.nxp.com
 [165.114.16.14])
 by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 343AC1A0231;
 Tue, 14 Apr 2020 02:51:32 +0200 (CEST)
Received: from localhost.localdomain (shlinux2.ap.freescale.net
 [10.192.224.44])
 by invc005.ap-rdc01.nxp.com (Postfix) with ESMTP id E994540307;
 Tue, 14 Apr 2020 08:51:19 +0800 (SGT)
From: Shengjiu Wang <shengjiu.wang@nxp.com>
To: timur@kernel.org, nicoleotsuka@gmail.com, Xiubo.Lee@gmail.com,
 festevam@gmail.com, broonie@kernel.org, alsa-devel@alsa-project.org,
 lgirdwood@gmail.com, perex@perex.cz, tiwai@suse.com, robh+dt@kernel.org,
 mark.rutland@arm.com, devicetree@vger.kernel.org
Subject: [PATCH v7 7/7] ASoC: fsl_easrc: Add EASRC ASoC CPU DAI drivers
Date: Tue, 14 Apr 2020 08:43:09 +0800
Message-Id: <5b71fa2e5ea4803d546eb5e7e8bd74f002ebae9e.1586747728.git.shengjiu.wang@nxp.com>
...
index 000000000000..2e639ebcd15b
--- /dev/null
...
+}
+
+static size_t fsl_easrc_get_ctx_priv_size(void)
+{
+	return sizeof(struct fsl_easrc_ctx_priv);
+}
+
...
+	easrc->get_pair_priv_size = fsl_easrc_get_ctx_priv_size;
+
