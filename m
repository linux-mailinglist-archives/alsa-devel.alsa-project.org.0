...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 1F25562595E
	for <lists+alsa-devel@lfdr.de>; Fri, 11 Nov 2022 12:29:02 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B50431671;
	Fri, 11 Nov 2022 12:28:11 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B50431671
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1668166141;
	bh=mchjhu8LtKf4BWgnEvhS6x07zv2jMGf6coUlOlvT5xA=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=CzhbYt2fudVebQXaWBUwgoowy2p615+qPfpsPcGEDsxkMFAn0ABlbEP6pOHOCHQLm
	 4flRXHvuR8H41qdLW9/xR78TxmJ3gpNY7mrETSfD0Xab8Ga4b9ySCNgi2X7d6SBUBX
	 4W98a9p+mFHM8oDCQcHUpwDIUXSIPwYfcUp+HUYM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 70A9BF8057A;
	Fri, 11 Nov 2022 12:27:18 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id AF26EF80578; Fri, 11 Nov 2022 12:27:15 +0100 (CET)
...
X-Spam-Status: No, score=-0.0 required=5.0 tests=RCVD_IN_DNSWL_NONE,
 ...
 version=3.4.0
Received: from out29-145.mail.aliyun.com (out29-145.mail.aliyun.com
 [115.124.29.145])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E5930F800CC
 for <alsa-devel@alsa-project.org>; Fri, 11 Nov 2022 12:27:05 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E5930F800CC
X-Alimail-AntiSpam: AC=CONTINUE; BC=0.07436282|-1;
 BR=01201311R441S39rulernew998_84748_2000303; CH=blue; DM=|CONTINUE|false|;
 DS=CONTINUE|ham_social|0.00543369-0.00674697-0.987819; FP=0|0|0|0|0|-1|-1|-1;
 HT=ay29a033018047202; MF=wangweidong.a@awinic.com; NM=1; PH=DS; RN=17; RT=17;
 SR=0; TI=SMTPD_---.Q5.SfRw_1668166019; 
Received: from localhost.localdomain(mailfrom:wangweidong.a@awinic.com
 fp:SMTPD_---.Q5.SfRw_1668166019) by smtp.aliyun-inc.com;
 Fri, 11 Nov 2022 19:27:01 +0800
...
Subject: [PATCH V3 3/6] ASoC: codecs: Add aw883xx chip control logic,
Date: Fri, 11 Nov 2022 19:26:29 +0800
Message-Id: <1668165992-6493-4-git-send-email-wangweidong.a@awinic.com>
...
+
+	dev_info(aw_dev->dev, "crc_value:0x%x", crc_value);
...
+			continue;
+		} else {
+			dev_info(aw_dev->dev, "dsp st check ok, reg_val:0x%04x", reg_val);
+			return 0;
+		}
+	}
+
...
+	dev_info(aw_dev->dev, "vsense inside");
+	return 0;
+}
+
...
+	dev_info(aw_dev->dev, "read cali delay: %d ms", desc->delay);
+
+	return 0;
+}
+
...
+	ret = aw_dev_mode1_pll_check(aw_dev);
+	if (ret < 0) {
+		dev_info(aw_dev->dev, "mode1 check iis failed try switch to mode2 check");
...
+}
+
+int aw_dev_get_ra(struct aw_cali_desc *cali_desc)
+{
+	int ret;
+	uint32_t dsp_ra;
...
+	dev_info(aw_dev->dev, "get ra:%d", cali_desc->ra);
+	return 0;
+}
+
...
+			return ret;
+		}
+		dev_info(aw_dev->dev, "get init vmax:0x%x",
...
+
+		/*update dsp firmware*/
+		dev_info(aw_dev->dev, "fw_ver: [%x]", set_prof_desc->fw_ver);
