...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id EEBC8560DED
	for <lists+alsa-devel@lfdr.de>; Thu, 30 Jun 2022 02:25:32 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9947B1675;
	Thu, 30 Jun 2022 02:24:42 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9947B1675
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1656548732;
	bh=ZVu1w9K7Rvp1ZA1la6IElI3fNqPmuNfvqQd2GXmdLqk=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=oowr1JpdCTvThwG0FaLifdqdoRRT/rnyit918m93ZdL4PlvZer3qEDTONP6dL/h0l
	 p/IDsaCNGLs8XiZMhhlK5wBv0hwumm2EtHYJ+ntYu2HrjVeNYu5wHzkGFjD9UtU7w4
	 lTN4ueCTIOOl1unXRH6UwrhDmqH1bzWPYiPmlEBg=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 58C70F80553;
	Thu, 30 Jun 2022 02:23:59 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 01ACAF80552; Thu, 30 Jun 2022 02:23:56 +0200 (CEST)
...
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id A5262F8027B
 for <alsa-devel@alsa-project.org>; Thu, 30 Jun 2022 02:23:50 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz A5262F8027B
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com
 header.b="quvQoodb"
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
 by mx0a-001ae601.pphosted.com (8.17.1.5/8.17.1.5) with ESMTP id 25T7p0Ok020678;
 Wed, 29 Jun 2022 19:23:47 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com;
 h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=PODMain02222019;
 bh=Uv6/ZUV7kVhBfVbIMaSOUjihAO5EX8+gpaJcVTUOrAM=;
 b= yA== 
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
 by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3gwys2p9gm-2
...
Received: from vitaly-Legion-7-16ACHg6.ad.cirrus.com (unknown [198.90.238.125])
 by ediswmail.ad.cirrus.com (Postfix) with ESMTP id 24A2E2D4;
 Thu, 30 Jun 2022 00:23:45 +0000 (UTC)
From: Vitaly Rodionov <vitalyr@opensource.cirrus.com>
To: Jaroslav Kysela <perex@perex.cz>, Takashi Iwai <tiwai@suse.com>, "Mark
 Brown" <broonie@kernel.org>
Subject: [PATCH v8 04/14] ALSA: hda: cs35l41: Add initial DSP support and
 firmware loading
Date: Thu, 30 Jun 2022 01:23:25 +0100
Message-ID: <20220630002335.366545-5-vitalyr@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: sRmrovsGqzYrP-tNoyFrQv9zw6C_TZzv
X-Proofpoint-GUID: sRmrovsGqzYrP-tNoyFrQv9zw6C_TZzv
...
index bbbaafac50c3..e0d236eae93e 100644
...
@@ -537,6 +780,8 @@ int cs35l41_hda_probe(struct device *dev, const char *device_name, int id, int i
 	if (ret)
 		goto err;
...
+
 	...
 	if (ret)
 		goto err;
@@ -564,6 +809,9 @@ void cs35l41_hda_remove(struct device *dev)
 {
 	struct cs35l41_hda *cs35l41 = dev_get_drvdata(dev);
...
@@ -573,5 +821,6 @@ void cs35l41_hda_remove(struct device *dev)
