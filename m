...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4EB246C95B9
	for <lists+alsa-devel@lfdr.de>; Sun, 26 Mar 2023 16:36:09 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B804EAEA;
	Sun, 26 Mar 2023 16:35:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B804EAEA
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1679841367;
	bh=Z/ig8x7CkmtmEhloRxj/xvGwq6NCZe9Ee387/KRc0UI=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=c2VblL8Ivwz5WrNWwk0CjzZ9alI37ZtMdqWaeIEJJZYqNs3oW+mQQim4GDac60HoY
	 ObpIjcil+YHXVq1dRcBuyTvNfHKV65HgM+6k/KGtcEwasYnueFla4Zk0Xr8d9q0FTB
	 G+I8zZ7WTT+v6cKHmkw2kX1HhtOPnBbo/huj9Kg4=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id DE372F8024E;
	Sun, 26 Mar 2023 16:35:16 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 644FEF80272; Sun, 26 Mar 2023 16:35:10 +0200 (CEST)
...
Received: from n169-110.mail.139.com (n169-110.mail.139.com [120.232.169.110])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 236EBF8021D
	for <alsa-devel@alsa-project.org>; Sun, 26 Mar 2023 16:34:42 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 236EBF8021D
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[183.194.156.192])
	by rmsmtp-lg-appmail-03-12081 (RichMail) with SMTP id 2f31642057f5431-f2c72;
	Sun, 26 Mar 2023 22:34:32 +0800 (CST)
X-RM-TRANSID: 2f31642057f5431-f2c72
From: Shenghao Ding <13916275206@139.com>
To: broonie@kernel.org,
	lgirdwood@gmail.com,
	perex@perex.cz,
	pierre-louis.bossart@linux.intel.com
Subject: [PATCH v7] ASoC: tas2781: Add tas2781 driver
Date: Sun, 26 Mar 2023 22:34:19 +0800
Message-Id: <20230326143419.11711-1-13916275206@139.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: HOQJLUZIJ3TT3SOGHK77WMQVTDF23WRH
X-Message-ID-Hash: HOQJLUZIJ3TT3SOGHK77WMQVTDF23WRH
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/HOQJLUZIJ3TT3SOGHK77WMQVTDF23WRH/>
List-Archive: 
...
Changes in v7:
 ...
 - tasdevice_parse_dt as void
 - In tasdevice_i2c_probe, return -ENOMEM directly if kzalloc failed,
   and remove " && tas_dev" after the "out" label
 - in tas2781_set_global_mode, removed unneeded inits
 - Add some comments on the use cases for global broadcast mode
 - remove unneeded break
 - add comments on firmware loading error
 | Reported-by: kernel test robot <lkp@intel.com>
 | Link: https://lore.kernel.org/oe-kbuild-all/202303251653.7HZjyxTf-lkp@intel.com/
 - rewrite check_inblock_yram and check_inpage_yram
 - Add comment on calibrated data load twice if it failed during bootup.
 - switch kcalloc to kzalloc, for one element memory alloc.
 - rewrite tasdevice_select_cfg_blk for better indentation
 - add an output paramin tasdevice_add_config to save the error
 - Add comment on why create the kcontrol via devm_kzalloc
...
---
 ...
 sound/soc/codecs/tas2781-dsp.c | 2232 ++++++++++++++++++++++++++++++++
 sound/soc/codecs/tas2781-dsp.h |  180 +++
 sound/soc/codecs/tas2781-i2c.c | 1650 +++++++++++++++++++++++
...
+	else if (book == TAS2781_YRAM_BOOK2)
+		in = check_inpage_yram_bk2(cd, page, reg, len);
+
+	return in;
+}
+
...
+
+	if (book == TAS2781_YRAM_BOOK1)
+		in = check_inblock_yram_bk1(cd, page, reg, len);
+	else if (book == TAS2781_YRAM_BOOK2)
+		in = check_inblock_yram_bk2(cd, page, reg, len);
+
+	return in;
+}
+
...
+		goto end;
+
+	if ((block->type == MAIN_ALL_DEVICES) || (block->type == MAIN_DEVICE_A)
...
new file mode 100644
index 000000000000..815b67b00e02
--- /dev/null
