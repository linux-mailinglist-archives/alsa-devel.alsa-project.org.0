...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id BB12719D363
	for <lists+alsa-devel@lfdr.de>; Fri,  3 Apr 2020 11:20:07 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 38EDD1688;
	Fri,  3 Apr 2020 11:19:17 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 38EDD1688
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1585905607;
	bh=csd5L1cb+UbmFtq+fKCtXpCE32K8OdN2gai23eWww5w=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=gtxwkENR1H1FjTVixlu1qmDllN+GwO4cqm59CeEgUQmYXD1Bf29h2WLMjEqD/pg7z
	 WFVCyG0zAQZx9hvTpRdZ9SKhr+uzn6TIIPl3k1j+ujLOkfw8lMKXh4WeR7KL5Snt88
	 e0FhWazQ9jAsQOZlK33W06y/wOAx1ynz7DkMvYB4=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 373FDF80323;
	Fri,  3 Apr 2020 11:15:00 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id E89D9F802A7; Fri,  3 Apr 2020 11:14:39 +0200 (CEST)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: ***
X-Spam-Status: No, score=3.5 required=5.0 tests=PRX_BODY_30,SPF_HELO_NONE,
 SPF_NONE,URIBL_BLOCKED,URIBL_DBL_SPAM autolearn=disabled version=3.4.0
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 79AD4F8028C;
 Fri,  3 Apr 2020 11:14:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 79AD4F8028C
IronPort-SDR: xWQtcOZ6JYagrOV6hyg1IMb7CV0M3Oy6oK5CdqPotJNh5/sU7XjsML0loSJOFN1NIe+IPRn7AX
 DkFZKCMgzWHA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
 by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 03 Apr 2020 02:14:23 -0700
IronPort-SDR: NV8WAweAktf2z6dL5kc1PpwJP7F3sm0Qle3TQITcthIHMoyWF3y9M7GFdPGAHmY/outrlRFm0n
 fzi4HICJtLYQ==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.72,339,1580803200"; d="scan'208";a="451234983"
Received: from gliakhov-mobl2.ger.corp.intel.com (HELO
 ubuntu.ger.corp.intel.com) ([10.249.36.113])
 by fmsmga006.fm.intel.com with ESMTP; 03 Apr 2020 02:14:21 -0700
From: Guennadi Liakhovetski <guennadi.liakhovetski@linux.intel.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH v2 08/12] [RESEND] ASoC: SOF: add a VirtIO DSP driver
Date: Fri,  3 Apr 2020 11:14:02 +0200
Message-Id: <20200403091406.22381-9-guennadi.liakhovetski@linux.intel.com>
...
index fe8ba3e..dcc897f 100644
--- a/sound/soc/sof/topology.c
+++ b/sound/soc/sof/topology.c
@@ -1301,7 +1301,8 @@ static int sof_widget_load_dai(struct snd_soc_component *scomp, int index,
...
+
 	if (ret < 0) {
 		dev_err(scomp->dev, "error: tplg request firmware %s failed err: %d\n",
 			file, ret);
@@ -3641,7 +3651,9 @@ int snd_sof_load_topology(struct snd_soc_component *scomp, const char *file)
 		ret = -EINVAL;
 	}
