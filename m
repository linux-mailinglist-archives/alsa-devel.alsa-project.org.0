...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 400391AE804
	for <lists+alsa-devel@lfdr.de>; Sat, 18 Apr 2020 00:16:26 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id DF9DE1673;
	Sat, 18 Apr 2020 00:15:35 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz DF9DE1673
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1587161786;
	bh=y8N97yfbuBt+oCdgEUNoXlxik3ouVrcl7gaycuYm98c=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Q1v2zL8xEtjr7OCtzMWdsCmEiAUWE+TqO0m0pH5C+HYw9EF7T7cvxgwMXh3jpenUq
	 JiWXLGwRIV7ETpD7laZLbJC2b2dHWfF+M+k7L68t43fu9oXtfnHrpOPemFAdR9X7Id
	 jEU1cZOOK6k19PcLwQZygBIabXl6IwFkvh25FQDM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 6ACB1F80268;
	Sat, 18 Apr 2020 00:14:05 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 96DF2F80245; Sat, 18 Apr 2020 00:13:56 +0200 (CEST)
...
Received: from mail-qv1-xf43.google.com (mail-qv1-xf43.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id E7899F800AB
 for <alsa-devel@alsa-project.org>; Sat, 18 Apr 2020 00:13:49 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz E7899F800AB
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="oc0CHcHt"
Received: by mail-qv1-xf43.google.com with SMTP id 37so1708470qvc.8
 for <alsa-devel@alsa-project.org>; Fri, 17 Apr 2020 15:13:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references;
 bh=7B6SrQT0D7WfMSqghGvoNR+EnmUDacbv7y61tIkDB3Y=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :references;
 bh=7B6SrQT0D7WfMSqghGvoNR+EnmUDacbv7y61tIkDB3Y=;
 b=
X-Gm-Message-State: AGi0PuYt/k7Pt8XeU17GgLDXxtYvgwqIycUSwgwWcI8TB7Avw0QeWcdE
 wZoLlS+jKgZWfWnIs0oFc7Y=
X-Google-Smtp-Source: APiQypJJsAZpufMa9M6sPywhOPDKf3SvVgilv88LkY2zlOnxnyjqs3O4H5Hepq5+g9Ayq9kUxqNhoA==
X-Received: by 2002:a0c:9aea:: with SMTP id k42mr4996795qvf.91.1587161626954; 
 Fri, 17 Apr 2020 15:13:46 -0700 (PDT)
Received: from localhost.localdomain ([72.53.229.195])
 by smtp.gmail.com with ESMTPSA id u65sm17780126qkh.100.2020.04.17.15.13.45
...
Subject: [PATCH v2 2/2] ASoC: Add initial ZL38060 driver
Date: Fri, 17 Apr 2020 18:13:41 -0400
Message-Id: <20200417221341.31428-2-TheSven73@gmail.com>
...
- fixup comment style at top of file.

- fixup curly braces in if-elseif-else statement.

- explicitly put the chip in reset so it reverts to a known state.
  
- remove 'mscc,load-firmware' devicetree property, which provided support for
  switching between chip bootstrap modes (host boot / auto boot from external
  flash).
  On reflection, I cannot test correct operation of auto-boot - it involves
  interaction with the Bootloader Status Register, and I have no access to an
  auto-boot zl38060.
  This means the only tested and supported mode will be 'host boot', where the
  firmware is programmed by the host CPU (ie. Linux).

- remove amplifier enable gpio. if required, it should be part of the machine
  layer.

Sven Van Asbroeck:

- add dapm widgets: DAC1, DAC2, DMICL. Routed to Playback and Capture,
  respectively. This is required to drive a microphone amp-enable gpio
