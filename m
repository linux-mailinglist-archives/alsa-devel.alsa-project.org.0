...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 544ACA4A899
	for <lists+alsa-devel@lfdr.de>; Sat,  1 Mar 2025 05:31:29 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [45.14.194.44])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B7B2C602A2;
	Sat,  1 Mar 2025 05:31:15 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B7B2C602A2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1740803485;
	bh=ByllyOvusNOozweZqeK0Nmu9VzK4Cdj7XDRZGfSnAig=;
	h=From:To:CC:Subject:Date:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=pa2tm/0deh4vc06F5+VDFlMQvlds8o1oc1RfPOTojnNZe5hetRp0AZ/j9W0nCSqgN
	 RWBCd+1lMbm9iivkp5qJvKffoK7XKP9rN+fKxiF50gzhct2HqNduI26XKI0LfPqVdF
	 vfPv6+J+xPKPDks1IjAaIYSZVI9U2g30ckbdzjdY=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 45710F805AD; Sat,  1 Mar 2025 05:30:46 +0100 (CET)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id DFD98F805BD;
	Sat,  1 Mar 2025 05:30:46 +0100 (CET)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 0D162F8014B; Sat,  1 Mar 2025 05:30:28 +0100 (CET)
...
Received: from fllvem-ot03.ext.ti.com (fllvem-ot03.ext.ti.com [198.47.19.245])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 8B2ADF800C1
	for <alsa-devel@alsa-project.org>; Sat,  1 Mar 2025 05:30:21 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 8B2ADF800C1
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=oNSNawqj
Received: from lelv0265.itg.ti.com ([10.180.67.224])
	by fllvem-ot03.ext.ti.com (8.15.2/8.15.2) with ESMTPS id 5214UD5b2234076
	(version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Fri, 28 Feb 2025 22:30:13 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1740803413;
	bh=RNDkb/SS7SR0Qx0EnwqXqfnwCzZRvd2OngDNd/EsqWk=;
	h=From:To:CC:Subject:Date;
	b=oNSNawqjvwcHi614N3MBdZbi+X7F1OWx16sGuKkdto/OgK0QvmYMaht6ZHv7SRJwv
	 6tPd4BMgoP7J69Lxcm5o9vLWZ3Z/LLIGyxItaUShPWsWSMvRya8XVIjwHt4U/myuqp
	 mLfg6cNnALHNfZJO91MJU6Ka0kzwoLYw+rwIAUZg=
Received: from DLEE115.ent.ti.com (dlee115.ent.ti.com [157.170.170.26])
	by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 5214UDWa029829
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Fri, 28 Feb 2025 22:30:13 -0600
Received: from DLEE106.ent.ti.com (157.170.170.36) by DLEE115.ent.ti.com
 (157.170.170.26) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Fri, 28
 Feb 2025 22:30:12 -0600
Received: from lelvsmtp5.itg.ti.com (10.180.75.250) by DLEE106.ent.ti.com
 (157.170.170.36) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Fri, 28 Feb 2025 22:30:12 -0600
Received: from LT5CG31242FY.dhcp.ti.com ([10.250.160.186])
	by lelvsmtp5.itg.ti.com (8.15.2/8.15.2) with ESMTP id 5214U7fG114348;
	Fri, 28 Feb 2025 22:30:08 -0600
From: Shenghao Ding <shenghao-ding@ti.com>
To: <broonie@kernel.org>, <tiwai@suse.de>
CC: <andriy.shevchenko@linux.intel.com>, <13916275206@139.com>,
        <13564923607@139.com>, <alsa-devel@alsa-project.org>,
        <baojun.xu@ti.com>, <v-hampiholi@ti.com>, <navada@ti.com>,
        Shenghao Ding <shenghao-ding@ti.com>
Subject: [PATCH v4] ASoC: tas2781: Support dsp firmware Alpha and Beta seaies
Date: Sat, 1 Mar 2025 12:30:01 +0800
Message-ID: <20250301043001.1262-1-shenghao-ding@ti.com>
X-Mailer: git-send-email 2.33.0.windows.2
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Content-Type: text/plain
X-C2ProcessedOrg: 333ef613-75bf-4e12-a4b1-8e3623f5dcea
Message-ID-Hash: 5S3PFU27D5NLUQ7FOCQSBNL5LT6DGSWG
X-Message-ID-Hash: 5S3PFU27D5NLUQ7FOCQSBNL5LT6DGSWG
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/5S3PFU27D5NLUQ7FOCQSBNL5LT6DGSWG/>
List-Archive: 
...
---
 ...
 sound/soc/codecs/tas2781-fmwlib.c | 214 +++++++++++++++++++++++++----
 sound/soc/codecs/tas2781-i2c.c    | 216 +++++++++++++++++++++++-------
 5 files changed, 395 insertions(+), 84 deletions(-)
...
index bc2f68bd9846..2007c25c5778 100644
...
@@ -560,6 +560,152 @@ static int fw_parse_configuration_data_kernel(
 	return offset;
 }
...
+
 static int fw_parse_variable_header_kernel(
 	...
 	int offset)
@@ -1687,13 +1833,29 @@ static int tasdevice_load_block(struct tasdevice_priv *tas_priv,
 	return rc;
 }
...
+		if (ppcver >= PPC3_VERSION_BASE) {
 			tas_priv->fw_parse_variable_header =
 				fw_parse_variable_header_kernel;
 			tas_priv->fw_parse_program_data =
@@ -1702,6 +1864,7 @@ static int dspfw_default_callback(struct tasdevice_priv *tas_priv,
...
+			dspbin_type_check(tas_priv, ppcver);
 			...
 			switch (ppcver) {
 			case 0x00:
@@ -1717,7 +1880,7 @@ static int dspfw_default_callback(struct tasdevice_priv *tas_priv,
 			default:
...
+					__func__, PPC3_VERSION_BASE);
 				dev_err(tas_priv->dev, " Current:0x%02x\n",
 					ppcver);
 				rc = -EINVAL;
@@ -1958,23 +2121,20 @@ static int tasdevice_dspfw_ready(const struct firmware *fmw,
 	if (!fmw || !fmw->data) {
...
@@ -2007,27 +2167,31 @@ static int tasdevice_dspfw_ready(const struct firmware *fmw,
...
index 90c5b2e74d12..7d0b119c828a 100644
...
+
 	...
 	dst[0] = bytes_ext->max;
 	return calib_data_get(tas_priv, reg, &dst[1]);
@@ -1172,10 +1231,52 @@ static int tasdevice_dsp_create_ctrls(struct tasdevice_priv *tas_priv)
...
+	struct tasdevice_fw *fmw = priv->fmw;
 	...
 	unsigned int nctrls;
@@ -1191,14 +1292,25 @@ static int tasdevice_create_cali_ctrls(struct tasdevice_priv *priv)
 	}
