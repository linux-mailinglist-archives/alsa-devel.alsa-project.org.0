...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id CA1BC1E4E5C
	for <lists+alsa-devel@lfdr.de>; Wed, 27 May 2020 21:40:06 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 6C0B116D0;
	Wed, 27 May 2020 21:39:16 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 6C0B116D0
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1590608406;
	bh=gycfCjnw7+VDmr5GsFf2nttyrpPIZ8CoVZkpZCYtteM=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=MMyQCyCA5otUy1TP7T9XzGTFGfyOzYjz33b0QZPpRPM+NlgDeL7i/7QtQbcDOAvlI
	 Mjk7mhj+8e9J/KRIn+LfzToBiLK7UtN8+rQdB8QxAoLspnSvcvlnLfheClxWpCPn+X
	 f/0GaKEtkgOzICnyvrI6ftWUfZK3+s+a8wPY49wA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 813E1F8016F;
	Wed, 27 May 2020 21:38:25 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id CF5DAF8014E; Wed, 27 May 2020 21:38:22 +0200 (CEST)
...
Received: from mout.kundenserver.de (mout.kundenserver.de [212.227.126.187])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 7B5AAF800CD
 for <alsa-devel@alsa-project.org>; Wed, 27 May 2020 21:38:15 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 7B5AAF800CD
Received: from threadripper.lan ([149.172.98.151]) by mrelayeu.kundenserver.de
 (mreue009 [212.227.15.129]) with ESMTPA (Nemesis) id
 1MplPh-1jEvnq0fXR-00qCFR; Wed, 27 May 2020 21:37:47 +0200
From: Arnd Bergmann <arnd@arndb.de>
To: Liam Girdwood <lgirdwood@gmail.com>,
	Mark Brown <broonie@kernel.org>
Subject: [PATCH] ASoC: rt5682: split i2c driver into separate module
Date: Wed, 27 May 2020 21:34:13 +0200
Message-Id: <20200527193730.930412-1-arnd@arndb.de>
X-Mailer: git-send-email 2.26.2
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Provags-ID: V03:K1:xMeVA2zEJVCiTZU2kxx9nsvWsANr5EAQiZMTuJAaB/mXRE0akxs
 VzPImWgMZ8dmm6maireo6PygbL5hEk5FQxBJuNOnOn2wZozRtW8VPWoMXV03mK+hDZmdV8a
 TpyZ1oUZ53wFNKs4N3L0maLVp424Tha6KYbEVb81q2BrSQ2S1SIy9Rrd5bIUUdwsjaTma4X
 DX2B2Ufjzsm6W2Z0k56jg==
X-UI-Out-Filterresults: notjunk:1;V03:K0:K8E/ZVWoIek=:kAHf0eDXOmkhso1Qe1NEGb
 
...
---
 ...
 sound/soc/codecs/rt5682-i2c.c  | 341 ++++++++++++++
 sound/soc/codecs/rt5682-sdw.c  | 459 ++++++++++++++++++-
 sound/soc/codecs/rt5682-sdw.h  |  20 -
 sound/soc/codecs/rt5682.c      | 790 ++-------------------------------
 sound/soc/codecs/rt5682.h      |  29 +-
 sound/soc/intel/boards/Kconfig |   6 +-
 9 files changed, 869 insertions(+), 791 deletions(-)
...
index 046e6110de73..372833936208 100644
...
@@ -55,7 +38,18 @@ static const struct reg_sequence patch_list[] = {
...
+const struct reg_default rt5682_reg[RT5682_REG_NUM] = {
 	...
 	{0x0003, 0x8000},
 	{0x0005, 0x0000},
@@ -375,8 +369,9 @@ static const struct reg_default rt5682_reg[] = {
 	{0x03f2, 0x0800},
 	{0x03f3, 0x0800},
 };
...
+bool rt5682_volatile_register(struct device *dev, unsigned int reg)
 {
 	switch (reg) {
 	case RT5682_RESET:
@@ -403,8 +398,9 @@ static bool rt5682_volatile_register(struct device *dev, unsigned int reg)
 		return false;
 	}
 }
...
+bool rt5682_readable_register(struct device *dev, unsigned int reg)
 {
 	switch (reg) {
 	case RT5682_RESET:
@@ -733,6 +729,7 @@ static bool rt5682_readable_register(struct device *dev, unsigned int reg)
 		return false;
 	}
 }
...
@@ -800,12 +797,13 @@ static SOC_ENUM_SINGLE_DECL(rt5682_dacr_enum,
...
@@ -910,8 +908,7 @@ static void rt5682_enable_push_button_irq(struct snd_soc_component *component,
  *
...
@@ -972,35 +969,7 @@ static int rt5682_headset_detect(struct snd_soc_component *component,
...
@@ -1077,7 +1046,7 @@ static int rt5682_set_jack_detect(struct snd_soc_component *component,
 	return 0;
 }
...
@@ -1160,6 +1129,7 @@ static void rt5682_jack_detect_handler(struct work_struct *work)
...
+EXPORT_SYMBOL_GPL(rt5682_jack_detect_handler);
 ...
 static const struct snd_kcontrol_new rt5682_snd_controls[] = {
 	/* DAC Digital Volume */
@@ -2899,7 +2869,8 @@ static int rt5682_resume(struct snd_soc_component *component)
 	regcache_cache_only(rt5682->regmap, false);
 	regcache_sync(rt5682->regmap);
...
@@ -2908,270 +2879,22 @@ static int rt5682_resume(struct snd_soc_component *component)
...
@@ -3190,56 +2913,9 @@ static const struct snd_soc_component_driver soc_component_dev_rt5682 = {
 	.endianness		= 1,
...
@@ -3289,407 +2965,7 @@ static void rt5682_calibrate(struct rt5682_priv *rt5682)
...
index 0baeece84ec4..65a211ab58f4 100644
...
+		SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S8)
 ...
 /* System Clock Source */
 enum {
@@ -1420,8 +1427,24 @@ struct rt5682_priv {
