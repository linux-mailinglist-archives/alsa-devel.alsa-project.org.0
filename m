...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E8B366C16CE
	for <lists+alsa-devel@lfdr.de>; Mon, 20 Mar 2023 16:09:14 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 679D21E0;
	Mon, 20 Mar 2023 16:08:23 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 679D21E0
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1679324953;
	bh=wJMd2NMrrscNdrhabQGN4kgoazZ8UPL7EHbHFT81TBc=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=MroZNR8hfJx7ipvBY2eDgCbBKimf0O8mi4N0qMEm2CHpT1zyqxoW+LdV/RiPmtfFJ
	 OU1CQT94/UQhQf3RlVjp0Vr8bg5Hsyp/DgPjQ56UWeJSEYX9JnzjsPMGCGyU5ik7sX
	 QC/s5L8DdSwDqlyWn0KA1sBUsLnVM2s1unAofk30=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 629BAF800C9;
	Mon, 20 Mar 2023 16:08:22 +0100 (CET)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 21961F8027B; Mon, 20 Mar 2023 16:08:17 +0100 (CET)
...
Received: from n169-114.mail.139.com (n169-114.mail.139.com [120.232.169.114])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 68777F80105
	for <alsa-devel@alsa-project.org>; Mon, 20 Mar 2023 16:07:58 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 68777F80105
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[183.194.157.166])
	by rmsmtp-lg-appmail-37-12051 (RichMail) with SMTP id 2f13641876c36be-a5d89;
	Mon, 20 Mar 2023 23:07:49 +0800 (CST)
X-RM-TRANSID: 2f13641876c36be-a5d89
...
Date: Mon, 20 Mar 2023 23:07:26 +0800
Message-Id: <20230320150726.20573-1-13916275206@139.com>
X-Mailer: git-send-email 2.34.1
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Message-ID-Hash: XF5IDC5LCB4NR23KSIQNA2IRDDR2SZRA
X-Message-ID-Hash: XF5IDC5LCB4NR23KSIQNA2IRDDR2SZRA
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/XF5IDC5LCB4NR23KSIQNA2IRDDR2SZRA/>
List-Archive: 
...
Changes in v4:
 ...
 - add comment for tas2781_digital_getvol on the reason to custom
   ...
   especially book switching will set the book swithc register, which is
   BXXP00R7F, after switching to the correct book, then the code
   can leverage the internal mechanism for paging, and access the
   register.
...
---
 ...
 sound/soc/codecs/tas2781-i2c.c | 1655 ++++++++++++++++++++++++
 sound/soc/codecs/tas2781.h     |  170 +++
 6 files changed, 4209 insertions(+)
...
new file mode 100644
index 000000000000..c5f1c8202d22
--- /dev/null
...
+		gpio_direction_output(tas_dev->rst_gpio, 0);
+
