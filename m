...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4187075A579
	for <lists+alsa-devel@lfdr.de>; Thu, 20 Jul 2023 07:29:53 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C337E1F6;
	Thu, 20 Jul 2023 07:29:01 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C337E1F6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1689830991;
	bh=izspD3tD8mGsfnJwUty/Nmk94tU4zIWfbb2EuRul08g=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=d//MeIpIJzlyx3u4fnmmJAGlBD9o5JZIAeo5gizzxhZ7C8RmSuBp7ruAmCOrMukQb
	 9yGmOkXcR3dIlm2A5fLncrxVs/pVy4XtfH0UNTF2abpG2DYDqfkT7Kv/Tvelkg+bJx
	 UlxVgWOqG9SYmW4C53jex3sKs6wS1h0JYjTjPRmI=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id D4B78F8027B; Thu, 20 Jul 2023 07:28:59 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 089D6F8032D;
	Thu, 20 Jul 2023 07:28:59 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id B0590F8047D; Thu, 20 Jul 2023 07:26:14 +0200 (CEST)
...
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.220.29])
 ...
 SHA256)
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 385B0F8027B
	for <alsa-devel@alsa-project.org>; Thu, 20 Jul 2023 07:25:25 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 385B0F8027B
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=suse.de header.i=@suse.de header.a=rsa-sha256
 header.s=susede2_rsa header.b=GXCFElv/;
	dkim=pass header.d=suse.de header.i=@suse.de header.a=ed25519-sha256
 header.s=susede2_ed25519 header.b=81teV+g1
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de
 [192.168.254.74])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
	(No client certificate requested)
	by smtp-out2.suse.de (Postfix) with ESMTPS id 561FD20480;
	Thu, 20 Jul 2023 05:25:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de;
 ...
 h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	...
	bh=I1WIaSm+5+ZKVqFpGSVBuQdYUwGr/rd6S+zs2/LYanE=;
	b=GXCFElv/HQrE3BlipMj5cZtM1z+8JwNwrJua6PLmnlXL6MjjPfoRAvRVb2doeF3a8N6uKE
	H+AL68xhYgbjCk9be5OMx4zBnAYGEFDkjcIEdfOrohb/2UjeokIuyeWdfPuCK2IyrkJ0QB
	n5Me/p2uSrAgDskpGKHKgjOB1l6Sm2o=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
	s=susede2_ed25519; t=1689830725;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
	 mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=I1WIaSm+5+ZKVqFpGSVBuQdYUwGr/rd6S+zs2/LYanE=;
	b=81teV+g1fxNZMQww9mQd9dueqoFrK/KA2NekdwmejX1TNv8iy9jOdbiCnRGpm1ITxMX/dU
	LkJ8rYyD6py4C7Cw==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de
 [192.168.254.74])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
	(No client certificate requested)
	by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id 230441361C;
	Thu, 20 Jul 2023 05:25:25 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
	by imap2.suse-dmz.suse.de with ESMTPSA
	id Y55wB0XFuGS/TgAAMHmgww
	(envelope-from <tiwai@suse.de>); Thu, 20 Jul 2023 05:25:25 +0000
Date: Thu, 20 Jul 2023 07:25:24 +0200
Message-ID: <874jlzkvcr.wl-tiwai@suse.de>
...
In-Reply-To: <b63ed57c9af6b6e4d52a2f73bf5d18bfbf5a996a.camel@uvos.xyz>
References: <dde0a305793ad7ddbd9e001e463207a84c2afcc9.camel@uvos.xyz>
	...
	<b63ed57c9af6b6e4d52a2f73bf5d18bfbf5a996a.camel@uvos.xyz>
User-Agent: Wanderlust/2.15.9 (Almost Unreal) Emacs/27.2 Mule/6.0
MIME-Version: 1.0 (generated by SEMI-EPG 1.14.7 - "Harue")
Content-Type: text/plain; charset=ISO-8859-1
Content-Transfer-Encoding: 8bit
Message-ID-Hash: UKLWKKSR4ZDN6IQQVL66RY52MFBWXWB4
X-Message-ID-Hash: UKLWKKSR4ZDN6IQQVL66RY52MFBWXWB4
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/UKLWKKSR4ZDN6IQQVL66RY52MFBWXWB4/>
List-Archive: 
...
On Wed, 19 Jul 2023 23:03:22 +0200,
Carl Klemm wrote:
> 
...
So the only condition is one playback and one capture?
And, you could reproduce with the aplay / arecord and -Dplughw, too?
We need to verify the exact condition to trigger the problem.
...
> > > > 
> > > > That's an interesting point.  You mean "values" as the PCM
> > > > positions?
...
> > > > 
> > > > And, how strange they are?  They jump up/down, random values, or
> > > > any
> > > > patterns?
> > > > 
> > > > 
...
> > > > > > tstamp,
> > > > > > hence
> > > > > > it must be the standard values.  That said, the incorrect
> > > > > > values
> > > > > > are
