...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 3450DCD2C0
	for <lists+alsa-devel@lfdr.de>; Sun,  6 Oct 2019 17:24:32 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 872BF1657;
	Sun,  6 Oct 2019 17:23:41 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 872BF1657
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1570375471;
	bh=DBsQzBmdstfTBk+OG3un14Ejac7205RyttKU+UmF1RQ=;
	h=From:To:Date:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=SUoG/jYUZrFbAIs/WKe+xUSPQHUB4AkzKOs7tij0kQ6KOjH6/O1oYAKzDEkHgffj3
	 +AEjGBITG+4QpxTtoZ0sG1dxdvJ23rjqZDSYUMqDAI4ajXQZcdH3aiBf6mcDzVp502
	 KulS3006pdeNk7u9uDP/pRUucAdU8wpiSNkonjfo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id CE345F8038F;
	Sun,  6 Oct 2019 17:22:46 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 8FE7CF8038F; Sun,  6 Oct 2019 17:22:44 +0200 (CEST)
...
Received: from mail1.perex.cz (mail1.perex.cz [77.48.224.245])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 8DF08F80137
 for <alsa-devel@alsa-project.org>; Sun,  6 Oct 2019 17:22:41 +0200 (CEST)
Received: from mail1.perex.cz (localhost [127.0.0.1])
 by smtp1.perex.cz (Perex's E-mail Delivery System) with ESMTP id BBF97A003F;
 Sun,  6 Oct 2019 17:22:40 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 smtp1.perex.cz BBF97A003F
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=perex.cz; s=default;
 t=1570375360; bh=VdaRtigZFWadlwyE4YErJYGrxMtb9CmOHFLsRqCoWuM=;
 h=From:To:Cc:Subject:Date:From;
 b=f7SGYz+2VavT3pLUG1f7OOXJ1o7M5GHMvTce8r8enQ8t1KOBAtCpiQ+L3aIBCafev
 vSZk3SX3sZpy03GDwnvsERh4PWiEzCf7RFldVaW41QtAD6JhmFkeP3SmwWozTDHZ2L
 SP3tjIqSEGfJZuSijvTjJZpMTLXyWynP1ZFoEkSE=
Received: from p50.perex-int.cz (unknown [192.168.100.94])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested) (Authenticated sender: perex)
 by mail1.perex.cz (Perex's E-mail Delivery System) with ESMTPSA;
 Sun,  6 Oct 2019 17:22:35 +0200 (CEST)
From: Jaroslav Kysela <perex@perex.cz>
To: ALSA development <alsa-devel@alsa-project.org>
Date: Sun,  6 Oct 2019 17:22:32 +0200
Message-Id: <20191006152232.17701-1-perex@perex.cz>
X-Mailer: git-send-email 2.20.1
MIME-Version: 1.0
Cc: Takashi Iwai <tiwai@suse.de>, Cezary Rojewski <cezary.rojewski@intel.com>,
 Pierre-Louis Bossart <pierre-louis.bossart@linux.intel.com>
Subject: [alsa-devel] [PATCH v3] ALSA: hda: add Intel DSP configuration /
	probe code
...
---
 ...
 sound/hda/intel-dsp-config.c     | 247 +++++++++++++++++++++++++++++++
...
new file mode 100644
index 000000000000..3f06377a1808
--- /dev/null
