...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 6452E380776
	for <lists+alsa-devel@lfdr.de>; Fri, 14 May 2021 12:38:25 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id B507417A9;
	Fri, 14 May 2021 12:37:34 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz B507417A9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1620988705;
	bh=XsPr/wJ0c5ulevoY3SgmAwqws0mVvAYwMgZp3Zk5ZX8=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=n9Rwfs4oJoV0xS9NGBrjz2OjfE/Jz11nLy3GJT63rbPBIaW6ZWc2F+vgVATtIy7Xa
	 /pl9BnldD28YuECTPxa33uW1qptQ09jop52K+7nRO5LluIg+hwaPyU+3UP+vNeXenT
	 686/KbtQ/r3Sd1TwNW+o5XTdA+gzmXC04DPwhCf8=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 7408EF804D8;
	Fri, 14 May 2021 12:34:51 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 64A2CF804B1; Fri, 14 May 2021 12:34:48 +0200 (CEST)
...
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 8716AF80272
 for <alsa-devel@alsa-project.org>; Fri, 14 May 2021 12:34:33 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 8716AF80272
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="Lz5YjJO9"
Received: by mail-wr1-x435.google.com with SMTP id i17so293315wrq.11
 for <alsa-devel@alsa-project.org>; Fri, 14 May 2021 03:34:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=80/0x9ry2jmmxC2svXckot6Hh6Omiks8MHmj3hnAXyk=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=80/0x9ry2jmmxC2svXckot6Hh6Omiks8MHmj3hnAXyk=;
 b=
X-Gm-Message-State: AOAM533/GKpCUVjERMDp5TawsEGHfUV+pqBwnAQsXyKKskOlEzSJf02z
 D7417YFN4K62b0cWwsCkLuK5cQ==
X-Google-Smtp-Source: ABdhPJxewtnQDmlEu46+dyVYobrQ3Dd+2ebbYCR53LlkdJGTjziZUla+ewUVNRVSzysRlFkX84pFGg==
X-Received: by 2002:a5d:6484:: with SMTP id o4mr56220312wri.8.1620988472740;
 Fri, 14 May 2021 03:34:32 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id k16sm5015498wmi.44.2021.05.14.03.34.31
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 14 May 2021 03:34:32 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH v5 3/9] ASoC: codecs: wcd938x: add basic driver
Date: Fri, 14 May 2021 11:33:59 +0100
Message-Id: <20210514103405.29927-4-srinivas.kandagatla@linaro.org>
...
---
 ...
 sound/soc/codecs/wcd938x.c | 1746 ++++++++++++++++++++++++++++++++++++
...
index 000000000000..6a0817868673
--- /dev/null
...
+	}
+
+	wcd938x->rxdev = bus_find_device_by_of_node(&sdw_bus_type, wcd938x->rxnode);
+	if (!wcd938x->rxdev) {
...
+
+	wcd938x->txdev = bus_find_device_by_of_node(&sdw_bus_type, wcd938x->txnode);
+	if (!wcd938x->txdev) {
