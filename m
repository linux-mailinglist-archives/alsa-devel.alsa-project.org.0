...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id A8BA57E0FE4
	for <lists+alsa-devel@lfdr.de>; Sat,  4 Nov 2023 15:26:47 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 18512846;
	Sat,  4 Nov 2023 15:25:57 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 18512846
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1699108007;
	bh=xgNPDFcom/uOLepK7uyPTekkKbeUXzgTCfEm/VP+56U=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=mOVVt7fCuEGzGEo1InJMA1K3FnAP5TKJ8JBhcTFUBbkQm/aBKfIcp6nZBxRh+L3Py
	 m4ylTB/njW45EUwBNbPdyZLQby/0oN55f9fGpzA179GgmN6p4ygvf94MzT5qI7DIUW
	 i7y8VocfYBWWYxod8tINLvU0wo23cLqYwTFpPjtE=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id BFFBAF8057E; Sat,  4 Nov 2023 15:25:19 +0100 (CET)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 6080DF8057A;
	Sat,  4 Nov 2023 15:25:19 +0100 (CET)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 93C2DF8057B; Sat,  4 Nov 2023 15:25:15 +0100 (CET)
...
Received: from us-smtp-delivery-124.mimecast.com
 ...
 SHA256)
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 527ACF8014B
	for <alsa-devel@alsa-project.org>; Sat,  4 Nov 2023 15:24:48 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 527ACF8014B
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=redhat.com header.i=@redhat.com header.a=rsa-sha256
 header.s=mimecast20190719 header.b=g2WOILGx
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1699107887;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=uuT4bwJMa/aBiuNnuCjyGU9b1XhYPIwDkqtL10vvzgk=;
	b=g2WOILGxkR0QEz2JGUobvyWS3YS9X9Tkx4uTqDpeIg0PeXfRFHEyjO8GMDWb8sJKFoNac5
	qDa4JNS7e4IaR1GO/GLlSshnjVrtEaC0RURYFQ2/QkbtJDUh9sp12iW6kfMokMT+s2TO48
	hRpBLJKwK5mDlRmKjs5hUazyT79AqJQ=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_256_GCM_SHA384) id
 us-mta-126-Rc8EmzOzMkmk6M5ar6R0MA-1; Sat, 04 Nov 2023 10:24:45 -0400
X-MC-Unique: Rc8EmzOzMkmk6M5ar6R0MA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com
 ...
 SHA256)
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 3FBD180C343;
	Sat,  4 Nov 2023 14:24:45 +0000 (UTC)
Received: from shalem.redhat.com (unknown [10.39.192.2])
	by smtp.corp.redhat.com (Postfix) with ESMTP id E61F225C0;
...
Subject: [PATCH 1/4] ASoC: Intel: es83xx: add ACPI DSM helper module
Date: Sat,  4 Nov 2023 15:24:36 +0100
Message-ID: <20231104142439.21983-2-hdegoede@redhat.com>
...
Message-ID-Hash: 2BQCQIG7W4B2X3OC42TVWTX7ES5K5XNL
X-Message-ID-Hash: 2BQCQIG7W4B2X3OC42TVWTX7ES5K5XNL
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/2BQCQIG7W4B2X3OC42TVWTX7ES5K5XNL/>
List-Archive: 
...
[hdegoede@redhat.com: Move from sound/soc/codecs to sounds/soc/intel/boards]
...
index 9e427f00deac..3acd1aefda75 100644
--- a/sound/soc/intel/boards/Kconfig
+++ b/sound/soc/intel/boards/Kconfig
@@ -222,6 +222,10 @@ config SND_SOC_INTEL_BYT_CHT_DA7213_MACH
...
index 943bf8b80e01..02a51373f383 100644
...
@@ -45,6 +46,7 @@ snd-soc-sof-sdw-objs += sof_sdw.o				\
 			sof_sdw_cs42l42.o sof_sdw_cs42l43.o	\
 			sof_sdw_cs_amp.o			\
 			sof_sdw_hdmi.o
+obj-$(CONFIG_SND_SOC_INTEL_ES83XX_DSM_COMMON) += snd-soc-es83xx-dsm-common.o
 obj-$(CONFIG_SND_SOC_INTEL_SOF_RT5682_MACH) += snd-soc-sof_rt5682.o
 obj-$(CONFIG_SND_SOC_INTEL_SOF_CS42L42_MACH) += snd-soc-sof_cs42l42.o
 obj-$(CONFIG_SND_SOC_INTEL_SOF_ES8336_MACH) += snd-soc-sof_es8336.o
diff --git a/sound/soc/intel/boards/es83xx-dsm-common.c b/sound/soc/intel/boards/es83xx-dsm-common.c
new file mode 100644
index 000000000000..94fd7d54c53b
--- /dev/null
+++ b/sound/soc/intel/boards/es83xx-dsm-common.c
@@ -0,0 +1,89 @@
+// SPDX-License-Identifier: GPL-2.0-only
+//
...
+MODULE_LICENSE("GPL");
diff --git a/sound/soc/intel/boards/es83xx-dsm-common.h b/sound/soc/intel/boards/es83xx-dsm-common.h
new file mode 100644
index 000000000000..91c9a89e75e9
--- /dev/null
+++ b/sound/soc/intel/boards/es83xx-dsm-common.h
@@ -0,0 +1,393 @@
+/* SPDX-License-Identifier: GPL-2.0-only */
+/*
+ * Copyright (c) Intel Corporation, 2022
