...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id DE55063BA1E
	for <lists+alsa-devel@lfdr.de>; Tue, 29 Nov 2022 08:03:45 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 622A51693;
	Tue, 29 Nov 2022 08:02:55 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 622A51693
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1669705425;
	bh=D/tHxCdhBfOj3EnRT9jhwshxa2LMQUijhGnqAn2tBIg=;
	h=Date:From:To:Subject:References:In-Reply-To:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=Q2xH0h9oSRfV+f3laivP8DV8R+WzMOGecNG1b4SN9qmJYQBtyhgyHC9ZemPN85HGt
	 L2GukiTFij3vgMBoMjLnLbRjzfH2RpvjJxg25OPN88/QlKbLh3mGxucjOAflN/AW/s
	 0XB0qAfM7GnR9pjrhGJVt2WgGtSpfms7/RU3Ngmo=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id A7F76F80482;
	Tue, 29 Nov 2022 08:02:26 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 092E0F8027D; Sun, 27 Nov 2022 09:50:49 +0100 (CET)
...
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id D1807F80169
 for <alsa-devel@alsa-project.org>; Sun, 27 Nov 2022 09:50:32 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz D1807F80169
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com
 header.b="mK61dHg9"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1669539034; x=1701075034;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=D/tHxCdhBfOj3EnRT9jhwshxa2LMQUijhGnqAn2tBIg=;
 b=mK61dHg903V6t63MH9x6jiB/Z3/akmdePG1C/T6OfqhiBbPWWdMCE+uU
 TT95V4O+xAa6ps5+bpOUepDjQuypOD3oRPFA+cj/fMHpgQNonXUkx8jts
 pnMGp9Dbz3xt5tlFg+xGlYchrjjk/iGWLEcjr151A8Bl3xfD6MBBLvIcN
 eWfwBLcZojCGtxa8t2pnCKAk1qdsVIFWw3sn/IKPTJY7QBPOXipWgSfb8
 q53zk9uM6XExg3SX0gwkiubEFeuDP9j2MWQs8lpQ0tyMXZJv38Ev9PY33
 xfGOZCKtro31Z1GzvIby0fxCMaL1yEo8pkaAgnjrGnuxumc3Y1bT5afIQ Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10543"; a="294357194"
X-IronPort-AV: E=Sophos;i="5.96,198,1665471600"; d="scan'208";a="294357194"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 27 Nov 2022 00:50:27 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10543"; a="645159158"
X-IronPort-AV: E=Sophos;i="5.96,198,1665471600"; d="scan'208";a="645159158"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
 by fmsmga007.fm.intel.com with ESMTP; 27 Nov 2022 00:50:25 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ozDMm-0006tL-1K;
 Sun, 27 Nov 2022 08:50:24 +0000
Date: Sun, 27 Nov 2022 16:49:42 +0800
From: kernel test robot <lkp@intel.com>
To: Daniel Beer <daniel.beer@igorinstitute.com>,
	alsa-devel@alsa-project.org
Subject: Re: [PATCH 1/2] ASoC: tas5805m: rework to avoid scheduling while
 atomic.
Message-ID: <202211271634.gGggqMdS-lkp@intel.com>
References: <638311c1.170a0220.5d7c0.85d6@mx.google.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="c91T80mUnzNfvyMY"
Content-Disposition: inline
In-Reply-To: <638311c1.170a0220.5d7c0.85d6@mx.google.com>
...
url:    https://github.com/intel-lab-lkp/linux/commits/Daniel-Beer/ASoC-tas5805m-rework-to-avoid-scheduling-while-atomic/20221127-152934
base:   https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound.git for-next
patch link:    https://lore.kernel.org/r/638311c1.170a0220.5d7c0.85d6%40mx.google.com
patch subject: [PATCH 1/2] ASoC: tas5805m: rework to avoid scheduling while atomic.
config: m68k-allyesconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/834b4c86b998cb6b51da6d2ab3f3d2110e17c6ab
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Daniel-Beer/ASoC-tas5805m-rework-to-avoid-scheduling-while-atomic/20221127-152934
        git checkout 834b4c86b998cb6b51da6d2ab3f3d2110e17c6ab
...
vim +/ret +251 sound/soc/codecs/tas5805m.c
   ...
   243	
   244	static int tas5805m_vol_put(struct snd_kcontrol *kcontrol,
   245				    struct snd_ctl_elem_value *ucontrol)
   246	{
   247		struct snd_soc_component *component =
   248			snd_soc_kcontrol_component(kcontrol);
   249		struct tas5805m_priv *tas5805m =
   250			snd_soc_component_get_drvdata(component);
 > 251		int ret = 0;
   252	
   253		if (!(volume_is_valid(ucontrol->value.integer.value[0]) &&
   254		      volume_is_valid(ucontrol->value.integer.value[1])))
   255			return -EINVAL;
   256	
   257		mutex_lock(&tas5805m->lock);
   258		if (tas5805m->vol[0] != ucontrol->value.integer.value[0] ||
   259		    tas5805m->vol[1] != ucontrol->value.integer.value[1]) {
   260			tas5805m->vol[0] = ucontrol->value.integer.value[0];
   261			tas5805m->vol[1] = ucontrol->value.integer.value[1];
   262			dev_dbg(component->dev, "set vol=%d/%d (is_powered=%d)\n",
   263				tas5805m->vol[0], tas5805m->vol[1],
   264				tas5805m->is_powered);
   265			if (tas5805m->is_powered)
