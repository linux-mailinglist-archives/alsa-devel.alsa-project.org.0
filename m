...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 65052686902
	for <lists+alsa-devel@lfdr.de>; Wed,  1 Feb 2023 15:54:47 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id EE8BCAE9;
	Wed,  1 Feb 2023 15:53:55 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz EE8BCAE9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1675263286;
	bh=fqXv3BWshCgK7HK/n9c/lRNL5ckQxNbpzJV/KdU5ghw=;
	h=From:To:Subject:Date:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:Cc:From;
	b=hUqV+GVWcAhoPqDUrkgsP9Ll1FeNt5P8fOGcAeQHSdOcTlzpZld6X8yamScfCsqib
	 f+8B5DFWS/QWwYw3gZMjgr/UmsI9ddsuEbc+IcnYQKpRDDMc3UAITJkdLPiuwc2f6d
	 egnrSFAX2VjEGWwcF62Jr2zck+1oszjjpIWXz3XE=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 1E017F80552;
	Wed,  1 Feb 2023 15:52:55 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id EAB11F80155; Tue, 31 Jan 2023 14:17:35 +0100 (CET)
...
Received: from n169-113.mail.139.com (n169-113.mail.139.com [120.232.169.113])
 ...
 by alsa1.perex.cz (Postfix) with ESMTPS id 81F53F80155
 for <alsa-devel@alsa-project.org>; Tue, 31 Jan 2023 14:17:17 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 81F53F80155
X-RM-TagInfo: emlType=0                                       
X-RM-SPAM: 
X-RM-SPAM-FLAG: 00000000
Received: from localhost.localdomain (unknown[39.144.43.110])
 by rmsmtp-lg-appmail-33-12047 (RichMail) with SMTP id 2f0f63d914d346a-3b780;
 Tue, 31 Jan 2023 21:17:12 +0800 (CST)
X-RM-TRANSID: 2f0f63d914d346a-3b780
From: Shenghao Ding <13916275206@139.com>
To: broonie@kernel.org, lgirdwood@gmail.com, perex@perex.cz,
 pierre-louis.bossart@linux.intel.com
Subject: [PATCH v2] ASoC: tas2781: Add tas2781 driver.
Date: Tue, 31 Jan 2023 21:17:01 +0800
Message-Id: <20230131131701.7097-1-13916275206@139.com>
...
Cc: kevin-lu@ti.com, Shenghao Ding <13916275206@139.com>,
...
---
 ...
 sound/soc/codecs/tas2781-dsp.c | 2273 ++++++++++++++++++++++++++++++++
 sound/soc/codecs/tas2781-dsp.h |  178 +++
 sound/soc/codecs/tas2781-i2c.c | 1926 +++++++++++++++++++++++++++
 sound/soc/codecs/tas2781.h     |  176 +++
 6 files changed, 4567 insertions(+)
...
index 0f9d71490..9016c4846 100644
...
index 71d3ce586..49f912aea 100644
...
+	struct tasdevice_block *block, const struct firmware *fmw, int offset)
+{
...
+
+	img_data->dev_blks =
+		kcalloc(img_data->n_blk, sizeof(struct tasdevice_block),
+			GFP_KERNEL);
...
+	struct tasdevice_priv *tasdevice, struct tasdevice_block *block)
+{
+	int ret = 0;
+
...
+					struct tasdevice_block *block;
+
+					for (n_block = 0; n_block <
+						img_data->n_blk;
+						n_block++) {
+						block =
+						&(img_data->dev_blks[n_block]);
+						kfree(block->data);
+					}
...
+		dev_err(tas_dev->dev, "File size not match, %ld %u", fmw->size,
+			fw_fixed_hdr->fwsize);
+		offset = -1;
+		goto out;
+	}
...
+	int ret = 0;
+	unsigned int n_block = 0;
+	struct tasdevice_block *block = NULL;
+
...
+		goto out;
+	}
+	offset = fw_parse_variable_header_cal(tas_dev, tas_fmw, &fmw,
+		offset);
+	if (offset == -1) {
+		dev_err(tas_dev->dev,
...
+				struct tasdevice_config *config;
+
+				for (i = 0; i < tas_fmw->n_configurations;
+					i++) {
+					config =
+					&(tas_fmw->configs[i]);
+					if (config) {
...
+	char name[64];
+	unsigned int n_blk;
+	struct tasdevice_block *dev_blks;
+};
...
+	if (tas_dev == NULL) {
+		dev_err(tas_dev->dev,
+			"tasdev: rca_ready: handle is NULL\n");
+		return;
+	}
+	mutex_lock(&tas_dev->codec_lock);
+	rca = &(tas_dev->rcabin);
...
+		break;
+	}
+	tasdevice_set_power_state(tas_dev, pwr_state);
+	/* Codec Lock Release*/
+	mutex_unlock(&tas_dev->codec_lock);
+out:
+	return 0;
