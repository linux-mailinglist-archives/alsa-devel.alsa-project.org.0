...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A0BC38B59E
	for <lists+alsa-devel@lfdr.de>; Thu, 20 May 2021 19:56:54 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 7C90816BA;
	Thu, 20 May 2021 19:56:03 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 7C90816BA
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1621533413;
	bh=pvvVoN9BqAcxbgcv524NaAQ9PJRunLrzEaRq0Li2Rkw=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=gBduI3L71l2imXySVyGiIroWJVu3Ttel6v/4p+ZFc4WQHuS5sCc+ZiaLcx8i3d9lj
	 /5Ku3jm4GNZoY2+uwWNQad0uAQNcAaUJLLJ8geiW4uZil2ONMHbl/09CYjSakYnOxS
	 44GG+uyO0c549I2xqhbra/CDlNtUm5By1pOvMQ50=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 5E162F8049C;
	Thu, 20 May 2021 19:54:39 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 4444AF8020B; Thu, 20 May 2021 19:54:36 +0200 (CEST)
...
Received: from mail-lf1-x131.google.com (mail-lf1-x131.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id CD13AF800C1
 for <alsa-devel@alsa-project.org>; Thu, 20 May 2021 19:54:26 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz CD13AF800C1
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="ks8elTIy"
Received: by mail-lf1-x131.google.com with SMTP id j6so23111068lfr.11
 for <alsa-devel@alsa-project.org>; Thu, 20 May 2021 10:54:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=CwT0UUNEjqDR57IbFfsmxNUkcaHjUPF+RhyQabOCgZY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=CwT0UUNEjqDR57IbFfsmxNUkcaHjUPF+RhyQabOCgZY=;
 b=
X-Gm-Message-State: AOAM5325a/yLPiZDMxu/knIZICLx/PzrO12ok0ldgHL7sb/2kR264ehG
 6kNBbg3QjHOfCnelVnke7CM=
X-Google-Smtp-Source: ABdhPJySs9GO1uIU4nxb4XPrRdqvGXhCxyeeDe6YPgia2pLMm6cj3CSI5OGUufnLmbLMM5HeihU9TA==
X-Received: by 2002:a19:c55:: with SMTP id 82mr4270502lfm.429.1621533265107;
 Thu, 20 May 2021 10:54:25 -0700 (PDT)
Received: from localhost.localdomain (109-252-193-88.dynamic.spd-mgts.ru.
 [109.252.193.88])
 by smtp.gmail.com with ESMTPSA id h16sm362972ljb.128.2021.05.20.10.54.24
...
Subject: [PATCH v2 2/2] ASoC: tegra: Unify ASoC machine drivers
Date: Thu, 20 May 2021 20:50:54 +0300
Message-Id: <20210520175054.28308-3-digetx@gmail.com>
...
index 66828c1a2a3a..c454a34c15c4 100644
--- a/sound/soc/tegra/tegra20_ac97.c
+++ b/sound/soc/tegra/tegra20_ac97.c
@@ -220,7 +220,6 @@ static int tegra20_ac97_probe(struct snd_soc_dai *dai)
...
index 000000000000..3e7bea8dd2c3
--- /dev/null
...
new file mode 100644
index 000000000000..43bfb3f8d735
--- /dev/null
...
index f219c26d66a3..131229be74b7 100644
...
-		return dev_err_probe(&pdev->dev, ret,
-				     "snd_soc_register_card failed\n");
+/* older device-trees use wrong polarity for the headphone GPIO */
