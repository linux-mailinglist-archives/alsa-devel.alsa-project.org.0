...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B7803F8393
	for <lists+alsa-devel@lfdr.de>; Thu, 26 Aug 2021 10:11:41 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C8AE21612;
	Thu, 26 Aug 2021 10:10:50 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C8AE21612
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1629965501;
	bh=BHVmXSs/I1oEDTpgsKERjpyRPg60dLP3FHxKVTtvZdE=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=DKE9wzVxPlCRQBHyfmdZ23wyEpqlbeGzJLspIoO8624N+Uc65y7OW2PIfRCI95tgz
	 y9klTnhTRbCI/JTP8LqMec3Xn46nWKNxHkncJ1Uzfi5tfoCUBGB5/u0gGcSso+VpgQ
	 ueCJQFogjGGuylb6sC+qPXGTzYUdMXxey0stIJlA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id E3E48F8032D;
	Thu, 26 Aug 2021 10:10:22 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id B631BF80224; Thu, 26 Aug 2021 10:10:18 +0200 (CEST)
...
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id CC6FEF80054
 for <alsa-devel@alsa-project.org>; Thu, 26 Aug 2021 10:09:53 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz CC6FEF80054
Authenticated-By: 
X-SpamFilter-By: ArmorX SpamTrap 5.73 with qID 17Q89kIU2006492,
 This message is accepted by code: ctloc85258
Received: from mail.realtek.com (rtexh36501.realtek.com.tw[172.21.6.27])
 by rtits2.realtek.com.tw (8.15.2/2.71/5.88) with ESMTPS id 17Q89kIU2006492
 (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=NOT);
 Thu, 26 Aug 2021 16:09:46 +0800
Received: from RTEXMBS01.realtek.com.tw (172.21.6.94) by
 RTEXH36501.realtek.com.tw (172.21.6.27) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Thu, 26 Aug 2021 16:09:45 +0800
Received: from derek-PORTEGE-R930.realtek.com.tw (172.22.102.119) by
 RTEXMBS01.realtek.com.tw (172.21.6.94) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2106.2; Thu, 26 Aug 2021 16:09:43 +0800
From: <derek.fang@realtek.com>
To: <broonie@kernel.org>, <lgirdwood@gmail.com>
Subject: [PATCH 1/2] ASoC: rt5682s: Add driver for ALC5682I-VS codec
Date: Thu, 26 Aug 2021 16:09:37 +0800
Message-ID: <20210826080938.14872-1-derek.fang@realtek.com>
...
---
 ...
 sound/soc/codecs/rt5682s.c | 3231 ++++++++++++++++++++++++++++++++++++
...
index 000000000000..37ecede2becd
--- /dev/null
...
new file mode 100644
index 000000000000..86df1dabf103
--- /dev/null
...
+
+	if (jack_insert) {
+		rt5682s_enable_push_button_irq(component, false);
...
+			rt5682s_enable_push_button_irq(component, true);
+			break;
+		default:
...
+};
+
+static SOC_ENUM_SINGLE_DECL(rt5682s_if2_adc_enum,
+	RT5682S_DIG_INF2_DATA, RT5682S_IF2_ADC_SEL_SFT,
+	rt5682s_data_select);
+
+static SOC_ENUM_SINGLE_DECL(rt5682s_if1_01_adc_enum,
+	RT5682S_TDM_ADDA_CTRL_1, RT5682S_IF1_ADC1_SEL_SFT,
+	rt5682s_data_select);
+
+static SOC_ENUM_SINGLE_DECL(rt5682s_if1_23_adc_enum,
+	RT5682S_TDM_ADDA_CTRL_1, RT5682S_IF1_ADC2_SEL_SFT,
+	rt5682s_data_select);
+
+static SOC_ENUM_SINGLE_DECL(rt5682s_if1_45_adc_enum,
+	RT5682S_TDM_ADDA_CTRL_1, RT5682S_IF1_ADC3_SEL_SFT,
+	rt5682s_data_select);
+
+static SOC_ENUM_SINGLE_DECL(rt5682s_if1_67_adc_enum,
+	RT5682S_TDM_ADDA_CTRL_1, RT5682S_IF1_ADC4_SEL_SFT,
+	rt5682s_data_select);
+
...
+	rt5682s_sto1_adc1l_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_sto1_adc1r_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_sto1_adcl_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_sto1_adcr_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_sto1_adc2l_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_sto1_adc2r_enum, RT5682S_STO1_ADC_MIXER,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_alg_dac_l1_enum, RT5682S_A_DAC1_MUX,
...
+
+static SOC_ENUM_SINGLE_DECL(
+	rt5682s_alg_dac_r1_enum, RT5682S_A_DAC1_MUX,
...
+		RT5682S_DMIC_1_EN_SFT, 0, set_dmic_power,
...
+		RT5682S_I2S1_SDP, RT5682S_SEL_ADCDAT_SFT, 1),
+	SND_SOC_DAPM_AIF_OUT("AIF2TX", "AIF2 Capture", 0,
+		RT5682S_I2S2_SDP, RT5682S_I2S2_PIN_CFG_SFT, 1),
...
+
+	if (source == rt5682s->pll_src[pll_id] &&
+	    freq_in == rt5682s->pll_in[pll_id] &&
...
+	}
+
+	ret = devm_add_action_or_reset(&i2c->dev, rt5682s_i2c_disable_regulators,
+					rt5682s);
+	if (ret)
+		return ret;
+
...
+
+	/* DMIC pin*/
+	if (rt5682s->pdata.dmic1_data_pin != RT5682S_DMIC1_NULL) {
...
+					RT5682S_PAD_DRIVING_CTRL,
+					RT5682S_PAD_DRV_GP3_MASK,
