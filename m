...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id A39FF1CF183
	for <lists+alsa-devel@lfdr.de>; Tue, 12 May 2020 11:23:38 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 357261684;
	Tue, 12 May 2020 11:22:48 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 357261684
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1589275418;
	bh=F7+ec+EEIFcDM2kQRT/rG/PaT1oB2oxrbaAwcbOIuX4=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=QaSsIM8dexfZnEImcKTm1BV7YVs3Y2KLoXC/dO0nYISWcElyQzFDG+KxBD6WaxWOr
	 tamL2UnyBl7gJnqfZW+vKTnqKNMA8AeVavVnDcXqY5vzdewa4ucHEjsSmm1FTBAeOy
	 1+iPWWUmTrs4N4ep2pYcHp6buIdUtKfwg7uWY4OA=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 6953CF8014C;
	Tue, 12 May 2020 11:21:57 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 8F9C8F800E3; Tue, 12 May 2020 11:21:54 +0200 (CEST)
...
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C8981F800E3
 for <alsa-devel@alsa-project.org>; Tue, 12 May 2020 11:21:47 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C8981F800E3
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="OARCwPhN"
Received: by mail-pf1-x444.google.com with SMTP id b190so335946pfg.6
 for <alsa-devel@alsa-project.org>; Tue, 12 May 2020 02:21:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20161025;
 h=from:to:cc:subject:date:message-id;
 bh=bdZ+1tTeVwhmIsUJKMNKB3qabcWz+lYCyLqV8kE9W1w=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id;
 bh=bdZ+1tTeVwhmIsUJKMNKB3qabcWz+lYCyLqV8kE9W1w=;
 b=
X-Gm-Message-State: AGi0PubP3CuhNkf5Wjh1Xpz6ubKjjrRDPpjHsF2T0SCJIIuos889xccO
 NBCQ+WLvsy/9KlngLKB0pAg=
X-Google-Smtp-Source: APiQypKch0xVxRm8ulQN5xOViq5o6DXpaY1zZHsNItb7p/VRTTM00Ni24mKs50wC08PRHpuU8IA6Zg==
X-Received: by 2002:a63:d850:: with SMTP id k16mr18882550pgj.190.1589275303600; 
 Tue, 12 May 2020 02:21:43 -0700 (PDT)
Received: from localhost.localdomain ([2001:2d8:308:9c7a:d5fe:3ea6:5791:c8e8])
 by smtp.gmail.com with ESMTPSA id
 z190sm11650088pfb.1.2020.05.12.02.21.35
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Tue, 12 May 2020 02:21:42 -0700 (PDT)
...
Subject: [V2 PATCH 2/2] ASoC: max98390: Added Amplifier Driver
Date: Tue, 12 May 2020 18:21:01 +0900
Message-Id: <20200512092101.31295-1-steves.lee@maximintegrated.com>
...
index 000000000000..c12da25885e4
--- /dev/null
...
+{
+	int ret;
+	const char *filename = "dsm_param.bin";
+	struct max98390_priv *max98390 =
+		snd_soc_component_get_drvdata(component);
