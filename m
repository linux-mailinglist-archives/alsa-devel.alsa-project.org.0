...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id B07BD3780FD
	for <lists+alsa-devel@lfdr.de>; Mon, 10 May 2021 12:14:37 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 338FB16B9;
	Mon, 10 May 2021 12:13:47 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 338FB16B9
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1620641677;
	bh=emQuENpNXhGby7eX5zzJCd8ywWCLnyTm8qwEjVZFC8A=;
	h=From:To:Subject:Date:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=FKNkfHivla0AdV6lp+3Hxm2rnJ8j1kipfE5/sJQgVJui8kH56qIvzK2DnwNhxK9+c
	 wnenkRcmht5YidR0JyUn1kZ5VHMOyMAoNcRoHLS9advBTgl1PfxETuGwCTfbXyftHw
	 B1XdU0wXb8VuxklbkbnIsCUl2csSRQaciY/iQcQM=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C622CF8042F;
	Mon, 10 May 2021 12:12:27 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 1563FF8042F; Mon, 10 May 2021 12:12:26 +0200 (CEST)
...
Received: from mail-wr1-x432.google.com (mail-wr1-x432.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 4698DF8026F
 for <alsa-devel@alsa-project.org>; Mon, 10 May 2021 12:12:16 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 4698DF8026F
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org
 header.b="Q5v2VI6I"
Received: by mail-wr1-x432.google.com with SMTP id l14so15990084wrx.5
 for <alsa-devel@alsa-project.org>; Mon, 10 May 2021 03:12:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linaro.org; s=google;
 h=from:to:cc:subject:date:message-id:in-reply-to:references
 :mime-version:content-transfer-encoding;
 bh=kov3DHVBsm94RDk7IqozCly1pvd9ESMGJCjHvu/XDkM=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=kov3DHVBsm94RDk7IqozCly1pvd9ESMGJCjHvu/XDkM=;
 b=
X-Gm-Message-State: AOAM532vngddExxYneRCNGFHVrTjX42NVPv1xVUxZ17SRDRAQ67NEjtN
 TOSzfgegaOUgpDNl26Eeb/vtOw==
X-Google-Smtp-Source: ABdhPJzq8ZkWbnjqVdhQUfvUFMGgO+h4l8AUoJATEwIbzriTRr2yXWSnhoFBp0RIssHausv88tD6Uw==
X-Received: by 2002:adf:e846:: with SMTP id d6mr29608274wrn.356.1620641536265; 
 Mon, 10 May 2021 03:12:16 -0700 (PDT)
Received: from srini-hackbox.lan
 (cpc86377-aztw32-2-0-cust226.18-1.cable.virginm.net. [92.233.226.227])
 by smtp.gmail.com with ESMTPSA id b7sm22072109wri.83.2021.05.10.03.12.15
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 10 May 2021 03:12:15 -0700 (PDT)
From: Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
To: broonie@kernel.org
Subject: [PATCH 3/4] ASoC: codecs: wcd934x: add mbhc support
Date: Mon, 10 May 2021 11:12:00 +0100
Message-Id: <20210510101201.7281-4-srinivas.kandagatla@linaro.org>
...
---
 ...
 3 files changed, 928 insertions(+), 15 deletions(-)
...
index 2faf0809d01f..9533ccddd22c 100644
--- a/sound/soc/codecs/Kconfig
+++ b/sound/soc/codecs/Kconfig
@@ -1531,6 +1531,7 @@ config SND_SOC_WCD_MBHC
...
index 046874ef490e..25124235e7e6 100644
...
@@ -2287,6 +2380,696 @@ static irqreturn_t wcd934x_slim_irq_handler(int irq, void *data)
 	return ret;
 }
...
+}
 ...
 {
 	struct wcd934x_codec *wcd = dev_get_drvdata(component->dev);
@@ -2309,6 +3092,10 @@ static int wcd934x_comp_probe(struct snd_soc_component *component)
...
@@ -3756,6 +4543,7 @@ static int wcd934x_codec_enable_hphl_pa(struct snd_soc_dapm_widget *w,
 					int event)
 {
...
@@ -3788,6 +4576,7 @@ static int wcd934x_codec_enable_hphl_pa(struct snd_soc_dapm_widget *w,
...
@@ -3806,6 +4595,7 @@ static int wcd934x_codec_enable_hphl_pa(struct snd_soc_dapm_widget *w,
...
@@ -3817,6 +4607,7 @@ static int wcd934x_codec_enable_hphr_pa(struct snd_soc_dapm_widget *w,
 					int event)
 {
 	struct snd_soc_component *comp = snd_soc_dapm_to_component(w->dapm);
+	struct wcd934x_codec *wcd = snd_soc_component_get_drvdata(comp);
 	...
 	switch (event) {
 	case SND_SOC_DAPM_POST_PMU:
@@ -3851,6 +4642,7 @@ static int wcd934x_codec_enable_hphr_pa(struct snd_soc_dapm_widget *w,
...
@@ -3868,6 +4660,7 @@ static int wcd934x_codec_enable_hphr_pa(struct snd_soc_dapm_widget *w,
 		 * disabled, then 20ms delay is needed after PA disable.
 		 */
 		usleep_range(20000, 20100);
...
@@ -4323,6 +5116,29 @@ static int wcd934x_codec_enable_adc(struct snd_soc_dapm_widget *w,
 	return 0;
 }
...
@@ -4778,13 +5594,17 @@ static const struct snd_soc_dapm_widget wcd934x_dapm_widgets[] = {
...
@@ -4961,6 +5781,26 @@ static const struct snd_soc_dapm_route wcd934x_audio_map[] = {
 	{"SRC1", NULL, "IIR1"},
 };
...
@@ -4971,11 +5811,13 @@ static const struct snd_soc_component_driver wcd934x_component_drv = {
...
@@ -5001,6 +5843,18 @@ static int wcd934x_codec_parse_data(struct wcd934x_codec *wcd)
...
@@ -5020,6 +5874,7 @@ static int wcd934x_codec_probe(struct platform_device *pdev)
