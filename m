...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E0EBF625454
	for <lists+alsa-devel@lfdr.de>; Fri, 11 Nov 2022 08:13:42 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 6B81A1674;
	Fri, 11 Nov 2022 08:12:52 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 6B81A1674
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1668150822;
	bh=bZs7GE5LPPvVRYSMyOmhxs8CknSTXgIZnrNa8RU3DJg=;
	h=Date:From:To:Subject:References:In-Reply-To:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=CrfVnO/APY3vT4s7mlGS18bSS3s/wg0Pdc57hE5iOnGowhBH7/S4hDxyh4S3x3Q/7
	 YBxuL4QCkX86l7vIUwBqdP/6GRPVf/hmDp0V7GtfomOv0G4WH3BnXojM7GeGJc6tmF
	 flxe0SKK22uP7cw0ntSiJMaatfE5suyVXfq2UUUs=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 253C0F80536;
	Fri, 11 Nov 2022 08:12:22 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 9C7FCF80162; Thu, 10 Nov 2022 21:21:07 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: *
X-Spam-Status: No, score=1.6 required=5.0 tests=DKIM_SIGNED,DKIM_VALID,
 DKIM_VALID_AU,PRX_BODY_13,SPF_HELO_NONE,SPF_NONE,T_SCC_BODY_TEXT_LINE,
 UPPERCASE_75_100,URIBL_BLOCKED,URIBL_DBL_BLOCKED_OPENDNS autolearn=disabled
 version=3.4.0
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 789ACF80163
 for <alsa-devel@alsa-project.org>; Thu, 10 Nov 2022 21:20:49 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 789ACF80163
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com
 header.b="PS6V6MwQ"
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1668111650; x=1699647650;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=bZs7GE5LPPvVRYSMyOmhxs8CknSTXgIZnrNa8RU3DJg=;
 b=PS6V6MwQNKil75jflnZROxUztyOysy4gxO6w7eSCbYoMUe0yb/xlnYKG
 oLya4+iSuOUMu4uwdrjq2hV2hsMl7MtaPavX2yDY4aHMVqVHgt9fHX/Wt
 KsKEAx0s0C4ud7Qetqh6rOA02KOmWeRWGS5XlxPZ2dUMdZ8oyhFPHMEW/
 wLzNwDjx/NTaAB1hZNwMBwCGbaXGPB7QMuaYvVDAmgdrSy8XmMmKM79DI
 UBnhAvcQ85oBoCBGDIhgnC7NRQuJAiGyjfsB+3rJOdJ3a+OpXyfgEpJQw
 KVbbrxqeJKiW7uW9UHg6SBtNfGj/6iVx++VfxZRM05wt3BHu2a0K9p0zP A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10527"; a="338197499"
X-IronPort-AV: E=Sophos;i="5.96,154,1665471600"; d="scan'208";a="338197499"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 10 Nov 2022 12:20:42 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10527"; a="700949953"
X-IronPort-AV: E=Sophos;i="5.96,154,1665471600"; d="scan'208";a="700949953"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
 by fmsmga008.fm.intel.com with ESMTP; 10 Nov 2022 12:20:38 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1otE2P-0003D1-1O;
 Thu, 10 Nov 2022 20:20:37 +0000
Date: Fri, 11 Nov 2022 04:20:01 +0800
...
To: Richard Fitzgerald <rf@opensource.cirrus.com>, lee@kernel.org,
 ...
 maz@kernel.org
Subject: Re: [PATCH 12/12] ASoC: cs48l32: Add codec driver for Cirrus Logic
 CS48L31/32/33
Message-ID: <202211110419.GHhsnhfs-lkp@intel.com>
References: <20221109165331.29332-13-rf@opensource.cirrus.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="4PHs3Q+OGjxA7QEK"
Content-Disposition: inline
In-Reply-To: <20221109165331.29332-13-rf@opensource.cirrus.com>
...
[also build test WARNING on lee-mfd/for-mfd-next linusw-pinctrl/devel linusw-pinctrl/for-next broonie-regulator/for-next linus/master]
...
patch link:    https://lore.kernel.org/r/20221109165331.29332-13-rf%40opensource.cirrus.com
patch subject: [PATCH 12/12] ASoC: cs48l32: Add codec driver for Cirrus Logic CS48L31/32/33
config: i386-allyesconfig
compiler: gcc-11 (Debian 11.3.0-8) 11.3.0
reproduce (this is a W=1 build):
        # https://github.com/intel-lab-lkp/linux/commit/66bc34007a7eabb0b819d76e13de3c33562b4525
        ...
        git checkout 66bc34007a7eabb0b819d76e13de3c33562b4525
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        make W=1 O=build_dir ARCH=i386 SHELL=/bin/bash drivers/pci/controller/cadence/ sound/soc/codecs/ sound/soc/intel/boards/
...
> 2257	static const char * const cs48l32_dai_clk_str(int clk_id)
  2258	{
  2259		switch (clk_id) {
  2260		case CS48L32_CLK_SYSCLK_1:
  2261		case CS48L32_CLK_SYSCLK_2:
  2262		case CS48L32_CLK_SYSCLK_3:
  2263		case CS48L32_CLK_SYSCLK_4:
  2264			return "SYSCLK";
  2265		default:
  2266			return "Unknown clock";
  2267		}
  2268	}
  2269	
