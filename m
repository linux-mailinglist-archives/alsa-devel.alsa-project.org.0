...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 363814B25B
	for <lists+alsa-devel@lfdr.de>; Wed, 19 Jun 2019 08:49:15 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 9BB0016B2;
	Wed, 19 Jun 2019 08:48:24 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 9BB0016B2
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1560926954;
	bh=4+CwOw/Vc+NYKIRoipcCd4XpQSxCLNCXQ32fp4/cTN8=;
	h=From:To:Date:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=dVV0sFSdVfIjsTq5xJwMkh5Pg+jZIxFpVFNHwBwmJYTVPXOMykt21ovyZZUPLK4Vr
	 QqSXP3AhK0+WQgcOqXUizCOqxcQ5tSqLjwT6JwqOCx6LPoaopJJPwojUE7NDVfMRej
	 DUOLlV/r6KZO92jNYz0cASpHxQJ/eQTK/82iop5g=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 147A6F89682;
	Wed, 19 Jun 2019 08:47:30 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 79E07F896B8; Wed, 19 Jun 2019 08:47:24 +0200 (CEST)
...
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 56A06F80C87
 for <alsa-devel@alsa-project.org>; Wed, 19 Jun 2019 08:47:18 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 56A06F80C87
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
 by orsmga106.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 18 Jun 2019 23:47:17 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.63,392,1557212400"; d="scan'208";a="150519890"
Received: from macchian.itwn.intel.com ([10.5.230.135])
 by orsmga007.jf.intel.com with ESMTP; 18 Jun 2019 23:47:15 -0700
From: mac.chiang@intel.com
To: alsa-devel@alsa-project.org
Date: Wed, 19 Jun 2019 14:47:17 +0800
Message-Id: <1560926837-5206-1-git-send-email-mac.chiang@intel.com>
X-Mailer: git-send-email 2.7.4
Cc: mac.chiang@intel.com, broonie@kernel.org, lgirdwood@gmail.com,
 liam.r.girdwood@intel.com
Subject: [alsa-devel] [PATCH v2] ASoC: max98357a: avoid speaker pop when
	playback startup
...
---
 ...
 sound/soc/codecs/max98357a.c                       | 68 +++++++++++++++++++---
...
@@ -61,19 +79,32 @@ static const struct snd_soc_dapm_route max98357a_dapm_routes[] = {
...
@@ -112,6 +143,25 @@ static struct snd_soc_dai_driver max98357a_dai_driver = {
