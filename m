...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 604F9630D78
	for <lists+alsa-devel@lfdr.de>; Sat, 19 Nov 2022 09:46:51 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id E5A0816F1;
	Sat, 19 Nov 2022 09:46:00 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz E5A0816F1
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1668847611;
	bh=sP5I3FMICjxqgWLJq2+4at1s6x8anFBdHJVeb6KeGAc=;
	h=Date:From:To:Subject:In-Reply-To:References:Cc:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 From;
	b=YMad43hWkxw9cK4sPx5ZSyxIWL0zUDj3ap+Lb1LuW8C7byB3SksPgyBqsEsd6yhTn
	 Z0wfk0BK754HcylnwNpMyPjfuaDbdgp/QyzVP1InRNUtsr4LRn6HyFUUoAz7uwmrOq
	 yH685ouv+JVNrrJ0D6Qu25wbMec/BMoeosteORcE=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 38C74F805E3;
	Sat, 19 Nov 2022 09:40:45 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 696F6F8025A; Thu, 17 Nov 2022 16:18:19 +0100 (CET)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on alsa1.perex.cz
X-Spam-Level: *
X-Spam-Status: No, score=1.5 required=5.0 tests=PRX_BODY_13,PRX_BODY_26,
...
Received: from frasgout.his.huawei.com (frasgout.his.huawei.com
 ...
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 72F78F80087
 for <alsa-devel@alsa-project.org>; Thu, 17 Nov 2022 16:18:12 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 72F78F80087
...
>=20
> diff --git a/Documentation/devicetree/bindings/arm/bcm/bcm2835.yaml b/Doc=
umentation/devicetree/bindings/arm/bcm/bcm2835.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,bcm21664.yaml=
...
>  maintainers:
>    - Florian Fainelli <f.fainelli@gmail.com>
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,bcm23550.yaml=
...
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,bcmbca.yaml b=
...
> =20
>  description:
>    Broadcom Broadband SoCs include family of high performance DSL/PON/Wir=
eless
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,cygnus.yaml b=
...
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,hr2.yaml b/Do=
cumentation/devicetree/bindings/arm/bcm/brcm,hr2.yaml
...
> =20
>  description:
>    Broadcom Hurricane 2 family of SoCs are used for switching control. Th=
ese SoCs
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,ns2.yaml b/Do=
cumentation/devicetree/bindings/arm/bcm/brcm,ns2.yaml
...
>  maintainers:
>    - Ray Jui <rjui@broadcom.com>
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,nsp.yaml b/Do=
cumentation/devicetree/bindings/arm/bcm/brcm,nsp.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,stingray.yaml=
...
>  maintainers:
>    - Ray Jui <rjui@broadcom.com>
> diff --git a/Documentation/devicetree/bindings/arm/bcm/brcm,vulcan-soc.ya=
ml b/Documentation/devicetree/bindings/arm/bcm/brcm,vulcan-soc.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/firmware/linaro,optee-=
tz.yaml b/Documentation/devicetree/bindings/arm/firmware/linaro,optee-tz.ya=
ml
...
> diff --git a/Documentation/devicetree/bindings/arm/hisilicon/hisilicon.ya=
ml b/Documentation/devicetree/bindings/arm/hisilicon/hisilicon.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/mstar/mstar.yaml b/Doc=
umentation/devicetree/bindings/arm/mstar/mstar.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/npcm/npcm.yaml b/Docum=
entation/devicetree/bindings/arm/npcm/npcm.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/nxp/lpc32xx.yaml b/Doc=
umentation/devicetree/bindings/arm/nxp/lpc32xx.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/socionext/milbeaut.yam=
l b/Documentation/devicetree/bindings/arm/socionext/milbeaut.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/socionext/uniphier.yam=
l b/Documentation/devicetree/bindings/arm/socionext/uniphier.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/sprd/sprd.yaml b/Docum=
entation/devicetree/bindings/arm/sprd/sprd.yaml
...
> diff --git a/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun6i-=
a31-cpuconfig.yaml b/Documentation/devicetree/bindings/arm/sunxi/allwinner,=
sun6i-a31-cpuconfig.yaml
> index f3878e0b3cc4..d805c4508b4e 100644
> --- a/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun6i-a31-cpu=
config.yaml
> +++ b/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun6i-a31-cpu=
config.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/arm/sunxi/allwinner,sun6i-a31-cpuconf=
ig.yaml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
> diff --git a/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun9i-=
a80-prcm.yaml b/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun9i=
-a80-prcm.yaml
> index 668aadbfe4c0..644f391afb32 100644
> --- a/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun9i-a80-prc=
m.yaml
> +++ b/Documentation/devicetree/bindings/arm/sunxi/allwinner,sun9i-a80-prc=
m.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/arm/sunxi/allwinner,sun9i-a80-prcm.ya=
ml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
>  maintainers:
>    - Chen-Yu Tsai <wens@csie.org>
> diff --git a/Documentation/devicetree/bindings/arm/tegra/nvidia,tegra-ccp=
lex-cluster.yaml b/Documentation/devicetree/bindings/arm/tegra/nvidia,tegra=
-ccplex-cluster.yaml
> index 869c266e7ebc..6089a96eae4f 100644
> --- a/Documentation/devicetree/bindings/arm/tegra/nvidia,tegra-ccplex-clu=
ster.yaml
> +++ b/Documentation/devicetree/bindings/arm/tegra/nvidia,tegra-ccplex-clu=
ster.yaml
> @@ -4,7 +4,7 @@
>  $id: "http://devicetree.org/schemas/arm/tegra/nvidia,tegra-ccplex-cluste=
r.yaml#"
>  $schema: "http://devicetree.org/meta-schemas/core.yaml#"
> =20
...
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
> -title: Texas Instruments K3 Multicore SoC architecture device tree bindi=
ngs
> +title: Texas Instruments K3 Multicore SoC architecture
> =20
>  maintainers:
>    - Nishanth Menon <nm@ti.com>
> diff --git a/Documentation/devicetree/bindings/arm/ti/ti,davinci.yaml b/D=
ocumentation/devicetree/bindings/arm/ti/ti,davinci.yaml
...
> diff --git a/Documentation/devicetree/bindings/display/bridge/anx6345.yam=
l b/Documentation/devicetree/bindings/display/bridge/anx6345.yaml
...
7033.yaml b/Documentation/devicetree/bindings/display/bridge/chrontel,ch703=
3.yaml
> index bb6289c7d375..b0589fa16736 100644
> --- a/Documentation/devicetree/bindings/display/bridge/chrontel,ch7033.ya=
ml
...
>  maintainers:
>    - Lubomir Rintel <lkundrak@v3.sk>
> diff --git a/Documentation/devicetree/bindings/display/bridge/ite,it6505.=
yaml b/Documentation/devicetree/bindings/display/bridge/ite,it6505.yaml
...
> diff --git a/Documentation/devicetree/bindings/display/bridge/ite,it66121=
.yaml b/Documentation/devicetree/bindings/display/bridge/ite,it66121.yaml
...
> diff --git a/Documentation/devicetree/bindings/display/ingenic,ipu.yaml b=
...
> diff --git a/Documentation/devicetree/bindings/display/ingenic,lcd.yaml b=
...
cec.yaml b/Documentation/devicetree/bindings/display/mediatek/mediatek,cec.=
yaml
...
> diff --git a/Documentation/devicetree/bindings/display/mediatek/mediatek,=
hdmi-ddc.yaml b/Documentation/devicetree/bindings/display/mediatek/mediatek=
,hdmi-ddc.yaml
> index b6fcdfb99ab2..bd8f7b8ae0ff 100644
> --- a/Documentation/devicetree/bindings/display/mediatek/mediatek,hdmi-dd=
c.yaml
> +++ b/Documentation/devicetree/bindings/display/mediatek/mediatek,hdmi-dd=
c.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/display/mediatek/mediatek,hdmi-ddc.ya=
ml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
>  maintainers:
>    - CK Hu <ck.hu@mediatek.com>
> diff --git a/Documentation/devicetree/bindings/display/panel/ilitek,ili91=
63.yaml b/Documentation/devicetree/bindings/display/panel/ilitek,ili9163.ya=
ml
...
> diff --git a/Documentation/devicetree/bindings/display/panel/visionox,rm6=
9299.yaml b/Documentation/devicetree/bindings/display/panel/visionox,rm6929=
9.yaml
> index 076b057b4af5..481ef051df1e 100644
> --- a/Documentation/devicetree/bindings/display/panel/visionox,rm69299.ya=
ml
> +++ b/Documentation/devicetree/bindings/display/panel/visionox,rm69299.ya=
ml
> @@ -4,7 +4,7 @@
...
> diff --git a/Documentation/devicetree/bindings/dma/ingenic,dma.yaml b/Doc=
umentation/devicetree/bindings/dma/ingenic,dma.yaml
...
> diff --git a/Documentation/devicetree/bindings/dma/ti/k3-pktdma.yaml b/Do=
cumentation/devicetree/bindings/dma/ti/k3-pktdma.yaml
...
>  maintainers:
>    - Peter Ujfalusi <peter.ujfalusi@gmail.com>
> diff --git a/Documentation/devicetree/bindings/dma/ti/k3-udma.yaml b/Docu=
mentation/devicetree/bindings/dma/ti/k3-udma.yaml
...
> diff --git a/Documentation/devicetree/bindings/eeprom/microchip,93lc46b.y=
aml b/Documentation/devicetree/bindings/eeprom/microchip,93lc46b.yaml
...
> diff --git a/Documentation/devicetree/bindings/i2c/ingenic,i2c.yaml b/Doc=
umentation/devicetree/bindings/i2c/ingenic,i2c.yaml
...
>  maintainers:
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/iio/adc/allwinner,sun8i-a3=
3-ths.yaml b/Documentation/devicetree/bindings/iio/adc/allwinner,sun8i-a33-=
ths.yaml
> index 15c514b83583..a73a355fc665 100644
> --- a/Documentation/devicetree/bindings/iio/adc/allwinner,sun8i-a33-ths.y=
aml
> +++ b/Documentation/devicetree/bindings/iio/adc/allwinner,sun8i-a33-ths.y=
aml
> @@ -4,7 +4,7 @@
...
>  maintainers:
>    - Chen-Yu Tsai <wens@csie.org>
> diff --git a/Documentation/devicetree/bindings/iio/adc/ti,palmas-gpadc.ya=
ml b/Documentation/devicetree/bindings/iio/adc/ti,palmas-gpadc.yaml
...
> diff --git a/Documentation/devicetree/bindings/input/pine64,pinephone-key=
board.yaml b/Documentation/devicetree/bindings/input/pine64,pinephone-keybo=
ard.yaml
> index e4a0ac0fff9a..490f6c3d9e4b 100644
> --- a/Documentation/devicetree/bindings/input/pine64,pinephone-keyboard.y=
aml
> +++ b/Documentation/devicetree/bindings/input/pine64,pinephone-keyboard.y=
aml
> @@ -4,7 +4,7 @@
...
> diff --git a/Documentation/devicetree/bindings/input/touchscreen/chipone,=
icn8318.yaml b/Documentation/devicetree/bindings/input/touchscreen/chipone,=
icn8318.yaml
> index 9df685bdc5db..74a8a01e0745 100644
> --- a/Documentation/devicetree/bindings/input/touchscreen/chipone,icn8318=
.yaml
> +++ b/Documentation/devicetree/bindings/input/touchscreen/chipone,icn8318=
.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/input/touchscreen/chipone,icn8318.yam=
l#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
> diff --git a/Documentation/devicetree/bindings/input/touchscreen/pixcir,p=
ixcir_ts.yaml b/Documentation/devicetree/bindings/input/touchscreen/pixcir,=
pixcir_ts.yaml
> index f9998edbff70..3305eda5ed88 100644
> --- a/Documentation/devicetree/bindings/input/touchscreen/pixcir,pixcir_t=
s.yaml
> +++ b/Documentation/devicetree/bindings/input/touchscreen/pixcir,pixcir_t=
s.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/input/touchscreen/pixcir,pixcir_ts.ya=
ml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
>  maintainers:
>    - Dmitry Torokhov <dmitry.torokhov@gmail.com>
> diff --git a/Documentation/devicetree/bindings/input/touchscreen/silead,g=
sl1680.yaml b/Documentation/devicetree/bindings/input/touchscreen/silead,gs=
l1680.yaml
> index eec6f7f6f0a3..95b554be25b4 100644
> --- a/Documentation/devicetree/bindings/input/touchscreen/silead,gsl1680.=
yaml
> +++ b/Documentation/devicetree/bindings/input/touchscreen/silead,gsl1680.=
yaml
> @@ -4,7 +4,7 @@
...
>  maintainers:
>    - Dmitry Torokhov <dmitry.torokhov@gmail.com>
> diff --git a/Documentation/devicetree/bindings/interrupt-controller/ingen=
ic,intc.yaml b/Documentation/devicetree/bindings/interrupt-controller/ingen=
ic,intc.yaml
> index 0358a7739c8e..609308a5f91d 100644
> --- a/Documentation/devicetree/bindings/interrupt-controller/ingenic,intc=
.yaml
> +++ b/Documentation/devicetree/bindings/interrupt-controller/ingenic,intc=
.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/interrupt-controller/ingenic,intc.yam=
l#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
intc.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/interrupt-controller/realtek,rtl-intc=
.yaml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
> =20
>  description:
>    Interrupt controller and router for Realtek MIPS SoCs, allowing each S=
oC
...
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
> -title: Dongwoon Anatech DW9768 Voice Coil Motor (VCM) Lens Device Tree B=
indings
...
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
> -title: STMicroelectronics VGxy61 HDR Global Shutter Sensor Family Device=
 Tree Bindings
> +title: STMicroelectronics VGxy61 HDR Global Shutter Sensor Family
> =20
>  maintainers:
>    - Benjamin Mugnier <benjamin.mugnier@foss.st.com>
> diff --git a/Documentation/devicetree/bindings/memory-controllers/ingenic=
,nemc-peripherals.yaml b/Documentation/devicetree/bindings/memory-controlle=
rs/ingenic,nemc-peripherals.yaml
> index b8ed52a44d57..89ebe3979012 100644
> --- a/Documentation/devicetree/bindings/memory-controllers/ingenic,nemc-p=
eripherals.yaml
> +++ b/Documentation/devicetree/bindings/memory-controllers/ingenic,nemc-p=
eripherals.yaml
> @@ -4,7 +4,7 @@
>  $id: http://devicetree.org/schemas/memory-controllers/ingenic,nemc-perip=
herals.yaml#
>  $schema: http://devicetree.org/meta-schemas/core.yaml#
> =20
...
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/memory-controllers/ingenic=
,nemc.yaml b/Documentation/devicetree/bindings/memory-controllers/ingenic,n=
emc.yaml
> index dd13a5106d6c..a02724221ff3 100644
> --- a/Documentation/devicetree/bindings/memory-controllers/ingenic,nemc.y=
aml
> +++ b/Documentation/devicetree/bindings/memory-controllers/ingenic,nemc.y=
aml
> @@ -4,7 +4,7 @@
...
>  maintainers:
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/memory-controllers/ti,gpmc=
.yaml b/Documentation/devicetree/bindings/memory-controllers/ti,gpmc.yaml
...
> diff --git a/Documentation/devicetree/bindings/mips/lantiq/lantiq,dma-xwa=
y.yaml b/Documentation/devicetree/bindings/mips/lantiq/lantiq,dma-xway.yaml
...
>  maintainers:
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/mtd/ingenic,nand.yaml b/Do=
cumentation/devicetree/bindings/mtd/ingenic,nand.yaml
...
>  maintainers:
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/net/can/allwinner,sun4i-a1=
0-can.yaml b/Documentation/devicetree/bindings/net/can/allwinner,sun4i-a10-=
can.yaml
> index 3c51b2d02957..9c494957a07a 100644
> --- a/Documentation/devicetree/bindings/net/can/allwinner,sun4i-a10-can.y=
aml
> +++ b/Documentation/devicetree/bindings/net/can/allwinner,sun4i-a10-can.y=
aml
> @@ -4,7 +4,7 @@
...
> =20
>  description: |
>    Open-source CAN FD IP core developed at the Czech Technical University=
 in Prague
...
>  maintainers:
>    - Andrew Lunn <andrew@lunn.ch>
> diff --git a/Documentation/devicetree/bindings/net/dsa/hirschmann,hellcre=
ek.yaml b/Documentation/devicetree/bindings/net/dsa/hirschmann,hellcreek.ya=
ml
...
>  allOf:
>    - $ref: dsa.yaml#
> diff --git a/Documentation/devicetree/bindings/net/dsa/mscc,ocelot.yaml b=
...
> diff --git a/Documentation/devicetree/bindings/net/dsa/nxp,sja1105.yaml b=
...
> =20
>  description:
>    The SJA1105 SPI interface requires a CS-to-CLK time (t2 in UM10944.pdf=
) of at
> diff --git a/Documentation/devicetree/bindings/net/wireless/esp,esp8089.y=
aml b/Documentation/devicetree/bindings/net/wireless/esp,esp8089.yaml
...
> =20
>  maintainers:
>    - J=C3=A9r=C3=B4me Pouiller <jerome.pouiller@silabs.com>
> diff --git a/Documentation/devicetree/bindings/nvmem/qcom,spmi-sdam.yaml =
...
> diff --git a/Documentation/devicetree/bindings/phy/ingenic,phy-usb.yaml b=
...
>  maintainers:
>    - Sebastian Reichel <sre@kernel.org>
> diff --git a/Documentation/devicetree/bindings/rtc/epson,rx8900.yaml b/Do=
cumentation/devicetree/bindings/rtc/epson,rx8900.yaml
...
> diff --git a/Documentation/devicetree/bindings/rtc/ingenic,rtc.yaml b/Doc=
umentation/devicetree/bindings/rtc/ingenic,rtc.yaml
...
> diff --git a/Documentation/devicetree/bindings/serial/brcm,bcm7271-uart.y=
aml b/Documentation/devicetree/bindings/serial/brcm,bcm7271-uart.yaml
...
> diff --git a/Documentation/devicetree/bindings/serial/ingenic,uart.yaml b=
...
> diff --git a/Documentation/devicetree/bindings/sound/cirrus,cs42l51.yaml =
...
> diff --git a/Documentation/devicetree/bindings/sound/ingenic,aic.yaml b/D=
ocumentation/devicetree/bindings/sound/ingenic,aic.yaml
...
>  maintainers:
>    - Paul Cercueil <paul@crapouillou.net>
> diff --git a/Documentation/devicetree/bindings/sound/ingenic,codec.yaml b=
...
> diff --git a/Documentation/devicetree/bindings/sound/qcom,lpass-tx-macro.=
yaml b/Documentation/devicetree/bindings/sound/qcom,lpass-tx-macro.yaml
...
>  maintainers:
>    - Srinivas Kandagatla <srinivas.kandagatla@linaro.org>
> diff --git a/Documentation/devicetree/bindings/sound/qcom,lpass-wsa-macro=
.yaml b/Documentation/devicetree/bindings/sound/qcom,lpass-wsa-macro.yaml
...
> diff --git a/Documentation/devicetree/bindings/sound/ti,src4xxx.yaml b/Do=
cumentation/devicetree/bindings/sound/ti,src4xxx.yaml
...
> diff --git a/Documentation/devicetree/bindings/spi/ingenic,spi.yaml b/Doc=
umentation/devicetree/bindings/spi/ingenic,spi.yaml
...
> diff --git a/Documentation/devicetree/bindings/spi/spi-gpio.yaml b/Docume=
ntation/devicetree/bindings/spi/spi-gpio.yaml
...
>  maintainers:
>    - Rob Herring <robh@kernel.org>
> diff --git a/Documentation/devicetree/bindings/timer/ingenic,tcu.yaml b/D=
ocumentation/devicetree/bindings/timer/ingenic,tcu.yaml
...
> diff --git a/Documentation/devicetree/bindings/usb/ingenic,musb.yaml b/Do=
cumentation/devicetree/bindings/usb/ingenic,musb.yaml
...
> diff --git a/Documentation/devicetree/bindings/usb/ti,tps6598x.yaml b/Doc=
umentation/devicetree/bindings/usb/ti,tps6598x.yaml
...
>  $schema: "http://devicetree.org/meta-schemas/core.yaml#"
> =20
> -title: Texas Instruments 6598x Type-C Port Switch and Power Delivery con=
troller DT bindings
> +title: Texas Instruments 6598x Type-C Port Switch and Power Delivery con=
troller
> =20
...
> diff --git a/Documentation/devicetree/bindings/usb/willsemi,wusb3801.yaml=
