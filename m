...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 8506E65E7F7
	for <lists+alsa-devel@lfdr.de>; Thu,  5 Jan 2023 10:38:08 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id C39D810325;
	Thu,  5 Jan 2023 10:37:08 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz C39D810325
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1672911478;
	bh=E9ThNX4ycgnAQLAPioK56btH5lPkY6OE2ShgbQRpaEI=;
	h=Date:From:To:Subject:References:In-Reply-To:List-Id:
	 List-Unsubscribe:List-Archive:List-Post:List-Help:List-Subscribe:
	 Cc:From;
	b=IZh4erWR9aDcKucQSoBNZN/Q3EIsEMJ3l8FBHJx2Ve5FbV3NxPQrs4vVqnS/eJWTo
	 cYnlyGlASuRsmwK8BNTGsDR+1jdXUrdmP/xlcooQgG96kmigdXiAa3lRaJevc6QsgG
	 XoZLd0ptxnyVhb9v95vxAr8/6rse1062o4/oEawk=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id C8174F8051A;
	Thu,  5 Jan 2023 10:37:04 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 0D3AFF80240; Wed,  4 Jan 2023 20:53:26 +0100 (CET)
...
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 052C8F8023B
 for <alsa-devel@alsa-project.org>; Wed,  4 Jan 2023 20:53:18 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 052C8F8023B
Authentication-Results: alsa1.perex.cz; dkim=pass (2048-bit key,
 unprotected) header.d=intel.com header.i=@intel.com header.a=rsa-sha256
 header.s=Intel header.b=KOVV8mgN
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1672862000; x=1704398000;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=E9ThNX4ycgnAQLAPioK56btH5lPkY6OE2ShgbQRpaEI=;
 b=KOVV8mgNNiUpIvmLpeUJ1SAE+O3TwFPot42fI8UE35VgoSDdKN88ElAP
 0m7T9YBIpMyXDuiHlIpMNDNq9FDjdBWViTX18+F7jUYi7ogL8i4UBcsSs
 2Pdne+KUG6CkmRdbsxlbTOudc2mGDQK20cPGhmlrK2fX1VN2EEhIqckpW
 b2BtXoDfNVy5+VsAb0dWlZhN1JwkDdJ0HvikIsc9ZSGqSFuNzcw/+xO1s
 /vyvEsZjDVhT2VgpTP0N+kdyBGKznlYD+c2HHUIfwZSEEhPB8ECJnCTS8
 M3zdpMxmyLZhYZUeGHZBZEcx6BWWO6MUVDP8o17Ehee/JhTaNB7nKQ5Ci w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="305530904"
X-IronPort-AV: E=Sophos;i="5.96,300,1665471600"; d="scan'208";a="305530904"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
 by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 04 Jan 2023 11:53:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10580"; a="723775296"
X-IronPort-AV: E=Sophos;i="5.96,300,1665471600"; d="scan'208";a="723775296"
Received: from lkp-server02.sh.intel.com (HELO f1920e93ebb5) ([10.239.97.151])
 by fmsmga004.fm.intel.com with ESMTP; 04 Jan 2023 11:53:08 -0800
Received: from kbuild by f1920e93ebb5 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1pD9ox-0000iO-2z;
 Wed, 04 Jan 2023 19:53:07 +0000
Date: Thu, 5 Jan 2023 03:52:08 +0800
...
Message-ID: <202301050336.xFesRzRS-lkp@intel.com>
References: <20230104064342.2094-2-kiseok.jo@irondevice.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="NqBGPLwKksrbWiTQ"
...
[also build test ERROR on robh/for-next linus/master v6.2-rc2 next-20221226]
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/0b15568ccfb962f9143de22e5b7c98ccbf058d71
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Kiseok-Jo/ASoC-sma1303-Add-driver-for-Iron-Device-SMA1303-Amp/20230104-150052
        git checkout 0b15568ccfb962f9143de22e5b7c98ccbf058d71
...
>> sound/soc/codecs/sma1303.c:2092:19: error: initialization of 'void (*)(struct i2c_client *)' from incompatible pointer type 'int (*)(struct i2c_client *)' [-Werror=incompatible-pointer-types]
    2092 |         .remove = sma1303_i2c_remove,
         |                   ^~~~~~~~~~~~~~~~~~
   sound/soc/codecs/sma1303.c:2092:19: note: (near initialization for 'sma1303_i2c_driver.remove')
...
vim +2092 sound/soc/codecs/sma1303.c
  ...
  2085	
  2086	static struct i2c_driver sma1303_i2c_driver = {
  2087		.driver = {
  2088			.name = "sma1303",
  2089			.of_match_table = sma1303_of_match,
  2090		},
  2091		.probe = sma1303_i2c_probe,
> 2092		.remove = sma1303_i2c_remove,
  2093		.id_table = sma1303_i2c_id,
  2094	};
  2095	
...
# Linux/mips 6.2.0-rc1 Kernel Configuration
#
