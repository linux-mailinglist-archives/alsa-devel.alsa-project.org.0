...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E5E026D921B
	for <lists+alsa-devel@lfdr.de>; Thu,  6 Apr 2023 10:57:11 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 06A8284B;
	Thu,  6 Apr 2023 10:56:20 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 06A8284B
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1680771430;
	bh=XCzkOKbYuBgQv+8QB2AgvwdNXFiU9EKkxEPc4L5TrFY=;
	h=From:To:Subject:Date:CC:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=oxgWeP+wp8din8yYlqmFXzmnbPcMJClGoIXZTAi8NEIxwvif7h0Ett7L8WBOpJV5o
	 vvJV9060woNDCxKDShrOYTEw9Dgsw+bt+l8/WThwOXTlb+meROguqkLq2+NNr+wu1N
	 QGMBaKwDgqRAq151w42TkyI2V7mMFw0jvWy7cnPc=
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 3A439F8013D;
	Thu,  6 Apr 2023 10:56:19 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id C0A4FF80246; Thu,  6 Apr 2023 10:56:13 +0200 (CEST)
...
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
 ...
 SHA256)
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 0F416F80149
	for <alsa-devel@alsa-project.org>; Thu,  6 Apr 2023 10:55:49 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 0F416F80149
Authenticated-By: 
X-SpamFilter-By: ArmorX SpamTrap 5.77 with qID 3368tMgU5012696,
 This message is accepted by code: ctloc85258
Received: from mail.realtek.com (rtexh36506.realtek.com.tw[172.21.6.27])
	by rtits2.realtek.com.tw (8.15.2/2.81/5.90) with ESMTPS id 3368tMgU5012696
	(version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=OK);
	Thu, 6 Apr 2023 16:55:22 +0800
Received: from RTEXMBS01.realtek.com.tw (172.21.6.94) by
 RTEXH36506.realtek.com.tw (172.21.6.27) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.17; Thu, 6 Apr 2023 16:55:42 +0800
...
Subject: [PATCH v4] ASoC: rt712-sdca: Add RT712 SDCA driver for Mic topology
Date: Thu, 6 Apr 2023 16:55:35 +0800
Message-ID: <20230406085535.52002-1-shumingf@realtek.com>
...
X-KSE-AntiSpam-Interceptor-Info: fallback
Message-ID-Hash: W3F6FYVPB35JDXR3KRLCUGMDOPKHAANO
X-Message-ID-Hash: W3F6FYVPB35JDXR3KRLCUGMDOPKHAANO
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/W3F6FYVPB35JDXR3KRLCUGMDOPKHAANO/>
List-Archive: 
...
---
Changes in v4:
  - fix the warnings reported by the test robot.
    warning: no previous prototype for 'rt712_sdca_dmic_io_init' [-Wmissing-prototypes]
    warning: no previous prototype for 'rt712_sdca_dmic_init' [-Wmissing-prototypes]

Changes in v3:
  - Re-order the include header and remove the redundant header.

Changes in v2:
  - Correct the signed name and e-mail address.
---
...
index 44ea747579fd..5cdbae88e6e3 100644
--- a/sound/soc/codecs/Makefile
+++ b/sound/soc/codecs/Makefile
@@ -234,6 +234,7 @@ snd-soc-rt700-objs := rt700.o rt700-sdw.o
...
@@ -603,6 +604,7 @@ obj-$(CONFIG_SND_SOC_RT700)     += snd-soc-rt700.o
