...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id E1D2458C3E4
	for <lists+alsa-devel@lfdr.de>; Mon,  8 Aug 2022 09:21:17 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 47958827;
	Mon,  8 Aug 2022 09:20:27 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 47958827
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1659943277;
	bh=vhwMw9SAcsqNgVd0+npBt5KPnFsVcNo4UdG3+UR6kiM=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=CjRR12SilCtWwCEaLzQovn5FVgncdoC0xBjC+LEHCEJ33TMbBGP0CubYdNsuMdaWL
	 j4UtoNJW8F846fCxWCd5niHAB3DWiSOZ0B0q9065V79ARFDzVXczKJje8kvUsEPTWb
	 jU6Gjo+jtCrPOUG96UEQwEZY8S0tB9ww+RDGwbN8=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id 9EC04F804B1;
	Mon,  8 Aug 2022 09:20:18 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 7310FF8049C; Mon,  8 Aug 2022 09:20:16 +0200 (CEST)
...
Received: from dev.flatmax.com (41.68.233.220.static.exetel.com.au
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id C774AF8012B
 for <alsa-devel@alsa-project.org>; Mon,  8 Aug 2022 09:20:09 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz C774AF8012B
Received: by dev.flatmax.com (Postfix, from userid 1000)
 id 853FB3846D76; Mon,  8 Aug 2022 17:20:03 +1000 (AEST)
From: Matt Flax <flatmax@flatmax.com>
To: alsa-devel@alsa-project.org
Subject: [PATCH] ASoC: codecs: add support for the TI SRC4392 codec
Date: Mon,  8 Aug 2022 17:19:52 +1000
Message-Id: <20220808071952.2432253-1-flatmax@flatmax.com>
...
---
 ...
 sound/soc/codecs/src4xxx.c     | 538 +++++++++++++++++++++++++++++++++
...
index d16b4efb88a7..44c19d973ef3 100644
...
index 000000000000..4547078a076b
--- /dev/null
...
new file mode 100644
index 000000000000..11ad6cb5b086
--- /dev/null
...
+	SND_SOC_DAPM_MUX("SRC mclk source", SRC4XXX_PWR_RST_01,
...
+
+	dev_info(dai->dev, "__func__ exit\n");
+	return 0;
+}
+
...
+
+	dev_info(dai->dev, "__func__ enter for dai %d\n", dai->id);
+
...
+		}
+
+		dev_info(dai->dev, "__func__ mclk %d rate %d div %d\n",
+			src4xxx->mclk_hz, params_rate(params), mclk_div);
+		val = ((int)mclk_div - 128) / 128;
+		dev_info(dai->dev,
+			"__func__ register value = %d\n", val);
+		if ((val < 0) | (val > 3)) {
+			dev_err(component->dev,
...
new file mode 100644
index 000000000000..5e7b468bc22e
--- /dev/null
...
+ *
+ * Copyright 2021-2022 Deqx Pty Ltd
+ * Author: Matt R, Fkax <flatmax@flatmax.com>
+ */
+
