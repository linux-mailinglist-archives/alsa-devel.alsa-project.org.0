...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CD8850C66F
	for <lists+alsa-devel@lfdr.de>; Sat, 23 Apr 2022 04:17:25 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 1CFA384A;
	Sat, 23 Apr 2022 04:16:35 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 1CFA384A
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1650680245;
	bh=RcAcyR0T3OQm6xHAgbQd2TLnd1jJ6gEyvwbg699wvjA=;
	h=From:To:Subject:Date:Cc:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=ZoCwEaXuJMsmJMNlldwys8SuJbqX3EgWIW9XevQNmxc1S7pKZ5w4GTKToAeGfd2sL
	 to+K5Rm2BtulYEJ+B/XGBJTudbxPEmmR/S5GurYFRs2x/n56YV/QP+0/2LioURsdWE
	 OqlnimeEQze/rjGuqA+HxshZ/PR+AvuId5cQQFqQ=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id A3E97F8013F;
	Sat, 23 Apr 2022 04:16:26 +0200 (CEST)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id BAC65F80248; Sat, 23 Apr 2022 04:16:23 +0200 (CEST)
...
Received: from mail-pl1-x62c.google.com (mail-pl1-x62c.google.com
 ...
 (No client certificate requested)
 by alsa1.perex.cz (Postfix) with ESMTPS id 9B649F800B6
 for <alsa-devel@alsa-project.org>; Sat, 23 Apr 2022 04:16:16 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 9B649F800B6
Authentication-Results: alsa1.perex.cz;
 dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com
 header.b="MVhmkFT8"
Received: by mail-pl1-x62c.google.com with SMTP id c12so14630582plr.6
 for <alsa-devel@alsa-project.org>; Fri, 22 Apr 2022 19:16:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=from:to:cc:subject:date:message-id:mime-version
 :content-transfer-encoding;
 bh=3nXTukVPgS+c4r/LMv04GclVMHgYNXxEaeiA4PFkVnY=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :content-transfer-encoding;
 bh=3nXTukVPgS+c4r/LMv04GclVMHgYNXxEaeiA4PFkVnY=;
 b=
X-Gm-Message-State: AOAM532Fm5Ros0/40jIjz6LXsIpkqoIx3Jsqoa/NL6lgsV+4izQCOtEk
 p+AhtG0yNNfFTJSQyRlzz2U=
X-Google-Smtp-Source: ABdhPJxIhX9rF9KEGLFQjCf2eWwSaUEhTqCc5GLAiOq4wCyvz109wDlysBs6m6Q1xsJSBepmDu2iyQ==
X-Received: by 2002:a17:902:7884:b0:158:b5b6:572c with SMTP id
 q4-20020a170902788400b00158b5b6572cmr7519904pll.144.1650680173674; 
 Fri, 22 Apr 2022 19:16:13 -0700 (PDT)
Received: from localhost.localdomain (c-73-241-94-58.hsd1.ca.comcast.net.
 [73.241.94.58]) by smtp.gmail.com with ESMTPSA id
 by8-20020a056a00400800b0050a96357226sm3613544pfb.40.2022.04.22.19.16.10
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Fri, 22 Apr 2022 19:16:12 -0700 (PDT)
...
Subject: [PATCH V3 2/2] ASoC: max98396: add amplifier driver
Date: Fri, 22 Apr 2022 19:15:58 -0700
Message-Id: <20220423021558.1773598-1-ryan.lee.analog@gmail.com>
...
---
  ...
  Changes from v2:
    : Fixed build warnings reported by kernel test robot.
      uninitialized variable 'update' was used.

 sound/soc/codecs/Kconfig    |   10 +
 sound/soc/codecs/Makefile   |    2 +
 sound/soc/codecs/max98396.c | 1636 +++++++++++++++++++++++++++++++++++
...
index 000000000000..745d7e761680
--- /dev/null
