...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 06A917E9BB1
	for <lists+alsa-devel@lfdr.de>; Mon, 13 Nov 2023 12:59:40 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id 231FDE0E;
	Mon, 13 Nov 2023 12:58:49 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz 231FDE0E
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1699876779;
	bh=ugub8qNcQYVCFE4YOObQQzm+fuPY4ZLuGoEXd7qg4wQ=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-Id:
	 List-Archive:List-Help:List-Owner:List-Post:List-Subscribe:
	 List-Unsubscribe:From;
	b=Mec9PYWYzkNHC0uCzfzrytV6xdcZrICCeqDIbnCSrob4iQ/T78cAbUP+z0+bKnDIQ
	 q2H0bcg2v1GxLIXB8El0AJTwTBUKssxFnNrqy7aqvOaHj2tyY8Y9TfbGxbNrXo6YXc
	 peRhrLPUVaMNdElPBX+ZhsKzfPVvI2wEEal8Hg+8=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id A5EE1F805C9; Mon, 13 Nov 2023 12:57:42 +0100 (CET)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 5BFDFF805BA;
	Mon, 13 Nov 2023 12:57:41 +0100 (CET)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 5F632F80152; Mon, 13 Nov 2023 11:25:26 +0100 (CET)
...
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id ACE07F802E8
	for <alsa-devel@alsa-project.org>; Mon, 13 Nov 2023 11:22:17 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz ACE07F802E8
Received: from smtp.kernel.org (transwarp.subspace.kernel.org [100.75.92.58])
	by ams.source.kernel.org (Postfix) with ESMTP id 1DB6CB80D27;
	Mon, 13 Nov 2023 10:22:17 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C1CA7C433C7;
...
Subject: [PATCH 6/8] v4l2-ctl: support v4l-audio devices
Date: Mon, 13 Nov 2023 11:18:47 +0100
Message-ID: 
 <3042616671bed8d6ae4480ed5e539b3f631bcacc.1699870530.git.hverkuil-cisco@xs4all.nl>
...
Message-ID-Hash: S4TWONMZQU2WD6K7HR4QJOSXZBNRJQFR
X-Message-ID-Hash: S4TWONMZQU2WD6K7HR4QJOSXZBNRJQFR
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/S4TWONMZQU2WD6K7HR4QJOSXZBNRJQFR/>
List-Archive: 
...
index 63522e87..18dd2c9b 100644
...
index 40817a82..82463244 100644
...
index 4cd84f78..d3f96bef 100644
...
@@ -1213,6 +1232,9 @@ int main(int argc, char **argv)
 		case OptHelpMeta:
 			meta_usage();
 			return 0;
+		case OptHelpAudio:
...
+			audio_cmd(ch, optarg);
 			...
 			misc_cmd(ch, optarg);
@@ -1315,6 +1338,7 @@ int main(int argc, char **argv)
