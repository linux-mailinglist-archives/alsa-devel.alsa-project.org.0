...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DF30892E44
	for <lists+alsa-devel@lfdr.de>; Sun, 31 Mar 2024 04:20:03 +0200 (CEST)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id A4386238D;
	Sun, 31 Mar 2024 04:19:52 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz A4386238D
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1711851602;
	bh=2J+aIDzm0dCEZU4eb9y+XYfK9Zh/Gzd9tuilQ3eGb3E=;
	h=From:To:CC:Subject:Date:List-Id:List-Archive:List-Help:List-Owner:
	 List-Post:List-Subscribe:List-Unsubscribe:From;
	b=pQwsvAY33uczWxyLFCel5Qv6kWXstXdGo8svQJas95dYdtAeLPX/R8d4nIDhpg0Aa
	 lksa74l1gnAiGOAtHyxETH1pv3Z12iljLLswx3DV7/bR2F7FQH19B5dEtIBb8zUfZR
	 jqlLagvI3bICDlTDAcq/HS+/F/TSUzPBKJnvQUXk=
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id AAE82F805A8; Sun, 31 Mar 2024 04:19:33 +0200 (CEST)
Received: from mailman-core.alsa-project.org (mailman-core.alsa-project.org [10.254.200.10])
	by alsa1.perex.cz (Postfix) with ESMTP id 95599F805A8;
	Sun, 31 Mar 2024 04:19:31 +0200 (CEST)
Received: by alsa1.perex.cz (Postfix, from userid 50401)
	id 21943F80236; Sun, 31 Mar 2024 04:15:47 +0200 (CEST)
...
Received: from lelv0142.ext.ti.com (lelv0142.ext.ti.com [198.47.23.249])
	...
	(No client certificate requested)
	by alsa1.perex.cz (Postfix) with ESMTPS id 3CA2AF80093
	for <alsa-devel@alsa-project.org>; Sun, 31 Mar 2024 04:15:12 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 3CA2AF80093
Authentication-Results: alsa1.perex.cz;
	dkim=pass (1024-bit key,
 unprotected) header.d=ti.com header.i=@ti.com header.a=rsa-sha256
 header.s=ti-com-17Q1 header.b=cg5QBBv5
Received: from lelv0265.itg.ti.com ([10.180.67.224])
	by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id 42V2F7JK034234;
	Sat, 30 Mar 2024 21:15:07 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
	s=ti-com-17Q1; t=1711851307;
	bh=6bTU5MjHl+KD7kUr5P0FmginN72FYOlvcHO/ED7SeWQ=;
	h=From:To:CC:Subject:Date;
	b=cg5QBBv5Q6VTr+ysMTpR2mUmDzWbJwbOz15PrepxZa729X9faJFGsJh76IdXQ7tcy
	 x6u6KBBngj/pNIaeubRKIkdKyJkk6dd95x4Pin6X/9LREX/Ir0eek8AZ+LN9JKn975
	 se1m/uQre0EGEkhLfx4ge90cGw2/fm+JEzbxdKSY=
Received: from DFLE108.ent.ti.com (dfle108.ent.ti.com [10.64.6.29])
	by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 42V2F7Qh028898
	(version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
	Sat, 30 Mar 2024 21:15:07 -0500
Received: from DFLE110.ent.ti.com (10.64.6.31) by DFLE108.ent.ti.com
 (10.64.6.29) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Sat, 30
 Mar 2024 21:15:07 -0500
Received: from lelvsmtp6.itg.ti.com (10.180.75.249) by DFLE110.ent.ti.com
 (10.64.6.31) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Sat, 30 Mar 2024 21:15:07 -0500
Received: from LT5CG31242FY.dhcp.ti.com ([10.250.160.249])
	by lelvsmtp6.itg.ti.com (8.15.2/8.15.2) with ESMTP id 42V2F0Kw102010;
	Sat, 30 Mar 2024 21:15:01 -0500
...
Subject: [PATCH v12] ASoc: tas2783: Add tas2783 codec driver
Date: Sun, 31 Mar 2024 10:14:57 +0800
Message-ID: <20240331021458.1418-1-shenghao-ding@ti.com>
X-Mailer: git-send-email 2.33.0.windows.2
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Content-Type: text/plain
X-EXCLAIMER-MD-CONFIG: e1e8a2fd-e40a-4ac6-ac9b-f7e9cc9ee180
Message-ID-Hash: NPWXYHHFK7BED4CWIRKUNBQ4OCHF732C
X-Message-ID-Hash: NPWXYHHFK7BED4CWIRKUNBQ4OCHF732C
...
Archived-At: 
 <https://mailman.alsa-project.org/hyperkitty/list/alsa-devel@alsa-project.org/message/NPWXYHHFK7BED4CWIRKUNBQ4OCHF732C/>
List-Archive: 
...
Change in v12:
 ...
 - remove "struct snd_soc_component *component"
 - Add some SDCA registers as readable
 - remove unnecessary dev_dbg log for timestamp
 - playback still work without calibrated data stored in UEFI, for example
   bypass mode. Even if in case of dsp mode, algo can still work with
   default calibrated data. So, not an error, use dev_info for them
---
 sound/soc/codecs/Kconfig       |  16 +
 sound/soc/codecs/Makefile      |   2 +
 sound/soc/codecs/tas2783-sdw.c | 892 +++++++++++++++++++++++++++++++++
...
index 000000000000..429191b79f8d
--- /dev/null
...
+	switch (reg) {
+	case 0x8000 ... 0x807F:
+	case SDW_SDCA_CTL(TAS2783_FUNC_TYPE_SMART_AMP, TAS2783_SDCA_ENT_FU21,
+		TAS2783_SDCA_CTL_FU_MUTE, 0):
+	case SDW_SDCA_CTL(TAS2783_FUNC_TYPE_SMART_AMP, TAS2783_SDCA_ENT_FU21,
+		TAS2783_SDCA_CTL_FU_VOLUME, 0):
+	case SDW_SDCA_CTL(TAS2783_FUNC_TYPE_SMART_AMP, TAS2783_SDCA_ENT_FU23,
+		TAS2783_SDCA_CTL_FU_MUTE, 0):
+		return true;
+	default:
+		return false;
...
+			"using default calibration data, wrong data in EFI.");
+		return;
+	}
+	crc = crc32(~0, tmp_val, calib_info.byt_sz) ^ ~0;
+	if (crc != tmp_val[calib_info.crc32_pos]) {
+		dev_info(tas_dev->dev,
+			"using default calibration data, crc not match.");
+		return;
+	}
+
...
+
+	for (i = 0; i < calib_info.number_of_devices; i++) {
+		k = i * (arr_size + 1);
+
+		if (dev_indx != calib_info.cali_data[k])
+			continue;
+
+		/* +1: skip 4 byte dev-indx info */
+		cali_start = (u8 *)&calib_info.cali_data[k + 1];
+
...
+			if (ret) {
+				dev_err(tas_dev->dev,
+					"%s: Cali data writing failed %x:%d\n",
+					__func__, tas2783_cali_reg[j], ret);
+				break;
+			}
+		}
+		return;
...
+	if (tmp_val[0] != 2783) {
+		dev_err(tas_dev->dev, "No tas2783 calibration data\n");
+		return;
+	}
+
...
new file mode 100644
index 000000000000..1b91eae47f29
--- /dev/null
