...
Received: from alsa0.perex.cz (alsa0.perex.cz [77.48.224.243])
	by mail.lfdr.de (Postfix) with ESMTPS id 2824015B91D
	for <lists+alsa-devel@lfdr.de>; Thu, 13 Feb 2020 06:39:46 +0100 (CET)
Received: from alsa1.perex.cz (alsa1.perex.cz [207.180.221.201])
	(using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
	(No client certificate requested)
	by alsa0.perex.cz (Postfix) with ESMTPS id BD8641676;
	Thu, 13 Feb 2020 06:38:55 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa0.perex.cz BD8641676
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=alsa-project.org;
	s=default; t=1581572385;
	bh=I/Wgw9zCN/jjx/pWjNC10r5UdPmKvuQNFPFaOxMdIss=;
	h=Date:From:To:Cc:Subject:List-Id:List-Unsubscribe:List-Archive:
	 List-Post:List-Help:List-Subscribe:From;
	b=O1CMyy2sD6r7tl0mb+8sAAGi8LI24QO6AJovao3o1Vlkpuj6ZCKsnBvUD2+prw81h
	 DFGrFVlExjMSjSw2d7nyB4R2mpj8WyUzySx3CbF3M3ks9/lPK35fnfi6mSyNtb1CrP
	 dTJsReAy4PQMbCuUXbeV6Lw5fwfH1NL+A0G1nBGQ=
Received: from alsa1.perex.cz (localhost.localdomain [127.0.0.1])
	by alsa1.perex.cz (Postfix) with ESMTP id E8A1FF80278;
	Thu, 13 Feb 2020 06:37:26 +0100 (CET)
X-Original-To: alsa-devel@alsa-project.org
Delivered-To: alsa-devel@alsa-project.org
Received: by alsa1.perex.cz (Postfix, from userid 50401)
 id 09511F80277; Thu, 13 Feb 2020 06:37:23 +0100 (CET)
...
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com
 [210.160.252.172])
 by alsa1.perex.cz (Postfix) with ESMTP id 40190F800F0
 for <alsa-devel@alsa-project.org>; Thu, 13 Feb 2020 06:37:15 +0100 (CET)
DKIM-Filter: OpenDKIM Filter v2.11.0 alsa1.perex.cz 40190F800F0
Date: 13 Feb 2020 14:37:13 +0900
X-IronPort-AV: E=Sophos;i="5.70,434,1574089200"; d="scan'208";a="38938188"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
 by relmlie6.idc.renesas.com with ESMTP; 13 Feb 2020 14:37:13 +0900
Received: from mercury.renesas.com (unknown [10.166.252.133])
 by relmlir5.idc.renesas.com (Postfix) with ESMTP id 92BA84009BE5;
 Thu, 13 Feb 2020 14:37:13 +0900 (JST)
Message-ID: <87sgjfqc8v.wl-kuninori.morimoto.gx@renesas.com>
...
Subject: [alsa-devel] [PATCH] ASoC: dt-bindings: simple-card: switch to yaml
	base Documentation
...
---
 ...
 .../bindings/sound/simple-card.yaml           | 459 ++++++++++++++++++
 2 files changed, 459 insertions(+), 351 deletions(-)
...
index 000000000000..7c9ced323787
--- /dev/null
...
+      Each entry is a pair of strings, the first being the
+      sink, the second being the source.
+    $ref: /schemas/types.yaml#/definitions/non-unique-string-array
+
+patternProperties:
+  "^simple-audio-card,cpu(@.*)?":
